...
func (t *FurnitureExcelDto) UnmarshalMessage(e *FurnitureExcel) error {
	...
	t.Category = FurnitureCategory(int32(fbsutils.Convert(e.Category(), t.FlatBuffer.TableKey)))
	...
	t.FurnitureFunctionType = FurnitureFunctionType(int32(fbsutils.Convert(e.FurnitureFunctionType(), t.FlatBuffer.TableKey)))
	...
	t.SubCategory = FurnitureSubCategory(int32(fbsutils.Convert(e.SubCategory(), t.FlatBuffer.TableKey)))
