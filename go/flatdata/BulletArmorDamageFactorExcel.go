...
func BulletArmorDamageFactorExcelAddShowHighlightFloater(builder *flatbuffers.Builder, showHighlightFloater bool) {
	builder.PrependBoolSlot(1, showHighlightFloater, false)
}
