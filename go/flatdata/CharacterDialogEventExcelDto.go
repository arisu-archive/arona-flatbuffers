...
func (t *CharacterDialogEventExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t.FlatBuffer.TableKey == nil {
		t.FlatBuffer.InitKey(fbsutils.CreateTableKey("CharacterDialogEventExcel"))
	}
	CharacterDialogEventExcelStart(b)
	CharacterDialogEventExcelAddActionName(b, fbsutils.Convert(b.CreateString(t.ActionName), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddAnimationName(b, fbsutils.Convert(b.CreateString(t.AnimationName), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddCollectionVisible(b, fbsutils.Convert(t.CollectionVisible, t.FlatBuffer.TableKey))
	...
	CharacterDialogEventExcelAddLocalizeCvGroup(b, fbsutils.Convert(b.CreateString(t.LocalizeCvGroup), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddLocalizeEn(b, fbsutils.Convert(b.CreateString(t.LocalizeEn), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddLocalizeJp(b, fbsutils.Convert(b.CreateString(t.LocalizeJp), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddLocalizeKr(b, fbsutils.Convert(b.CreateString(t.LocalizeKr), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddLocalizeTh(b, fbsutils.Convert(b.CreateString(t.LocalizeTh), t.FlatBuffer.TableKey))
	CharacterDialogEventExcelAddLocalizeTw(b, fbsutils.Convert(b.CreateString(t.LocalizeTw), t.FlatBuffer.TableKey))
...
func (t *CharacterDialogEventExcelDto) UnmarshalMessage(e *CharacterDialogEventExcel) error {
	...
	t.DialogConditionDetail = DialogConditionDetail(int32(fbsutils.Convert(e.DialogConditionDetail(), t.FlatBuffer.TableKey)))
