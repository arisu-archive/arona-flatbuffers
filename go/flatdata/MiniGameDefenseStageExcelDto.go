...
func (t *MiniGameDefenseStageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	MiniGameDefenseStageExcelAddName(b, fbsutils.Convert(b.CreateString(t.Name), t.FlatBuffer.TableKey))
	...
	MiniGameDefenseStageExcelAddDefenseFormationBgPrefab(b, fbsutils.Convert(b.CreateString(t.DefenseFormationBgPrefab), t.FlatBuffer.TableKey))
