...
func (t *ConquestObjectExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConquestObjectExcelAddDisposable(b, fbsutils.Convert(t.Disposable, t.FlatBuffer.TableKey))
	...
	ConquestObjectExcelAddName(b, fbsutils.Convert(b.CreateString(t.Name), t.FlatBuffer.TableKey))
	ConquestObjectExcelAddPrefabName(b, fbsutils.Convert(b.CreateString(t.PrefabName), t.FlatBuffer.TableKey))
