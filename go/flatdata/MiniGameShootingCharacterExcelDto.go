...
func (t *MiniGameShootingCharacterExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	MiniGameShootingCharacterExcelAddDeathSkillData(b, fbsutils.Convert(b.CreateString(t.DeathSkillData), t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddDefensePower(b, fbsutils.Convert(t.DefensePower, t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddIgnoreObstacleCheck(b, fbsutils.Convert(t.IgnoreObstacleCheck, t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddIsBoss(b, fbsutils.Convert(t.IsBoss, t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddMaxHp(b, fbsutils.Convert(t.MaxHp, t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddModelPrefabName(b, fbsutils.Convert(b.CreateString(t.ModelPrefabName), t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddMoveSpeed(b, fbsutils.Convert(t.MoveSpeed, t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelAddNormalAttackSkillData(b, fbsutils.Convert(b.CreateString(t.NormalAttackSkillData), t.FlatBuffer.TableKey))
	MiniGameShootingCharacterExcelStartPublicSkillDataVector(b, len(t.PublicSkillData))
	for i := range len(t.PublicSkillData) {
		b.PrependUOffsetT(fbsutils.Convert(b.CreateString(t.PublicSkillData[len(t.PublicSkillData)-i-1]), t.FlatBuffer.TableKey))
	}
	...
	MiniGameShootingCharacterExcelAddSpineResourceName(b, fbsutils.Convert(b.CreateString(t.SpineResourceName), t.FlatBuffer.TableKey))
...
func (t *MiniGameShootingCharacterExcelDto) UnmarshalMessage(e *MiniGameShootingCharacterExcel) error {
	...
	t.IgnoreObstacleCheck = fbsutils.Convert(e.IgnoreObstacleCheck(), t.FlatBuffer.TableKey)
	t.IsBoss = fbsutils.Convert(e.IsBoss(), t.FlatBuffer.TableKey)
