...
func (t *MiniGameRhythmExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	MiniGameRhythmExcelAddComboImagePath(b, fbsutils.Convert(b.CreateString(t.ComboImagePath), t.FlatBuffer.TableKey))
	...
	MiniGameRhythmExcelAddIsSpecial(b, fbsutils.Convert(t.IsSpecial, t.FlatBuffer.TableKey))
	...
	MiniGameRhythmExcelAddPresetName(b, fbsutils.Convert(b.CreateString(t.PresetName), t.FlatBuffer.TableKey))
	MiniGameRhythmExcelAddRhythmBgmId(b, fbsutils.Convert(t.RhythmBgmId, t.FlatBuffer.TableKey))
	MiniGameRhythmExcelAddRhythmFileName(b, fbsutils.Convert(b.CreateString(t.RhythmFileName), t.FlatBuffer.TableKey))
