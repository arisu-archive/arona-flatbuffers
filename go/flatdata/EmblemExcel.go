...
func EmblemExcelAddEmblemBgPathEn(builder *flatbuffers.Builder, emblemBgPathEn flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(emblemBgPathEn), 0)
}
...
func EmblemExcelAddEmblemBgPathKr(builder *flatbuffers.Builder, emblemBgPathKr flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(emblemBgPathKr), 0)
}
...
func EmblemExcelAddEmblemBgPathTw(builder *flatbuffers.Builder, emblemBgPathTw flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(emblemBgPathTw), 0)
}
func EmblemExcelAddEmblemIconBgPath(builder *flatbuffers.Builder, emblemIconBgPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(emblemIconBgPath), 0)
}
...
func EmblemExcelAddEmblemIconPath(builder *flatbuffers.Builder, emblemIconPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(emblemIconPath), 0)
}
...
func EmblemExcelAddEmblemTextVisible(builder *flatbuffers.Builder, emblemTextVisible bool) {
	builder.PrependBoolSlot(17, emblemTextVisible, false)
}
func EmblemExcelAddIconPath(builder *flatbuffers.Builder, iconPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(iconPath), 0)
}
