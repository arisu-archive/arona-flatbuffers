...
func (t *CharacterDialogExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t.FlatBuffer.TableKey == nil {
		t.FlatBuffer.InitKey(fbsutils.CreateTableKey("CharacterDialog"))
	}
	...
	CharacterDialogExcelAddStartDate(b, fbsutils.Convert(b.CreateString(t.StartDate), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddEndDate(b, fbsutils.Convert(b.CreateString(t.EndDate), t.FlatBuffer.TableKey))
	...
	CharacterDialogExcelAddLocalizeKr(b, fbsutils.Convert(b.CreateString(t.LocalizeKr), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddLocalizeJp(b, fbsutils.Convert(b.CreateString(t.LocalizeJp), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddLocalizeTh(b, fbsutils.Convert(b.CreateString(t.LocalizeTh), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddLocalizeTw(b, fbsutils.Convert(b.CreateString(t.LocalizeTw), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddLocalizeEn(b, fbsutils.Convert(b.CreateString(t.LocalizeEn), t.FlatBuffer.TableKey))
	...
	CharacterDialogExcelAddApplyPosition(b, fbsutils.Convert(t.ApplyPosition, t.FlatBuffer.TableKey))
	...
	CharacterDialogExcelAddCollectionVisible(b, fbsutils.Convert(t.CollectionVisible, t.FlatBuffer.TableKey))
	...
	CharacterDialogExcelAddUnlockEquipWeapon(b, fbsutils.Convert(t.UnlockEquipWeapon, t.FlatBuffer.TableKey))
	CharacterDialogExcelAddLocalizeCvGroup(b, fbsutils.Convert(b.CreateString(t.LocalizeCvGroup), t.FlatBuffer.TableKey))
	CharacterDialogExcelAddTeenMode(b, fbsutils.Convert(t.TeenMode, t.FlatBuffer.TableKey))
...
func (t *CharacterDialogExcelDto) UnmarshalMessage(e *CharacterDialogExcel) error {
	...
	t.DialogCondition = DialogCondition(int32(fbsutils.Convert(e.DialogCondition(), t.FlatBuffer.TableKey)))
	...
	t.DialogType = DialogType(int32(fbsutils.Convert(e.DialogType(), t.FlatBuffer.TableKey)))
	...
	t.UnlockEquipWeapon = fbsutils.Convert(e.UnlockEquipWeapon(), t.FlatBuffer.TableKey)
