...
func (t *ItemExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t.FlatBuffer.TableKey == nil {
		t.FlatBuffer.InitKey(fbsutils.CreateTableKey("ItemExcel"))
	}
	ItemExcelStart(b)
	ItemExcelAddCanTierUpgrade(b, fbsutils.Convert(t.CanTierUpgrade, t.FlatBuffer.TableKey))
	...
	ItemExcelAddExpirationDateTime(b, fbsutils.Convert(b.CreateString(t.ExpirationDateTime), t.FlatBuffer.TableKey))
	...
	ItemExcelAddIcon(b, fbsutils.Convert(b.CreateString(t.Icon), t.FlatBuffer.TableKey))
	ItemExcelAddId(b, fbsutils.Convert(t.Id, t.FlatBuffer.TableKey))
	ItemExcelAddImmediateUse(b, fbsutils.Convert(t.ImmediateUse, t.FlatBuffer.TableKey))
	...
	for i := range len(t.ShopCategory) {
		b.PrependInt32(fbsutils.Convert(int32(fbsutils.Convert(t.ShopCategory[len(t.ShopCategory)-i-1], t.FlatBuffer.TableKey)), t.FlatBuffer.TableKey))
	}
	...
	ItemExcelAddSpriteName(b, fbsutils.Convert(b.CreateString(t.SpriteName), t.FlatBuffer.TableKey))
