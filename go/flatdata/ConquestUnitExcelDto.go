...
func (t *ConquestUnitExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConquestUnitExcelAddName(b, fbsutils.Convert(b.CreateString(t.Name), t.FlatBuffer.TableKey))
	ConquestUnitExcelAddPrefabName(b, fbsutils.Convert(b.CreateString(t.PrefabName), t.FlatBuffer.TableKey))
	ConquestUnitExcelAddStrategyPrefabName(b, fbsutils.Convert(b.CreateString(t.StrategyPrefabName), t.FlatBuffer.TableKey))
	...
	ConquestUnitExcelAddUnitFxPrefabName(b, fbsutils.Convert(b.CreateString(t.UnitFxPrefabName), t.FlatBuffer.TableKey))
	ConquestUnitExcelAddPointAnimation(b, fbsutils.Convert(b.CreateString(t.PointAnimation), t.FlatBuffer.TableKey))
