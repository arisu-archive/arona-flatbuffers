...
func (t *PresetCharacterGroupExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	PresetCharacterGroupExcelAddGetPresetType(b, fbsutils.Convert(b.CreateString(t.GetPresetType), t.FlatBuffer.TableKey))
	...
	PresetCharacterGroupExcelAddEquipSlot01(b, fbsutils.Convert(t.EquipSlot01, t.FlatBuffer.TableKey))
	...
	PresetCharacterGroupExcelAddEquipSlot02(b, fbsutils.Convert(t.EquipSlot02, t.FlatBuffer.TableKey))
	...
	PresetCharacterGroupExcelAddEquipSlot03(b, fbsutils.Convert(t.EquipSlot03, t.FlatBuffer.TableKey))
	...
	PresetCharacterGroupExcelAddEquipCharacterWeapon(b, fbsutils.Convert(t.EquipCharacterWeapon, t.FlatBuffer.TableKey))
...
func (t *PresetCharacterGroupExcelDto) UnmarshalMessage(e *PresetCharacterGroupExcel) error {
	...
	t.EquipSlot01 = fbsutils.Convert(e.EquipSlot01(), t.FlatBuffer.TableKey)
	...
	t.EquipSlot02 = fbsutils.Convert(e.EquipSlot02(), t.FlatBuffer.TableKey)
	...
	t.EquipSlot03 = fbsutils.Convert(e.EquipSlot03(), t.FlatBuffer.TableKey)
	...
	t.EquipCharacterWeapon = fbsutils.Convert(e.EquipCharacterWeapon(), t.FlatBuffer.TableKey)
