...
func EventContentLobbyMenuExcelAddButtonText(builder *flatbuffers.Builder, buttonText flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(buttonText), 0)
}
