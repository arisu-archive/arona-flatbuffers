...
func TerrainAdaptationFactorExcelAddTerrainAdaptation(builder *flatbuffers.Builder, terrainAdaptation StageTopography) {
	builder.PrependInt32Slot(1, int32(terrainAdaptation), 0)
}
