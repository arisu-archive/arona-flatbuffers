...
func (t *ConstMinigameTBGExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConstMinigameTBGExcelAddEffectAllyBattleAttack(b, fbsutils.Convert(b.CreateString(t.EffectAllyBattleAttack), t.FlatBuffer.TableKey))
	ConstMinigameTBGExcelAddEffectAllyBattleDamage(b, fbsutils.Convert(b.CreateString(t.EffectAllyBattleDamage), t.FlatBuffer.TableKey))
	ConstMinigameTBGExcelAddAniEnemyBattleAttack(b, fbsutils.Convert(b.CreateString(t.AniEnemyBattleAttack), t.FlatBuffer.TableKey))
	ConstMinigameTBGExcelAddEffectEnemyBattleAttack(b, fbsutils.Convert(b.CreateString(t.EffectEnemyBattleAttack), t.FlatBuffer.TableKey))
	ConstMinigameTBGExcelAddEffectEnemyBattleDamage(b, fbsutils.Convert(b.CreateString(t.EffectEnemyBattleDamage), t.FlatBuffer.TableKey))
