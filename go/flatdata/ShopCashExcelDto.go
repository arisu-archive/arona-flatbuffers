...
func (t *ShopCashExcelDto) UnmarshalMessage(e *ShopCashExcel) error {
	...
	t.CategoryType = ProductCategory(int32(fbsutils.Convert(e.CategoryType(), t.FlatBuffer.TableKey)))
	...
	t.PackageClientType = PurchaseSourceType(int32(fbsutils.Convert(e.PackageClientType(), t.FlatBuffer.TableKey)))
