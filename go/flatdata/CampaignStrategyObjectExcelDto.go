...
func (t *CampaignStrategyObjectExcelDto) UnmarshalMessage(e *CampaignStrategyObjectExcel) error {
	...
	t.StrategyObjectType = StrategyObjectType(int32(fbsutils.Convert(e.StrategyObjectType(), t.FlatBuffer.TableKey)))
	t.StrategyRewardParcelType = ParcelType(int32(fbsutils.Convert(e.StrategyRewardParcelType(), t.FlatBuffer.TableKey)))
