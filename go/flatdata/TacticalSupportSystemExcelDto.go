...
func (t *TacticalSupportSystemExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	TacticalSupportSystemExcelAddGetOnEndEffectPath(b, fbsutils.Convert(b.CreateString(t.GetOnEndEffectPath), t.FlatBuffer.TableKey))
	TacticalSupportSystemExcelAddGetOnStartEffectPath(b, fbsutils.Convert(b.CreateString(t.GetOnStartEffectPath), t.FlatBuffer.TableKey))
	...
	TacticalSupportSystemExcelAddInteractionSkillCardTexture(b, fbsutils.Convert(b.CreateString(t.InteractionSkillCardTexture), t.FlatBuffer.TableKey))
	TacticalSupportSystemExcelAddInteractionSkillSpine(b, fbsutils.Convert(b.CreateString(t.InteractionSkillSpine), t.FlatBuffer.TableKey))
	TacticalSupportSystemExcelAddInteractionStudentExSkillGroupId(b, fbsutils.Convert(b.CreateString(t.InteractionStudentExSkillGroupId), t.FlatBuffer.TableKey))
	...
	TacticalSupportSystemExcelAddIsTssBlockedNodeCheck(b, fbsutils.Convert(t.IsTssBlockedNodeCheck, t.FlatBuffer.TableKey))
	...
	TacticalSupportSystemExcelAddObstacleUniqueName(b, fbsutils.Convert(b.CreateString(t.ObstacleUniqueName), t.FlatBuffer.TableKey))
	...
	TacticalSupportSystemExcelAddSummonSkilllGroupId(b, fbsutils.Convert(b.CreateString(t.SummonSkilllGroupId), t.FlatBuffer.TableKey))
...
func (t *TacticalSupportSystemExcelDto) UnmarshalMessage(e *TacticalSupportSystemExcel) error {
	...
	t.IsTssBlockedNodeCheck = fbsutils.Convert(e.IsTssBlockedNodeCheck(), t.FlatBuffer.TableKey)
