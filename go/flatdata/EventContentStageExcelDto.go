...
func (t *EventContentStageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	EventContentStageExcelAddName(b, fbsutils.Convert(b.CreateString(t.Name), t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddStageNumber(b, fbsutils.Convert(b.CreateString(t.StageNumber), t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddStrategyMap(b, fbsutils.Convert(b.CreateString(t.StrategyMap), t.FlatBuffer.TableKey))
	EventContentStageExcelAddStrategyMapBg(b, fbsutils.Convert(b.CreateString(t.StrategyMapBg), t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddBgmId(b, fbsutils.Convert(b.CreateString(t.BgmId), t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddInstantClear(b, fbsutils.Convert(t.InstantClear, t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddChallengeDisplay(b, fbsutils.Convert(t.ChallengeDisplay, t.FlatBuffer.TableKey))
	...
	EventContentStageExcelAddIsDefeatBattle(b, fbsutils.Convert(t.IsDefeatBattle, t.FlatBuffer.TableKey))
...
func (t *EventContentStageExcelDto) UnmarshalMessage(e *EventContentStageExcel) error {
	...
	t.OpenConditionContentType = EventContentType(int32(fbsutils.Convert(e.OpenConditionContentType(), t.FlatBuffer.TableKey)))
