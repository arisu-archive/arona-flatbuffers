...
func (t *ScenarioContentCollectionExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ScenarioContentCollectionExcelAddFullResource(b, fbsutils.Convert(b.CreateString(t.FullResource), t.FlatBuffer.TableKey))
	...
	ScenarioContentCollectionExcelAddIsHorizon(b, fbsutils.Convert(t.IsHorizon, t.FlatBuffer.TableKey))
	ScenarioContentCollectionExcelAddIsObject(b, fbsutils.Convert(t.IsObject, t.FlatBuffer.TableKey))
	...
	ScenarioContentCollectionExcelAddSubNameLocalizeCodeId(b, fbsutils.Convert(b.CreateString(t.SubNameLocalizeCodeId), t.FlatBuffer.TableKey))
	ScenarioContentCollectionExcelAddThumbResource(b, fbsutils.Convert(b.CreateString(t.ThumbResource), t.FlatBuffer.TableKey))
