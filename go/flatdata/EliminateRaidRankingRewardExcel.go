...
func EliminateRaidRankingRewardExcelAddRankEndGlobal(builder *flatbuffers.Builder, rankEndGlobal int64) {
	builder.PrependInt64Slot(4, rankEndGlobal, 0)
}
...
func EliminateRaidRankingRewardExcelAddRankStartAsia(builder *flatbuffers.Builder, rankStartAsia int64) {
	builder.PrependInt64Slot(7, rankStartAsia, 0)
}
...
func EliminateRaidRankingRewardExcelAddRankEndAsia(builder *flatbuffers.Builder, rankEndAsia int64) {
	builder.PrependInt64Slot(9, rankEndAsia, 0)
}
...
func EliminateRaidRankingRewardExcelAddRewardParcelUniqueName(builder *flatbuffers.Builder, rewardParcelUniqueName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(rewardParcelUniqueName), 0)
}
...
func EliminateRaidRankingRewardExcelAddRewardParcelUniqueId(builder *flatbuffers.Builder, rewardParcelUniqueId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(rewardParcelUniqueId), 0)
}
