...
func (t *EquipmentExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	EquipmentExcelAddIcon(b, fbsutils.Convert(b.CreateString(t.Icon), t.FlatBuffer.TableKey))
	EquipmentExcelAddId(b, fbsutils.Convert(t.Id, t.FlatBuffer.TableKey))
	EquipmentExcelAddImageName(b, fbsutils.Convert(b.CreateString(t.ImageName), t.FlatBuffer.TableKey))
	...
	EquipmentExcelAddWear(b, fbsutils.Convert(t.Wear, t.FlatBuffer.TableKey))
