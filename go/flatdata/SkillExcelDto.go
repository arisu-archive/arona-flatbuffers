...
func (t *SkillExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	SkillExcelAddGroupId(b, fbsutils.Convert(b.CreateString(t.GroupId), t.FlatBuffer.TableKey))
	SkillExcelAddSkillDataKey(b, fbsutils.Convert(b.CreateString(t.SkillDataKey), t.FlatBuffer.TableKey))
	SkillExcelAddVisualDataKey(b, fbsutils.Convert(b.CreateString(t.VisualDataKey), t.FlatBuffer.TableKey))
	...
	SkillExcelAddIconName(b, fbsutils.Convert(b.CreateString(t.IconName), t.FlatBuffer.TableKey))
	SkillExcelAddIsShowInfo(b, fbsutils.Convert(t.IsShowInfo, t.FlatBuffer.TableKey))
	SkillExcelAddIsShowSpeechbubble(b, fbsutils.Convert(t.IsShowSpeechbubble, t.FlatBuffer.TableKey))
	...
	SkillExcelAddTextureSkillCardForFormConversion(b, fbsutils.Convert(b.CreateString(t.TextureSkillCardForFormConversion), t.FlatBuffer.TableKey))
	SkillExcelAddSkillCardLabelPath(b, fbsutils.Convert(b.CreateString(t.SkillCardLabelPath), t.FlatBuffer.TableKey))
...
func (t *SkillExcelDto) UnmarshalMessage(e *SkillExcel) error {
	...
	t.IsShowInfo = fbsutils.Convert(e.IsShowInfo(), t.FlatBuffer.TableKey)
	t.IsShowSpeechbubble = fbsutils.Convert(e.IsShowSpeechbubble(), t.FlatBuffer.TableKey)
