...
func (t *GroundExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	GroundExcelAddBattleReadyTimelinePath(b, fbsutils.Convert(b.CreateString(t.BattleReadyTimelinePath), t.FlatBuffer.TableKey))
	GroundExcelAddBeforeVictoryTimelinePath(b, fbsutils.Convert(b.CreateString(t.BeforeVictoryTimelinePath), t.FlatBuffer.TableKey))
	GroundExcelAddBgmId(b, fbsutils.Convert(t.BgmId, t.FlatBuffer.TableKey))
	GroundExcelAddCoverPointOff(b, fbsutils.Convert(t.CoverPointOff, t.FlatBuffer.TableKey))
	...
	GroundExcelAddEnemySightRangeMax(b, fbsutils.Convert(t.EnemySightRangeMax, t.FlatBuffer.TableKey))
	...
	GroundExcelAddGroundSceneName(b, fbsutils.Convert(b.CreateString(t.GroundSceneName), t.FlatBuffer.TableKey))
	GroundExcelAddHideNpcWhenBattleEnd(b, fbsutils.Convert(t.HideNpcWhenBattleEnd, t.FlatBuffer.TableKey))
	GroundExcelAddId(b, fbsutils.Convert(t.Id, t.FlatBuffer.TableKey))
	GroundExcelAddImmuneHitBeforeTimeOutEnd(b, fbsutils.Convert(t.ImmuneHitBeforeTimeOutEnd, t.FlatBuffer.TableKey))
	GroundExcelAddIsPhaseBgm(b, fbsutils.Convert(t.IsPhaseBgm, t.FlatBuffer.TableKey))
	...
	GroundExcelAddPlayerSightRangeMax(b, fbsutils.Convert(t.PlayerSightRangeMax, t.FlatBuffer.TableKey))
	...
	GroundExcelAddSkipBattleEnd(b, fbsutils.Convert(t.SkipBattleEnd, t.FlatBuffer.TableKey))
	GroundExcelStartStageFileNameVector(b, len(t.StageFileName))
	for i := range len(t.StageFileName) {
		b.PrependUOffsetT(fbsutils.Convert(b.CreateString(t.StageFileName[len(t.StageFileName)-i-1]), t.FlatBuffer.TableKey))
	}
	...
	GroundExcelAddTssHatchOpen(b, fbsutils.Convert(t.TssHatchOpen, t.FlatBuffer.TableKey))
	GroundExcelAddUiBattleHideFromScratch(b, fbsutils.Convert(t.UiBattleHideFromScratch, t.FlatBuffer.TableKey))
	...
	GroundExcelAddWarningUi(b, fbsutils.Convert(t.WarningUi, t.FlatBuffer.TableKey))
...
func (t *GroundExcelDto) UnmarshalMessage(e *GroundExcel) error {
	...
	t.CoverPointOff = fbsutils.Convert(e.CoverPointOff(), t.FlatBuffer.TableKey)
	t.EnemyArmorType = ArmorType(int32(fbsutils.Convert(e.EnemyArmorType(), t.FlatBuffer.TableKey)))
	...
	t.EnemyBulletType = BulletType(int32(fbsutils.Convert(e.EnemyBulletType(), t.FlatBuffer.TableKey)))
	...
	t.EnemySightRangeMax = fbsutils.Convert(e.EnemySightRangeMax(), t.FlatBuffer.TableKey)
	...
	t.ForcedSkillUse = TacticSkillUse(int32(fbsutils.Convert(e.ForcedSkillUse(), t.FlatBuffer.TableKey)))
	t.ForcedTacticSpeed = TacticSpeed(int32(fbsutils.Convert(e.ForcedTacticSpeed(), t.FlatBuffer.TableKey)))
	...
	t.HideNpcWhenBattleEnd = fbsutils.Convert(e.HideNpcWhenBattleEnd(), t.FlatBuffer.TableKey)
	t.Id = fbsutils.Convert(e.Id(), t.FlatBuffer.TableKey)
	t.ImmuneHitBeforeTimeOutEnd = fbsutils.Convert(e.ImmuneHitBeforeTimeOutEnd(), t.FlatBuffer.TableKey)
	t.IsPhaseBgm = fbsutils.Convert(e.IsPhaseBgm(), t.FlatBuffer.TableKey)
	...
	t.PlayerSightRangeMax = fbsutils.Convert(e.PlayerSightRangeMax(), t.FlatBuffer.TableKey)
	...
	t.ShowNpcSkillCutIn = ShowSkillCutIn(int32(fbsutils.Convert(e.ShowNpcSkillCutIn(), t.FlatBuffer.TableKey)))
	t.SkipBattleEnd = fbsutils.Convert(e.SkipBattleEnd(), t.FlatBuffer.TableKey)
	...
	t.TssHatchOpen = fbsutils.Convert(e.TssHatchOpen(), t.FlatBuffer.TableKey)
	t.UiBattleHideFromScratch = fbsutils.Convert(e.UiBattleHideFromScratch(), t.FlatBuffer.TableKey)
	...
	t.WarningUi = fbsutils.Convert(e.WarningUi(), t.FlatBuffer.TableKey)
	return nil
}
