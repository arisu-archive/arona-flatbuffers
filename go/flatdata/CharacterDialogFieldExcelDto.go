...
func (t *CharacterDialogFieldExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CharacterDialogFieldExcelAddMotionName(b, fbsutils.Convert(b.CreateString(t.MotionName), t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddIsInteractionDialog(b, fbsutils.Convert(t.IsInteractionDialog, t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddHideUi(b, fbsutils.Convert(t.HideUi, t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddLocalizeKr(b, fbsutils.Convert(b.CreateString(t.LocalizeKr), t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddLocalizeJp(b, fbsutils.Convert(b.CreateString(t.LocalizeJp), t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddLocalizeTh(b, fbsutils.Convert(b.CreateString(t.LocalizeTh), t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddLocalizeTw(b, fbsutils.Convert(b.CreateString(t.LocalizeTw), t.FlatBuffer.TableKey))
	CharacterDialogFieldExcelAddLocalizeEn(b, fbsutils.Convert(b.CreateString(t.LocalizeEn), t.FlatBuffer.TableKey))
...
func (t *CharacterDialogFieldExcelDto) UnmarshalMessage(e *CharacterDialogFieldExcel) error {
	...
	t.HideUi = fbsutils.Convert(e.HideUi(), t.FlatBuffer.TableKey)
