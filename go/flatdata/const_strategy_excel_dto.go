...
type ConstStrategyExcelDto struct {
	...
	MultiSweepPresetNameMaxLengthKr      int32         `json:"multi_sweep_preset_name_max_length_kr"`
...
func (t *ConstStrategyExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConstStrategyExcelAddMultiSweepPresetNameMaxLengthKr(b, fbsutils.Convert(t.MultiSweepPresetNameMaxLengthKr, t.FlatBuffer.TableKey))
...
func (t *ConstStrategyExcelDto) UnmarshalMessage(e *ConstStrategyExcel) error {
	...
	t.MultiSweepPresetNameMaxLengthKr = fbsutils.Convert(e.MultiSweepPresetNameMaxLengthKr(), t.FlatBuffer.TableKey)
