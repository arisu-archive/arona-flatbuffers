...
func LogicEffectCommonVisualExcelAddParticleEndPath(builder *flatbuffers.Builder, particleEndPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(particleEndPath), 0)
}
