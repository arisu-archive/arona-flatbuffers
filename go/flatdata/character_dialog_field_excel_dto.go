...
func (t *CharacterDialogFieldExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	localizeThOffset := b.CreateString(fbsutils.Encode(t.LocalizeTh, t.FlatBuffer.TableKey))
	localizeTwOffset := b.CreateString(fbsutils.Encode(t.LocalizeTw, t.FlatBuffer.TableKey))
	localizeEnOffset := b.CreateString(fbsutils.Encode(t.LocalizeEn, t.FlatBuffer.TableKey))
	...
	CharacterDialogFieldExcelAddLocalizeTh(b, localizeThOffset)
	CharacterDialogFieldExcelAddLocalizeTw(b, localizeTwOffset)
	CharacterDialogFieldExcelAddLocalizeEn(b, localizeEnOffset)
...
func (t *CharacterDialogFieldExcelDto) UnmarshalMessage(e *CharacterDialogFieldExcel) error {
	...
	t.LocalizeTh = fbsutils.Decode(string(e.LocalizeTh()), t.FlatBuffer.TableKey)
	t.LocalizeTw = fbsutils.Decode(string(e.LocalizeTw()), t.FlatBuffer.TableKey)
	t.LocalizeEn = fbsutils.Decode(string(e.LocalizeEn()), t.FlatBuffer.TableKey)
	return nil
}
