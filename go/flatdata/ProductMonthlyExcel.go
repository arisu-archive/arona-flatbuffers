...
func ProductMonthlyExcelAddPrice(builder *flatbuffers.Builder, price int64) {
	builder.PrependInt64Slot(0, price, 0)
}
...
func ProductMonthlyExcelAddDailyParcelAmount(builder *flatbuffers.Builder, dailyParcelAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(dailyParcelAmount), 0)
}
...
func ProductMonthlyExcelAddDailyParcelType(builder *flatbuffers.Builder, dailyParcelType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(dailyParcelType), 0)
}
...
func ProductMonthlyExcelAddDailyParcelId(builder *flatbuffers.Builder, dailyParcelId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(dailyParcelId), 0)
}
...
func ProductMonthlyExcelAddTeenProductId(builder *flatbuffers.Builder, teenProductId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(teenProductId), 0)
}
