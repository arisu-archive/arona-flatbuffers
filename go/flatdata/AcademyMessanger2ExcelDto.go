...
func (t *AcademyMessanger2ExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	AcademyMessanger2ExcelAddMessageTh(b, __offset_message_th)
	AcademyMessanger2ExcelAddMessageTw(b, __offset_message_tw)
	AcademyMessanger2ExcelAddMessageEn(b, __offset_message_en)
