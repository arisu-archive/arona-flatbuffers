...
func CafeProductionExcelAddCafeProductionParcelType(builder *flatbuffers.Builder, cafeProductionParcelType ParcelType) {
	builder.PrependInt32Slot(5, int32(cafeProductionParcelType), 0)
}
