...
func (t *MinigameTBGSeasonExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	MinigameTBGSeasonExcelAddEchelonSlot1Portrait(b, fbsutils.Convert(b.CreateString(t.EchelonSlot1Portrait), t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot2CharacterId(b, fbsutils.Convert(t.EchelonSlot2CharacterId, t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot2Portrait(b, fbsutils.Convert(b.CreateString(t.EchelonSlot2Portrait), t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot3CharacterId(b, fbsutils.Convert(t.EchelonSlot3CharacterId, t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot3Portrait(b, fbsutils.Convert(b.CreateString(t.EchelonSlot3Portrait), t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot4CharacterId(b, fbsutils.Convert(t.EchelonSlot4CharacterId, t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddEchelonSlot4Portrait(b, fbsutils.Convert(b.CreateString(t.EchelonSlot4Portrait), t.FlatBuffer.TableKey))
	...
	MinigameTBGSeasonExcelAddMapImagePath(b, fbsutils.Convert(b.CreateString(t.MapImagePath), t.FlatBuffer.TableKey))
	MinigameTBGSeasonExcelAddMapNameLocalize(b, fbsutils.Convert(b.CreateString(t.MapNameLocalize), t.FlatBuffer.TableKey))
...
func (t *MinigameTBGSeasonExcelDto) UnmarshalMessage(e *MinigameTBGSeasonExcel) error {
	...
	t.EchelonRevivalCostType = ParcelType(int32(fbsutils.Convert(e.EchelonRevivalCostType(), t.FlatBuffer.TableKey)))
	...
	t.EventUseCostType = ParcelType(int32(fbsutils.Convert(e.EventUseCostType(), t.FlatBuffer.TableKey)))
