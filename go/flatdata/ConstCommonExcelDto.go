...
func (t *ConstCommonExcelDto) UnmarshalMessage(e *ConstCommonExcel) error {
	...
	t.BirthdayMailParcelType = ParcelType(int32(fbsutils.Convert(e.BirthdayMailParcelType(), t.FlatBuffer.TableKey)))
	...
	for i := range e.CommonFavorItemTagsLength() {
		t.CommonFavorItemTags[i] = e.CommonFavorItemTags(i)
	}
	...
	t.TimeAttackDungeonEnterCostType = ParcelType(int32(fbsutils.Convert(e.TimeAttackDungeonEnterCostType(), t.FlatBuffer.TableKey)))
	...
	t.TutorialShopCategoryType = ShopCategoryType(int32(fbsutils.Convert(e.TutorialShopCategoryType(), t.FlatBuffer.TableKey)))
