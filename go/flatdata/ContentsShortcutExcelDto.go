...
func (t *ContentsShortcutExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ContentsShortcutExcelAddLocalize(b, fbsutils.Convert(b.CreateString(t.Localize), t.FlatBuffer.TableKey))
	...
	ContentsShortcutExcelAddShortcutCloseTime(b, fbsutils.Convert(b.CreateString(t.ShortcutCloseTime), t.FlatBuffer.TableKey))
	ContentsShortcutExcelAddShortcutContentId(b, fbsutils.Convert(t.ShortcutContentId, t.FlatBuffer.TableKey))
	ContentsShortcutExcelAddShortcutOpenTime(b, fbsutils.Convert(b.CreateString(t.ShortcutOpenTime), t.FlatBuffer.TableKey))
