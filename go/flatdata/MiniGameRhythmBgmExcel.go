...
func MiniGameRhythmBgmExcelAddBgmComposerText(builder *flatbuffers.Builder, bgmComposerText flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(bgmComposerText), 0)
}
