...
func (t *ConstCommonExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ConstCommonExcelAddClanNameLength(b, fbsutils.Convert(t.ClanNameLength, t.FlatBuffer.TableKey))
...
func (t *ConstCommonExcelDto) UnmarshalMessage(e *ConstCommonExcel) error {
	...
	t.ClanNameLength = fbsutils.Convert(e.ClanNameLength(), t.FlatBuffer.TableKey)
