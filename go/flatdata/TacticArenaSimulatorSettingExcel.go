...
func TacticArenaSimulatorSettingExcelAddDefenderStrikerNum(builder *flatbuffers.Builder, defenderStrikerNum int64) {
	builder.PrependInt64Slot(0, defenderStrikerNum, 0)
}
