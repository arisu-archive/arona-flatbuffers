...
func (t *CampaignStageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	if t.FlatBuffer.TableKey == nil {
		t.FlatBuffer.InitKey(fbsutils.CreateTableKey("CampaignStageExcel"))
	}
	CampaignStageExcelStart(b)
	CampaignStageExcelAddBattleDuration(b, fbsutils.Convert(t.BattleDuration, t.FlatBuffer.TableKey))
	CampaignStageExcelAddBgmId(b, fbsutils.Convert(b.CreateString(t.BgmId), t.FlatBuffer.TableKey))
	...
	CampaignStageExcelAddDeprecated(b, fbsutils.Convert(t.Deprecated, t.FlatBuffer.TableKey))
	...
	CampaignStageExcelAddFirstClearEventMessage(b, fbsutils.Convert(b.CreateString(t.FirstClearEventMessage), t.FlatBuffer.TableKey))
	CampaignStageExcelAddFirstClearFunnelMessage(b, fbsutils.Convert(b.CreateString(t.FirstClearFunnelMessage), t.FlatBuffer.TableKey))
	CampaignStageExcelAddFirstClearReportEventName(b, fbsutils.Convert(b.CreateString(t.FirstClearReportEventName), t.FlatBuffer.TableKey))
	...
	CampaignStageExcelAddName(b, fbsutils.Convert(b.CreateString(t.Name), t.FlatBuffer.TableKey))
	...
	CampaignStageExcelAddStageNumber(b, fbsutils.Convert(b.CreateString(t.StageNumber), t.FlatBuffer.TableKey))
	...
	CampaignStageExcelAddStrategyMap(b, fbsutils.Convert(b.CreateString(t.StrategyMap), t.FlatBuffer.TableKey))
	CampaignStageExcelAddStrategyMapBg(b, fbsutils.Convert(b.CreateString(t.StrategyMapBg), t.FlatBuffer.TableKey))
...
func (t *CampaignStageExcelDto) UnmarshalMessage(e *CampaignStageExcel) error {
	...
	t.Deprecated = fbsutils.Convert(e.Deprecated(), t.FlatBuffer.TableKey)
