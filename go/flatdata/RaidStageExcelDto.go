...
func (t *RaidStageExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	RaidStageExcelAddBgPath(b, fbsutils.Convert(b.CreateString(t.BgPath), t.FlatBuffer.TableKey))
	...
	RaidStageExcelAddDifficultyOpenCondition(b, fbsutils.Convert(t.DifficultyOpenCondition, t.FlatBuffer.TableKey))
	...
	RaidStageExcelAddEnterTimeLine(b, fbsutils.Convert(b.CreateString(t.EnterTimeLine), t.FlatBuffer.TableKey))
	RaidStageExcelAddGroundDevName(b, fbsutils.Convert(b.CreateString(t.GroundDevName), t.FlatBuffer.TableKey))
	...
	RaidStageExcelAddPhaseChangeTimelinePath(b, fbsutils.Convert(b.CreateString(t.PhaseChangeTimelinePath), t.FlatBuffer.TableKey))
	RaidStageExcelAddPortraitPath(b, fbsutils.Convert(b.CreateString(t.PortraitPath), t.FlatBuffer.TableKey))
	RaidStageExcelAddRaidBossGroup(b, fbsutils.Convert(b.CreateString(t.RaidBossGroup), t.FlatBuffer.TableKey))
	...
	RaidStageExcelAddShowSkillCard(b, fbsutils.Convert(t.ShowSkillCard, t.FlatBuffer.TableKey))
	...
	RaidStageExcelAddUseBossAiPhaseSync(b, fbsutils.Convert(t.UseBossAiPhaseSync, t.FlatBuffer.TableKey))
	RaidStageExcelAddUseBossIndex(b, fbsutils.Convert(t.UseBossIndex, t.FlatBuffer.TableKey))
	RaidStageExcelAddVictoryTimelinePath(b, fbsutils.Convert(b.CreateString(t.VictoryTimelinePath), t.FlatBuffer.TableKey))
