...
func (t *ScenarioModeExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ScenarioModeExcelAddCompleteReportEventName(b, fbsutils.Convert(b.CreateString(t.CompleteReportEventName), t.FlatBuffer.TableKey))
	...
	ScenarioModeExcelAddEventIconParcelPath(b, fbsutils.Convert(b.CreateString(t.EventIconParcelPath), t.FlatBuffer.TableKey))
	ScenarioModeExcelAddExposedTime(b, fbsutils.Convert(b.CreateString(t.ExposedTime), t.FlatBuffer.TableKey))
	...
	ScenarioModeExcelAddHide(b, fbsutils.Convert(t.Hide, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddIsContinue(b, fbsutils.Convert(t.IsContinue, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddIsDefeatBattle(b, fbsutils.Convert(t.IsDefeatBattle, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddIsScenarioSpecialReward(b, fbsutils.Convert(t.IsScenarioSpecialReward, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddLof(b, fbsutils.Convert(t.Lof, t.FlatBuffer.TableKey))
	...
	ScenarioModeExcelAddOpen(b, fbsutils.Convert(t.Open, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddRecommendLevel(b, fbsutils.Convert(t.RecommendLevel, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddScenarioCloseDate(b, fbsutils.Convert(b.CreateString(t.ScenarioCloseDate), t.FlatBuffer.TableKey))
	ScenarioModeExcelAddScenarioModeRewardId(b, fbsutils.Convert(t.ScenarioModeRewardId, t.FlatBuffer.TableKey))
	ScenarioModeExcelAddScenarioOpenDate(b, fbsutils.Convert(b.CreateString(t.ScenarioOpenDate), t.FlatBuffer.TableKey))
...
func (t *ScenarioModeExcelDto) UnmarshalMessage(e *ScenarioModeExcel) error {
	...
	t.Hide = fbsutils.Convert(e.Hide(), t.FlatBuffer.TableKey)
	t.IsContinue = fbsutils.Convert(e.IsContinue(), t.FlatBuffer.TableKey)
	...
	t.Lof = fbsutils.Convert(e.Lof(), t.FlatBuffer.TableKey)
	...
	t.ModeType = ScenarioModeTypes(int32(fbsutils.Convert(e.ModeType(), t.FlatBuffer.TableKey)))
	t.NeedClub = Club(int32(fbsutils.Convert(e.NeedClub(), t.FlatBuffer.TableKey)))
	t.NeedClubStudentCount = fbsutils.Convert(e.NeedClubStudentCount(), t.FlatBuffer.TableKey)
	t.Open = fbsutils.Convert(e.Open(), t.FlatBuffer.TableKey)
	...
	t.SubType = ScenarioModeSubTypes(int32(fbsutils.Convert(e.SubType(), t.FlatBuffer.TableKey)))
