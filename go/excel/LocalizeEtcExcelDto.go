...
func (t *LocalizeEtcExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	LocalizeEtcExcelAddNameTh(b, __offset_name_th)
	LocalizeEtcExcelAddDescriptionTh(b, __offset_description_th)
	LocalizeEtcExcelAddNameTw(b, __offset_name_tw)
	LocalizeEtcExcelAddDescriptionTw(b, __offset_description_tw)
	LocalizeEtcExcelAddNameEn(b, __offset_name_en)
	LocalizeEtcExcelAddDescriptionEn(b, __offset_description_en)
