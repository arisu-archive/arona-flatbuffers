...
func RaidRankingRewardExcelAddRankEndNa(builder *flatbuffers.Builder, rankEndNa int64) {
	builder.PrependInt64Slot(0, rankEndNa, 0)
}
func RaidRankingRewardExcelAddRewardParcelUniqueName(builder *flatbuffers.Builder, rewardParcelUniqueName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(rewardParcelUniqueName), 0)
}
