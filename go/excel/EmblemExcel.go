...
func (rcv *EmblemExcel) EmblemBgPathTh() []byte {
...
func (rcv *EmblemExcel) EmblemBgPathTw() []byte {
...
func (rcv *EmblemExcel) EmblemBgPathEn() []byte {
...
func EmblemExcelAddEmblemParameter(builder *flatbuffers.Builder, emblemParameter int64) {
	builder.PrependInt64Slot(0, emblemParameter, 0)
}
...
func EmblemExcelAddEmblemEffectPath(builder *flatbuffers.Builder, emblemEffectPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(emblemEffectPath), 0)
}
...
func EmblemExcelAddUseAtLocalizeId(builder *flatbuffers.Builder, useAtLocalizeId int64) {
	builder.PrependInt64Slot(9, useAtLocalizeId, 0)
}
func EmblemExcelAddEmblemIconPath(builder *flatbuffers.Builder, emblemIconPath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(emblemIconPath), 0)
}
func EmblemExcelAddEmblemBgPathTh(builder *flatbuffers.Builder, emblemBgPathTh flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(emblemBgPathTh), 0)
}
func EmblemExcelAddDisplayType(builder *flatbuffers.Builder, displayType EmblemDisplayType) {
	builder.PrependInt32Slot(12, int32(displayType), 0)
}
func EmblemExcelAddCategory(builder *flatbuffers.Builder, category EmblemCategory) {
	builder.PrependInt32Slot(13, int32(category), 0)
}
...
func EmblemExcelAddCheckPassCount(builder *flatbuffers.Builder, checkPassCount int64) {
	builder.PrependInt64Slot(16, checkPassCount, 0)
}
func EmblemExcelAddEmblemBgPathTw(builder *flatbuffers.Builder, emblemBgPathTw flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(17, flatbuffers.UOffsetT(emblemBgPathTw), 0)
}
func EmblemExcelAddEmblemIconNumControl(builder *flatbuffers.Builder, emblemIconNumControl int32) {
	builder.PrependInt32Slot(18, emblemIconNumControl, 0)
}
func EmblemExcelAddEmblemBgPathJp(builder *flatbuffers.Builder, emblemBgPathJp flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(19, flatbuffers.UOffsetT(emblemBgPathJp), 0)
}
func EmblemExcelAddCheckPassType(builder *flatbuffers.Builder, checkPassType EmblemCheckPassType) {
	builder.PrependInt32Slot(20, int32(checkPassType), 0)
}
func EmblemExcelAddLocalizeCodeId(builder *flatbuffers.Builder, localizeCodeId uint32) {
	builder.PrependUint32Slot(21, localizeCodeId, 0)
}
func EmblemExcelAddEmblemBgPathEn(builder *flatbuffers.Builder, emblemBgPathEn flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(22, flatbuffers.UOffsetT(emblemBgPathEn), 0)
}
func EmblemExcelAddDisplayStartDate(builder *flatbuffers.Builder, displayStartDate flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(displayStartDate), 0)
}
func EmblemExcelAddEmblemBgPathKr(builder *flatbuffers.Builder, emblemBgPathKr flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(24, flatbuffers.UOffsetT(emblemBgPathKr), 0)
}
