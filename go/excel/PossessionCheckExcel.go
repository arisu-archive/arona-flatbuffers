...
func PossessionCheckExcelAddReplaceParcelType(builder *flatbuffers.Builder, replaceParcelType ParcelType) {
	builder.PrependInt32Slot(0, int32(replaceParcelType), 0)
}
