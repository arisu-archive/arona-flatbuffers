...
func (t *ScenarioCharacterNameExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_nickname_th := b.CreateString(fbsutils.Convert(t.NicknameTh, t.FlatBuffer.TableKey))
	__offset_name_tw := b.CreateString(fbsutils.Convert(t.NameTw, t.FlatBuffer.TableKey))
	__offset_nickname_tw := b.CreateString(fbsutils.Convert(t.NicknameTw, t.FlatBuffer.TableKey))
	__offset_name_en := b.CreateString(fbsutils.Convert(t.NameEn, t.FlatBuffer.TableKey))
	__offset_nickname_en := b.CreateString(fbsutils.Convert(t.NicknameEn, t.FlatBuffer.TableKey))
	...
	ScenarioCharacterNameExcelAddNameTh(b, __offset_name_th)
	ScenarioCharacterNameExcelAddNicknameTh(b, __offset_nickname_th)
	ScenarioCharacterNameExcelAddNameTw(b, __offset_name_tw)
	ScenarioCharacterNameExcelAddNicknameTw(b, __offset_nickname_tw)
	ScenarioCharacterNameExcelAddNameEn(b, __offset_name_en)
	ScenarioCharacterNameExcelAddNicknameEn(b, __offset_nickname_en)
