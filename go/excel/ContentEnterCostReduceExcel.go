...
func ContentEnterCostReduceExcelAddReduceEnterCostType(builder *flatbuffers.Builder, reduceEnterCostType ParcelType) {
	builder.PrependInt32Slot(0, int32(reduceEnterCostType), 0)
}
