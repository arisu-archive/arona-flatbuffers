...
func (t *TutorialCharacterDialogExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	TutorialCharacterDialogExcelAddLocalizeTh(b, localizeThOffset)
	TutorialCharacterDialogExcelAddLocalizeTw(b, localizeTwOffset)
	TutorialCharacterDialogExcelAddLocalizeEn(b, localizeEnOffset)
