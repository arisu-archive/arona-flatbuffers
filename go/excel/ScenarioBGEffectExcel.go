...
func ScenarioBGEffectExcelAddEffect2(builder *flatbuffers.Builder, effect2 flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(effect2), 0)
}
