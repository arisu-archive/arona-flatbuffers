...
func MiniGameDreamParameterExcelAddParameterBase(builder *flatbuffers.Builder, parameterBase int64) {
	builder.PrependInt64Slot(2, parameterBase, 0)
}
