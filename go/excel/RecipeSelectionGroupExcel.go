...
func RecipeSelectionGroupExcelAddRecipeSelectionGroupComponentId(builder *flatbuffers.Builder, recipeSelectionGroupComponentId int64) {
	builder.PrependInt64Slot(5, recipeSelectionGroupComponentId, 0)
}
