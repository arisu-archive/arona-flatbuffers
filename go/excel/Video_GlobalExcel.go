...
func Video_GlobalExcelAddVideoPathKr(builder *flatbuffers.Builder, videoPathKr flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(videoPathKr), 0)
}
