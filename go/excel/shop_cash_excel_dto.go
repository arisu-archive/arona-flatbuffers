...
func (t *ShopCashExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	ShopCashExcelAddPackageClientType(b, t.PackageClientType)
	ShopCashExcelAddIsStartDash(b, t.IsStartDash)
	ShopCashExcelAddViewFlag(b, t.ViewFlag)
...
func (t *ShopCashExcelDto) UnmarshalMessage(e *ShopCashExcel) error {
	...
	t.PackageClientType = e.PackageClientType()
	t.IsStartDash = e.IsStartDash()
