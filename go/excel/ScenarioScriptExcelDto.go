...
func (t *ScenarioScriptExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_text_th := b.CreateString(fbsutils.Convert(t.TextTh, t.FlatBuffer.TableKey))
	__offset_text_tw := b.CreateString(fbsutils.Convert(t.TextTw, t.FlatBuffer.TableKey))
	__offset_text_en := b.CreateString(fbsutils.Convert(t.TextEn, t.FlatBuffer.TableKey))
	...
	ScenarioScriptExcelAddTextTh(b, __offset_text_th)
	ScenarioScriptExcelAddTextTw(b, __offset_text_tw)
	ScenarioScriptExcelAddTextEn(b, __offset_text_en)
