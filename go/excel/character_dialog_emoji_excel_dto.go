...
func (t *CharacterDialogEmojiExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CharacterDialogEmojiExcelAddDurationKr(b, t.DurationKr)
	...
	CharacterDialogEmojiExcelAddLocalizeTh(b, localizeThOffset)
	CharacterDialogEmojiExcelAddLocalizeTw(b, localizeTwOffset)
	CharacterDialogEmojiExcelAddLocalizeEn(b, localizeEnOffset)
