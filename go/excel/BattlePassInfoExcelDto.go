...
func (t *BattlePassInfoExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	__offset_purchase_step_bg_image_path := b.CreateString(fbsutils.Convert(t.PurchaseStepBgImagePath, t.FlatBuffer.TableKey))
	...
	BattlePassInfoExcelAddPurchaseStepBgImagePath(b, __offset_purchase_step_bg_image_path)
