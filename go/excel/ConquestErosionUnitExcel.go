...
func ConquestErosionUnitExcelAddMassErosionUnitRotationY(builder *flatbuffers.Builder, massErosionUnitRotationY float32) {
	builder.PrependFloat32Slot(1, massErosionUnitRotationY, 0.0)
}
