...
func (rcv *CharacterWeaponExcel) Tags(j int) Tag {
...
func (rcv *CharacterWeaponExcel) TagsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(20))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func (rcv *CharacterWeaponExcel) MutateTags(j int, n Tag) bool {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(20))
	if o != 0 {
		a := rcv._tab.Vector(o)
...
func CharacterWeaponExcelAddHealPower100(builder *flatbuffers.Builder, healPower100 int64) {
	builder.PrependInt64Slot(2, healPower100, 0)
}
...
func CharacterWeaponExcelAddStatValue(builder *flatbuffers.Builder, statValue flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(statValue), 0)
}
...
func CharacterWeaponExcelAddRecipeId(builder *flatbuffers.Builder, recipeId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(recipeId), 0)
}
...
func CharacterWeaponExcelAddAttackPower(builder *flatbuffers.Builder, attackPower int64) {
	builder.PrependInt64Slot(7, attackPower, 0)
}
func CharacterWeaponExcelAddTags(builder *flatbuffers.Builder, tags flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(tags), 0)
}
func CharacterWeaponExcelStartTagsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
...
func CharacterWeaponExcelAddImagePath(builder *flatbuffers.Builder, imagePath flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(imagePath), 0)
}
func CharacterWeaponExcelAddMaxLevel(builder *flatbuffers.Builder, maxLevel flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(maxLevel), 0)
}
