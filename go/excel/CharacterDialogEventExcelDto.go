...
func (t *CharacterDialogEventExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CharacterDialogEventExcelAddLocalizeTh(b, __offset_localize_th)
	CharacterDialogEventExcelAddLocalizeTw(b, __offset_localize_tw)
	CharacterDialogEventExcelAddLocalizeEn(b, __offset_localize_en)
