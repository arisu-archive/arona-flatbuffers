...
func (t *CharacterDialogExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CharacterDialogExcelAddLocalizeTh(b, __offset_localize_th)
	CharacterDialogExcelAddLocalizeTw(b, __offset_localize_tw)
	CharacterDialogExcelAddLocalizeEn(b, __offset_localize_en)
