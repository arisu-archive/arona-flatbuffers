...
func (t *InteractiveWorldRaidBossGroupExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	InteractiveWorldRaidBossGroupExcelAddWorldBossHpTw(b, fbsutils.Convert(t.WorldBossHpTw, t.FlatBuffer.TableKey))
	InteractiveWorldRaidBossGroupExcelAddWorldBossHpAsia(b, fbsutils.Convert(t.WorldBossHpAsia, t.FlatBuffer.TableKey))
	InteractiveWorldRaidBossGroupExcelAddWorldBossHpNa(b, fbsutils.Convert(t.WorldBossHpNa, t.FlatBuffer.TableKey))
	InteractiveWorldRaidBossGroupExcelAddWorldBossHpGlobal(b, fbsutils.Convert(t.WorldBossHpGlobal, t.FlatBuffer.TableKey))
