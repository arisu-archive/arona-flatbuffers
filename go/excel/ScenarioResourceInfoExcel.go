...
func ScenarioResourceInfoExcelAddAudioName(builder *flatbuffers.Builder, audioName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(audioName), 0)
}
