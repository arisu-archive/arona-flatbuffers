...
func GoodsExcelAddProductIdSgs(builder *flatbuffers.Builder, productIdSgs int64) {
	builder.PrependInt64Slot(4, productIdSgs, 0)
}
...
func GoodsExcelAddConsumeGachaTicketTypeAmount(builder *flatbuffers.Builder, consumeGachaTicketTypeAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(consumeGachaTicketTypeAmount), 0)
}
...
func GoodsExcelAddConsumeGachaTicketType(builder *flatbuffers.Builder, consumeGachaTicketType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(consumeGachaTicketType), 0)
}
...
func GoodsExcelAddParcelAmount(builder *flatbuffers.Builder, parcelAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(16, flatbuffers.UOffsetT(parcelAmount), 0)
}
...
func GoodsExcelAddConsumeCondition(builder *flatbuffers.Builder, consumeCondition flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(17, flatbuffers.UOffsetT(consumeCondition), 0)
}
...
func GoodsExcelAddConsumeParcelAmount(builder *flatbuffers.Builder, consumeParcelAmount flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(consumeParcelAmount), 0)
}
...
func GoodsExcelAddProductIdAos(builder *flatbuffers.Builder, productIdAos int64) {
	builder.PrependInt64Slot(19, productIdAos, 0)
}
func GoodsExcelAddConsumeParcelId(builder *flatbuffers.Builder, consumeParcelId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(20, flatbuffers.UOffsetT(consumeParcelId), 0)
}
