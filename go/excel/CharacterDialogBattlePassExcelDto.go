...
func (t *CharacterDialogBattlePassExcelDto) MarshalModel(b *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	CharacterDialogBattlePassExcelAddLocalizeTh(b, __offset_localize_th)
	CharacterDialogBattlePassExcelAddLocalizeTw(b, __offset_localize_tw)
	CharacterDialogBattlePassExcelAddLocalizeEn(b, __offset_localize_en)
