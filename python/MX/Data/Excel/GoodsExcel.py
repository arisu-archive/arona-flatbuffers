...
def GoodsExcelStart(builder): builder.StartObject(21)
def Start(builder):
    return GoodsExcelStart(builder)
def GoodsExcelAddProductIdOne(builder, productIdOne): builder.PrependInt64Slot(0, productIdOne, 0)
def AddProductIdOne(builder, productIdOne):
    return GoodsExcelAddProductIdOne(builder, productIdOne)
def GoodsExcelAddProductIdSteam(builder, productIdSteam): builder.PrependInt64Slot(1, productIdSteam, 0)
def AddProductIdSteam(builder, productIdSteam):
    return GoodsExcelAddProductIdSteam(builder, productIdSteam)
def GoodsExcelAddConsumeParcelType(builder, consumeParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(consumeParcelType), 0)
...
def GoodsExcelAddRarity(builder, rarity): builder.PrependInt32Slot(3, rarity, 0)
def AddRarity(builder, rarity):
    return GoodsExcelAddRarity(builder, rarity)
def GoodsExcelAddProductIdSgs(builder, productIdSgs): builder.PrependInt64Slot(4, productIdSgs, 0)
def AddProductIdSgs(builder, productIdSgs):
    return GoodsExcelAddProductIdSgs(builder, productIdSgs)
def GoodsExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def GoodsExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return GoodsExcelAddId(builder, id)
def GoodsExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def GoodsExcelAddType(builder, type): builder.PrependInt32Slot(8, type, 0)
def AddType(builder, type):
    return GoodsExcelAddType(builder, type)
def GoodsExcelAddProductIdiOs(builder, productIdiOs): builder.PrependInt64Slot(9, productIdiOs, 0)
def AddProductIdiOs(builder, productIdiOs):
    return GoodsExcelAddProductIdiOs(builder, productIdiOs)
def GoodsExcelAddConsumeGachaTicketTypeAmount(builder, consumeGachaTicketTypeAmount): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(consumeGachaTicketTypeAmount), 0)
...
def GoodsExcelAddConsumeGachaTicketType(builder, consumeGachaTicketType): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(consumeGachaTicketType), 0)
...
def GoodsExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
def AddIconPath(builder, iconPath):
    return GoodsExcelAddIconPath(builder, iconPath)
def GoodsExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def GoodsExcelAddConsumeCondition(builder, consumeCondition): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(consumeCondition), 0)
...
def GoodsExcelAddConsumeParcelAmount(builder, consumeParcelAmount): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(consumeParcelAmount), 0)
...
def GoodsExcelAddProductIdAos(builder, productIdAos): builder.PrependInt64Slot(19, productIdAos, 0)
def AddProductIdAos(builder, productIdAos):
    return GoodsExcelAddProductIdAos(builder, productIdAos)
def GoodsExcelAddConsumeParcelId(builder, consumeParcelId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(consumeParcelId), 0)
