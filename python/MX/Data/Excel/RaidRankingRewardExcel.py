...
def RaidRankingRewardExcelAddRankEndNa(builder, rankEndNa): builder.PrependInt64Slot(0, rankEndNa, 0)
def AddRankEndNa(builder, rankEndNa):
    return RaidRankingRewardExcelAddRankEndNa(builder, rankEndNa)
def RaidRankingRewardExcelAddRewardParcelUniqueName(builder, rewardParcelUniqueName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueName), 0)
...
def RaidRankingRewardExcelAddRankEndTw(builder, rankEndTw): builder.PrependInt64Slot(2, rankEndTw, 0)
def AddRankEndTw(builder, rankEndTw):
    return RaidRankingRewardExcelAddRankEndTw(builder, rankEndTw)
def RaidRankingRewardExcelAddRankStartGlobal(builder, rankStartGlobal): builder.PrependInt64Slot(3, rankStartGlobal, 0)
...
def RaidRankingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def RaidRankingRewardExcelAddTier(builder, tier): builder.PrependInt32Slot(7, tier, 0)
def AddTier(builder, tier):
    return RaidRankingRewardExcelAddTier(builder, tier)
def RaidRankingRewardExcelAddRankStartTw(builder, rankStartTw): builder.PrependInt64Slot(8, rankStartTw, 0)
def AddRankStartTw(builder, rankStartTw):
    return RaidRankingRewardExcelAddRankStartTw(builder, rankStartTw)
def RaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd): builder.PrependInt64Slot(9, percentRankEnd, 0)
def AddPercentRankEnd(builder, percentRankEnd):
    return RaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd)
def RaidRankingRewardExcelAddPercentRankStart(builder, percentRankStart): builder.PrependInt64Slot(10, percentRankStart, 0)
...
def RaidRankingRewardExcelAddRankStartAsia(builder, rankStartAsia): builder.PrependInt64Slot(11, rankStartAsia, 0)
def AddRankStartAsia(builder, rankStartAsia):
    return RaidRankingRewardExcelAddRankStartAsia(builder, rankStartAsia)
def RaidRankingRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(12, rankEnd, 0)
...
def RaidRankingRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def RaidRankingRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(16, rankStart, 0)
def AddRankStart(builder, rankStart):
    return RaidRankingRewardExcelAddRankStart(builder, rankStart)
def RaidRankingRewardExcelAddRankEndAsia(builder, rankEndAsia): builder.PrependInt64Slot(17, rankEndAsia, 0)
def AddRankEndAsia(builder, rankEndAsia):
    return RaidRankingRewardExcelAddRankEndAsia(builder, rankEndAsia)
def RaidRankingRewardExcelAddId(builder, id): builder.PrependInt64Slot(18, id, 0)
