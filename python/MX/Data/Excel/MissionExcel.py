...
def MissionExcelAddDescription(builder, description): builder.PrependUint32Slot(0, description, 0)
def AddDescription(builder, description):
    return MissionExcelAddDescription(builder, description)
def MissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(1, toastDisplayType, 0)
...
def MissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def MissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MissionExcelAddDateAutoRefer(builder, dateAutoRefer): builder.PrependInt32Slot(5, dateAutoRefer, 0)
def AddDateAutoRefer(builder, dateAutoRefer):
    return MissionExcelAddDateAutoRefer(builder, dateAutoRefer)
def MissionExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return MissionExcelAddEndDate(builder, endDate)
def MissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MissionExcelAddLimit(builder, limit): builder.PrependBoolSlot(8, limit, 0)
...
def MissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(10, viewFlag, 0)
def AddViewFlag(builder, viewFlag):
    return MissionExcelAddViewFlag(builder, viewFlag)
def MissionExcelAddId(builder, id): builder.PrependInt64Slot(11, id, 0)
def AddId(builder, id):
    return MissionExcelAddId(builder, id)
def MissionExcelAddCategory(builder, category): builder.PrependInt32Slot(12, category, 0)
...
def MissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def MissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def MissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return MissionExcelAddToastImagePath(builder, toastImagePath)
def MissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(18, resetType, 0)
def AddResetType(builder, resetType):
    return MissionExcelAddResetType(builder, resetType)
def MissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(20, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MissionExcelAddDisplayOrder(builder, displayOrder)
def MissionExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(21, accountType, 0)
def AddAccountType(builder, accountType):
    return MissionExcelAddAccountType(builder, accountType)
def MissionExcelAddContentTags(builder, contentTags): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(contentTags), 0)
...
def MissionExcelAddEndDay(builder, endDay): builder.PrependInt64Slot(23, endDay, 0)
...
def MissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(25, completeConditionType, 0)
...
def MissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(26, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return MissionExcelAddAccountLevel(builder, accountLevel)
def MissionExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
