...
def RaidStageRewardExcelAddClearStageRewardProb(builder, clearStageRewardProb): builder.PrependInt64Slot(0, clearStageRewardProb, 0)
...
def RaidStageRewardExcelAddClearStageRewardAmount(builder, clearStageRewardAmount): builder.PrependInt64Slot(2, clearStageRewardAmount, 0)
...
def RaidStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(6, groupId, 0)
