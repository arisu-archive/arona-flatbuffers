...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdNormal(builder, limitedRewardIdNormal): builder.PrependInt64Slot(0, limitedRewardIdNormal, 0)
...
def EliminateRaidSeasonManageExcelAddSeasonStartData(builder, seasonStartData): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(seasonStartData), 0)
...
def EliminateRaidSeasonManageExcelAddOpenRaidBossGroup01(builder, openRaidBossGroup01): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup01), 0)
...
def EliminateRaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay): builder.PrependInt64Slot(3, seasonDisplay, 0)
def AddSeasonDisplay(builder, seasonDisplay):
    return EliminateRaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay)
def EliminateRaidSeasonManageExcelAddLimitedRewardIdHardcore(builder, limitedRewardIdHardcore): builder.PrependInt64Slot(4, limitedRewardIdHardcore, 0)
...
def EliminateRaidSeasonManageExcelAddSeasonEndData(builder, seasonEndData): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(seasonEndData), 0)
...
def EliminateRaidSeasonManageExcelAddSettlementEndDate(builder, settlementEndDate): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(settlementEndDate), 0)
...
def EliminateRaidSeasonManageExcelAddSeasonRewardId(builder, seasonRewardId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(seasonRewardId), 0)
...
def EliminateRaidSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdInsane(builder, limitedRewardIdInsane): builder.PrependInt64Slot(11, limitedRewardIdInsane, 0)
...
def EliminateRaidSeasonManageExcelAddOpenRaidBossGroup03(builder, openRaidBossGroup03): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup03), 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdVeryhard(builder, limitedRewardIdVeryhard): builder.PrependInt64Slot(15, limitedRewardIdVeryhard, 0)
...
def EliminateRaidSeasonManageExcelAddLobbyTableBgPath(builder, lobbyTableBgPath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(lobbyTableBgPath), 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdHard(builder, limitedRewardIdHard): builder.PrependInt64Slot(17, limitedRewardIdHard, 0)
...
def EliminateRaidSeasonManageExcelAddMaxSeasonRewardGauage(builder, maxSeasonRewardGauage): builder.PrependInt32Slot(18, maxSeasonRewardGauage, 0)
...
def EliminateRaidSeasonManageExcelAddRankingRewardGroupId(builder, rankingRewardGroupId): builder.PrependInt64Slot(20, rankingRewardGroupId, 0)
