...
def MiniGameMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(0, resetType, 0)
def AddResetType(builder, resetType):
    return MiniGameMissionExcelAddResetType(builder, resetType)
def MiniGameMissionExcelAddIsCompleteExtensionTime(builder, isCompleteExtensionTime): builder.PrependBoolSlot(1, isCompleteExtensionTime, 0)
...
def MiniGameMissionExcelAddCompleteConditionMissionId(builder, completeConditionMissionId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionMissionId), 0)
...
def MiniGameMissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return MiniGameMissionExcelAddRewardIcon(builder, rewardIcon)
def MiniGameMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MiniGameMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def MiniGameMissionExcelAddConditionRewardParcelType(builder, conditionRewardParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelType), 0)
...
def MiniGameMissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def MiniGameMissionExcelAddCompleteConditionMissionCount(builder, completeConditionMissionCount): builder.PrependInt64Slot(8, completeConditionMissionCount, 0)
...
def MiniGameMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(9, description, 0)
def AddDescription(builder, description):
    return MiniGameMissionExcelAddDescription(builder, description)
def MiniGameMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(10, completeConditionCount, 0)
...
def MiniGameMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def MiniGameMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MiniGameMissionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(13, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameMissionExcelAddEventContentId(builder, eventContentId)
def MiniGameMissionExcelAddId(builder, id): builder.PrependInt64Slot(14, id, 0)
def AddId(builder, id):
    return MiniGameMissionExcelAddId(builder, id)
def MiniGameMissionExcelAddConditionRewardAmount(builder, conditionRewardAmount): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardAmount), 0)
...
def MiniGameMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return MiniGameMissionExcelAddToastImagePath(builder, toastImagePath)
def MiniGameMissionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(17, groupId, 0)
def AddGroupId(builder, groupId):
    return MiniGameMissionExcelAddGroupId(builder, groupId)
def MiniGameMissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(18, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return MiniGameMissionExcelAddAccountLevel(builder, accountLevel)
def MiniGameMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(19, completeConditionType, 0)
...
def MiniGameMissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(20, toastDisplayType, 0)
...
def MiniGameMissionExcelAddConditionRewardParcelId(builder, conditionRewardParcelId): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelId), 0)
...
def MiniGameMissionExcelAddGroupName(builder, groupName): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
def AddGroupName(builder, groupName):
    return MiniGameMissionExcelAddGroupName(builder, groupName)
def MiniGameMissionExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(25, accountType, 0)
def AddAccountType(builder, accountType):
    return MiniGameMissionExcelAddAccountType(builder, accountType)
def MiniGameMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MiniGameMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(27, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MiniGameMissionExcelAddDisplayOrder(builder, displayOrder)
def MiniGameMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(28, category, 0)
