...
def MiniGameDreamReplayScenarioExcelAddOrder(builder, order): builder.PrependInt64Slot(1, order, 0)
def AddOrder(builder, order):
    return MiniGameDreamReplayScenarioExcelAddOrder(builder, order)
def MiniGameDreamReplayScenarioExcelAddIsReplayScenarioHorizon(builder, isReplayScenarioHorizon): builder.PrependBoolSlot(2, isReplayScenarioHorizon, 0)
...
def MiniGameDreamReplayScenarioExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
...
def MiniGameDreamReplayScenarioExcelAddReplaySummaryLocalizeScenarioId(builder, replaySummaryLocalizeScenarioId): builder.PrependUint32Slot(6, replaySummaryLocalizeScenarioId, 0)
