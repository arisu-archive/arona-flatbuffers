...
def TutorialCharacterDialogExcelAddLocalizeTh(builder, localizeTh): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTh), 0)
def AddLocalizeTh(builder, localizeTh):
    return TutorialCharacterDialogExcelAddLocalizeTh(builder, localizeTh)
def TutorialCharacterDialogExcelAddLocalizeTw(builder, localizeTw): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTw), 0)
def AddLocalizeTw(builder, localizeTw):
    return TutorialCharacterDialogExcelAddLocalizeTw(builder, localizeTw)
def TutorialCharacterDialogExcelAddTalkId(builder, talkId): builder.PrependInt64Slot(2, talkId, 0)
def AddTalkId(builder, talkId):
    return TutorialCharacterDialogExcelAddTalkId(builder, talkId)
def TutorialCharacterDialogExcelAddVoiceId(builder, voiceId): builder.PrependUint32Slot(3, voiceId, 0)
def AddVoiceId(builder, voiceId):
    return TutorialCharacterDialogExcelAddVoiceId(builder, voiceId)
def TutorialCharacterDialogExcelAddLocalizeJp(builder, localizeJp): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(localizeJp), 0)
def AddLocalizeJp(builder, localizeJp):
    return TutorialCharacterDialogExcelAddLocalizeJp(builder, localizeJp)
def TutorialCharacterDialogExcelAddAnimationName(builder, animationName): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(animationName), 0)
def AddAnimationName(builder, animationName):
    return TutorialCharacterDialogExcelAddAnimationName(builder, animationName)
def TutorialCharacterDialogExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return TutorialCharacterDialogExcelAddLocalizeKr(builder, localizeKr)
def TutorialCharacterDialogExcelAddLocalizeEn(builder, localizeEn): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(localizeEn), 0)
