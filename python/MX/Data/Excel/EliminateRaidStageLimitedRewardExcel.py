...
def EliminateRaidStageLimitedRewardExcelAddLimitedRewardParcelType(builder, limitedRewardParcelType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(limitedRewardParcelType), 0)
...
def EliminateRaidStageLimitedRewardExcelAddLimitedRewardId(builder, limitedRewardId): builder.PrependInt64Slot(2, limitedRewardId, 0)
