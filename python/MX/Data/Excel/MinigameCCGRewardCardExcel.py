...
def MinigameCCGRewardCardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(2, groupId, 0)
def AddGroupId(builder, groupId):
    return MinigameCCGRewardCardExcelAddGroupId(builder, groupId)
def MinigameCCGRewardCardExcelAddEntityType(builder, entityType): builder.PrependInt32Slot(3, entityType, 0)
