...
def BGMUIExcelAddBgmId2nd(builder, bgmId2nd): builder.PrependInt64Slot(0, bgmId2nd, 0)
...
def BGMUIExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(2, bgmId, 0)
