...
def ScenarioTransitionExcelAddTransitionOutResource(builder, transitionOutResource): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(transitionOutResource), 0)
...
def ScenarioTransitionExcelAddTransitionOutDuration(builder, transitionOutDuration): builder.PrependInt64Slot(3, transitionOutDuration, 0)
...
def ScenarioTransitionExcelAddName(builder, name): builder.PrependUint32Slot(5, name, 0)
