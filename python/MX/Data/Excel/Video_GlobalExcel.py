...
def Video_GlobalExcelAddVideoTeenPathKr(builder, videoTeenPathKr): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(videoTeenPathKr), 0)
def AddVideoTeenPathKr(builder, videoTeenPathKr):
    return Video_GlobalExcelAddVideoTeenPathKr(builder, videoTeenPathKr)
def Video_GlobalExcelAddVideoTeenPathEn(builder, videoTeenPathEn): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(videoTeenPathEn), 0)
def AddVideoTeenPathEn(builder, videoTeenPathEn):
    return Video_GlobalExcelAddVideoTeenPathEn(builder, videoTeenPathEn)
def Video_GlobalExcelAddVideoPathTw(builder, videoPathTw): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(videoPathTw), 0)
...
def Video_GlobalExcelAddVideoTeenPathTw(builder, videoTeenPathTw): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(videoTeenPathTw), 0)
def AddVideoTeenPathTw(builder, videoTeenPathTw):
    return Video_GlobalExcelAddVideoTeenPathTw(builder, videoTeenPathTw)
def Video_GlobalExcelAddVideoId(builder, videoId): builder.PrependInt64Slot(5, videoId, 0)
def AddVideoId(builder, videoId):
    return Video_GlobalExcelAddVideoId(builder, videoId)
def Video_GlobalExcelAddVideoPathEn(builder, videoPathEn): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(videoPathEn), 0)
...
def Video_GlobalExcelAddVideoPathKr(builder, videoPathKr): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(videoPathKr), 0)
