...
def VoiceLogicEffectExcelAddVoiceId(builder, voiceId): builder.PrependUint32Slot(1, voiceId, 0)
...
def VoiceLogicEffectExcelAddSelf(builder, self): builder.PrependBoolSlot(4, self, 0)
