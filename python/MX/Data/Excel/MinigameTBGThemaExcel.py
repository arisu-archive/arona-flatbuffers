...
def MinigameTBGThemaExcelAddThemaGoalLocalize(builder, themaGoalLocalize): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(themaGoalLocalize), 0)
...
def MinigameTBGThemaExcelAddInstantClearCostAmount(builder, instantClearCostAmount): builder.PrependInt64Slot(2, instantClearCostAmount, 0)
...
def MinigameTBGThemaExcelAddThemaPlayerPrefab(builder, themaPlayerPrefab): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(themaPlayerPrefab), 0)
...
def MinigameTBGThemaExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(4, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameTBGThemaExcelAddUniqueId(builder, uniqueId)
def MinigameTBGThemaExcelAddThemaNameLocalize(builder, themaNameLocalize): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(themaNameLocalize), 0)
...
def MinigameTBGThemaExcelAddThemaMap(builder, themaMap): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(themaMap), 0)
def AddThemaMap(builder, themaMap):
    return MinigameTBGThemaExcelAddThemaMap(builder, themaMap)
def MinigameTBGThemaExcelAddThemaLeaderId(builder, themaLeaderId): builder.PrependInt64Slot(8, themaLeaderId, 0)
def AddThemaLeaderId(builder, themaLeaderId):
    return MinigameTBGThemaExcelAddThemaLeaderId(builder, themaLeaderId)
def MinigameTBGThemaExcelAddThemaIndex(builder, themaIndex): builder.PrependInt32Slot(9, themaIndex, 0)
def AddThemaIndex(builder, themaIndex):
    return MinigameTBGThemaExcelAddThemaIndex(builder, themaIndex)
def MinigameTBGThemaExcelAddThemaLoadingImage(builder, themaLoadingImage): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(themaLoadingImage), 0)
...
def MinigameTBGThemaExcelAddIsTutorial(builder, isTutorial): builder.PrependBoolSlot(11, isTutorial, 0)
...
def MinigameTBGThemaExcelAddThemaMapBg(builder, themaMapBg): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(themaMapBg), 0)
