...
def MiniGameRoadPuzzleRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def MiniGameRoadPuzzleRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameRoadPuzzleRewardExcelAddEventContentId(builder, eventContentId)
def MiniGameRoadPuzzleRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MiniGameRoadPuzzleRewardExcelAddUniqueId(builder, uniqueId)
def MiniGameRoadPuzzleRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def MiniGameRoadPuzzleRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
