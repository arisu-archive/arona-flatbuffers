...
def MiniGameShootingCharacterExcelAddModelPrefabName(builder, modelPrefabName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
...
def MiniGameShootingCharacterExcelAddNormalAttackSkillData(builder, normalAttackSkillData): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(normalAttackSkillData), 0)
...
def MiniGameShootingCharacterExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MiniGameShootingCharacterExcelAddUniqueId(builder, uniqueId)
def MiniGameShootingCharacterExcelAddDeathSkillData(builder, deathSkillData): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(deathSkillData), 0)
...
def MiniGameShootingCharacterExcelAddPublicSkillData(builder, publicSkillData): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillData), 0)
...
def MiniGameShootingCharacterExcelAddAttackPower(builder, attackPower): builder.PrependInt64Slot(7, attackPower, 0)
def AddAttackPower(builder, attackPower):
    return MiniGameShootingCharacterExcelAddAttackPower(builder, attackPower)
def MiniGameShootingCharacterExcelAddMaxHp(builder, maxHp): builder.PrependInt64Slot(8, maxHp, 0)
def AddMaxHp(builder, maxHp):
    return MiniGameShootingCharacterExcelAddMaxHp(builder, maxHp)
def MiniGameShootingCharacterExcelAddAttackRange(builder, attackRange): builder.PrependInt64Slot(9, attackRange, 0)
def AddAttackRange(builder, attackRange):
    return MiniGameShootingCharacterExcelAddAttackRange(builder, attackRange)
def MiniGameShootingCharacterExcelAddDefensePower(builder, defensePower): builder.PrependInt64Slot(10, defensePower, 0)
def AddDefensePower(builder, defensePower):
    return MiniGameShootingCharacterExcelAddDefensePower(builder, defensePower)
def MiniGameShootingCharacterExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(11, characterVoiceGroupId, 0)
...
def MiniGameShootingCharacterExcelAddCriticalDamageRate(builder, criticalDamageRate): builder.PrependInt64Slot(12, criticalDamageRate, 0)
...
def MiniGameShootingCharacterExcelAddBodyRadius(builder, bodyRadius): builder.PrependFloat32Slot(13, bodyRadius, 0.0)
def AddBodyRadius(builder, bodyRadius):
    return MiniGameShootingCharacterExcelAddBodyRadius(builder, bodyRadius)
def MiniGameShootingCharacterExcelAddSpineResourceName(builder, spineResourceName): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceName), 0)
...
def MiniGameShootingCharacterExcelAddIgnoreObstacleCheck(builder, ignoreObstacleCheck): builder.PrependBoolSlot(16, ignoreObstacleCheck, 0)
...
def MiniGameShootingCharacterExcelAddIsBoss(builder, isBoss): builder.PrependBoolSlot(17, isBoss, 0)
def AddIsBoss(builder, isBoss):
    return MiniGameShootingCharacterExcelAddIsBoss(builder, isBoss)
def MiniGameShootingCharacterExcelAddCriticalRate(builder, criticalRate): builder.PrependInt64Slot(18, criticalRate, 0)
