...
def ArenaNPCExcelAddNpcStarGrade(builder, npcStarGrade): builder.PrependInt64Slot(2, npcStarGrade, 0)
def AddNpcStarGrade(builder, npcStarGrade):
    return ArenaNPCExcelAddNpcStarGrade(builder, npcStarGrade)
def ArenaNPCExcelAddNpcLevelDeviation(builder, npcLevelDeviation): builder.PrependInt64Slot(3, npcLevelDeviation, 0)
def AddNpcLevelDeviation(builder, npcLevelDeviation):
    return ArenaNPCExcelAddNpcLevelDeviation(builder, npcLevelDeviation)
def ArenaNPCExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(4, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return ArenaNPCExcelAddUniqueId(builder, uniqueId)
def ArenaNPCExcelAddRank(builder, rank): builder.PrependInt64Slot(5, rank, 0)
def AddRank(builder, rank):
    return ArenaNPCExcelAddRank(builder, rank)
def ArenaNPCExcelAddNpcAccountLevel(builder, npcAccountLevel): builder.PrependInt64Slot(6, npcAccountLevel, 0)
def AddNpcAccountLevel(builder, npcAccountLevel):
    return ArenaNPCExcelAddNpcAccountLevel(builder, npcAccountLevel)
def ArenaNPCExcelAddExceptionTssIds(builder, exceptionTssIds): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(exceptionTssIds), 0)
...
def ArenaNPCExcelAddNpcLevel(builder, npcLevel): builder.PrependInt64Slot(8, npcLevel, 0)
def AddNpcLevel(builder, npcLevel):
    return ArenaNPCExcelAddNpcLevel(builder, npcLevel)
def ArenaNPCExcelAddExceptionMainCharacterIds(builder, exceptionMainCharacterIds): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(exceptionMainCharacterIds), 0)
