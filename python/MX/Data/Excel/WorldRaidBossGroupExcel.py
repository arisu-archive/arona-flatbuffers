...
def WorldRaidBossGroupExcelAddExclusiveOperatorScenarioBattle(builder, exclusiveOperatorScenarioBattle): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorScenarioBattle), 0)
...
def WorldRaidBossGroupExcelAddExclusiveOperatorBossKill(builder, exclusiveOperatorBossKill): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorBossKill), 0)
...
def WorldRaidBossGroupExcelAddWorldBossHp(builder, worldBossHp): builder.PrependInt64Slot(3, worldBossHp, 0)
def AddWorldBossHp(builder, worldBossHp):
    return WorldRaidBossGroupExcelAddWorldBossHp(builder, worldBossHp)
def WorldRaidBossGroupExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return WorldRaidBossGroupExcelAddId(builder, id)
def WorldRaidBossGroupExcelAddWorldBossListParcel(builder, worldBossListParcel): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossListParcel), 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpAsia(builder, worldBossHpAsia): builder.PrependInt64Slot(6, worldBossHpAsia, 0)
def AddWorldBossHpAsia(builder, worldBossHpAsia):
    return WorldRaidBossGroupExcelAddWorldBossHpAsia(builder, worldBossHpAsia)
def WorldRaidBossGroupExcelAddWorldBossPopupBg(builder, worldBossPopupBg): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossPopupBg), 0)
...
def WorldRaidBossGroupExcelAddExclusiveOperatorBossSpawn(builder, exclusiveOperatorBossSpawn): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorBossSpawn), 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpGlobal(builder, worldBossHpGlobal): builder.PrependInt64Slot(10, worldBossHpGlobal, 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpTw(builder, worldBossHpTw): builder.PrependInt64Slot(11, worldBossHpTw, 0)
...
def WorldRaidBossGroupExcelAddWorldBossClearRewardGroupId(builder, worldBossClearRewardGroupId): builder.PrependInt64Slot(13, worldBossClearRewardGroupId, 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpNa(builder, worldBossHpNa): builder.PrependInt64Slot(14, worldBossHpNa, 0)
...
def WorldRaidBossGroupExcelAddHideAnotherBossKilled(builder, hideAnotherBossKilled): builder.PrependBoolSlot(16, hideAnotherBossKilled, 0)
...
def WorldRaidBossGroupExcelAddWorldBossName(builder, worldBossName): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossName), 0)
...
def WorldRaidBossGroupExcelAddEchelonConstraintGroupId(builder, echelonConstraintGroupId): builder.PrependInt64Slot(19, echelonConstraintGroupId, 0)
...
def WorldRaidBossGroupExcelAddWorldBossPopupPortrait(builder, worldBossPopupPortrait): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossPopupPortrait), 0)
