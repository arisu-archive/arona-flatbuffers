...
def ItemExcelAddUsingResultParcelType(builder, usingResultParcelType): builder.PrependInt32Slot(0, usingResultParcelType, 0)
...
def ItemExcelAddQuality(builder, quality): builder.PrependInt64Slot(1, quality, 0)
def AddQuality(builder, quality):
    return ItemExcelAddQuality(builder, quality)
def ItemExcelAddMailType(builder, mailType): builder.PrependInt32Slot(2, mailType, 0)
def AddMailType(builder, mailType):
    return ItemExcelAddMailType(builder, mailType)
def ItemExcelAddRarity(builder, rarity): builder.PrependInt32Slot(3, rarity, 0)
...
def ItemExcelAddGachaTicket(builder, gachaTicket): builder.PrependInt32Slot(7, gachaTicket, 0)
def AddGachaTicket(builder, gachaTicket):
    return ItemExcelAddGachaTicket(builder, gachaTicket)
def ItemExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
def AddId(builder, id):
    return ItemExcelAddId(builder, id)
def ItemExcelAddStackableFunction(builder, stackableFunction): builder.PrependInt32Slot(9, stackableFunction, 0)
...
def ItemExcelAddStackableMax(builder, stackableMax): builder.PrependInt32Slot(11, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return ItemExcelAddStackableMax(builder, stackableMax)
def ItemExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(12, craftQualityTier0, 0)
def AddCraftQualityTier0(builder, craftQualityTier0):
    return ItemExcelAddCraftQualityTier0(builder, craftQualityTier0)
def ItemExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
def AddSpriteName(builder, spriteName):
    return ItemExcelAddSpriteName(builder, spriteName)
def ItemExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def ItemExcelAddTierUpgradeRecipeCraftId(builder, tierUpgradeRecipeCraftId): builder.PrependInt64Slot(15, tierUpgradeRecipeCraftId, 0)
...
def ItemExcelAddItemCategory(builder, itemCategory): builder.PrependInt32Slot(16, itemCategory, 0)
...
def ItemExcelAddShortcutTypeId(builder, shortcutTypeId): builder.PrependInt64Slot(18, shortcutTypeId, 0)
def AddShortcutTypeId(builder, shortcutTypeId):
    return ItemExcelAddShortcutTypeId(builder, shortcutTypeId)
def ItemExcelAddUsingResultId(builder, usingResultId): builder.PrependInt64Slot(19, usingResultId, 0)
def AddUsingResultId(builder, usingResultId):
    return ItemExcelAddUsingResultId(builder, usingResultId)
def ItemExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def ItemExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return ItemExcelAddIcon(builder, icon)
def ItemExcelAddExpiryChangeParcelType(builder, expiryChangeParcelType): builder.PrependInt32Slot(23, expiryChangeParcelType, 0)
...
def ItemExcelAddImmediateUse(builder, immediateUse): builder.PrependBoolSlot(24, immediateUse, 0)
def AddImmediateUse(builder, immediateUse):
    return ItemExcelAddImmediateUse(builder, immediateUse)
def ItemExcelAddUsingResultAmount(builder, usingResultAmount): builder.PrependInt64Slot(25, usingResultAmount, 0)
def AddUsingResultAmount(builder, usingResultAmount):
    return ItemExcelAddUsingResultAmount(builder, usingResultAmount)
def ItemExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(26, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return ItemExcelAddProductionStep(builder, productionStep)
def ItemExcelAddCanTierUpgrade(builder, canTierUpgrade): builder.PrependBoolSlot(27, canTierUpgrade, 0)
...
def ItemExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(29, craftQualityTier2, 0)
...
def ItemExcelAddExpiryChangeId(builder, expiryChangeId): builder.PrependInt64Slot(31, expiryChangeId, 0)
