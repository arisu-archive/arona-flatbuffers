...
def CampaignStrategyObjectExcelAddStrategySightRange(builder, strategySightRange): builder.PrependInt64Slot(3, strategySightRange, 0)
...
def CampaignStrategyObjectExcelAddHealValue(builder, healValue): builder.PrependInt32Slot(4, healValue, 0)
def AddHealValue(builder, healValue):
    return CampaignStrategyObjectExcelAddHealValue(builder, healValue)
def CampaignStrategyObjectExcelAddStrategyRewardName(builder, strategyRewardName): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(strategyRewardName), 0)
...
def CampaignStrategyObjectExcelAddStrategyRewardParcelType(builder, strategyRewardParcelType): builder.PrependInt32Slot(6, strategyRewardParcelType, 0)
...
def CampaignStrategyObjectExcelAddId(builder, id): builder.PrependInt64Slot(7, id, 0)
...
def CampaignStrategyObjectExcelAddPortalId(builder, portalId): builder.PrependInt32Slot(9, portalId, 0)
...
def CampaignStrategyObjectExcelAddKey(builder, key): builder.PrependUint32Slot(11, key, 0)
def AddKey(builder, key):
    return CampaignStrategyObjectExcelAddKey(builder, key)
def CampaignStrategyObjectExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return CampaignStrategyObjectExcelAddPrefabName(builder, prefabName)
def CampaignStrategyObjectExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignStrategyObjectExcelAddName(builder, name)
def CampaignStrategyObjectExcelAddStrategyObjectType(builder, strategyObjectType): builder.PrependInt32Slot(14, strategyObjectType, 0)
