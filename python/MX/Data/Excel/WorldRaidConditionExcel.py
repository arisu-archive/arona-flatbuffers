...
def WorldRaidConditionExcelAddMultipleConditionCheckType(builder, multipleConditionCheckType): builder.PrependInt32Slot(0, multipleConditionCheckType, 0)
...
def WorldRaidConditionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(1, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return WorldRaidConditionExcelAddAccountLevel(builder, accountLevel)
def WorldRaidConditionExcelAddWorldRaidBossKill(builder, worldRaidBossKill): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidBossKill), 0)
...
def WorldRaidConditionExcelAddAfterWhenDate(builder, afterWhenDate): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(afterWhenDate), 0)
def AddAfterWhenDate(builder, afterWhenDate):
    return WorldRaidConditionExcelAddAfterWhenDate(builder, afterWhenDate)
def WorldRaidConditionExcelAddHideWhenLocked(builder, hideWhenLocked): builder.PrependBoolSlot(4, hideWhenLocked, 0)
...
def WorldRaidConditionExcelAddCampaignStageId(builder, campaignStageId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(campaignStageId), 0)
