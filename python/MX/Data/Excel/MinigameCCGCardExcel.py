...
def MinigameCCGCardExcelAddPassiveSkillId(builder, passiveSkillId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(passiveSkillId), 0)
...
def MinigameCCGCardExcelAddPassiveActivateCount(builder, passiveActivateCount): builder.PrependInt32Slot(2, passiveActivateCount, 0)
...
def MinigameCCGCardExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
...
def MinigameCCGCardExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def MinigameCCGCardExcelAddType(builder, type): builder.PrependInt32Slot(6, type, 0)
def AddType(builder, type):
    return MinigameCCGCardExcelAddType(builder, type)
def MinigameCCGCardExcelAddIsDisposal(builder, isDisposal): builder.PrependBoolSlot(7, isDisposal, 0)
def AddIsDisposal(builder, isDisposal):
    return MinigameCCGCardExcelAddIsDisposal(builder, isDisposal)
def MinigameCCGCardExcelAddUiImagePath(builder, uiImagePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(uiImagePath), 0)
def AddUiImagePath(builder, uiImagePath):
    return MinigameCCGCardExcelAddUiImagePath(builder, uiImagePath)
def MinigameCCGCardExcelAddImagePath(builder, imagePath): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(imagePath), 0)
def AddImagePath(builder, imagePath):
    return MinigameCCGCardExcelAddImagePath(builder, imagePath)
def MinigameCCGCardExcelAddDescription(builder, description): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)
def AddDescription(builder, description):
    return MinigameCCGCardExcelAddDescription(builder, description)
def MinigameCCGCardExcelAddName(builder, name): builder.PrependUint32Slot(11, name, 0)
def AddName(builder, name):
    return MinigameCCGCardExcelAddName(builder, name)
def MinigameCCGCardExcelAddActiveSkillId(builder, activeSkillId): builder.PrependInt32Slot(12, activeSkillId, 0)
