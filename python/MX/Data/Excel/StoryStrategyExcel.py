...
def StoryStrategyExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(0, stageEnterEchelonCount, 0)
...
def StoryStrategyExcelAddLocalize(builder, localize): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(localize), 0)
def AddLocalize(builder, localize):
    return StoryStrategyExcelAddLocalize(builder, localize)
def StoryStrategyExcelAddStrategyMapBg(builder, strategyMapBg): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMapBg), 0)
def AddStrategyMapBg(builder, strategyMapBg):
    return StoryStrategyExcelAddStrategyMapBg(builder, strategyMapBg)
def StoryStrategyExcelAddContentType(builder, contentType): builder.PrependInt32Slot(3, contentType, 0)
...
def StoryStrategyExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(5, bgmId, 0)
def AddBgmId(builder, bgmId):
    return StoryStrategyExcelAddBgmId(builder, bgmId)
def StoryStrategyExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(6, battleDuration, 0)
...
def StoryStrategyExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return StoryStrategyExcelAddStrategyMap(builder, strategyMap)
def StoryStrategyExcelAddWhiteListId(builder, whiteListId): builder.PrependInt64Slot(9, whiteListId, 0)
def AddWhiteListId(builder, whiteListId):
    return StoryStrategyExcelAddWhiteListId(builder, whiteListId)
def StoryStrategyExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(10, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return StoryStrategyExcelAddStageTopography(builder, stageTopography)
def StoryStrategyExcelAddId(builder, id): builder.PrependInt64Slot(11, id, 0)
...
def StoryStrategyExcelAddMaxTurn(builder, maxTurn): builder.PrependInt32Slot(13, maxTurn, 0)
