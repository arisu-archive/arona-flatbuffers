...
def ShopRecruitExcelAddDirectPayOneStoreShopCashId(builder, directPayOneStoreShopCashId): builder.PrependInt64Slot(27, directPayOneStoreShopCashId, 0)
...
def ShopRecruitExcelAddProbabilityUrlDev(builder, probabilityUrlDev): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(probabilityUrlDev), 0)
def AddProbabilityUrlDev(builder, probabilityUrlDev):
    return ShopRecruitExcelAddProbabilityUrlDev(builder, probabilityUrlDev)
def ShopRecruitExcelAddProbabilityUrlLive(builder, probabilityUrlLive): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(probabilityUrlLive), 0)
