...
def CampaignStageRewardExcelAddStageRewardAmount(builder, stageRewardAmount): builder.PrependInt32Slot(0, stageRewardAmount, 0)
...
def CampaignStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(1, groupId, 0)
def AddGroupId(builder, groupId):
    return CampaignStageRewardExcelAddGroupId(builder, groupId)
def CampaignStageRewardExcelAddIsDisplayed(builder, isDisplayed): builder.PrependBoolSlot(2, isDisplayed, 0)
def AddIsDisplayed(builder, isDisplayed):
    return CampaignStageRewardExcelAddIsDisplayed(builder, isDisplayed)
def CampaignStageRewardExcelAddRewardTag(builder, rewardTag): builder.PrependInt32Slot(3, rewardTag, 0)
def AddRewardTag(builder, rewardTag):
    return CampaignStageRewardExcelAddRewardTag(builder, rewardTag)
def CampaignStageRewardExcelAddStageRewardParcelType(builder, stageRewardParcelType): builder.PrependInt32Slot(4, stageRewardParcelType, 0)
...
def CampaignStageRewardExcelAddStageRewardProb(builder, stageRewardProb): builder.PrependInt32Slot(5, stageRewardProb, 0)
def AddStageRewardProb(builder, stageRewardProb):
    return CampaignStageRewardExcelAddStageRewardProb(builder, stageRewardProb)
def CampaignStageRewardExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(6, stageRewardId, 0)
