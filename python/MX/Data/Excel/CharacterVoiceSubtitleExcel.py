...
def CharacterVoiceSubtitleExcelAddSeparate(builder, separate): builder.PrependBoolSlot(0, separate, 0)
...
def CharacterVoiceSubtitleExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(5, characterVoiceGroupId, 0)
...
def CharacterVoiceSubtitleExcelAddLocalizeTh(builder, localizeTh): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTh), 0)
def AddLocalizeTh(builder, localizeTh):
    return CharacterVoiceSubtitleExcelAddLocalizeTh(builder, localizeTh)
def CharacterVoiceSubtitleExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return CharacterVoiceSubtitleExcelAddLocalizeKr(builder, localizeKr)
def CharacterVoiceSubtitleExcelAddLocalizeJp(builder, localizeJp): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(localizeJp), 0)
def AddLocalizeJp(builder, localizeJp):
    return CharacterVoiceSubtitleExcelAddLocalizeJp(builder, localizeJp)
def CharacterVoiceSubtitleExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
