...
def MiniGameDreamParameterExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(0, localizeEtcId, 0)
...
def MiniGameDreamParameterExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
def AddIconPath(builder, iconPath):
    return MiniGameDreamParameterExcelAddIconPath(builder, iconPath)
def MiniGameDreamParameterExcelAddParameterBaseMax(builder, parameterBaseMax): builder.PrependInt64Slot(4, parameterBaseMax, 0)
...
def MiniGameDreamParameterExcelAddParameterMax(builder, parameterMax): builder.PrependInt64Slot(5, parameterMax, 0)
def AddParameterMax(builder, parameterMax):
    return MiniGameDreamParameterExcelAddParameterMax(builder, parameterMax)
def MiniGameDreamParameterExcelAddParameterMin(builder, parameterMin): builder.PrependInt64Slot(6, parameterMin, 0)
def AddParameterMin(builder, parameterMin):
    return MiniGameDreamParameterExcelAddParameterMin(builder, parameterMin)
def MiniGameDreamParameterExcelAddParameterType(builder, parameterType): builder.PrependInt32Slot(7, parameterType, 0)
