...
def MiniGameDreamParameterExcelAddParameterType(builder, parameterType): builder.PrependInt32Slot(0, parameterType, 0)
def AddParameterType(builder, parameterType):
    return MiniGameDreamParameterExcelAddParameterType(builder, parameterType)
def MiniGameDreamParameterExcelAddParameterBaseMax(builder, parameterBaseMax): builder.PrependInt64Slot(1, parameterBaseMax, 0)
...
def MiniGameDreamParameterExcelAddParameterBase(builder, parameterBase): builder.PrependInt64Slot(2, parameterBase, 0)
def AddParameterBase(builder, parameterBase):
    return MiniGameDreamParameterExcelAddParameterBase(builder, parameterBase)
def MiniGameDreamParameterExcelAddParameterMin(builder, parameterMin): builder.PrependInt64Slot(3, parameterMin, 0)
def AddParameterMin(builder, parameterMin):
    return MiniGameDreamParameterExcelAddParameterMin(builder, parameterMin)
def MiniGameDreamParameterExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(4, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameDreamParameterExcelAddEventContentId(builder, eventContentId)
def MiniGameDreamParameterExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
def AddIconPath(builder, iconPath):
    return MiniGameDreamParameterExcelAddIconPath(builder, iconPath)
def MiniGameDreamParameterExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(6, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return MiniGameDreamParameterExcelAddLocalizeEtcId(builder, localizeEtcId)
def MiniGameDreamParameterExcelAddParameterMax(builder, parameterMax): builder.PrependInt64Slot(7, parameterMax, 0)
