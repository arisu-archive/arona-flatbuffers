...
def ParcelAutoSynthExcelAddResultParcelType(builder, resultParcelType): builder.PrependInt32Slot(0, resultParcelType, 0)
def AddResultParcelType(builder, resultParcelType):
    return ParcelAutoSynthExcelAddResultParcelType(builder, resultParcelType)
def ParcelAutoSynthExcelAddSynthEndAmount(builder, synthEndAmount): builder.PrependInt64Slot(1, synthEndAmount, 0)
def AddSynthEndAmount(builder, synthEndAmount):
    return ParcelAutoSynthExcelAddSynthEndAmount(builder, synthEndAmount)
def ParcelAutoSynthExcelAddResultParcelId(builder, resultParcelId): builder.PrependInt64Slot(2, resultParcelId, 0)
...
def ParcelAutoSynthExcelAddSynthStartAmount(builder, synthStartAmount): builder.PrependInt64Slot(4, synthStartAmount, 0)
def AddSynthStartAmount(builder, synthStartAmount):
    return ParcelAutoSynthExcelAddSynthStartAmount(builder, synthStartAmount)
def ParcelAutoSynthExcelAddRequireParcelId(builder, requireParcelId): builder.PrependInt64Slot(5, requireParcelId, 0)
def AddRequireParcelId(builder, requireParcelId):
    return ParcelAutoSynthExcelAddRequireParcelId(builder, requireParcelId)
def ParcelAutoSynthExcelAddResultParcelAmount(builder, resultParcelAmount): builder.PrependInt64Slot(6, resultParcelAmount, 0)
...
def ParcelAutoSynthExcelAddRequireParcelType(builder, requireParcelType): builder.PrependInt32Slot(7, requireParcelType, 0)
...
def ParcelAutoSynthExcelAddRequireParcelAmount(builder, requireParcelAmount): builder.PrependInt64Slot(8, requireParcelAmount, 0)
