...
def BattlePassRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(0, rewardParcelType, 0)
...
def BattlePassRewardExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return BattlePassRewardExcelAddId(builder, id)
def BattlePassRewardExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(5, rewardGroupId, 0)
