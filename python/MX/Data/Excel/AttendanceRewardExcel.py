...
def AttendanceRewardExcelAddDay(builder, day): builder.PrependInt64Slot(0, day, 0)
def AddDay(builder, day):
    return AttendanceRewardExcelAddDay(builder, day)
def AttendanceRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AttendanceRewardExcelAddAttendanceId(builder, attendanceId): builder.PrependInt64Slot(3, attendanceId, 0)
...
def AttendanceRewardExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
