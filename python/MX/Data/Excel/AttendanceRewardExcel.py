...
def AttendanceRewardExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return AttendanceRewardExcelAddRewardIcon(builder, rewardIcon)
def AttendanceRewardExcelAddAttendanceId(builder, attendanceId): builder.PrependInt64Slot(1, attendanceId, 0)
def AddAttendanceId(builder, attendanceId):
    return AttendanceRewardExcelAddAttendanceId(builder, attendanceId)
def AttendanceRewardExcelAddRewardId(builder, rewardId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardId), 0)
...
def AttendanceRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AttendanceRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def AttendanceRewardExcelAddDay(builder, day): builder.PrependInt64Slot(5, day, 0)
