...
def ConquestErosionExcelAddPhaseAlarm(builder, phaseAlarm): builder.PrependBoolSlot(0, phaseAlarm, 0)
def AddPhaseAlarm(builder, phaseAlarm):
    return ConquestErosionExcelAddPhaseAlarm(builder, phaseAlarm)
def ConquestErosionExcelAddPhaseBeforeExposeConditionType(builder, phaseBeforeExposeConditionType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(phaseBeforeExposeConditionType), 0)
...
def ConquestErosionExcelAddPhase(builder, phase): builder.PrependInt32Slot(2, phase, 0)
def AddPhase(builder, phase):
    return ConquestErosionExcelAddPhase(builder, phase)
def ConquestErosionExcelAddErosionType(builder, erosionType): builder.PrependInt32Slot(3, erosionType, 0)
def AddErosionType(builder, erosionType):
    return ConquestErosionExcelAddErosionType(builder, erosionType)
def ConquestErosionExcelAddPhaseStartConditionType(builder, phaseStartConditionType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(phaseStartConditionType), 0)
...
def ConquestErosionExcelAddPhaseStartConditionParameter(builder, phaseStartConditionParameter): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(phaseStartConditionParameter), 0)
...
def ConquestErosionExcelAddErosionBattleConditionParcelType(builder, erosionBattleConditionParcelType): builder.PrependInt32Slot(6, erosionBattleConditionParcelType, 0)
...
def ConquestErosionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(7, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestErosionExcelAddEventContentId(builder, eventContentId)
def ConquestErosionExcelAddPhaseBeforeExposeConditionParameter(builder, phaseBeforeExposeConditionParameter): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(phaseBeforeExposeConditionParameter), 0)
...
def ConquestErosionExcelAddStepIndex(builder, stepIndex): builder.PrependInt32Slot(9, stepIndex, 0)
def AddStepIndex(builder, stepIndex):
    return ConquestErosionExcelAddStepIndex(builder, stepIndex)
def ConquestErosionExcelAddErosionBattleConditionParcelUniqueId(builder, erosionBattleConditionParcelUniqueId): builder.PrependInt64Slot(10, erosionBattleConditionParcelUniqueId, 0)
...
def ConquestErosionExcelAddErosionBattleConditionParcelAmount(builder, erosionBattleConditionParcelAmount): builder.PrependInt64Slot(11, erosionBattleConditionParcelAmount, 0)
...
def ConquestErosionExcelAddConquestRewardId(builder, conquestRewardId): builder.PrependInt64Slot(12, conquestRewardId, 0)
def AddConquestRewardId(builder, conquestRewardId):
    return ConquestErosionExcelAddConquestRewardId(builder, conquestRewardId)
def ConquestErosionExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
