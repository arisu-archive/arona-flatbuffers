...
def LevelExpMasterCoinExcelAddMaxLevel(builder, maxLevel): builder.PrependInt32Slot(0, maxLevel, 0)
...
def LevelExpMasterCoinExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
