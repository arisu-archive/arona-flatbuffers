...
def ScenarioBGEffectExcelAddScroll(builder, scroll): builder.PrependInt32Slot(1, scroll, 0)
def AddScroll(builder, scroll):
    return ScenarioBGEffectExcelAddScroll(builder, scroll)
def ScenarioBGEffectExcelAddScrollTo(builder, scrollTo): builder.PrependInt64Slot(2, scrollTo, 0)
...
def ScenarioBGEffectExcelAddName(builder, name): builder.PrependUint32Slot(4, name, 0)
...
def ScenarioBGEffectExcelAddEffect2(builder, effect2): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(effect2), 0)
