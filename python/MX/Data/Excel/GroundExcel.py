...
def GroundExcelAddLevelElite(builder, levelElite): builder.PrependInt64Slot(0, levelElite, 0)
def AddLevelElite(builder, levelElite):
    return GroundExcelAddLevelElite(builder, levelElite)
def GroundExcelAddUiEnemyCount(builder, uiEnemyCount): builder.PrependInt32Slot(1, uiEnemyCount, 0)
def AddUiEnemyCount(builder, uiEnemyCount):
    return GroundExcelAddUiEnemyCount(builder, uiEnemyCount)
def GroundExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return GroundExcelAddId(builder, id)
def GroundExcelAddLevelNpc(builder, levelNpc): builder.PrependInt64Slot(3, levelNpc, 0)
...
def GroundExcelAddHideNpcWhenBattleEnd(builder, hideNpcWhenBattleEnd): builder.PrependBoolSlot(5, hideNpcWhenBattleEnd, 0)
...
def GroundExcelAddEnemyAttackRangeRate(builder, enemyAttackRangeRate): builder.PrependInt64Slot(6, enemyAttackRangeRate, 0)
...
def GroundExcelAddTssHatchOpen(builder, tssHatchOpen): builder.PrependBoolSlot(7, tssHatchOpen, 0)
def AddTssHatchOpen(builder, tssHatchOpen):
    return GroundExcelAddTssHatchOpen(builder, tssHatchOpen)
def GroundExcelAddLevelBoss(builder, levelBoss): builder.PrependInt64Slot(8, levelBoss, 0)
def AddLevelBoss(builder, levelBoss):
    return GroundExcelAddLevelBoss(builder, levelBoss)
def GroundExcelAddShowNpcSkillCutIn(builder, showNpcSkillCutIn): builder.PrependInt32Slot(9, showNpcSkillCutIn, 0)
def AddShowNpcSkillCutIn(builder, showNpcSkillCutIn):
    return GroundExcelAddShowNpcSkillCutIn(builder, showNpcSkillCutIn)
def GroundExcelAddPlayerSightPointRate(builder, playerSightPointRate): builder.PrependInt64Slot(10, playerSightPointRate, 0)
...
def GroundExcelAddPlayerAttackRangeAdd(builder, playerAttackRangeAdd): builder.PrependInt64Slot(11, playerAttackRangeAdd, 0)
...
def GroundExcelAddGradeBoss(builder, gradeBoss): builder.PrependInt64Slot(12, gradeBoss, 0)
def AddGradeBoss(builder, gradeBoss):
    return GroundExcelAddGradeBoss(builder, gradeBoss)
def GroundExcelAddEnemySkillRangeAdd(builder, enemySkillRangeAdd): builder.PrependInt64Slot(13, enemySkillRangeAdd, 0)
def AddEnemySkillRangeAdd(builder, enemySkillRangeAdd):
    return GroundExcelAddEnemySkillRangeAdd(builder, enemySkillRangeAdd)
def GroundExcelAddAllyPassiveSkillId(builder, allyPassiveSkillId): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkillId), 0)
...
def GroundExcelAddIsPhaseBgm(builder, isPhaseBgm): builder.PrependBoolSlot(15, isPhaseBgm, 0)
def AddIsPhaseBgm(builder, isPhaseBgm):
    return GroundExcelAddIsPhaseBgm(builder, isPhaseBgm)
def GroundExcelAddSkipBattleEnd(builder, skipBattleEnd): builder.PrependBoolSlot(16, skipBattleEnd, 0)
def AddSkipBattleEnd(builder, skipBattleEnd):
    return GroundExcelAddSkipBattleEnd(builder, skipBattleEnd)
def GroundExcelAddCoverPointOff(builder, coverPointOff): builder.PrependBoolSlot(17, coverPointOff, 0)
def AddCoverPointOff(builder, coverPointOff):
    return GroundExcelAddCoverPointOff(builder, coverPointOff)
def GroundExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(18, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return GroundExcelAddStageTopography(builder, stageTopography)
def GroundExcelAddUiHpScale(builder, uiHpScale): builder.PrependFloat32Slot(19, uiHpScale, 0.0)
def AddUiHpScale(builder, uiHpScale):
    return GroundExcelAddUiHpScale(builder, uiHpScale)
def GroundExcelAddPlayerSkillRangeAdd(builder, playerSkillRangeAdd): builder.PrependInt64Slot(20, playerSkillRangeAdd, 0)
...
def GroundExcelAddObstacleLevel(builder, obstacleLevel): builder.PrependInt64Slot(21, obstacleLevel, 0)
def AddObstacleLevel(builder, obstacleLevel):
    return GroundExcelAddObstacleLevel(builder, obstacleLevel)
def GroundExcelAddTssAirUnitHeight(builder, tssAirUnitHeight): builder.PrependInt64Slot(22, tssAirUnitHeight, 0)
def AddTssAirUnitHeight(builder, tssAirUnitHeight):
    return GroundExcelAddTssAirUnitHeight(builder, tssAirUnitHeight)
def GroundExcelAddEnemyAttackRangeAdd(builder, enemyAttackRangeAdd): builder.PrependInt64Slot(23, enemyAttackRangeAdd, 0)
...
def GroundExcelAddBeforeVictoryTimelinePath(builder, beforeVictoryTimelinePath): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(beforeVictoryTimelinePath), 0)
...
def GroundExcelAddEnemySightPointRate(builder, enemySightPointRate): builder.PrependInt64Slot(25, enemySightPointRate, 0)
...
def GroundExcelAddUiBattleHideFromScratch(builder, uiBattleHideFromScratch): builder.PrependBoolSlot(26, uiBattleHideFromScratch, 0)
...
def GroundExcelAddLevelChampion(builder, levelChampion): builder.PrependInt64Slot(27, levelChampion, 0)
def AddLevelChampion(builder, levelChampion):
    return GroundExcelAddLevelChampion(builder, levelChampion)
def GroundExcelAddEnemyMinimumPositionGapRate(builder, enemyMinimumPositionGapRate): builder.PrependInt64Slot(28, enemyMinimumPositionGapRate, 0)
...
def GroundExcelAddEnemySightRangeMax(builder, enemySightRangeMax): builder.PrependBoolSlot(29, enemySightRangeMax, 0)
def AddEnemySightRangeMax(builder, enemySightRangeMax):
    return GroundExcelAddEnemySightRangeMax(builder, enemySightRangeMax)
def GroundExcelAddLevelMinion(builder, levelMinion): builder.PrependInt64Slot(30, levelMinion, 0)
def AddLevelMinion(builder, levelMinion):
    return GroundExcelAddLevelMinion(builder, levelMinion)
def GroundExcelAddPlayerSightPointAdd(builder, playerSightPointAdd): builder.PrependInt64Slot(31, playerSightPointAdd, 0)
...
def GroundExcelAddGradeElite(builder, gradeElite): builder.PrependInt64Slot(32, gradeElite, 0)
def AddGradeElite(builder, gradeElite):
    return GroundExcelAddGradeElite(builder, gradeElite)
def GroundExcelAddEnemyArmorType(builder, enemyArmorType): builder.PrependInt32Slot(33, enemyArmorType, 0)
def AddEnemyArmorType(builder, enemyArmorType):
    return GroundExcelAddEnemyArmorType(builder, enemyArmorType)
def GroundExcelAddStageFileName(builder, stageFileName): builder.PrependUOffsetTRelativeSlot(34, flatbuffers.number_types.UOffsetTFlags.py_type(stageFileName), 0)
...
def GroundExcelAddEnemyPassiveSkillId(builder, enemyPassiveSkillId): builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPassiveSkillId), 0)
...
def GroundExcelAddBattleReadyTimelinePath(builder, battleReadyTimelinePath): builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePath), 0)
...
def GroundExcelAddForcedTacticSpeed(builder, forcedTacticSpeed): builder.PrependInt32Slot(37, forcedTacticSpeed, 0)
def AddForcedTacticSpeed(builder, forcedTacticSpeed):
    return GroundExcelAddForcedTacticSpeed(builder, forcedTacticSpeed)
def GroundExcelAddPlayerAttackRangeRate(builder, playerAttackRangeRate): builder.PrependInt64Slot(38, playerAttackRangeRate, 0)
...
def GroundExcelAddUiEmojiScale(builder, uiEmojiScale): builder.PrependFloat32Slot(39, uiEmojiScale, 0.0)
def AddUiEmojiScale(builder, uiEmojiScale):
    return GroundExcelAddUiEmojiScale(builder, uiEmojiScale)
def GroundExcelAddImmuneHitBeforeTimeOutEnd(builder, immuneHitBeforeTimeOutEnd): builder.PrependBoolSlot(40, immuneHitBeforeTimeOutEnd, 0)
...
def GroundExcelAddGroundSceneName(builder, groundSceneName): builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(groundSceneName), 0)
def AddGroundSceneName(builder, groundSceneName):
    return GroundExcelAddGroundSceneName(builder, groundSceneName)
def GroundExcelAddGradeNpc(builder, gradeNpc): builder.PrependInt64Slot(42, gradeNpc, 0)
def AddGradeNpc(builder, gradeNpc):
    return GroundExcelAddGradeNpc(builder, gradeNpc)
def GroundExcelAddEnemyBulletType(builder, enemyBulletType): builder.PrependInt32Slot(43, enemyBulletType, 0)
def AddEnemyBulletType(builder, enemyBulletType):
    return GroundExcelAddEnemyBulletType(builder, enemyBulletType)
def GroundExcelAddGradeChampion(builder, gradeChampion): builder.PrependInt64Slot(44, gradeChampion, 0)
def AddGradeChampion(builder, gradeChampion):
    return GroundExcelAddGradeChampion(builder, gradeChampion)
def GroundExcelAddEnemySkillRangeRate(builder, enemySkillRangeRate): builder.PrependInt64Slot(45, enemySkillRangeRate, 0)
...
def GroundExcelAddEnemyPassiveSkillLevel(builder, enemyPassiveSkillLevel): builder.PrependUOffsetTRelativeSlot(46, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPassiveSkillLevel), 0)
...
def GroundExcelAddEffectCountLimit(builder, effectCountLimit): builder.PrependInt32Slot(47, effectCountLimit, 0)
def AddEffectCountLimit(builder, effectCountLimit):
    return GroundExcelAddEffectCountLimit(builder, effectCountLimit)
def GroundExcelAddFormationGroupId(builder, formationGroupId): builder.PrependInt64Slot(48, formationGroupId, 0)
def AddFormationGroupId(builder, formationGroupId):
    return GroundExcelAddFormationGroupId(builder, formationGroupId)
def GroundExcelAddAllyPassiveSkillLevel(builder, allyPassiveSkillLevel): builder.PrependUOffsetTRelativeSlot(49, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkillLevel), 0)
...
def GroundExcelAddPlayerSkillRangeRate(builder, playerSkillRangeRate): builder.PrependInt64Slot(50, playerSkillRangeRate, 0)
...
def GroundExcelAddGradeMinion(builder, gradeMinion): builder.PrependInt64Slot(51, gradeMinion, 0)
def AddGradeMinion(builder, gradeMinion):
    return GroundExcelAddGradeMinion(builder, gradeMinion)
def GroundExcelAddPlayerSightRangeMax(builder, playerSightRangeMax): builder.PrependBoolSlot(52, playerSightRangeMax, 0)
...
def GroundExcelAddWarningUi(builder, warningUi): builder.PrependBoolSlot(53, warningUi, 0)
def AddWarningUi(builder, warningUi):
    return GroundExcelAddWarningUi(builder, warningUi)
def GroundExcelAddForcedSkillUse(builder, forcedSkillUse): builder.PrependInt32Slot(54, forcedSkillUse, 0)
def AddForcedSkillUse(builder, forcedSkillUse):
    return GroundExcelAddForcedSkillUse(builder, forcedSkillUse)
def GroundExcelAddPlayerMinimumPositionGapRate(builder, playerMinimumPositionGapRate): builder.PrependInt64Slot(55, playerMinimumPositionGapRate, 0)
...
def GroundExcelAddEnemySightPointAdd(builder, enemySightPointAdd): builder.PrependInt64Slot(56, enemySightPointAdd, 0)
def AddEnemySightPointAdd(builder, enemySightPointAdd):
    return GroundExcelAddEnemySightPointAdd(builder, enemySightPointAdd)
def GroundExcelAddUiSkillMainLogScale(builder, uiSkillMainLogScale): builder.PrependFloat32Slot(57, uiSkillMainLogScale, 0.0)
