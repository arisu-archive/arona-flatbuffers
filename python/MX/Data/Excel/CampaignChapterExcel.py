...
def CampaignChapterExcelAddNormalExtraStageId(builder, normalExtraStageId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(normalExtraStageId), 0)
...
def CampaignChapterExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
...
def CampaignChapterExcelAddHardCampaignStageId(builder, hardCampaignStageId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(hardCampaignStageId), 0)
...
def CampaignChapterExcelAddChapterRewardId(builder, chapterRewardId): builder.PrependInt64Slot(5, chapterRewardId, 0)
def AddChapterRewardId(builder, chapterRewardId):
    return CampaignChapterExcelAddChapterRewardId(builder, chapterRewardId)
def CampaignChapterExcelAddOrder(builder, order): builder.PrependInt64Slot(6, order, 0)
def AddOrder(builder, order):
    return CampaignChapterExcelAddOrder(builder, order)
def CampaignChapterExcelAddVeryHardCampaignStageId(builder, veryHardCampaignStageId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(veryHardCampaignStageId), 0)
...
def CampaignChapterExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignChapterExcelAddName(builder, name)
def CampaignChapterExcelAddChapterVeryHardRewardId(builder, chapterVeryHardRewardId): builder.PrependInt64Slot(9, chapterVeryHardRewardId, 0)
...
def CampaignChapterExcelAddPreChapterId(builder, preChapterId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(preChapterId), 0)
...
def CampaignChapterExcelAddIsTacticSkip(builder, isTacticSkip): builder.PrependBoolSlot(11, isTacticSkip, 0)
def AddIsTacticSkip(builder, isTacticSkip):
    return CampaignChapterExcelAddIsTacticSkip(builder, isTacticSkip)
def CampaignChapterExcelAddNormalCampaignStageId(builder, normalCampaignStageId): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(normalCampaignStageId), 0)
...
def CampaignChapterExcelAddChapterHardRewardId(builder, chapterHardRewardId): builder.PrependInt64Slot(13, chapterHardRewardId, 0)
