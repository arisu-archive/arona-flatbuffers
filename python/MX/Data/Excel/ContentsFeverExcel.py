...
def ContentsFeverExcelAddFeverStartTime(builder, feverStartTime): builder.PrependInt64Slot(0, feverStartTime, 0)
def AddFeverStartTime(builder, feverStartTime):
    return ContentsFeverExcelAddFeverStartTime(builder, feverStartTime)
def ContentsFeverExcelAddConditionContent(builder, conditionContent): builder.PrependInt32Slot(1, conditionContent, 0)
def AddConditionContent(builder, conditionContent):
    return ContentsFeverExcelAddConditionContent(builder, conditionContent)
def ContentsFeverExcelAddFeverDurationTime(builder, feverDurationTime): builder.PrependInt64Slot(2, feverDurationTime, 0)
