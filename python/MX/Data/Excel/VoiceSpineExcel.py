...
def VoiceSpineExcelAddPath(builder, path): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
...
def VoiceSpineExcelAddSoundVolume(builder, soundVolume): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(soundVolume), 0)
...
def VoiceSpineExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(3, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return VoiceSpineExcelAddUniqueId(builder, uniqueId)
def VoiceSpineExcelAddId(builder, id): builder.PrependUint32Slot(4, id, 0)
