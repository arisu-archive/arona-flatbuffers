...
def VoiceSpineExcelAddSoundVolume(builder, soundVolume): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(soundVolume), 0)
