...
def MiniGameDreamInfoExcelAddDreamMakerActionPoint(builder, dreamMakerActionPoint): builder.PrependInt64Slot(1, dreamMakerActionPoint, 0)
...
def MiniGameDreamInfoExcelAddDreamMakerParameterTransfer(builder, dreamMakerParameterTransfer): builder.PrependInt64Slot(3, dreamMakerParameterTransfer, 0)
...
def MiniGameDreamInfoExcelAddDreamMakerMultiplierConditionValue(builder, dreamMakerMultiplierConditionValue): builder.PrependInt64Slot(4, dreamMakerMultiplierConditionValue, 0)
...
def MiniGameDreamInfoExcelAddScheduleCostGoodsId(builder, scheduleCostGoodsId): builder.PrependInt64Slot(5, scheduleCostGoodsId, 0)
...
def MiniGameDreamInfoExcelAddLobbyBgmChangeScenarioId(builder, lobbyBgmChangeScenarioId): builder.PrependInt64Slot(7, lobbyBgmChangeScenarioId, 0)
...
def MiniGameDreamInfoExcelAddDreamMakerMultiplierMax(builder, dreamMakerMultiplierMax): builder.PrependInt64Slot(12, dreamMakerMultiplierMax, 0)
