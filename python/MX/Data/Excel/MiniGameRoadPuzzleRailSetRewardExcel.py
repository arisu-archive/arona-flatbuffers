...
def MiniGameRoadPuzzleRailSetRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(0, uniqueId, 0)
...
def MiniGameRoadPuzzleRailSetRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
...
def MiniGameRoadPuzzleRailSetRewardExcelAddLocalizePrefabId(builder, localizePrefabId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(localizePrefabId), 0)
