...
def OperatorExcelAddDuration(builder, duration): builder.PrependInt32Slot(3, duration, 0)
...
def OperatorExcelAddOperatorCondition(builder, operatorCondition): builder.PrependInt32Slot(5, operatorCondition, 0)
def AddOperatorCondition(builder, operatorCondition):
    return OperatorExcelAddOperatorCondition(builder, operatorCondition)
def OperatorExcelAddOperatorOutputPriority(builder, operatorOutputPriority): builder.PrependInt32Slot(6, operatorOutputPriority, 0)
...
def OperatorExcelAddVoiceId(builder, voiceId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(voiceId), 0)
...
def OperatorExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(9, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return OperatorExcelAddUniqueId(builder, uniqueId)
def OperatorExcelAddOutputSequence(builder, outputSequence): builder.PrependInt32Slot(10, outputSequence, 0)
def AddOutputSequence(builder, outputSequence):
    return OperatorExcelAddOutputSequence(builder, outputSequence)
def OperatorExcelAddGroupId(builder, groupId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(groupId), 0)
