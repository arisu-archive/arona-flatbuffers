...
def OperatorExcelAddPortraitPath(builder, portraitPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(portraitPath), 0)
def AddPortraitPath(builder, portraitPath):
    return OperatorExcelAddPortraitPath(builder, portraitPath)
def OperatorExcelAddOutputDelay(builder, outputDelay): builder.PrependInt32Slot(1, outputDelay, 0)
def AddOutputDelay(builder, outputDelay):
    return OperatorExcelAddOutputDelay(builder, outputDelay)
def OperatorExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return OperatorExcelAddUniqueId(builder, uniqueId)
def OperatorExcelAddTextLocalizeKey(builder, textLocalizeKey): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(textLocalizeKey), 0)
def AddTextLocalizeKey(builder, textLocalizeKey):
    return OperatorExcelAddTextLocalizeKey(builder, textLocalizeKey)
def OperatorExcelAddGroupId(builder, groupId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(groupId), 0)
def AddGroupId(builder, groupId):
    return OperatorExcelAddGroupId(builder, groupId)
def OperatorExcelAddVoiceId(builder, voiceId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(voiceId), 0)
...
def OperatorExcelAddRandomWeight(builder, randomWeight): builder.PrependInt32Slot(6, randomWeight, 0)
def AddRandomWeight(builder, randomWeight):
    return OperatorExcelAddRandomWeight(builder, randomWeight)
def OperatorExcelAddOperatorCondition(builder, operatorCondition): builder.PrependInt32Slot(7, operatorCondition, 0)
...
def OperatorExcelAddOperatorWaitQueue(builder, operatorWaitQueue): builder.PrependBoolSlot(9, operatorWaitQueue, 0)
def AddOperatorWaitQueue(builder, operatorWaitQueue):
    return OperatorExcelAddOperatorWaitQueue(builder, operatorWaitQueue)
def OperatorExcelAddOperatorOutputPriority(builder, operatorOutputPriority): builder.PrependInt32Slot(10, operatorOutputPriority, 0)
...
def OperatorExcelAddDuration(builder, duration): builder.PrependInt32Slot(11, duration, 0)
