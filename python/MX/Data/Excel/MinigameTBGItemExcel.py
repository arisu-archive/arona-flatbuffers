...
def MinigameTBGItemExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeEtcId), 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return MinigameTBGItemExcelAddLocalizeEtcId(builder, localizeEtcId)
def MinigameTBGItemExcelAddEncounterCount(builder, encounterCount): builder.PrependInt32Slot(1, encounterCount, 0)
def AddEncounterCount(builder, encounterCount):
    return MinigameTBGItemExcelAddEncounterCount(builder, encounterCount)
def MinigameTBGItemExcelAddBuffIcon(builder, buffIcon): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(buffIcon), 0)
...
def MinigameTBGItemExcelAddDiceEffectAniClip(builder, diceEffectAniClip): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(diceEffectAniClip), 0)
...
def MinigameTBGItemExcelAddTbgItemEffectType(builder, tbgItemEffectType): builder.PrependInt32Slot(6, tbgItemEffectType, 0)
...
def MinigameTBGItemExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(7, uniqueId, 0)
