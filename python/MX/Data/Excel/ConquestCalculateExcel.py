...
def ConquestCalculateExcelAddCalculateConditionParcelUniqueId(builder, calculateConditionParcelUniqueId): builder.PrependInt64Slot(0, calculateConditionParcelUniqueId, 0)
...
def ConquestCalculateExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
