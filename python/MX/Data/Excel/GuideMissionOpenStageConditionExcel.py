...
def GuideMissionOpenStageConditionExcelAddShortcutScenarioUi(builder, shortcutScenarioUi): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutScenarioUi), 0)
...
def GuideMissionOpenStageConditionExcelAddClearScenarioModeId(builder, clearScenarioModeId): builder.PrependInt64Slot(6, clearScenarioModeId, 0)
...
def GuideMissionOpenStageConditionExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(7, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return GuideMissionOpenStageConditionExcelAddSeasonId(builder, seasonId)
def GuideMissionOpenStageConditionExcelAddClearStageId(builder, clearStageId): builder.PrependInt64Slot(8, clearStageId, 0)
