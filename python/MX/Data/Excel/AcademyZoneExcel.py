...
def AcademyZoneExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(0, rewardGroupId, 0)
...
def AcademyZoneExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
