...
def ShortcutTypeExcelAddIsAscending(builder, isAscending): builder.PrependBoolSlot(0, isAscending, 0)
def AddIsAscending(builder, isAscending):
    return ShortcutTypeExcelAddIsAscending(builder, isAscending)
def ShortcutTypeExcelAddContentType(builder, contentType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(contentType), 0)
