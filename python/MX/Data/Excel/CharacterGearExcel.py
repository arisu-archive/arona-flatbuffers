...
def CharacterGearExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def CharacterGearExcelAddMinStatValue(builder, minStatValue): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(minStatValue), 0)
...
def CharacterGearExcelAddNextTierEquipment(builder, nextTierEquipment): builder.PrependInt64Slot(2, nextTierEquipment, 0)
...
def CharacterGearExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
...
def CharacterGearExcelAddRecipeId(builder, recipeId): builder.PrependInt64Slot(7, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return CharacterGearExcelAddRecipeId(builder, recipeId)
def CharacterGearExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(8, characterId, 0)
...
def CharacterGearExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(10, statLevelUpType, 0)
...
def CharacterGearExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def CharacterGearExcelAddLearnSkillSlot(builder, learnSkillSlot): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(learnSkillSlot), 0)
