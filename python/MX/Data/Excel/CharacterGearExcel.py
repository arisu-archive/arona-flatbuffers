...
def CharacterGearExcelAddMaxStatValue(builder, maxStatValue): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(maxStatValue), 0)
...
def CharacterGearExcelAddMinStatValue(builder, minStatValue): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(minStatValue), 0)
...
def CharacterGearExcelAddRecipeId(builder, recipeId): builder.PrependInt64Slot(3, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return CharacterGearExcelAddRecipeId(builder, recipeId)
def CharacterGearExcelAddLearnSkillSlot(builder, learnSkillSlot): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(learnSkillSlot), 0)
def AddLearnSkillSlot(builder, learnSkillSlot):
    return CharacterGearExcelAddLearnSkillSlot(builder, learnSkillSlot)
def CharacterGearExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(5, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return CharacterGearExcelAddLocalizeEtcId(builder, localizeEtcId)
def CharacterGearExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return CharacterGearExcelAddId(builder, id)
def CharacterGearExcelAddOpenFavorLevel(builder, openFavorLevel): builder.PrependInt64Slot(7, openFavorLevel, 0)
...
def CharacterGearExcelAddTier(builder, tier): builder.PrependInt64Slot(9, tier, 0)
def AddTier(builder, tier):
    return CharacterGearExcelAddTier(builder, tier)
def CharacterGearExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def CharacterGearExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
...
def CharacterGearExcelAddMaxLevel(builder, maxLevel): builder.PrependInt64Slot(14, maxLevel, 0)
