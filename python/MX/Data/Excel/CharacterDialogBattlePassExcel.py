...
def CharacterDialogBattlePassExcelAddDurationKr(builder, durationKr): builder.PrependInt64Slot(12, durationKr, 0)
...
def CharacterDialogBattlePassExcelAddUnlockBattlePassId(builder, unlockBattlePassId): builder.PrependInt64Slot(22, unlockBattlePassId, 0)
