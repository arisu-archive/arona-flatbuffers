...
def CharacterDialogBattlePassExcelAddDurationKr(builder, durationKr):
    builder.PrependInt64Slot(12, durationKr, 0)

def AddDurationKr(builder, durationKr):
    CharacterDialogBattlePassExcelAddDurationKr(builder, durationKr)
...
def CharacterDialogBattlePassExcelAddLocalizeTh(builder, localizeTh):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTh), 0)

def AddLocalizeTh(builder, localizeTh):
    CharacterDialogBattlePassExcelAddLocalizeTh(builder, localizeTh)

def CharacterDialogBattlePassExcelAddLocalizeTw(builder, localizeTw):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTw), 0)

def AddLocalizeTw(builder, localizeTw):
    CharacterDialogBattlePassExcelAddLocalizeTw(builder, localizeTw)

def CharacterDialogBattlePassExcelAddLocalizeEn(builder, localizeEn):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(localizeEn), 0)
...
def CharacterDialogBattlePassExcelAddVoiceId(builder, voiceId):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(voiceId), 0)
...
def CharacterDialogBattlePassExcelAddLocalizeCvGroup(builder, localizeCvGroup):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)

def AddLocalizeCvGroup(builder, localizeCvGroup):
    CharacterDialogBattlePassExcelAddLocalizeCvGroup(builder, localizeCvGroup)

def CharacterDialogBattlePassExcelAddTeenMode(builder, teenMode):
    builder.PrependBoolSlot(24, teenMode, 0)

def AddTeenMode(builder, teenMode):
    CharacterDialogBattlePassExcelAddTeenMode(builder, teenMode)
