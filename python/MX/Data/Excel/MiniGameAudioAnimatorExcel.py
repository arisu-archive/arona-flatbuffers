...
def MiniGameAudioAnimatorExcelAddVoiceNamePrefix(builder, voiceNamePrefix): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(voiceNamePrefix), 0)
...
def MiniGameAudioAnimatorExcelAddVolume(builder, volume): builder.PrependFloat32Slot(1, volume, 0.0)
def AddVolume(builder, volume):
    return MiniGameAudioAnimatorExcelAddVolume(builder, volume)
def MiniGameAudioAnimatorExcelAddIgnoreInterruptDelay(builder, ignoreInterruptDelay): builder.PrependBoolSlot(2, ignoreInterruptDelay, 0)
...
def MiniGameAudioAnimatorExcelAddControllerNameHash(builder, controllerNameHash): builder.PrependUint32Slot(4, controllerNameHash, 0)
...
def MiniGameAudioAnimatorExcelAddStateName(builder, stateName): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(stateName), 0)
def AddStateName(builder, stateName):
    return MiniGameAudioAnimatorExcelAddStateName(builder, stateName)
def MiniGameAudioAnimatorExcelAddIgnoreInterruptPlay(builder, ignoreInterruptPlay): builder.PrependBoolSlot(6, ignoreInterruptPlay, 0)
...
def MiniGameAudioAnimatorExcelAddAudioPriority(builder, audioPriority): builder.PrependInt32Slot(7, audioPriority, 0)
...
def MiniGameAudioAnimatorExcelAddVoiceHash(builder, voiceHash): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(voiceHash), 0)
...
def MiniGameAudioAnimatorExcelAddAudioClipPath(builder, audioClipPath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(audioClipPath), 0)
