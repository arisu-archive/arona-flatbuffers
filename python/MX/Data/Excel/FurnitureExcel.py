...
def FurnitureExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(0, craftQualityTier2, 0)
def AddCraftQualityTier2(builder, craftQualityTier2):
    return FurnitureExcelAddCraftQualityTier2(builder, craftQualityTier2)
def FurnitureExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(1, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return FurnitureExcelAddLocalizeEtcId(builder, localizeEtcId)
def FurnitureExcelAddCafeCharacterStateReq(builder, cafeCharacterStateReq): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(cafeCharacterStateReq), 0)
...
def FurnitureExcelAddReverseRotation(builder, reverseRotation): builder.PrependBoolSlot(3, reverseRotation, 0)
def AddReverseRotation(builder, reverseRotation):
    return FurnitureExcelAddReverseRotation(builder, reverseRotation)
def FurnitureExcelAddEventCollectionId(builder, eventCollectionId): builder.PrependInt64Slot(4, eventCollectionId, 0)
def AddEventCollectionId(builder, eventCollectionId):
    return FurnitureExcelAddEventCollectionId(builder, eventCollectionId)
def FurnitureExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def FurnitureExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return FurnitureExcelAddIcon(builder, icon)
def FurnitureExcelAddFurnitureBubbleOffsetX(builder, furnitureBubbleOffsetX): builder.PrependInt64Slot(7, furnitureBubbleOffsetX, 0)
...
def FurnitureExcelAddVisitBonusOperationType(builder, visitBonusOperationType): builder.PrependInt64Slot(8, visitBonusOperationType, 0)
...
def FurnitureExcelAddCheckFloorDecoration(builder, checkFloorDecoration): builder.PrependBoolSlot(9, checkFloorDecoration, 0)
...
def FurnitureExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(10, craftQualityTier1, 0)
def AddCraftQualityTier1(builder, craftQualityTier1):
    return FurnitureExcelAddCraftQualityTier1(builder, craftQualityTier1)
def FurnitureExcelAddCafeCharacterStateOnly(builder, cafeCharacterStateOnly): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(cafeCharacterStateOnly), 0)
...
def FurnitureExcelAddHideCraftShortcut(builder, hideCraftShortcut): builder.PrependBoolSlot(12, hideCraftShortcut, 0)
def AddHideCraftShortcut(builder, hideCraftShortcut):
    return FurnitureExcelAddHideCraftShortcut(builder, hideCraftShortcut)
def FurnitureExcelAddRarity(builder, rarity): builder.PrependInt32Slot(13, rarity, 0)
def AddRarity(builder, rarity):
    return FurnitureExcelAddRarity(builder, rarity)
def FurnitureExcelAddTier(builder, tier): builder.PrependInt64Slot(14, tier, 0)
def AddTier(builder, tier):
    return FurnitureExcelAddTier(builder, tier)
def FurnitureExcelAddSubCategory(builder, subCategory): builder.PrependInt32Slot(15, subCategory, 0)
...
def FurnitureExcelAddEnable(builder, enable): builder.PrependBoolSlot(17, enable, 0)
def AddEnable(builder, enable):
    return FurnitureExcelAddEnable(builder, enable)
def FurnitureExcelAddStackableMax(builder, stackableMax): builder.PrependInt64Slot(18, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return FurnitureExcelAddStackableMax(builder, stackableMax)
def FurnitureExcelAddVideoId(builder, videoId): builder.PrependInt64Slot(19, videoId, 0)
def AddVideoId(builder, videoId):
    return FurnitureExcelAddVideoId(builder, videoId)
def FurnitureExcelAddSetGroudpId(builder, setGroudpId): builder.PrependInt64Slot(20, setGroudpId, 0)
def AddSetGroudpId(builder, setGroudpId):
    return FurnitureExcelAddSetGroudpId(builder, setGroudpId)
def FurnitureExcelAddShiftingCraftQuality(builder, shiftingCraftQuality): builder.PrependInt64Slot(21, shiftingCraftQuality, 0)
...
def FurnitureExcelAddCafeCharacterStateMake(builder, cafeCharacterStateMake): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(cafeCharacterStateMake), 0)
...
def FurnitureExcelAddSubPrefab(builder, subPrefab): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(subPrefab), 0)
def AddSubPrefab(builder, subPrefab):
    return FurnitureExcelAddSubPrefab(builder, subPrefab)
def FurnitureExcelAddVisitOperationType(builder, visitOperationType): builder.PrependInt64Slot(26, visitOperationType, 0)
...
def FurnitureExcelAddCafeCharacterStateAdd(builder, cafeCharacterStateAdd): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(cafeCharacterStateAdd), 0)
...
def FurnitureExcelAddSizeWidth(builder, sizeWidth): builder.PrependInt32Slot(28, sizeWidth, 0)
def AddSizeWidth(builder, sizeWidth):
    return FurnitureExcelAddSizeWidth(builder, sizeWidth)
def FurnitureExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(29, craftQualityTier0, 0)
def AddCraftQualityTier0(builder, craftQualityTier0):
    return FurnitureExcelAddCraftQualityTier0(builder, craftQualityTier0)
def FurnitureExcelAddFurnitureBubbleOffsetY(builder, furnitureBubbleOffsetY): builder.PrependInt64Slot(30, furnitureBubbleOffsetY, 0)
...
def FurnitureExcelAddRecipeCraftId(builder, recipeCraftId): builder.PrependInt64Slot(31, recipeCraftId, 0)
def AddRecipeCraftId(builder, recipeCraftId):
    return FurnitureExcelAddRecipeCraftId(builder, recipeCraftId)
def FurnitureExcelAddId(builder, id): builder.PrependInt64Slot(32, id, 0)
def AddId(builder, id):
    return FurnitureExcelAddId(builder, id)
def FurnitureExcelAddStarGradeInit(builder, starGradeInit): builder.PrependInt32Slot(33, starGradeInit, 0)
def AddStarGradeInit(builder, starGradeInit):
    return FurnitureExcelAddStarGradeInit(builder, starGradeInit)
def FurnitureExcelAddFurnitureFunctionType(builder, furnitureFunctionType): builder.PrependInt32Slot(34, furnitureFunctionType, 0)
...
def FurnitureExcelAddSubExpandPrefab(builder, subExpandPrefab): builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(subExpandPrefab), 0)
def AddSubExpandPrefab(builder, subExpandPrefab):
    return FurnitureExcelAddSubExpandPrefab(builder, subExpandPrefab)
def FurnitureExcelAddCategory(builder, category): builder.PrependInt32Slot(36, category, 0)
def AddCategory(builder, category):
    return FurnitureExcelAddCategory(builder, category)
def FurnitureExcelAddPrefabExpand(builder, prefabExpand): builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(prefabExpand), 0)
def AddPrefabExpand(builder, prefabExpand):
    return FurnitureExcelAddPrefabExpand(builder, prefabExpand)
def FurnitureExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(38, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return FurnitureExcelAddProductionStep(builder, productionStep)
def FurnitureExcelAddOtherSize(builder, otherSize): builder.PrependInt32Slot(39, otherSize, 0)
def AddOtherSize(builder, otherSize):
    return FurnitureExcelAddOtherSize(builder, otherSize)
def FurnitureExcelAddPrefab(builder, prefab): builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(prefab), 0)
def AddPrefab(builder, prefab):
    return FurnitureExcelAddPrefab(builder, prefab)
def FurnitureExcelAddSizeHeight(builder, sizeHeight): builder.PrependInt32Slot(41, sizeHeight, 0)
def AddSizeHeight(builder, sizeHeight):
    return FurnitureExcelAddSizeHeight(builder, sizeHeight)
def FurnitureExcelAddExpandWidth(builder, expandWidth): builder.PrependInt32Slot(42, expandWidth, 0)
