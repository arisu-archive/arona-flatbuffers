...
def InformationExcelAddIsPcBuild(builder, isPcBuild): builder.PrependBoolSlot(3, isPcBuild, 0)
...
def InformationExcelAddTutorialParentName(builder, tutorialParentName): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(tutorialParentName), 0)
