...
def ScenarioCharacterSituationSetExcelAddBehavior(builder, behavior): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(behavior), 0)
def AddBehavior(builder, behavior):
    return ScenarioCharacterSituationSetExcelAddBehavior(builder, behavior)
def ScenarioCharacterSituationSetExcelAddEmotion(builder, emotion): builder.PrependUint32Slot(1, emotion, 0)
def AddEmotion(builder, emotion):
    return ScenarioCharacterSituationSetExcelAddEmotion(builder, emotion)
def ScenarioCharacterSituationSetExcelAddName(builder, name): builder.PrependUint32Slot(2, name, 0)
...
def ScenarioCharacterSituationSetExcelAddEffect(builder, effect): builder.PrependUint32Slot(4, effect, 0)
