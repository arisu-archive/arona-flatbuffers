...
def AttendanceExcelAddMailType(builder, mailType): builder.PrependInt32Slot(1, mailType, 0)
def AddMailType(builder, mailType):
    return AttendanceExcelAddMailType(builder, mailType)
def AttendanceExcelAddInfomationLocalizeCode(builder, infomationLocalizeCode): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(infomationLocalizeCode), 0)
...
def AttendanceExcelAddTitleImagePath(builder, titleImagePath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(titleImagePath), 0)
def AddTitleImagePath(builder, titleImagePath):
    return AttendanceExcelAddTitleImagePath(builder, titleImagePath)
def AttendanceExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
...
def AttendanceExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(6, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return AttendanceExcelAddDisplayOrder(builder, displayOrder)
def AttendanceExcelAddExpiryDate(builder, expiryDate): builder.PrependInt64Slot(7, expiryDate, 0)
def AddExpiryDate(builder, expiryDate):
    return AttendanceExcelAddExpiryDate(builder, expiryDate)
def AttendanceExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(8, accountType, 0)
...
def AttendanceExcelAddType(builder, type): builder.PrependInt32Slot(10, type, 0)
def AddType(builder, type):
    return AttendanceExcelAddType(builder, type)
def AttendanceExcelAddStartableEndDate(builder, startableEndDate): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(startableEndDate), 0)
def AddStartableEndDate(builder, startableEndDate):
    return AttendanceExcelAddStartableEndDate(builder, startableEndDate)
def AttendanceExcelAddDecorationGarlandImagePath(builder, decorationGarlandImagePath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(decorationGarlandImagePath), 0)
...
def AttendanceExcelAddCountdownPrefab(builder, countdownPrefab): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(countdownPrefab), 0)
def AddCountdownPrefab(builder, countdownPrefab):
    return AttendanceExcelAddCountdownPrefab(builder, countdownPrefab)
def AttendanceExcelAddTitle(builder, title): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(title), 0)
def AddTitle(builder, title):
    return AttendanceExcelAddTitle(builder, title)
def AttendanceExcelAddDialogCategory(builder, dialogCategory): builder.PrependInt32Slot(15, dialogCategory, 0)
def AddDialogCategory(builder, dialogCategory):
    return AttendanceExcelAddDialogCategory(builder, dialogCategory)
def AttendanceExcelAddDecorationImagePath(builder, decorationImagePath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(decorationImagePath), 0)
...
def AttendanceExcelAddCountReset(builder, countReset): builder.PrependInt32Slot(17, countReset, 0)
def AddCountReset(builder, countReset):
    return AttendanceExcelAddCountReset(builder, countReset)
def AttendanceExcelAddBookSize(builder, bookSize): builder.PrependInt64Slot(18, bookSize, 0)
def AddBookSize(builder, bookSize):
    return AttendanceExcelAddBookSize(builder, bookSize)
def AttendanceExcelAddAccountLevelLimit(builder, accountLevelLimit): builder.PrependInt64Slot(19, accountLevelLimit, 0)
