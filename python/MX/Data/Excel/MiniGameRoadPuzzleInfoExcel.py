...
def MiniGameRoadPuzzleInfoExcelAddRailSetRewardId(builder, railSetRewardId): builder.PrependInt64Slot(0, railSetRewardId, 0)
...
def MiniGameRoadPuzzleInfoExcelAddInstantClearRound(builder, instantClearRound): builder.PrependInt32Slot(2, instantClearRound, 0)
...
def MiniGameRoadPuzzleInfoExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(5, costGoodsId, 0)
