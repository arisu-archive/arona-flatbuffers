...
def CharacterVoiceExcelAddOnlyOne(builder, onlyOne): builder.PrependBoolSlot(0, onlyOne, 0)
def AddOnlyOne(builder, onlyOne):
    return CharacterVoiceExcelAddOnlyOne(builder, onlyOne)
def CharacterVoiceExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(1, collectionVisible, 0)
...
def CharacterVoiceExcelAddPriority(builder, priority): builder.PrependInt32Slot(3, priority, 0)
def AddPriority(builder, priority):
    return CharacterVoiceExcelAddPriority(builder, priority)
def CharacterVoiceExcelAddCharacterVoiceUniqueId(builder, characterVoiceUniqueId): builder.PrependInt64Slot(4, characterVoiceUniqueId, 0)
...
def CharacterVoiceExcelAddCvCollectionType(builder, cvCollectionType): builder.PrependInt32Slot(5, cvCollectionType, 0)
def AddCvCollectionType(builder, cvCollectionType):
    return CharacterVoiceExcelAddCvCollectionType(builder, cvCollectionType)
def CharacterVoiceExcelAddPath(builder, path): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
...
def CharacterVoiceExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(7, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return CharacterVoiceExcelAddDisplayOrder(builder, displayOrder)
def CharacterVoiceExcelAddDelay(builder, delay): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(delay), 0)
...
def CharacterVoiceExcelAddVoiceHash(builder, voiceHash): builder.PrependUint32Slot(9, voiceHash, 0)
def AddVoiceHash(builder, voiceHash):
    return CharacterVoiceExcelAddVoiceHash(builder, voiceHash)
def CharacterVoiceExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
...
def CharacterVoiceExcelAddNation(builder, nation): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(nation), 0)
