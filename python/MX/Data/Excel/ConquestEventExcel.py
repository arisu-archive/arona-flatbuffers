...
def ConquestEventExcelAddAnimationUnitAmountMin(builder, animationUnitAmountMin): builder.PrependInt32Slot(0, animationUnitAmountMin, 0)
...
def ConquestEventExcelAddUseConquestObject(builder, useConquestObject): builder.PrependBoolSlot(1, useConquestObject, 0)
...
def ConquestEventExcelAddEvnetMapGoalLocalize(builder, evnetMapGoalLocalize): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(evnetMapGoalLocalize), 0)
...
def ConquestEventExcelAddLocalizeUnexpected(builder, localizeUnexpected): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(localizeUnexpected), 0)
...
def ConquestEventExcelAddManageUnitChange(builder, manageUnitChange): builder.PrependInt32Slot(4, manageUnitChange, 0)
def AddManageUnitChange(builder, manageUnitChange):
    return ConquestEventExcelAddManageUnitChange(builder, manageUnitChange)
def ConquestEventExcelAddLocalizeUpgrade(builder, localizeUpgrade): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(localizeUpgrade), 0)
def AddLocalizeUpgrade(builder, localizeUpgrade):
    return ConquestEventExcelAddLocalizeUpgrade(builder, localizeUpgrade)
def ConquestEventExcelAddEvnetMapNameLocalize(builder, evnetMapNameLocalize): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(evnetMapNameLocalize), 0)
...
def ConquestEventExcelAddMapEnterScenarioGroupId(builder, mapEnterScenarioGroupId): builder.PrependInt64Slot(7, mapEnterScenarioGroupId, 0)
...
def ConquestEventExcelAddLocalizeMapInfo(builder, localizeMapInfo): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(localizeMapInfo), 0)
def AddLocalizeMapInfo(builder, localizeMapInfo):
    return ConquestEventExcelAddLocalizeMapInfo(builder, localizeMapInfo)
def ConquestEventExcelAddPlayTimeLimitInSeconds(builder, playTimeLimitInSeconds): builder.PrependInt32Slot(9, playTimeLimitInSeconds, 0)
...
def ConquestEventExcelAddConquestEventType(builder, conquestEventType): builder.PrependInt32Slot(10, conquestEventType, 0)
...
def ConquestEventExcelAddLocalizeStep(builder, localizeStep): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(localizeStep), 0)
def AddLocalizeStep(builder, localizeStep):
    return ConquestEventExcelAddLocalizeStep(builder, localizeStep)
def ConquestEventExcelAddUseErosion(builder, useErosion): builder.PrependBoolSlot(12, useErosion, 0)
def AddUseErosion(builder, useErosion):
    return ConquestEventExcelAddUseErosion(builder, useErosion)
def ConquestEventExcelAddMainStoryEventContentId(builder, mainStoryEventContentId): builder.PrependInt64Slot(13, mainStoryEventContentId, 0)
...
def ConquestEventExcelAddAnimationUnitDelay(builder, animationUnitDelay): builder.PrependFloat32Slot(14, animationUnitDelay, 0.0)
...
def ConquestEventExcelAddIndividualErosionDailyCount(builder, individualErosionDailyCount): builder.PrependInt64Slot(16, individualErosionDailyCount, 0)
...
def ConquestEventExcelAddLocalizeManage(builder, localizeManage): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(localizeManage), 0)
def AddLocalizeManage(builder, localizeManage):
    return ConquestEventExcelAddLocalizeManage(builder, localizeManage)
def ConquestEventExcelAddUseUnexpectedEvent(builder, useUnexpectedEvent): builder.PrependBoolSlot(18, useUnexpectedEvent, 0)
...
def ConquestEventExcelAddAssistCount(builder, assistCount): builder.PrependInt32Slot(19, assistCount, 0)
def AddAssistCount(builder, assistCount):
    return ConquestEventExcelAddAssistCount(builder, assistCount)
def ConquestEventExcelAddLocalizeErosions(builder, localizeErosions): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(localizeErosions), 0)
def AddLocalizeErosions(builder, localizeErosions):
    return ConquestEventExcelAddLocalizeErosions(builder, localizeErosions)
def ConquestEventExcelAddUseCalculate(builder, useCalculate): builder.PrependBoolSlot(21, useCalculate, 0)
def AddUseCalculate(builder, useCalculate):
    return ConquestEventExcelAddUseCalculate(builder, useCalculate)
def ConquestEventExcelAddLocalizeTreasureBox(builder, localizeTreasureBox): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTreasureBox), 0)
...
def ConquestEventExcelAddLocalizeTile(builder, localizeTile): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTile), 0)
def AddLocalizeTile(builder, localizeTile):
    return ConquestEventExcelAddLocalizeTile(builder, localizeTile)
def ConquestEventExcelAddEvnetScenarioBg(builder, evnetScenarioBg): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(evnetScenarioBg), 0)
