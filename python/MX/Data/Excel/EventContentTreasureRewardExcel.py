...
def EventContentTreasureRewardExcelAddLocalizeCodeId(builder, localizeCodeId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCodeId), 0)
...
def EventContentTreasureRewardExcelAddCellUnderImageHeight(builder, cellUnderImageHeight): builder.PrependInt32Slot(1, cellUnderImageHeight, 0)
...
def EventContentTreasureRewardExcelAddHiddenImage(builder, hiddenImage): builder.PrependBoolSlot(5, hiddenImage, 0)
def AddHiddenImage(builder, hiddenImage):
    return EventContentTreasureRewardExcelAddHiddenImage(builder, hiddenImage)
def EventContentTreasureRewardExcelAddTreasureSizeIconPath(builder, treasureSizeIconPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(treasureSizeIconPath), 0)
...
def EventContentTreasureRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentTreasureRewardExcelAddTreasureSmallImagePath(builder, treasureSmallImagePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(treasureSmallImagePath), 0)
