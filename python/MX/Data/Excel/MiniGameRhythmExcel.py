...
def MiniGameRhythmExcelAddOpenStageScoreAmount(builder, openStageScoreAmount): builder.PrependInt64Slot(0, openStageScoreAmount, 0)
...
def MiniGameRhythmExcelAddMaxHpScore(builder, maxHpScore): builder.PrependInt64Slot(1, maxHpScore, 0)
...
def MiniGameRhythmExcelAddNoteScoreRate(builder, noteScoreRate): builder.PrependInt64Slot(3, noteScoreRate, 0)
...
def MiniGameRhythmExcelAddFeverScoreRate(builder, feverScoreRate): builder.PrependInt64Slot(5, feverScoreRate, 0)
def AddFeverScoreRate(builder, feverScoreRate):
    return MiniGameRhythmExcelAddFeverScoreRate(builder, feverScoreRate)
def MiniGameRhythmExcelAddComboScoreRate(builder, comboScoreRate): builder.PrependInt64Slot(6, comboScoreRate, 0)
def AddComboScoreRate(builder, comboScoreRate):
    return MiniGameRhythmExcelAddComboScoreRate(builder, comboScoreRate)
def MiniGameRhythmExcelAddRhythmBgmId(builder, rhythmBgmId): builder.PrependInt64Slot(7, rhythmBgmId, 0)
def AddRhythmBgmId(builder, rhythmBgmId):
    return MiniGameRhythmExcelAddRhythmBgmId(builder, rhythmBgmId)
def MiniGameRhythmExcelAddMaxHp(builder, maxHp): builder.PrependInt64Slot(8, maxHp, 0)
...
def MiniGameRhythmExcelAddAttackScoreRate(builder, attackScoreRate): builder.PrependInt64Slot(10, attackScoreRate, 0)
def AddAttackScoreRate(builder, attackScoreRate):
    return MiniGameRhythmExcelAddAttackScoreRate(builder, attackScoreRate)
def MiniGameRhythmExcelAddRhythmFileName(builder, rhythmFileName): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(rhythmFileName), 0)
def AddRhythmFileName(builder, rhythmFileName):
    return MiniGameRhythmExcelAddRhythmFileName(builder, rhythmFileName)
def MiniGameRhythmExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(12, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MiniGameRhythmExcelAddUniqueId(builder, uniqueId)
def MiniGameRhythmExcelAddIsSpecial(builder, isSpecial): builder.PrependBoolSlot(13, isSpecial, 0)
def AddIsSpecial(builder, isSpecial):
    return MiniGameRhythmExcelAddIsSpecial(builder, isSpecial)
def MiniGameRhythmExcelAddMissDamage(builder, missDamage): builder.PrependInt64Slot(14, missDamage, 0)
def AddMissDamage(builder, missDamage):
    return MiniGameRhythmExcelAddMissDamage(builder, missDamage)
def MiniGameRhythmExcelAddComboImagePath(builder, comboImagePath): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(comboImagePath), 0)
def AddComboImagePath(builder, comboImagePath):
    return MiniGameRhythmExcelAddComboImagePath(builder, comboImagePath)
def MiniGameRhythmExcelAddArtLevelSceneName(builder, artLevelSceneName): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(artLevelSceneName), 0)
...
def MiniGameRhythmExcelAddStageDifficulty(builder, stageDifficulty): builder.PrependInt32Slot(17, stageDifficulty, 0)
def AddStageDifficulty(builder, stageDifficulty):
    return MiniGameRhythmExcelAddStageDifficulty(builder, stageDifficulty)
def MiniGameRhythmExcelAddFeverCriticalRate(builder, feverCriticalRate): builder.PrependFloat32Slot(18, feverCriticalRate, 0.0)
...
def MiniGameRhythmExcelAddCriticalHpRestoreValue(builder, criticalHpRestoreValue): builder.PrependInt64Slot(19, criticalHpRestoreValue, 0)
