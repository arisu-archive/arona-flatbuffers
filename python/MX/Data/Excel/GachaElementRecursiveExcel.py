...
def GachaElementRecursiveExcelAddParcelAmountMax(builder, parcelAmountMax): builder.PrependInt32Slot(0, parcelAmountMax, 0)
...
def GachaElementRecursiveExcelAddState(builder, state): builder.PrependInt32Slot(3, state, 0)
...
def GachaElementRecursiveExcelAddProb(builder, prob): builder.PrependInt32Slot(5, prob, 0)
