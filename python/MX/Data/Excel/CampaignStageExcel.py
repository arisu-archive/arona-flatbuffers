...
def CampaignStageExcelAddFirstClearFunnelMessage(builder, firstClearFunnelMessage): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearFunnelMessage), 0)
...
def CampaignStageExcelAddFirstClearEventMessage(builder, firstClearEventMessage): builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearEventMessage), 0)
...
def CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(33, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId)
def CampaignStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(34, echelonExtensionType, 0)
