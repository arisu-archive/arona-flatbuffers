...
def CampaignStageExcelStart(builder): builder.StartObject(35)
def Start(builder):
    return CampaignStageExcelStart(builder)
def CampaignStageExcelAddMaxTurn(builder, maxTurn): builder.PrependInt32Slot(0, maxTurn, 0)
...
def CampaignStageExcelAddStarConditionTacticRankSCount(builder, starConditionTacticRankSCount): builder.PrependInt64Slot(2, starConditionTacticRankSCount, 0)
...
def CampaignStageExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return CampaignStageExcelAddStrategyMap(builder, strategyMap)
def CampaignStageExcelAddBgmIdC9738509(builder, bgmIdC9738509): builder.PrependInt64Slot(4, bgmIdC9738509, 0)
def AddBgmIdC9738509(builder, bgmIdC9738509):
    return CampaignStageExcelAddBgmIdC9738509(builder, bgmIdC9738509)
def CampaignStageExcelAddStarConditionTurnCount(builder, starConditionTurnCount): builder.PrependInt64Slot(5, starConditionTurnCount, 0)
...
def CampaignStageExcelAddCampaignStageRewardId(builder, campaignStageRewardId): builder.PrependInt64Slot(6, campaignStageRewardId, 0)
...
def CampaignStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(7, stageEnterCostType, 0)
...
def CampaignStageExcelAddFirstClearFunnelMessage(builder, firstClearFunnelMessage): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearFunnelMessage), 0)
def AddFirstClearFunnelMessage(builder, firstClearFunnelMessage):
    return CampaignStageExcelAddFirstClearFunnelMessage(builder, firstClearFunnelMessage)
def CampaignStageExcelAddMinEquipmentTierForGuide(builder, minEquipmentTierForGuide): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(minEquipmentTierForGuide), 0)
...
def CampaignStageExcelAddStrategySkipGroundId(builder, strategySkipGroundId): builder.PrependInt32Slot(10, strategySkipGroundId, 0)
...
def CampaignStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(11, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return CampaignStageExcelAddBattleDuration(builder, battleDuration)
def CampaignStageExcelAddFirstClearEventMessage(builder, firstClearEventMessage): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearEventMessage), 0)
def AddFirstClearEventMessage(builder, firstClearEventMessage):
    return CampaignStageExcelAddFirstClearEventMessage(builder, firstClearEventMessage)
def CampaignStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(13, echelonExtensionType, 0)
...
def CampaignStageExcelAddStrategyMapBg(builder, strategyMapBg): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMapBg), 0)
def AddStrategyMapBg(builder, strategyMapBg):
    return CampaignStageExcelAddStrategyMapBg(builder, strategyMapBg)
def CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(15, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId)
def CampaignStageExcelAddFirstClearReportEventName(builder, firstClearReportEventName): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearReportEventName), 0)
...
def CampaignStageExcelAddId(builder, id): builder.PrependInt64Slot(17, id, 0)
def AddId(builder, id):
    return CampaignStageExcelAddId(builder, id)
def CampaignStageExcelAddStageNumber(builder, stageNumber): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(stageNumber), 0)
def AddStageNumber(builder, stageNumber):
    return CampaignStageExcelAddStageNumber(builder, stageNumber)
def CampaignStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(19, stageEnterCostId, 0)
def AddStageEnterCostId(builder, stageEnterCostId):
    return CampaignStageExcelAddStageEnterCostId(builder, stageEnterCostId)
def CampaignStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(20, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return CampaignStageExcelAddStageTopography(builder, stageTopography)
def CampaignStageExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(21, stageEnterEchelonCount, 0)
...
def CampaignStageExcelAddCleardScenarioId(builder, cleardScenarioId): builder.PrependInt64Slot(23, cleardScenarioId, 0)
def AddCleardScenarioId(builder, cleardScenarioId):
    return CampaignStageExcelAddCleardScenarioId(builder, cleardScenarioId)
def CampaignStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignStageExcelAddName(builder, name)
def CampaignStageExcelAddContentType(builder, contentType): builder.PrependInt32Slot(25, contentType, 0)
def AddContentType(builder, contentType):
    return CampaignStageExcelAddContentType(builder, contentType)
def CampaignStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(26, stageEnterCostAmount, 0)
...
def CampaignStageExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
...
def CampaignStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(28, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return CampaignStageExcelAddRecommandLevel(builder, recommandLevel)
def CampaignStageExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def CampaignStageExcelAddRecommandLevelGapForGuide(builder, recommandLevelGapForGuide): builder.PrependInt32Slot(30, recommandLevelGapForGuide, 0)
...
def CampaignStageExcelAddStrategyEnvironment(builder, strategyEnvironment): builder.PrependInt32Slot(31, strategyEnvironment, 0)
...
def CampaignStageExcelAddDeprecated(builder, deprecated): builder.PrependBoolSlot(32, deprecated, 0)
def AddDeprecated(builder, deprecated):
    return CampaignStageExcelAddDeprecated(builder, deprecated)
def CampaignStageExcelAddTacticRewardExp(builder, tacticRewardExp): builder.PrependInt64Slot(33, tacticRewardExp, 0)
def AddTacticRewardExp(builder, tacticRewardExp):
    return CampaignStageExcelAddTacticRewardExp(builder, tacticRewardExp)
def CampaignStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(34, groundId, 0)
