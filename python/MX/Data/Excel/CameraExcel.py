...
def CameraExcelAddRotationX(builder, rotationX): builder.PrependFloat32Slot(0, rotationX, 0.0)
...
def CameraExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
...
def CameraExcelAddBottomMargin(builder, bottomMargin): builder.PrependFloat32Slot(4, bottomMargin, 0.0)
...
def CameraExcelAddIgnoreEnemies(builder, ignoreEnemies): builder.PrependBoolSlot(7, ignoreEnemies, 0)
def AddIgnoreEnemies(builder, ignoreEnemies):
    return CameraExcelAddIgnoreEnemies(builder, ignoreEnemies)
def CameraExcelAddLeftMargin(builder, leftMargin): builder.PrependFloat32Slot(8, leftMargin, 0.0)
def AddLeftMargin(builder, leftMargin):
    return CameraExcelAddLeftMargin(builder, leftMargin)
def CameraExcelAddUseRailPointCompensation(builder, useRailPointCompensation): builder.PrependBoolSlot(9, useRailPointCompensation, 0)
...
def CameraExcelAddMoveInstantlyRotationSave(builder, moveInstantlyRotationSave): builder.PrependBoolSlot(10, moveInstantlyRotationSave, 0)
