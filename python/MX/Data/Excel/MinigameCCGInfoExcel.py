...
def MinigameCCGInfoExcelAddCostParcelType(builder, costParcelType): builder.PrependInt32Slot(0, costParcelType, 0)
def AddCostParcelType(builder, costParcelType):
    return MinigameCCGInfoExcelAddCostParcelType(builder, costParcelType)
def MinigameCCGInfoExcelAddPerkCostParcelId(builder, perkCostParcelId): builder.PrependInt64Slot(1, perkCostParcelId, 0)
def AddPerkCostParcelId(builder, perkCostParcelId):
    return MinigameCCGInfoExcelAddPerkCostParcelId(builder, perkCostParcelId)
def MinigameCCGInfoExcelAddCcgId(builder, ccgId): builder.PrependInt64Slot(2, ccgId, 0)
...
def MinigameCCGInfoExcelAddPerkCostParcelType(builder, perkCostParcelType): builder.PrependInt32Slot(4, perkCostParcelType, 0)
...
def MinigameCCGInfoExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(6, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameCCGInfoExcelAddEventContentId(builder, eventContentId)
def MinigameCCGInfoExcelAddCostParcelId(builder, costParcelId): builder.PrependInt64Slot(7, costParcelId, 0)
