...
def ConquestUnitExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def ConquestUnitExcelAddShieldEffectScale(builder, shieldEffectScale): builder.PrependFloat32Slot(1, shieldEffectScale, 0.0)
def AddShieldEffectScale(builder, shieldEffectScale):
    return ConquestUnitExcelAddShieldEffectScale(builder, shieldEffectScale)
def ConquestUnitExcelAddPointAnimation(builder, pointAnimation): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(pointAnimation), 0)
def AddPointAnimation(builder, pointAnimation):
    return ConquestUnitExcelAddPointAnimation(builder, pointAnimation)
def ConquestUnitExcelAddUnitGroup(builder, unitGroup): builder.PrependInt64Slot(3, unitGroup, 0)
def AddUnitGroup(builder, unitGroup):
    return ConquestUnitExcelAddUnitGroup(builder, unitGroup)
def ConquestUnitExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(4, stageEnterCostType, 0)
...
def ConquestUnitExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
def AddId(builder, id):
    return ConquestUnitExcelAddId(builder, id)
def ConquestUnitExcelAddEnemyType(builder, enemyType): builder.PrependInt32Slot(6, enemyType, 0)
def AddEnemyType(builder, enemyType):
    return ConquestUnitExcelAddEnemyType(builder, enemyType)
def ConquestUnitExcelAddConquestRewardId(builder, conquestRewardId): builder.PrependInt64Slot(7, conquestRewardId, 0)
def AddConquestRewardId(builder, conquestRewardId):
    return ConquestUnitExcelAddConquestRewardId(builder, conquestRewardId)
def ConquestUnitExcelAddManageEchelonStageEnterCostType(builder, manageEchelonStageEnterCostType): builder.PrependInt32Slot(8, manageEchelonStageEnterCostType, 0)
...
def ConquestUnitExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(9, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return ConquestUnitExcelAddFixedEchelonId(builder, fixedEchelonId)
def ConquestUnitExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(10, groundId, 0)
...
def ConquestUnitExcelAddScale(builder, scale): builder.PrependFloat32Slot(12, scale, 0.0)
def AddScale(builder, scale):
    return ConquestUnitExcelAddScale(builder, scale)
def ConquestUnitExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
...
def ConquestUnitExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(14, echelonExtensionType, 0)
...
def ConquestUnitExcelAddManageEchelonStageEnterCostId(builder, manageEchelonStageEnterCostId): builder.PrependInt64Slot(15, manageEchelonStageEnterCostId, 0)
...
def ConquestUnitExcelAddKey(builder, key): builder.PrependUint32Slot(17, key, 0)
...
def ConquestUnitExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(19, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return ConquestUnitExcelAddStageTopography(builder, stageTopography)
def ConquestUnitExcelAddUnitFxPrefabName(builder, unitFxPrefabName): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(unitFxPrefabName), 0)
...
def ConquestUnitExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(22, stageEnterCostAmount, 0)
...
def ConquestUnitExcelAddStrategyPrefabName(builder, strategyPrefabName): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(strategyPrefabName), 0)
...
def ConquestUnitExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(24, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return ConquestUnitExcelAddBattleDuration(builder, battleDuration)
def ConquestUnitExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependInt64Slot(25, enterScenarioGroupId, 0)
...
def ConquestUnitExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependInt64Slot(26, clearScenarioGroupId, 0)
...
def ConquestUnitExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(27, stageEnterCostId, 0)
...
def ConquestUnitExcelAddGroupBuffId(builder, groupBuffId): builder.PrependInt64Slot(29, groupBuffId, 0)
def AddGroupBuffId(builder, groupBuffId):
    return ConquestUnitExcelAddGroupBuffId(builder, groupBuffId)
def ConquestUnitExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return ConquestUnitExcelAddName(builder, name)
def ConquestUnitExcelAddPrevUnitGroup(builder, prevUnitGroup): builder.PrependInt64Slot(31, prevUnitGroup, 0)
