...
def LocalizeCharProfileChangeExcelAddScenarioModeId(builder, scenarioModeId): builder.PrependInt64Slot(0, scenarioModeId, 0)
...
def LocalizeCharProfileChangeExcelAddChangeCharacterId(builder, changeCharacterId): builder.PrependInt64Slot(1, changeCharacterId, 0)
