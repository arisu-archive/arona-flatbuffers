...
def FixedStrategyExcelAddStageEnterEchelon01FixedEchelonId(builder, stageEnterEchelon01FixedEchelonId): builder.PrependInt64Slot(0, stageEnterEchelon01FixedEchelonId, 0)
...
def FixedStrategyExcelAddStageEnterEchelon02FixedEchelonId(builder, stageEnterEchelon02FixedEchelonId): builder.PrependInt64Slot(1, stageEnterEchelon02FixedEchelonId, 0)
...
def FixedStrategyExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return FixedStrategyExcelAddId(builder, id)
def FixedStrategyExcelAddStageEnterEchelon03Starttile(builder, stageEnterEchelon03Starttile): builder.PrependInt64Slot(3, stageEnterEchelon03Starttile, 0)
...
def FixedStrategyExcelAddStageEnterEchelon04FixedEchelonId(builder, stageEnterEchelon04FixedEchelonId): builder.PrependInt64Slot(5, stageEnterEchelon04FixedEchelonId, 0)
...
def FixedStrategyExcelAddStageEnterEchelon03FixedEchelonId(builder, stageEnterEchelon03FixedEchelonId): builder.PrependInt64Slot(7, stageEnterEchelon03FixedEchelonId, 0)
