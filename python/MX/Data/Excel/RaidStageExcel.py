...
def RaidStageExcelAddBattleReadyTimelinePhaseStart(builder, battleReadyTimelinePhaseStart): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseStart), 0)
...
def RaidStageExcelAddMaxPlayerCount(builder, maxPlayerCount): builder.PrependInt64Slot(1, maxPlayerCount, 0)
def AddMaxPlayerCount(builder, maxPlayerCount):
    return RaidStageExcelAddMaxPlayerCount(builder, maxPlayerCount)
def RaidStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(2, echelonExtensionType, 0)
...
def RaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey): builder.PrependUint32Slot(3, bossBgInfoKey, 0)
def AddBossBgInfoKey(builder, bossBgInfoKey):
    return RaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey)
def RaidStageExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return RaidStageExcelAddId(builder, id)
def RaidStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(5, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return RaidStageExcelAddBattleDuration(builder, battleDuration)
def RaidStageExcelAddRaidBossGroup(builder, raidBossGroup): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(raidBossGroup), 0)
def AddRaidBossGroup(builder, raidBossGroup):
    return RaidStageExcelAddRaidBossGroup(builder, raidBossGroup)
def RaidStageExcelAddRaidRewardGroupId(builder, raidRewardGroupId): builder.PrependInt64Slot(7, raidRewardGroupId, 0)
def AddRaidRewardGroupId(builder, raidRewardGroupId):
    return RaidStageExcelAddRaidRewardGroupId(builder, raidRewardGroupId)
def RaidStageExcelAddUseBossAiPhaseSync(builder, useBossAiPhaseSync): builder.PrependBoolSlot(8, useBossAiPhaseSync, 0)
...
def RaidStageExcelAddBattleReadyTimelinePhaseEnd(builder, battleReadyTimelinePhaseEnd): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseEnd), 0)
...
def RaidStageExcelAddPhaseChangeTimelinePath(builder, phaseChangeTimelinePath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(phaseChangeTimelinePath), 0)
...
def RaidStageExcelAddGroundDevName(builder, groundDevName): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(groundDevName), 0)
def AddGroundDevName(builder, groundDevName):
    return RaidStageExcelAddGroundDevName(builder, groundDevName)
def RaidStageExcelAddHpPercentScore(builder, hpPercentScore): builder.PrependInt64Slot(12, hpPercentScore, 0)
def AddHpPercentScore(builder, hpPercentScore):
    return RaidStageExcelAddHpPercentScore(builder, hpPercentScore)
def RaidStageExcelAddDefaultClearScore(builder, defaultClearScore): builder.PrependInt64Slot(13, defaultClearScore, 0)
def AddDefaultClearScore(builder, defaultClearScore):
    return RaidStageExcelAddDefaultClearScore(builder, defaultClearScore)
def RaidStageExcelAddPortraitPath(builder, portraitPath): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(portraitPath), 0)
def AddPortraitPath(builder, portraitPath):
    return RaidStageExcelAddPortraitPath(builder, portraitPath)
def RaidStageExcelAddBgPath(builder, bgPath): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(bgPath), 0)
def AddBgPath(builder, bgPath):
    return RaidStageExcelAddBgPath(builder, bgPath)
def RaidStageExcelAddMinimumAcquisitionScore(builder, minimumAcquisitionScore): builder.PrependInt64Slot(16, minimumAcquisitionScore, 0)
...
def RaidStageExcelAddDifficultyOpenCondition(builder, difficultyOpenCondition): builder.PrependBoolSlot(17, difficultyOpenCondition, 0)
...
def RaidStageExcelAddRaidRoomLifeTime(builder, raidRoomLifeTime): builder.PrependInt32Slot(18, raidRoomLifeTime, 0)
def AddRaidRoomLifeTime(builder, raidRoomLifeTime):
    return RaidStageExcelAddRaidRoomLifeTime(builder, raidRoomLifeTime)
def RaidStageExcelAddTacticEnvironment(builder, tacticEnvironment): builder.PrependInt32Slot(19, tacticEnvironment, 0)
def AddTacticEnvironment(builder, tacticEnvironment):
    return RaidStageExcelAddTacticEnvironment(builder, tacticEnvironment)
def RaidStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(20, groundId, 0)
def AddGroundId(builder, groundId):
    return RaidStageExcelAddGroundId(builder, groundId)
def RaidStageExcelAddPerSecondMinusScore(builder, perSecondMinusScore): builder.PrependInt64Slot(21, perSecondMinusScore, 0)
...
def RaidStageExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(22, difficulty, 0)
def AddDifficulty(builder, difficulty):
    return RaidStageExcelAddDifficulty(builder, difficulty)
def RaidStageExcelAddTimeLinePhase(builder, timeLinePhase): builder.PrependInt64Slot(23, timeLinePhase, 0)
def AddTimeLinePhase(builder, timeLinePhase):
    return RaidStageExcelAddTimeLinePhase(builder, timeLinePhase)
def RaidStageExcelAddClearScenarioKey(builder, clearScenarioKey): builder.PrependUint32Slot(24, clearScenarioKey, 0)
def AddClearScenarioKey(builder, clearScenarioKey):
    return RaidStageExcelAddClearScenarioKey(builder, clearScenarioKey)
def RaidStageExcelAddShowSkillCard(builder, showSkillCard): builder.PrependBoolSlot(25, showSkillCard, 0)
...
def RaidStageExcelAddMaximumAcquisitionScore(builder, maximumAcquisitionScore): builder.PrependInt64Slot(27, maximumAcquisitionScore, 0)
...
def RaidStageExcelAddEnterTimeLine(builder, enterTimeLine): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(enterTimeLine), 0)
def AddEnterTimeLine(builder, enterTimeLine):
    return RaidStageExcelAddEnterTimeLine(builder, enterTimeLine)
def RaidStageExcelAddBattleReadyTimelinePath(builder, battleReadyTimelinePath): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePath), 0)
...
def RaidStageExcelAddVictoryTimelinePath(builder, victoryTimelinePath): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(victoryTimelinePath), 0)
...
def RaidStageExcelAddMaximumScore(builder, maximumScore): builder.PrependInt64Slot(31, maximumScore, 0)
def AddMaximumScore(builder, maximumScore):
    return RaidStageExcelAddMaximumScore(builder, maximumScore)
def RaidStageExcelAddBossCharacterId(builder, bossCharacterId): builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(bossCharacterId), 0)
...
def RaidStageExcelAddEnterScenarioKey(builder, enterScenarioKey): builder.PrependUint32Slot(33, enterScenarioKey, 0)
def AddEnterScenarioKey(builder, enterScenarioKey):
    return RaidStageExcelAddEnterScenarioKey(builder, enterScenarioKey)
def RaidStageExcelAddUseBossIndex(builder, useBossIndex): builder.PrependBoolSlot(34, useBossIndex, 0)
