...
def ConquestErosionUnitExcelAddMassErosionUnitRotationY(builder, massErosionUnitRotationY): builder.PrependFloat32Slot(1, massErosionUnitRotationY, 0.0)
...
def ConquestErosionUnitExcelAddTilePrefabId(builder, tilePrefabId): builder.PrependInt64Slot(3, tilePrefabId, 0)
def AddTilePrefabId(builder, tilePrefabId):
    return ConquestErosionUnitExcelAddTilePrefabId(builder, tilePrefabId)
def ConquestErosionUnitExcelAddIndividualErosionUnitId(builder, individualErosionUnitId): builder.PrependInt64Slot(4, individualErosionUnitId, 0)
