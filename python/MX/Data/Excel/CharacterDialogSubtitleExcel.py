...
def CharacterDialogSubtitleExcelAddDurationKr(builder, durationKr): builder.PrependInt64Slot(1, durationKr, 0)
...
def CharacterDialogSubtitleExcelAddTlmid(builder, tlmid): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(tlmid), 0)
...
def CharacterDialogSubtitleExcelAddLocalizeTh(builder, localizeTh): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTh), 0)
def AddLocalizeTh(builder, localizeTh):
    return CharacterDialogSubtitleExcelAddLocalizeTh(builder, localizeTh)
def CharacterDialogSubtitleExcelAddDuration(builder, duration): builder.PrependInt64Slot(6, duration, 0)
def AddDuration(builder, duration):
    return CharacterDialogSubtitleExcelAddDuration(builder, duration)
def CharacterDialogSubtitleExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
...
def CharacterDialogSubtitleExcelAddLocalizeJp(builder, localizeJp): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(localizeJp), 0)
