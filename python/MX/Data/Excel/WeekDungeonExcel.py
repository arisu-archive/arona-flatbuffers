...
def WeekDungeonExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(0, stageRewardId, 0)
def AddStageRewardId(builder, stageRewardId):
    return WeekDungeonExcelAddStageRewardId(builder, stageRewardId)
def WeekDungeonExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt64Slot(1, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return WeekDungeonExcelAddRecommandLevel(builder, recommandLevel)
def WeekDungeonExcelAddBattleRewardExp(builder, battleRewardExp): builder.PrependInt64Slot(2, battleRewardExp, 0)
def AddBattleRewardExp(builder, battleRewardExp):
    return WeekDungeonExcelAddBattleRewardExp(builder, battleRewardExp)
def WeekDungeonExcelAddGroundId(builder, groundId): builder.PrependInt32Slot(3, groundId, 0)
def AddGroundId(builder, groundId):
    return WeekDungeonExcelAddGroundId(builder, groundId)
def WeekDungeonExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(4, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return WeekDungeonExcelAddStageTopography(builder, stageTopography)
def WeekDungeonExcelAddStageId(builder, stageId): builder.PrependInt64Slot(5, stageId, 0)
def AddStageId(builder, stageId):
    return WeekDungeonExcelAddStageId(builder, stageId)
def WeekDungeonExcelAddBattleRewardPlayerExp(builder, battleRewardPlayerExp): builder.PrependInt64Slot(6, battleRewardPlayerExp, 0)
...
def WeekDungeonExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(7, difficulty, 0)
def AddDifficulty(builder, difficulty):
    return WeekDungeonExcelAddDifficulty(builder, difficulty)
def WeekDungeonExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
...
def WeekDungeonExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostAmount), 0)
...
def WeekDungeonExcelAddGroupBuffId(builder, groupBuffId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(groupBuffId), 0)
...
def WeekDungeonExcelAddPlayTimeLimitInSeconds(builder, playTimeLimitInSeconds): builder.PrependInt64Slot(11, playTimeLimitInSeconds, 0)
...
def WeekDungeonExcelAddWeekDungeonType(builder, weekDungeonType): builder.PrependInt32Slot(13, weekDungeonType, 0)
def AddWeekDungeonType(builder, weekDungeonType):
    return WeekDungeonExcelAddWeekDungeonType(builder, weekDungeonType)
def WeekDungeonExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostId), 0)
...
def WeekDungeonExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(16, prevStageId, 0)
def AddPrevStageId(builder, prevStageId):
    return WeekDungeonExcelAddPrevStageId(builder, prevStageId)
def WeekDungeonExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
