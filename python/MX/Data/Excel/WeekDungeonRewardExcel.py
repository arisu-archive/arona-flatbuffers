...
def WeekDungeonRewardExcelAddDungeonType(builder, dungeonType): builder.PrependInt32Slot(3, dungeonType, 0)
...
def WeekDungeonRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(6, rewardParcelId, 0)
