...
def EventContentNotifyExcelAddEventNotifyType(builder, eventNotifyType): builder.PrependInt32Slot(1, eventNotifyType, 0)
...
def EventContentNotifyExcelAddShortcutEventTargetType(builder, shortcutEventTargetType): builder.PrependInt32Slot(3, shortcutEventTargetType, 0)
...
def EventContentNotifyExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(4, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentNotifyExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentNotifyExcelAddEventTargetType(builder, eventTargetType): builder.PrependInt32Slot(5, eventTargetType, 0)
