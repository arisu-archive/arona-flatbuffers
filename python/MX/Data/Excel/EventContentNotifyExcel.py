...
def EventContentNotifyExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(2, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentNotifyExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentNotifyExcelAddIsShortcutEnable(builder, isShortcutEnable): builder.PrependBoolSlot(3, isShortcutEnable, 0)
...
def EventContentNotifyExcelAddShortcutEventTargetType(builder, shortcutEventTargetType): builder.PrependInt32Slot(4, shortcutEventTargetType, 0)
...
def EventContentNotifyExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
def AddIconPath(builder, iconPath):
    return EventContentNotifyExcelAddIconPath(builder, iconPath)
def EventContentNotifyExcelAddEventNotifyType(builder, eventNotifyType): builder.PrependInt32Slot(6, eventNotifyType, 0)
