...
def MultiFloorRaidSeasonManageExcelAddSeasonEndDate(builder, seasonEndDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(seasonEndDate), 0)
...
def MultiFloorRaidSeasonManageExcelAddOpenRaidBossGroupId(builder, openRaidBossGroupId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroupId), 0)
...
def MultiFloorRaidSeasonManageExcelAddSettlementEndDate(builder, settlementEndDate): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(settlementEndDate), 0)
...
def MultiFloorRaidSeasonManageExcelAddShowLobbyBanner(builder, showLobbyBanner): builder.PrependBoolSlot(4, showLobbyBanner, 0)
...
def MultiFloorRaidSeasonManageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(5, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return MultiFloorRaidSeasonManageExcelAddSeasonId(builder, seasonId)
def MultiFloorRaidSeasonManageExcelAddLobbyImgPath(builder, lobbyImgPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(lobbyImgPath), 0)
...
def MultiFloorRaidSeasonManageExcelAddPlayTip(builder, playTip): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(playTip), 0)
def AddPlayTip(builder, playTip):
    return MultiFloorRaidSeasonManageExcelAddPlayTip(builder, playTip)
def MultiFloorRaidSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def MultiFloorRaidSeasonManageExcelAddSeasonStartDate(builder, seasonStartDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(seasonStartDate), 0)
...
def MultiFloorRaidSeasonManageExcelAddLobbyEnterScenario(builder, lobbyEnterScenario): builder.PrependUint32Slot(11, lobbyEnterScenario, 0)
