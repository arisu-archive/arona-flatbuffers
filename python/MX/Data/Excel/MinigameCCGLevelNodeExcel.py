...
def MinigameCCGLevelNodeExcelAddNodeIcon(builder, nodeIcon): builder.PrependInt32Slot(0, nodeIcon, 0)
...
def MinigameCCGLevelNodeExcelAddNodeId(builder, nodeId): builder.PrependInt64Slot(2, nodeId, 0)
def AddNodeId(builder, nodeId):
    return MinigameCCGLevelNodeExcelAddNodeId(builder, nodeId)
def MinigameCCGLevelNodeExcelAddLevelId(builder, levelId): builder.PrependInt64Slot(3, levelId, 0)
