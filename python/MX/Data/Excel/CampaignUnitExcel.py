...
def CampaignUnitExcelAddStrategyPrefabName(builder, strategyPrefabName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(strategyPrefabName), 0)
...
def CampaignUnitExcelAddAiMoveType(builder, aiMoveType): builder.PrependInt32Slot(1, aiMoveType, 0)
def AddAiMoveType(builder, aiMoveType):
    return CampaignUnitExcelAddAiMoveType(builder, aiMoveType)
def CampaignUnitExcelAddGrade(builder, grade): builder.PrependInt32Slot(2, grade, 0)
def AddGrade(builder, grade):
    return CampaignUnitExcelAddGrade(builder, grade)
def CampaignUnitExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(3, groundId, 0)
def AddGroundId(builder, groundId):
    return CampaignUnitExcelAddGroundId(builder, groundId)
def CampaignUnitExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def CampaignUnitExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
def AddId(builder, id):
    return CampaignUnitExcelAddId(builder, id)
def CampaignUnitExcelAddKey(builder, key): builder.PrependUint32Slot(6, key, 0)
def AddKey(builder, key):
    return CampaignUnitExcelAddKey(builder, key)
def CampaignUnitExcelAddScale(builder, scale): builder.PrependFloat32Slot(7, scale, 0.0)
def AddScale(builder, scale):
    return CampaignUnitExcelAddScale(builder, scale)
def CampaignUnitExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return CampaignUnitExcelAddPrefabName(builder, prefabName)
def CampaignUnitExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
...
def CampaignUnitExcelAddEnvironmentType(builder, environmentType): builder.PrependInt32Slot(13, environmentType, 0)
