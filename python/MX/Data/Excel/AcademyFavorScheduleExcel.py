...
def AcademyFavorScheduleExcelAddScheduleGroupId(builder, scheduleGroupId): builder.PrependInt64Slot(1, scheduleGroupId, 0)
def AddScheduleGroupId(builder, scheduleGroupId):
    return AcademyFavorScheduleExcelAddScheduleGroupId(builder, scheduleGroupId)
def AcademyFavorScheduleExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AcademyFavorScheduleExcelAddSecretStoneAmount(builder, secretStoneAmount): builder.PrependInt64Slot(3, secretStoneAmount, 0)
...
def AcademyFavorScheduleExcelAddFavorRank(builder, favorRank): builder.PrependInt64Slot(4, favorRank, 0)
...
def AcademyFavorScheduleExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(6, characterId, 0)
...
def AcademyFavorScheduleExcelAddLocation(builder, location): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(location), 0)
def AddLocation(builder, location):
    return AcademyFavorScheduleExcelAddLocation(builder, location)
def AcademyFavorScheduleExcelAddLocalizeScenarioId(builder, localizeScenarioId): builder.PrependUint32Slot(11, localizeScenarioId, 0)
