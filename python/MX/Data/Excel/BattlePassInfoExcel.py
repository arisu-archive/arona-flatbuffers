...
def BattlePassInfoExcelAddNormalProductGroupId(builder, normalProductGroupId): builder.PrependInt64Slot(0, normalProductGroupId, 0)
...
def BattlePassInfoExcelAddPassExpLocalizeEtcId(builder, passExpLocalizeEtcId): builder.PrependUint32Slot(1, passExpLocalizeEtcId, 0)
...
def BattlePassInfoExcelAddPurchaseStepProductImagePath(builder, purchaseStepProductImagePath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(purchaseStepProductImagePath), 0)
...
def BattlePassInfoExcelAddPremiumProductGroupId(builder, premiumProductGroupId): builder.PrependInt64Slot(3, premiumProductGroupId, 0)
...
def BattlePassInfoExcelAddPassLvUpGoodsId(builder, passLvUpGoodsId): builder.PrependInt64Slot(4, passLvUpGoodsId, 0)
def AddPassLvUpGoodsId(builder, passLvUpGoodsId):
    return BattlePassInfoExcelAddPassLvUpGoodsId(builder, passLvUpGoodsId)
def BattlePassInfoExcelAddVideoId(builder, videoId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(videoId), 0)
...
def BattlePassInfoExcelAddDiscountPremiumProductGroupId(builder, discountPremiumProductGroupId): builder.PrependInt64Slot(6, discountPremiumProductGroupId, 0)
...
def BattlePassInfoExcelAddMainIconParcelPath(builder, mainIconParcelPath): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(mainIconParcelPath), 0)
...
def BattlePassInfoExcelAddFreeRewardGroupId(builder, freeRewardGroupId): builder.PrependInt64Slot(9, freeRewardGroupId, 0)
...
def BattlePassInfoExcelAddPurchaseRewardGroupId(builder, purchaseRewardGroupId): builder.PrependInt64Slot(11, purchaseRewardGroupId, 0)
...
def BattlePassInfoExcelAddLobbyBannerPath(builder, lobbyBannerPath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(lobbyBannerPath), 0)
def AddLobbyBannerPath(builder, lobbyBannerPath):
    return BattlePassInfoExcelAddLobbyBannerPath(builder, lobbyBannerPath)
def BattlePassInfoExcelAddExclusiveEmblemId(builder, exclusiveEmblemId): builder.PrependInt64Slot(13, exclusiveEmblemId, 0)
...
def BattlePassInfoExcelAddNextLvNeedExp(builder, nextLvNeedExp): builder.PrependInt32Slot(14, nextLvNeedExp, 0)
def AddNextLvNeedExp(builder, nextLvNeedExp):
    return BattlePassInfoExcelAddNextLvNeedExp(builder, nextLvNeedExp)
def BattlePassInfoExcelAddSalePeriodFrom(builder, salePeriodFrom): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodFrom), 0)
def AddSalePeriodFrom(builder, salePeriodFrom):
    return BattlePassInfoExcelAddSalePeriodFrom(builder, salePeriodFrom)
def BattlePassInfoExcelAddExclusiveRewardId(builder, exclusiveRewardId): builder.PrependInt64Slot(16, exclusiveRewardId, 0)
...
def BattlePassInfoExcelAddFlavorTextGroupId(builder, flavorTextGroupId): builder.PrependInt64Slot(17, flavorTextGroupId, 0)
