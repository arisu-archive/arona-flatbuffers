...
def EquipmentLevelExcelAddTotalExp(builder, totalExp): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(totalExp), 0)
...
def EquipmentLevelExcelAddTierLevelExp(builder, tierLevelExp): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tierLevelExp), 0)
