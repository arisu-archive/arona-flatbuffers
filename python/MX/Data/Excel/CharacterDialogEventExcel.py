...
def CharacterDialogEventExcelStart(builder): builder.StartObject(27)
def Start(builder):
    return CharacterDialogEventExcelStart(builder)
def CharacterDialogEventExcelAddCvCollectionType(builder, cvCollectionType): builder.PrependInt32Slot(0, cvCollectionType, 0)
...
def CharacterDialogEventExcelAddDuration(builder, duration): builder.PrependInt64Slot(1, duration, 0)
def AddDuration(builder, duration):
    return CharacterDialogEventExcelAddDuration(builder, duration)
def CharacterDialogEventExcelAddScenarioGroupId(builder, scenarioGroupId): builder.PrependInt64Slot(2, scenarioGroupId, 0)
def AddScenarioGroupId(builder, scenarioGroupId):
    return CharacterDialogEventExcelAddScenarioGroupId(builder, scenarioGroupId)
def CharacterDialogEventExcelAddLocalizeJp(builder, localizeJp): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(localizeJp), 0)
def AddLocalizeJp(builder, localizeJp):
    return CharacterDialogEventExcelAddLocalizeJp(builder, localizeJp)
def CharacterDialogEventExcelAddVoiceId(builder, voiceId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(voiceId), 0)
...
def CharacterDialogEventExcelAddDialogCondition(builder, dialogCondition): builder.PrependInt32Slot(5, dialogCondition, 0)
def AddDialogCondition(builder, dialogCondition):
    return CharacterDialogEventExcelAddDialogCondition(builder, dialogCondition)
def CharacterDialogEventExcelAddDialogType(builder, dialogType): builder.PrependInt32Slot(6, dialogType, 0)
def AddDialogType(builder, dialogType):
    return CharacterDialogEventExcelAddDialogType(builder, dialogType)
def CharacterDialogEventExcelAddLocalizeEn(builder, localizeEn): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(localizeEn), 0)
def AddLocalizeEn(builder, localizeEn):
    return CharacterDialogEventExcelAddLocalizeEn(builder, localizeEn)
def CharacterDialogEventExcelAddLocalizeTw(builder, localizeTw): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTw), 0)
def AddLocalizeTw(builder, localizeTw):
    return CharacterDialogEventExcelAddLocalizeTw(builder, localizeTw)
def CharacterDialogEventExcelAddCostumeUniqueId(builder, costumeUniqueId): builder.PrependInt64Slot(9, costumeUniqueId, 0)
def AddCostumeUniqueId(builder, costumeUniqueId):
    return CharacterDialogEventExcelAddCostumeUniqueId(builder, costumeUniqueId)
def CharacterDialogEventExcelAddLocalizeKr(builder, localizeKr): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(localizeKr), 0)
def AddLocalizeKr(builder, localizeKr):
    return CharacterDialogEventExcelAddLocalizeKr(builder, localizeKr)
def CharacterDialogEventExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(11, groupId, 0)
def AddGroupId(builder, groupId):
    return CharacterDialogEventExcelAddGroupId(builder, groupId)
def CharacterDialogEventExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(12, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CharacterDialogEventExcelAddProductionStep(builder, productionStep)
def CharacterDialogEventExcelAddLocalizeCvGroup(builder, localizeCvGroup): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(localizeCvGroup), 0)
def AddLocalizeCvGroup(builder, localizeCvGroup):
    return CharacterDialogEventExcelAddLocalizeCvGroup(builder, localizeCvGroup)
def CharacterDialogEventExcelAddCvUnlockScenarioType(builder, cvUnlockScenarioType): builder.PrependInt32Slot(14, cvUnlockScenarioType, 0)
...
def CharacterDialogEventExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(15, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return CharacterDialogEventExcelAddDisplayOrder(builder, displayOrder)
def CharacterDialogEventExcelAddDialogConditionDetailValue(builder, dialogConditionDetailValue): builder.PrependInt64Slot(16, dialogConditionDetailValue, 0)
...
def CharacterDialogEventExcelAddActionName(builder, actionName): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(actionName), 0)
def AddActionName(builder, actionName):
    return CharacterDialogEventExcelAddActionName(builder, actionName)
def CharacterDialogEventExcelAddOriginalCharacterId(builder, originalCharacterId): builder.PrependInt64Slot(19, originalCharacterId, 0)
...
def CharacterDialogEventExcelAddDurationKr(builder, durationKr): builder.PrependInt64Slot(20, durationKr, 0)
def AddDurationKr(builder, durationKr):
    return CharacterDialogEventExcelAddDurationKr(builder, durationKr)
def CharacterDialogEventExcelAddEventId(builder, eventId): builder.PrependInt64Slot(21, eventId, 0)
def AddEventId(builder, eventId):
    return CharacterDialogEventExcelAddEventId(builder, eventId)
def CharacterDialogEventExcelAddUnlockEventSeason(builder, unlockEventSeason): builder.PrependInt64Slot(22, unlockEventSeason, 0)
...
def CharacterDialogEventExcelAddAnimationName(builder, animationName): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(animationName), 0)
def AddAnimationName(builder, animationName):
    return CharacterDialogEventExcelAddAnimationName(builder, animationName)
def CharacterDialogEventExcelAddLocalizeTh(builder, localizeTh): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTh), 0)
def AddLocalizeTh(builder, localizeTh):
    return CharacterDialogEventExcelAddLocalizeTh(builder, localizeTh)
def CharacterDialogEventExcelAddDialogConditionDetail(builder, dialogConditionDetail): builder.PrependInt32Slot(25, dialogConditionDetail, 0)
...
def CharacterDialogEventExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(26, collectionVisible, 0)
