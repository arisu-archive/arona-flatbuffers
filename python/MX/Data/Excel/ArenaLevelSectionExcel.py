...
def ArenaLevelSectionExcelAddArenaSeasonId(builder, arenaSeasonId): builder.PrependInt64Slot(1, arenaSeasonId, 0)
def AddArenaSeasonId(builder, arenaSeasonId):
    return ArenaLevelSectionExcelAddArenaSeasonId(builder, arenaSeasonId)
def ArenaLevelSectionExcelAddUserCount(builder, userCount): builder.PrependInt64Slot(2, userCount, 0)
