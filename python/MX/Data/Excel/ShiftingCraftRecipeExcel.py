...
def ShiftingCraftRecipeExcelAddResultAmount(builder, resultAmount): builder.PrependInt64Slot(1, resultAmount, 0)
...
def ShiftingCraftRecipeExcelAddRequireItemId(builder, requireItemId): builder.PrependInt64Slot(3, requireItemId, 0)
def AddRequireItemId(builder, requireItemId):
    return ShiftingCraftRecipeExcelAddRequireItemId(builder, requireItemId)
def ShiftingCraftRecipeExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return ShiftingCraftRecipeExcelAddId(builder, id)
def ShiftingCraftRecipeExcelAddRequireItemAmount(builder, requireItemAmount): builder.PrependInt64Slot(5, requireItemAmount, 0)
...
def ShiftingCraftRecipeExcelAddResultParcel(builder, resultParcel): builder.PrependInt32Slot(6, resultParcel, 0)
def AddResultParcel(builder, resultParcel):
    return ShiftingCraftRecipeExcelAddResultParcel(builder, resultParcel)
def ShiftingCraftRecipeExcelAddIngredientExp(builder, ingredientExp): builder.PrependInt64Slot(7, ingredientExp, 0)
...
def ShiftingCraftRecipeExcelAddIngredientTag(builder, ingredientTag): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientTag), 0)
