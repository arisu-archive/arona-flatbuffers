...
def MiniGameShootingGeasExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(1, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MiniGameShootingGeasExcelAddUniqueId(builder, uniqueId)
def MiniGameShootingGeasExcelAddProbability(builder, probability): builder.PrependInt64Slot(2, probability, 0)
...
def MiniGameShootingGeasExcelAddGeasData(builder, geasData): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(geasData), 0)
...
def MiniGameShootingGeasExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
