...
def ShopFreeRecruitPeriodExcelAddIntervalDate(builder, intervalDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(intervalDate), 0)
def AddIntervalDate(builder, intervalDate):
    return ShopFreeRecruitPeriodExcelAddIntervalDate(builder, intervalDate)
def ShopFreeRecruitPeriodExcelAddFreeRecruitCount(builder, freeRecruitCount): builder.PrependInt32Slot(1, freeRecruitCount, 0)
