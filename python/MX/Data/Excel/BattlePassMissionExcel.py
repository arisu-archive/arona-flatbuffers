...
def BattlePassMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(0, resetType, 0)
def AddResetType(builder, resetType):
    return BattlePassMissionExcelAddResetType(builder, resetType)
def BattlePassMissionExcelAddBattlePassExpAmount(builder, battlePassExpAmount): builder.PrependInt32Slot(1, battlePassExpAmount, 0)
...
def BattlePassMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(2, description, 0)
def AddDescription(builder, description):
    return BattlePassMissionExcelAddDescription(builder, description)
def BattlePassMissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(3, viewFlag, 0)
def AddViewFlag(builder, viewFlag):
    return BattlePassMissionExcelAddViewFlag(builder, viewFlag)
def BattlePassMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def BattlePassMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(5, completeConditionType, 0)
...
def BattlePassMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return BattlePassMissionExcelAddToastImagePath(builder, toastImagePath)
def BattlePassMissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def BattlePassMissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(8, toastDisplayType, 0)
...
def BattlePassMissionExcelAddChallengeStageShortcut(builder, challengeStageShortcut): builder.PrependInt64Slot(9, challengeStageShortcut, 0)
...
def BattlePassMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(10, completeConditionCount, 0)
...
def BattlePassMissionExcelAddBattlePassId(builder, battlePassId): builder.PrependInt64Slot(11, battlePassId, 0)
def AddBattlePassId(builder, battlePassId):
    return BattlePassMissionExcelAddBattlePassId(builder, battlePassId)
def BattlePassMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(12, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return BattlePassMissionExcelAddDisplayOrder(builder, displayOrder)
def BattlePassMissionExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
...
def BattlePassMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(16, category, 0)
