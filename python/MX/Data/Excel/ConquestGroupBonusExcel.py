...
def ConquestGroupBonusExcelAddBonusId(builder, bonusId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(bonusId), 0)
...
def ConquestGroupBonusExcelAddBonusParcelType(builder, bonusParcelType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(bonusParcelType), 0)
...
def ConquestGroupBonusExcelAddBonusPercentage3(builder, bonusPercentage3): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(bonusPercentage3), 0)
...
def ConquestGroupBonusExcelAddConquestBonusId(builder, conquestBonusId): builder.PrependInt64Slot(3, conquestBonusId, 0)
def AddConquestBonusId(builder, conquestBonusId):
    return ConquestGroupBonusExcelAddConquestBonusId(builder, conquestBonusId)
def ConquestGroupBonusExcelAddBonusCharacterCount2(builder, bonusCharacterCount2): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(bonusCharacterCount2), 0)
...
def ConquestGroupBonusExcelAddRecommandLocalizeEtcId(builder, recommandLocalizeEtcId): builder.PrependUint32Slot(5, recommandLocalizeEtcId, 0)
...
def ConquestGroupBonusExcelAddBonusCharacterCount3(builder, bonusCharacterCount3): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(bonusCharacterCount3), 0)
...
def ConquestGroupBonusExcelAddSchool(builder, school): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(school), 0)
...
def ConquestGroupBonusExcelAddBonusCharacterCount1(builder, bonusCharacterCount1): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(bonusCharacterCount1), 0)
...
def ConquestGroupBonusExcelAddBonusPercentage1(builder, bonusPercentage1): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(bonusPercentage1), 0)
