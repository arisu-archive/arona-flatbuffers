...
def SchoolDungeonStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(0, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return SchoolDungeonStageExcelAddStageTopography(builder, stageTopography)
def SchoolDungeonStageExcelAddStageEnterCostMinimumAmount(builder, stageEnterCostMinimumAmount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostMinimumAmount), 0)
...
def SchoolDungeonStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(2, echelonExtensionType, 0)
...
def SchoolDungeonStageExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(3, difficulty, 0)
def AddDifficulty(builder, difficulty):
    return SchoolDungeonStageExcelAddDifficulty(builder, difficulty)
def SchoolDungeonStageExcelAddPlayTimeLimitInSeconds(builder, playTimeLimitInSeconds): builder.PrependInt64Slot(4, playTimeLimitInSeconds, 0)
...
def SchoolDungeonStageExcelAddGroundId(builder, groundId): builder.PrependInt32Slot(5, groundId, 0)
def AddGroundId(builder, groundId):
    return SchoolDungeonStageExcelAddGroundId(builder, groundId)
def SchoolDungeonStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostType), 0)
...
def SchoolDungeonStageExcelAddDungeonType(builder, dungeonType): builder.PrependInt32Slot(8, dungeonType, 0)
def AddDungeonType(builder, dungeonType):
    return SchoolDungeonStageExcelAddDungeonType(builder, dungeonType)
def SchoolDungeonStageExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(9, prevStageId, 0)
...
def SchoolDungeonStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostId), 0)
...
def SchoolDungeonStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt64Slot(12, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return SchoolDungeonStageExcelAddRecommandLevel(builder, recommandLevel)
def SchoolDungeonStageExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def SchoolDungeonStageExcelAddStageId(builder, stageId): builder.PrependInt64Slot(14, stageId, 0)
def AddStageId(builder, stageId):
    return SchoolDungeonStageExcelAddStageId(builder, stageId)
def SchoolDungeonStageExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(15, stageRewardId, 0)
def AddStageRewardId(builder, stageRewardId):
    return SchoolDungeonStageExcelAddStageRewardId(builder, stageRewardId)
def SchoolDungeonStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(16, battleDuration, 0)
