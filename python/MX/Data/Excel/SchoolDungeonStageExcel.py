...
def SchoolDungeonStageExcelAddStageEnterCostMinimumAmount(builder, stageEnterCostMinimumAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostMinimumAmount), 0)
...
def SchoolDungeonStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(1, stageTopography, 0)
...
def SchoolDungeonStageExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(3, stageRewardId, 0)
def AddStageRewardId(builder, stageRewardId):
    return SchoolDungeonStageExcelAddStageRewardId(builder, stageRewardId)
def SchoolDungeonStageExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(4, difficulty, 0)
def AddDifficulty(builder, difficulty):
    return SchoolDungeonStageExcelAddDifficulty(builder, difficulty)
def SchoolDungeonStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(5, echelonExtensionType, 0)
...
def SchoolDungeonStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt64Slot(6, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return SchoolDungeonStageExcelAddRecommandLevel(builder, recommandLevel)
def SchoolDungeonStageExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def SchoolDungeonStageExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
...
def SchoolDungeonStageExcelAddStageId(builder, stageId): builder.PrependInt64Slot(9, stageId, 0)
def AddStageId(builder, stageId):
    return SchoolDungeonStageExcelAddStageId(builder, stageId)
def SchoolDungeonStageExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(10, prevStageId, 0)
def AddPrevStageId(builder, prevStageId):
    return SchoolDungeonStageExcelAddPrevStageId(builder, prevStageId)
def SchoolDungeonStageExcelAddGroundId(builder, groundId): builder.PrependInt32Slot(11, groundId, 0)
def AddGroundId(builder, groundId):
    return SchoolDungeonStageExcelAddGroundId(builder, groundId)
def SchoolDungeonStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(12, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return SchoolDungeonStageExcelAddBattleDuration(builder, battleDuration)
def SchoolDungeonStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostId), 0)
...
def SchoolDungeonStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostAmount), 0)
...
def SchoolDungeonStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostType), 0)
