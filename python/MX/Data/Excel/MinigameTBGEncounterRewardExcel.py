...
def MinigameTBGEncounterRewardExcelAddProb(builder, prob): builder.PrependInt32Slot(1, prob, 0)
...
def MinigameTBGEncounterRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(3, groupId, 0)
...
def MinigameTBGEncounterRewardExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(7, parcelType, 0)
