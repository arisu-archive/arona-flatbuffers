...
def MiniGameDefenseInfoExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameDefenseInfoExcelAddEventContentId(builder, eventContentId)
def MiniGameDefenseInfoExcelAddDefenseBattleParcelId(builder, defenseBattleParcelId): builder.PrependInt64Slot(3, defenseBattleParcelId, 0)
...
def MiniGameDefenseInfoExcelAddDefenseBattleParcelType(builder, defenseBattleParcelType): builder.PrependInt32Slot(4, defenseBattleParcelType, 0)
