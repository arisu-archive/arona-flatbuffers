...
def CurrencyExcelAddCurrencyName(builder, currencyName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(currencyName), 0)
def AddCurrencyName(builder, currencyName):
    return CurrencyExcelAddCurrencyName(builder, currencyName)
def CurrencyExcelAddCurrencyType(builder, currencyType): builder.PrependInt32Slot(1, currencyType, 0)
def AddCurrencyType(builder, currencyType):
    return CurrencyExcelAddCurrencyType(builder, currencyType)
def CurrencyExcelAddAutoChargeAmount(builder, autoChargeAmount): builder.PrependInt32Slot(2, autoChargeAmount, 0)
def AddAutoChargeAmount(builder, autoChargeAmount):
    return CurrencyExcelAddAutoChargeAmount(builder, autoChargeAmount)
def CurrencyExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(3, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return CurrencyExcelAddLocalizeEtcId(builder, localizeEtcId)
def CurrencyExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
...
def CurrencyExcelAddChargeLimit(builder, chargeLimit): builder.PrependInt64Slot(6, chargeLimit, 0)
def AddChargeLimit(builder, chargeLimit):
    return CurrencyExcelAddChargeLimit(builder, chargeLimit)
def CurrencyExcelAddRarity(builder, rarity): builder.PrependInt32Slot(7, rarity, 0)
def AddRarity(builder, rarity):
    return CurrencyExcelAddRarity(builder, rarity)
def CurrencyExcelAddExpirationDateTime(builder, expirationDateTime): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(expirationDateTime), 0)
def AddExpirationDateTime(builder, expirationDateTime):
    return CurrencyExcelAddExpirationDateTime(builder, expirationDateTime)
def CurrencyExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return CurrencyExcelAddIcon(builder, icon)
def CurrencyExcelAddDailyRefillTime(builder, dailyRefillTime): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(dailyRefillTime), 0)
...
def CurrencyExcelAddCurrencyAdditionalChargeType(builder, currencyAdditionalChargeType): builder.PrependInt32Slot(11, currencyAdditionalChargeType, 0)
...
def CurrencyExcelAddOverChargeLimit(builder, overChargeLimit): builder.PrependInt64Slot(12, overChargeLimit, 0)
def AddOverChargeLimit(builder, overChargeLimit):
    return CurrencyExcelAddOverChargeLimit(builder, overChargeLimit)
def CurrencyExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
def AddId(builder, id):
    return CurrencyExcelAddId(builder, id)
def CurrencyExcelAddAutoChargeMsc(builder, autoChargeMsc): builder.PrependInt32Slot(14, autoChargeMsc, 0)
def AddAutoChargeMsc(builder, autoChargeMsc):
    return CurrencyExcelAddAutoChargeMsc(builder, autoChargeMsc)
def CurrencyExcelAddDailyRefillType(builder, dailyRefillType): builder.PrependInt32Slot(15, dailyRefillType, 0)
def AddDailyRefillType(builder, dailyRefillType):
    return CurrencyExcelAddDailyRefillType(builder, dailyRefillType)
def CurrencyExcelAddExpiryChangeAmount(builder, expiryChangeAmount): builder.PrependInt64Slot(16, expiryChangeAmount, 0)
def AddExpiryChangeAmount(builder, expiryChangeAmount):
    return CurrencyExcelAddExpiryChangeAmount(builder, expiryChangeAmount)
def CurrencyExcelAddCurrencyOverChargeType(builder, currencyOverChargeType): builder.PrependInt32Slot(17, currencyOverChargeType, 0)
...
def CurrencyExcelAddExpiryChangeId(builder, expiryChangeId): builder.PrependInt64Slot(18, expiryChangeId, 0)
def AddExpiryChangeId(builder, expiryChangeId):
    return CurrencyExcelAddExpiryChangeId(builder, expiryChangeId)
def CurrencyExcelAddExpiryChangeParcelType(builder, expiryChangeParcelType): builder.PrependInt32Slot(19, expiryChangeParcelType, 0)
...
def CurrencyExcelAddDailyRefillAmount(builder, dailyRefillAmount): builder.PrependInt64Slot(20, dailyRefillAmount, 0)
