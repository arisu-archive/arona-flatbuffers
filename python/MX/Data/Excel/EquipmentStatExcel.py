...
def EquipmentStatExcelAddLevelUpFeedExp(builder, levelUpFeedExp): builder.PrependInt64Slot(0, levelUpFeedExp, 0)
def AddLevelUpFeedExp(builder, levelUpFeedExp):
    return EquipmentStatExcelAddLevelUpFeedExp(builder, levelUpFeedExp)
def EquipmentStatExcelAddMinStat(builder, minStat): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(minStat), 0)
...
def EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax): builder.PrependInt32Slot(2, transcendenceMax, 0)
def AddTranscendenceMax(builder, transcendenceMax):
    return EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax)
def EquipmentStatExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(3, statLevelUpType, 0)
...
def EquipmentStatExcelAddDefaultMaxLevel(builder, defaultMaxLevel): builder.PrependInt32Slot(6, defaultMaxLevel, 0)
...
def EquipmentStatExcelAddLevelUpFeedAddExp(builder, levelUpFeedAddExp): builder.PrependInt64Slot(8, levelUpFeedAddExp, 0)
...
def EquipmentStatExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def EquipmentStatExcelAddLevelUpFeedCostAmount(builder, levelUpFeedCostAmount): builder.PrependInt64Slot(11, levelUpFeedCostAmount, 0)
