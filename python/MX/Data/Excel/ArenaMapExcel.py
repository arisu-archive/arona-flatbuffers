...
def ArenaMapExcelAddImagePath(builder, imagePath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(imagePath), 0)
def AddImagePath(builder, imagePath):
    return ArenaMapExcelAddImagePath(builder, imagePath)
def ArenaMapExcelAddGroundGroupNameLocalizeKey(builder, groundGroupNameLocalizeKey): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(groundGroupNameLocalizeKey), 0)
...
def ArenaMapExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
...
def ArenaMapExcelAddStartRank(builder, startRank): builder.PrependInt64Slot(4, startRank, 0)
def AddStartRank(builder, startRank):
    return ArenaMapExcelAddStartRank(builder, startRank)
def ArenaMapExcelAddTerrainType(builder, terrainType): builder.PrependInt64Slot(5, terrainType, 0)
def AddTerrainType(builder, terrainType):
    return ArenaMapExcelAddTerrainType(builder, terrainType)
def ArenaMapExcelAddEndRank(builder, endRank): builder.PrependInt64Slot(6, endRank, 0)
def AddEndRank(builder, endRank):
    return ArenaMapExcelAddEndRank(builder, endRank)
def ArenaMapExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(7, groundId, 0)
def AddGroundId(builder, groundId):
    return ArenaMapExcelAddGroundId(builder, groundId)
def ArenaMapExcelAddGroundGroupId(builder, groundGroupId): builder.PrependInt64Slot(8, groundGroupId, 0)
