...
def LogicEffectCommonVisualExcelAddParticleApplyPath(builder, particleApplyPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(particleApplyPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleApplySocket(builder, particleApplySocket): builder.PrependInt32Slot(1, particleApplySocket, 0)
...
def LogicEffectCommonVisualExcelAddIconSpriteName(builder, iconSpriteName): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(iconSpriteName), 0)
def AddIconSpriteName(builder, iconSpriteName):
    return LogicEffectCommonVisualExcelAddIconSpriteName(builder, iconSpriteName)
def LogicEffectCommonVisualExcelAddParticleLoopSocket(builder, particleLoopSocket): builder.PrependInt32Slot(3, particleLoopSocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleEndPath(builder, particleEndPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(particleEndPath), 0)
...
def LogicEffectCommonVisualExcelAddParticleRemovedSocket(builder, particleRemovedSocket): builder.PrependInt32Slot(7, particleRemovedSocket, 0)
...
def LogicEffectCommonVisualExcelAddStringId(builder, stringId): builder.PrependUint32Slot(8, stringId, 0)
def AddStringId(builder, stringId):
    return LogicEffectCommonVisualExcelAddStringId(builder, stringId)
def LogicEffectCommonVisualExcelAddIconDispelColor(builder, iconDispelColor): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(iconDispelColor), 0)
...
def LogicEffectCommonVisualExcelAddParticleEnterSocket(builder, particleEnterSocket): builder.PrependInt32Slot(11, particleEnterSocket, 0)
...
def LogicEffectCommonVisualExcelAddParticleEnterPath(builder, particleEnterPath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(particleEnterPath), 0)
