...
def StickerPageContentExcelAddStickerGetConditionCount(builder, stickerGetConditionCount): builder.PrependInt64Slot(3, stickerGetConditionCount, 0)
...
def StickerPageContentExcelAddStickerGetConditionParameter(builder, stickerGetConditionParameter): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(stickerGetConditionParameter), 0)
...
def StickerPageContentExcelAddStickerGetConditionType(builder, stickerGetConditionType): builder.PrependInt32Slot(5, stickerGetConditionType, 0)
...
def StickerPageContentExcelAddStickerGroupId(builder, stickerGroupId): builder.PrependInt64Slot(6, stickerGroupId, 0)
def AddStickerGroupId(builder, stickerGroupId):
    return StickerPageContentExcelAddStickerGroupId(builder, stickerGroupId)
def StickerPageContentExcelAddStickerGetConditionParameterTag(builder, stickerGetConditionParameterTag): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(stickerGetConditionParameterTag), 0)
...
def StickerPageContentExcelAddPackedStickerIconLocalizeEtcId(builder, packedStickerIconLocalizeEtcId): builder.PrependUint32Slot(8, packedStickerIconLocalizeEtcId, 0)
...
def StickerPageContentExcelAddId(builder, id): builder.PrependInt64Slot(9, id, 0)
def AddId(builder, id):
    return StickerPageContentExcelAddId(builder, id)
def StickerPageContentExcelAddPackedStickerIconPath(builder, packedStickerIconPath): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(packedStickerIconPath), 0)
...
def StickerPageContentExcelAddStickerSlot(builder, stickerSlot): builder.PrependInt64Slot(11, stickerSlot, 0)
def AddStickerSlot(builder, stickerSlot):
    return StickerPageContentExcelAddStickerSlot(builder, stickerSlot)
def StickerPageContentExcelAddGetStickerConditionType(builder, getStickerConditionType): builder.PrependInt32Slot(12, getStickerConditionType, 0)
...
def StickerPageContentExcelAddStickerCheckPassType(builder, stickerCheckPassType): builder.PrependInt32Slot(13, stickerCheckPassType, 0)
