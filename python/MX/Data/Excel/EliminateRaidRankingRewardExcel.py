...
def EliminateRaidRankingRewardExcelAddPercentRankEnd(builder, percentRankEnd): builder.PrependInt64Slot(0, percentRankEnd, 0)
...
def EliminateRaidRankingRewardExcelAddRankStartAsia(builder, rankStartAsia): builder.PrependInt64Slot(1, rankStartAsia, 0)
def AddRankStartAsia(builder, rankStartAsia):
    return EliminateRaidRankingRewardExcelAddRankStartAsia(builder, rankStartAsia)
def EliminateRaidRankingRewardExcelAddTier(builder, tier): builder.PrependInt32Slot(2, tier, 0)
def AddTier(builder, tier):
    return EliminateRaidRankingRewardExcelAddTier(builder, tier)
def EliminateRaidRankingRewardExcelAddRankStartNa(builder, rankStartNa): builder.PrependInt64Slot(3, rankStartNa, 0)
def AddRankStartNa(builder, rankStartNa):
    return EliminateRaidRankingRewardExcelAddRankStartNa(builder, rankStartNa)
def EliminateRaidRankingRewardExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return EliminateRaidRankingRewardExcelAddId(builder, id)
def EliminateRaidRankingRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def EliminateRaidRankingRewardExcelAddRankingRewardGroupId(builder, rankingRewardGroupId): builder.PrependInt64Slot(7, rankingRewardGroupId, 0)
...
def EliminateRaidRankingRewardExcelAddPercentRankStart(builder, percentRankStart): builder.PrependInt64Slot(8, percentRankStart, 0)
...
def EliminateRaidRankingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EliminateRaidRankingRewardExcelAddRankEndTw(builder, rankEndTw): builder.PrependInt64Slot(11, rankEndTw, 0)
def AddRankEndTw(builder, rankEndTw):
    return EliminateRaidRankingRewardExcelAddRankEndTw(builder, rankEndTw)
def EliminateRaidRankingRewardExcelAddRankStartTw(builder, rankStartTw): builder.PrependInt64Slot(12, rankStartTw, 0)
def AddRankStartTw(builder, rankStartTw):
    return EliminateRaidRankingRewardExcelAddRankStartTw(builder, rankStartTw)
def EliminateRaidRankingRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(13, rankStart, 0)
def AddRankStart(builder, rankStart):
    return EliminateRaidRankingRewardExcelAddRankStart(builder, rankStart)
def EliminateRaidRankingRewardExcelAddRewardParcelUniqueName(builder, rewardParcelUniqueName): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueName), 0)
...
def EliminateRaidRankingRewardExcelAddRankEndGlobal(builder, rankEndGlobal): builder.PrependInt64Slot(15, rankEndGlobal, 0)
def AddRankEndGlobal(builder, rankEndGlobal):
    return EliminateRaidRankingRewardExcelAddRankEndGlobal(builder, rankEndGlobal)
def EliminateRaidRankingRewardExcelAddRankEndAsia(builder, rankEndAsia): builder.PrependInt64Slot(16, rankEndAsia, 0)
def AddRankEndAsia(builder, rankEndAsia):
    return EliminateRaidRankingRewardExcelAddRankEndAsia(builder, rankEndAsia)
def EliminateRaidRankingRewardExcelAddRankEndNa(builder, rankEndNa): builder.PrependInt64Slot(17, rankEndNa, 0)
def AddRankEndNa(builder, rankEndNa):
    return EliminateRaidRankingRewardExcelAddRankEndNa(builder, rankEndNa)
def EliminateRaidRankingRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(18, rankEnd, 0)
