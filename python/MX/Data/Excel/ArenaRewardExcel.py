...
def ArenaRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(0, rankStart, 0)
...
def ArenaRewardExcelAddRewardParcelUniqueName(builder, rewardParcelUniqueName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueName), 0)
...
def ArenaRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def ArenaRewardExcelAddArenaRewardType(builder, arenaRewardType): builder.PrependInt32Slot(5, arenaRewardType, 0)
def AddArenaRewardType(builder, arenaRewardType):
    return ArenaRewardExcelAddArenaRewardType(builder, arenaRewardType)
def ArenaRewardExcelAddRankIconPath(builder, rankIconPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(rankIconPath), 0)
