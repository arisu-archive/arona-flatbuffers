...
def ScenarioBGName_GlobalExcelAddNameTeen(builder, nameTeen): builder.PrependUint32Slot(0, nameTeen, 0)
...
def ScenarioBGName_GlobalExcelAddNameNa(builder, nameNa): builder.PrependUint32Slot(3, nameNa, 0)
def AddNameNa(builder, nameNa):
    return ScenarioBGName_GlobalExcelAddNameNa(builder, nameNa)
def ScenarioBGName_GlobalExcelAddNameTw(builder, nameTw): builder.PrependUint32Slot(4, nameTw, 0)
def AddNameTw(builder, nameTw):
    return ScenarioBGName_GlobalExcelAddNameTw(builder, nameTw)
def ScenarioBGName_GlobalExcelAddNameAsia(builder, nameAsia): builder.PrependUint32Slot(5, nameAsia, 0)
