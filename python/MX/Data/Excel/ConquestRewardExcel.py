...
def ConquestRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(1, rewardParcelType, 0)
...
def ConquestRewardExcelAddRewardTag(builder, rewardTag): builder.PrependInt32Slot(3, rewardTag, 0)
def AddRewardTag(builder, rewardTag):
    return ConquestRewardExcelAddRewardTag(builder, rewardTag)
def ConquestRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependInt32Slot(4, rewardAmount, 0)
