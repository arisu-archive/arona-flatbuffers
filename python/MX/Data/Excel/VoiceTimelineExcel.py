...
def VoiceTimelineExcelAddSoundVolume(builder, soundVolume): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(soundVolume), 0)
...
def VoiceTimelineExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(3, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return VoiceTimelineExcelAddUniqueId(builder, uniqueId)
def VoiceTimelineExcelAddPath(builder, path): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
