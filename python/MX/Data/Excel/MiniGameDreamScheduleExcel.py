...
def MiniGameDreamScheduleExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
...
def MiniGameDreamScheduleExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameDreamScheduleExcelAddEventContentId(builder, eventContentId)
def MiniGameDreamScheduleExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(3, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MiniGameDreamScheduleExcelAddDisplayOrder(builder, displayOrder)
def MiniGameDreamScheduleExcelAddLoadingResource01(builder, loadingResource01): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(loadingResource01), 0)
...
def MiniGameDreamScheduleExcelAddLoadingResource02(builder, loadingResource02): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(loadingResource02), 0)
