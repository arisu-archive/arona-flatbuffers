...
def MinigameDreamVoiceExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(0, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameDreamVoiceExcelAddUniqueId(builder, uniqueId)
def MinigameDreamVoiceExcelAddVoiceClip(builder, voiceClip): builder.PrependUint32Slot(1, voiceClip, 0)
