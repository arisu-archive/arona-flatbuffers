...
def TimeAttackDungeonSeasonManageExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return TimeAttackDungeonSeasonManageExcelAddEndDate(builder, endDate)
def TimeAttackDungeonSeasonManageExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
...
def TimeAttackDungeonSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def TimeAttackDungeonSeasonManageExcelAddUiSlot(builder, uiSlot): builder.PrependInt64Slot(5, uiSlot, 0)
...
def TimeAttackDungeonSeasonManageExcelAddDifficultyGeas(builder, difficultyGeas): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(difficultyGeas), 0)
...
def TimeAttackDungeonSeasonManageExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
