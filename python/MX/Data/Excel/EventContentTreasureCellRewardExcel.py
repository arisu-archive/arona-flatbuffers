...
def EventContentTreasureCellRewardExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
...
def EventContentTreasureCellRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
