...
def MinigameCCGEnemyExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(0, groupId, 0)
...
def MinigameCCGEnemyExcelAddOrder(builder, order): builder.PrependInt32Slot(2, order, 0)
def AddOrder(builder, order):
    return MinigameCCGEnemyExcelAddOrder(builder, order)
def MinigameCCGEnemyExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(3, characterId, 0)
