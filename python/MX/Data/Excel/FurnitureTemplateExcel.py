...
def FurnitureTemplateExcelAddImagePath(builder, imagePath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(imagePath), 0)
...
def FurnitureTemplateExcelAddFunitureTemplateTitle(builder, funitureTemplateTitle): builder.PrependUint32Slot(3, funitureTemplateTitle, 0)
