...
def BattlePassFlavorTextExcelAddId(builder, id): builder.PrependInt64Slot(0, id, 0)
def AddId(builder, id):
    return BattlePassFlavorTextExcelAddId(builder, id)
def BattlePassFlavorTextExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(1, groupId, 0)
