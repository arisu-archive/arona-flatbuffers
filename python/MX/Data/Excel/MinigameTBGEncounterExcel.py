...
def MinigameTBGEncounterExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(0, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameTBGEncounterExcelAddUniqueId(builder, uniqueId)
def MinigameTBGEncounterExcelAddAttackDefenceLocalize(builder, attackDefenceLocalize): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(attackDefenceLocalize), 0)
...
def MinigameTBGEncounterExcelAddAllyAttackLocalize(builder, allyAttackLocalize): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(allyAttackLocalize), 0)
...
def MinigameTBGEncounterExcelAddEnemyNameLocalize(builder, enemyNameLocalize): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(enemyNameLocalize), 0)
...
def MinigameTBGEncounterExcelAddClearStoryLocalize(builder, clearStoryLocalize): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(clearStoryLocalize), 0)
...
def MinigameTBGEncounterExcelAddEnemyAttackLocalize(builder, enemyAttackLocalize): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(enemyAttackLocalize), 0)
...
def MinigameTBGEncounterExcelAddObjectType(builder, objectType): builder.PrependInt32Slot(6, objectType, 0)
def AddObjectType(builder, objectType):
    return MinigameTBGEncounterExcelAddObjectType(builder, objectType)
def MinigameTBGEncounterExcelAddRewardHide(builder, rewardHide): builder.PrependBoolSlot(7, rewardHide, 0)
def AddRewardHide(builder, rewardHide):
    return MinigameTBGEncounterExcelAddRewardHide(builder, rewardHide)
def MinigameTBGEncounterExcelAddBeforeStoryLocalize(builder, beforeStoryLocalize): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(beforeStoryLocalize), 0)
...
def MinigameTBGEncounterExcelAddBeforeStoryOption3Localize(builder, beforeStoryOption3Localize): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(beforeStoryOption3Localize), 0)
...
def MinigameTBGEncounterExcelAddThemaType(builder, themaType): builder.PrependInt32Slot(10, themaType, 0)
...
def MinigameTBGEncounterExcelAddEncounterTitleLocalize(builder, encounterTitleLocalize): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(encounterTitleLocalize), 0)
...
def MinigameTBGEncounterExcelAddBeforeStoryOption2Localize(builder, beforeStoryOption2Localize): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(beforeStoryOption2Localize), 0)
...
def MinigameTBGEncounterExcelAddOptionGroupId(builder, optionGroupId): builder.PrependInt64Slot(14, optionGroupId, 0)
def AddOptionGroupId(builder, optionGroupId):
    return MinigameTBGEncounterExcelAddOptionGroupId(builder, optionGroupId)
def MinigameTBGEncounterExcelAddStoryImagePath(builder, storyImagePath): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(storyImagePath), 0)
def AddStoryImagePath(builder, storyImagePath):
    return MinigameTBGEncounterExcelAddStoryImagePath(builder, storyImagePath)
def MinigameTBGEncounterExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(16, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameTBGEncounterExcelAddEventContentId(builder, eventContentId)
def MinigameTBGEncounterExcelAddThemaIndex(builder, themaIndex): builder.PrependInt32Slot(17, themaIndex, 0)
def AddThemaIndex(builder, themaIndex):
    return MinigameTBGEncounterExcelAddThemaIndex(builder, themaIndex)
def MinigameTBGEncounterExcelAddBeforeStoryOption1Localize(builder, beforeStoryOption1Localize): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(beforeStoryOption1Localize), 0)
...
def MinigameTBGEncounterExcelAddDefeatStoryLocalize(builder, defeatStoryLocalize): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(defeatStoryLocalize), 0)
...
def MinigameTBGEncounterExcelAddEnemyPrefabName(builder, enemyPrefabName): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPrefabName), 0)
def AddEnemyPrefabName(builder, enemyPrefabName):
    return MinigameTBGEncounterExcelAddEnemyPrefabName(builder, enemyPrefabName)
def MinigameTBGEncounterExcelAddRunawayStoryLocalize(builder, runawayStoryLocalize): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(runawayStoryLocalize), 0)
...
def MinigameTBGEncounterExcelAddAllThema(builder, allThema): builder.PrependBoolSlot(22, allThema, 0)
