...
def WorldRaidSeasonManageExcelAddEnterTicket(builder, enterTicket): builder.PrependInt32Slot(1, enterTicket, 0)
def AddEnterTicket(builder, enterTicket):
    return WorldRaidSeasonManageExcelAddEnterTicket(builder, enterTicket)
def WorldRaidSeasonManageExcelAddBossSpawnTime(builder, bossSpawnTime): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(bossSpawnTime), 0)
...
def WorldRaidSeasonManageExcelAddCanWorldRaidGemEnter(builder, canWorldRaidGemEnter): builder.PrependBoolSlot(3, canWorldRaidGemEnter, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBannerShow(builder, worldRaidLobbyBannerShow): builder.PrependBoolSlot(4, worldRaidLobbyBannerShow, 0)
...
def WorldRaidSeasonManageExcelAddEliminateTime(builder, eliminateTime): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(eliminateTime), 0)
...
def WorldRaidSeasonManageExcelAddUseFavorRankBuff(builder, useFavorRankBuff): builder.PrependBoolSlot(6, useFavorRankBuff, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBanner(builder, worldRaidLobbyBanner): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyBanner), 0)
...
def WorldRaidSeasonManageExcelAddSeasonOpenCondition(builder, seasonOpenCondition): builder.PrependInt64Slot(8, seasonOpenCondition, 0)
...
def WorldRaidSeasonManageExcelAddScenarioOutputConditionId(builder, scenarioOutputConditionId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(scenarioOutputConditionId), 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBg(builder, worldRaidLobbyBg): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyBg), 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyScene(builder, worldRaidLobbyScene): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyScene), 0)
...
def WorldRaidSeasonManageExcelAddConditionScenarioGroupid(builder, conditionScenarioGroupid): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(conditionScenarioGroupid), 0)
...
def WorldRaidSeasonManageExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(14, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return WorldRaidSeasonManageExcelAddEventContentId(builder, eventContentId)
def WorldRaidSeasonManageExcelAddWorldRaidMapEnterOperator(builder, worldRaidMapEnterOperator): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidMapEnterOperator), 0)
...
def WorldRaidSeasonManageExcelAddHideWorldRaidBossCompleteRewardUi(builder, hideWorldRaidBossCompleteRewardUi): builder.PrependBoolSlot(16, hideWorldRaidBossCompleteRewardUi, 0)
...
def WorldRaidSeasonManageExcelAddUseWorldRaidCommonToast(builder, useWorldRaidCommonToast): builder.PrependBoolSlot(17, useWorldRaidCommonToast, 0)
...
def WorldRaidSeasonManageExcelAddCanPlayNotSeasonTime(builder, canPlayNotSeasonTime): builder.PrependBoolSlot(18, canPlayNotSeasonTime, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyEnterScenario(builder, worldRaidLobbyEnterScenario): builder.PrependInt64Slot(19, worldRaidLobbyEnterScenario, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidUniqueThemeLobbyUi(builder, worldRaidUniqueThemeLobbyUi): builder.PrependBoolSlot(20, worldRaidUniqueThemeLobbyUi, 0)
...
def WorldRaidSeasonManageExcelAddOpenRaidBossGroupId(builder, openRaidBossGroupId): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroupId), 0)
...
def WorldRaidSeasonManageExcelAddHideWorldRaidTicketUi(builder, hideWorldRaidTicketUi): builder.PrependBoolSlot(22, hideWorldRaidTicketUi, 0)
