...
def MiniGameRhythmBgmExcelAddHasLyricist(builder, hasLyricist): builder.PrependBoolSlot(0, hasLyricist, 0)
...
def MiniGameRhythmBgmExcelAddRhythmBgmId(builder, rhythmBgmId): builder.PrependInt64Slot(2, rhythmBgmId, 0)
...
def MiniGameRhythmBgmExcelAddBgmLength(builder, bgmLength): builder.PrependInt32Slot(6, bgmLength, 0)
def AddBgmLength(builder, bgmLength):
    return MiniGameRhythmBgmExcelAddBgmLength(builder, bgmLength)
def MiniGameRhythmBgmExcelAddBgmArtistText(builder, bgmArtistText): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(bgmArtistText), 0)
def AddBgmArtistText(builder, bgmArtistText):
    return MiniGameRhythmBgmExcelAddBgmArtistText(builder, bgmArtistText)
def MiniGameRhythmBgmExcelAddStageSelectImagePath(builder, stageSelectImagePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(stageSelectImagePath), 0)
...
def MiniGameRhythmBgmExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(9, eventContentId, 0)
