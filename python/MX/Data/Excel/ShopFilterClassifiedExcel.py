...
def ShopFilterClassifiedExcelAddShopFilterType(builder, shopFilterType): builder.PrependInt32Slot(0, shopFilterType, 0)
def AddShopFilterType(builder, shopFilterType):
    return ShopFilterClassifiedExcelAddShopFilterType(builder, shopFilterType)
def ShopFilterClassifiedExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return ShopFilterClassifiedExcelAddId(builder, id)
def ShopFilterClassifiedExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(2, categoryType, 0)
...
def ShopFilterClassifiedExcelAddConsumeParcelId(builder, consumeParcelId): builder.PrependInt64Slot(4, consumeParcelId, 0)
def AddConsumeParcelId(builder, consumeParcelId):
    return ShopFilterClassifiedExcelAddConsumeParcelId(builder, consumeParcelId)
def ShopFilterClassifiedExcelAddConsumeParcelType(builder, consumeParcelType): builder.PrependInt32Slot(5, consumeParcelType, 0)
