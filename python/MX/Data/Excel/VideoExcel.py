...
def VideoExcelAddVideoTeenPath(builder, videoTeenPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(videoTeenPath), 0)
...
def VideoExcelAddNation(builder, nation): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(nation), 0)
...
def VideoExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
