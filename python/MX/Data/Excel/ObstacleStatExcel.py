...
def ObstacleStatExcelAddCanNotStandRange(builder, canNotStandRange): builder.PrependInt64Slot(0, canNotStandRange, 0)
def AddCanNotStandRange(builder, canNotStandRange):
    return ObstacleStatExcelAddCanNotStandRange(builder, canNotStandRange)
def ObstacleStatExcelAddEnhanceLightArmorRate(builder, enhanceLightArmorRate): builder.PrependInt64Slot(1, enhanceLightArmorRate, 0)
...
def ObstacleStatExcelAddEnhanceUnarmedRate(builder, enhanceUnarmedRate): builder.PrependInt64Slot(2, enhanceUnarmedRate, 0)
...
def ObstacleStatExcelAddStringId(builder, stringId): builder.PrependUint32Slot(4, stringId, 0)
def AddStringId(builder, stringId):
    return ObstacleStatExcelAddStringId(builder, stringId)
def ObstacleStatExcelAddBlockRate(builder, blockRate): builder.PrependInt64Slot(5, blockRate, 0)
def AddBlockRate(builder, blockRate):
    return ObstacleStatExcelAddBlockRate(builder, blockRate)
def ObstacleStatExcelAddReduceExDamagedRate(builder, reduceExDamagedRate): builder.PrependInt64Slot(6, reduceExDamagedRate, 0)
...
def ObstacleStatExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return ObstacleStatExcelAddName(builder, name)
def ObstacleStatExcelAddDodge(builder, dodge): builder.PrependInt64Slot(8, dodge, 0)
...
def ObstacleStatExcelAddEnhanceHeavyArmorRate(builder, enhanceHeavyArmorRate): builder.PrependInt64Slot(10, enhanceHeavyArmorRate, 0)
...
def ObstacleStatExcelAddEnhanceStructureRate(builder, enhanceStructureRate): builder.PrependInt64Slot(11, enhanceStructureRate, 0)
...
def ObstacleStatExcelAddMaxHp100(builder, maxHp100): builder.PrependInt64Slot(12, maxHp100, 0)
def AddMaxHp100(builder, maxHp100):
    return ObstacleStatExcelAddMaxHp100(builder, maxHp100)
def ObstacleStatExcelAddMaxHp1(builder, maxHp1): builder.PrependInt64Slot(13, maxHp1, 0)
def AddMaxHp1(builder, maxHp1):
    return ObstacleStatExcelAddMaxHp1(builder, maxHp1)
def ObstacleStatExcelAddEnhanceNormalArmorRate(builder, enhanceNormalArmorRate): builder.PrependInt64Slot(14, enhanceNormalArmorRate, 0)
