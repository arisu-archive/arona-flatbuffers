...
def LoadingImageExcelAddImagePathTh(builder, imagePathTh): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(imagePathTh), 0)
def AddImagePathTh(builder, imagePathTh):
    return LoadingImageExcelAddImagePathTh(builder, imagePathTh)
def LoadingImageExcelAddImagePathTw(builder, imagePathTw): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(imagePathTw), 0)
def AddImagePathTw(builder, imagePathTw):
    return LoadingImageExcelAddImagePathTw(builder, imagePathTw)
def LoadingImageExcelAddDisplayWeight(builder, displayWeight): builder.PrependInt32Slot(4, displayWeight, 0)
def AddDisplayWeight(builder, displayWeight):
    return LoadingImageExcelAddDisplayWeight(builder, displayWeight)
def LoadingImageExcelAddImagePathEn(builder, imagePathEn): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(imagePathEn), 0)
def AddImagePathEn(builder, imagePathEn):
    return LoadingImageExcelAddImagePathEn(builder, imagePathEn)
def LoadingImageExcelAddImagePathJp(builder, imagePathJp): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(imagePathJp), 0)
