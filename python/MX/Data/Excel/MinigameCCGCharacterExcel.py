...
def MinigameCCGCharacterExcelAddImagePath(builder, imagePath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(imagePath), 0)
def AddImagePath(builder, imagePath):
    return MinigameCCGCharacterExcelAddImagePath(builder, imagePath)
def MinigameCCGCharacterExcelAddPassiveSkillId(builder, passiveSkillId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(passiveSkillId), 0)
...
def MinigameCCGCharacterExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def MinigameCCGCharacterExcelAddUiImagePath(builder, uiImagePath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(uiImagePath), 0)
def AddUiImagePath(builder, uiImagePath):
    return MinigameCCGCharacterExcelAddUiImagePath(builder, uiImagePath)
def MinigameCCGCharacterExcelAddActiveSkillCost(builder, activeSkillCost): builder.PrependInt32Slot(6, activeSkillCost, 0)
...
def MinigameCCGCharacterExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
...
def MinigameCCGCharacterExcelAddMaxHealth(builder, maxHealth): builder.PrependInt32Slot(10, maxHealth, 0)
...
def MinigameCCGCharacterExcelAddName(builder, name): builder.PrependUint32Slot(12, name, 0)
