...
def MiniGameDreamEndingRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def MiniGameDreamEndingRewardExcelAddDreamMakerEndingType(builder, dreamMakerEndingType): builder.PrependInt32Slot(2, dreamMakerEndingType, 0)
...
def MiniGameDreamEndingRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def MiniGameDreamEndingRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
...
def MiniGameDreamEndingRewardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(7, localizeEtcId, 0)
