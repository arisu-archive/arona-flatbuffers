...
def FurnitureTemplateElementExcelAddPositionY(builder, positionY): builder.PrependFloat32Slot(1, positionY, 0.0)
def AddPositionY(builder, positionY):
    return FurnitureTemplateElementExcelAddPositionY(builder, positionY)
def FurnitureTemplateElementExcelAddRotation(builder, rotation): builder.PrependFloat32Slot(2, rotation, 0.0)
def AddRotation(builder, rotation):
    return FurnitureTemplateElementExcelAddRotation(builder, rotation)
def FurnitureTemplateElementExcelAddLocation(builder, location): builder.PrependInt32Slot(3, location, 0)
def AddLocation(builder, location):
    return FurnitureTemplateElementExcelAddLocation(builder, location)
def FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId): builder.PrependInt64Slot(4, furnitureId, 0)
def AddFurnitureId(builder, furnitureId):
    return FurnitureTemplateElementExcelAddFurnitureId(builder, furnitureId)
def FurnitureTemplateElementExcelAddPositionX(builder, positionX): builder.PrependFloat32Slot(5, positionX, 0.0)
