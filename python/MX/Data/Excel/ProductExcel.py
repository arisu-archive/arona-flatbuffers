...
def ProductExcelAddPriceReference(builder, priceReference): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(priceReference), 0)
def AddPriceReference(builder, priceReference):
    return ProductExcelAddPriceReference(builder, priceReference)
def ProductExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return ProductExcelAddId(builder, id)
def ProductExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductExcelAddTeenProductId(builder, teenProductId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(teenProductId), 0)
...
def ProductExcelAddPrice(builder, price): builder.PrependInt64Slot(9, price, 0)
def AddPrice(builder, price):
    return ProductExcelAddPrice(builder, price)
def ProductExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
