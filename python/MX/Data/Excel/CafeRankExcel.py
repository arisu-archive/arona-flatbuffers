...
def CafeRankExcelAddComfortMax(builder, comfortMax): builder.PrependInt64Slot(0, comfortMax, 0)
def AddComfortMax(builder, comfortMax):
    return CafeRankExcelAddComfortMax(builder, comfortMax)
def CafeRankExcelAddRecipeId(builder, recipeId): builder.PrependInt64Slot(1, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return CafeRankExcelAddRecipeId(builder, recipeId)
def CafeRankExcelAddCharacterVisitMin(builder, characterVisitMin): builder.PrependInt32Slot(2, characterVisitMin, 0)
def AddCharacterVisitMin(builder, characterVisitMin):
    return CafeRankExcelAddCharacterVisitMin(builder, characterVisitMin)
def CafeRankExcelAddTagCountMax(builder, tagCountMax): builder.PrependInt64Slot(3, tagCountMax, 0)
def AddTagCountMax(builder, tagCountMax):
    return CafeRankExcelAddTagCountMax(builder, tagCountMax)
def CafeRankExcelAddRank(builder, rank): builder.PrependInt64Slot(4, rank, 0)
def AddRank(builder, rank):
    return CafeRankExcelAddRank(builder, rank)
def CafeRankExcelAddCafeId(builder, cafeId): builder.PrependInt64Slot(5, cafeId, 0)
...
def CafeRankExcelAddCafeVisitWeightTagBonusStep(builder, cafeVisitWeightTagBonusStep): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(cafeVisitWeightTagBonusStep), 0)
...
def CafeRankExcelAddCafeVisitWeightBase(builder, cafeVisitWeightBase): builder.PrependInt32Slot(8, cafeVisitWeightBase, 0)
