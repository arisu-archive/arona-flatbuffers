...
def RecipeExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
def AddId(builder, id):
    return RecipeExcelAddId(builder, id)
def RecipeExcelAddRecipeIngredientId(builder, recipeIngredientId): builder.PrependInt64Slot(4, recipeIngredientId, 0)
def AddRecipeIngredientId(builder, recipeIngredientId):
    return RecipeExcelAddRecipeIngredientId(builder, recipeIngredientId)
def RecipeExcelAddRecipeSelectionGroupId(builder, recipeSelectionGroupId): builder.PrependInt64Slot(5, recipeSelectionGroupId, 0)
...
def RecipeExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def RecipeExcelAddRecipeType(builder, recipeType): builder.PrependInt32Slot(7, recipeType, 0)
