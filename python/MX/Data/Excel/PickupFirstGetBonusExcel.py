...
def PickupFirstGetBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(1, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return PickupFirstGetBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def PickupFirstGetBonusExcelAddRecruitSellectionShopId(builder, recruitSellectionShopId): builder.PrependInt64Slot(2, recruitSellectionShopId, 0)
