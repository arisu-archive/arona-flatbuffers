...
def CafeProductionExcelAddParcelProductionCoefficient(builder, parcelProductionCoefficient): builder.PrependInt64Slot(0, parcelProductionCoefficient, 0)
...
def CafeProductionExcelAddCafeProductionParcelType(builder, cafeProductionParcelType): builder.PrependInt32Slot(1, cafeProductionParcelType, 0)
...
def CafeProductionExcelAddParcelStorageMax(builder, parcelStorageMax): builder.PrependInt64Slot(2, parcelStorageMax, 0)
def AddParcelStorageMax(builder, parcelStorageMax):
    return CafeProductionExcelAddParcelStorageMax(builder, parcelStorageMax)
def CafeProductionExcelAddParcelProductionCorrectionValue(builder, parcelProductionCorrectionValue): builder.PrependInt64Slot(3, parcelProductionCorrectionValue, 0)
...
def CafeProductionExcelAddCafeId(builder, cafeId): builder.PrependInt64Slot(4, cafeId, 0)
...
def CafeProductionExcelAddCafeProductionParcelId(builder, cafeProductionParcelId): builder.PrependInt64Slot(6, cafeProductionParcelId, 0)
