...
def FarmingDungeonLocationManageExcelAddOpenStartDateTime(builder, openStartDateTime): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(openStartDateTime), 0)
...
def FarmingDungeonLocationManageExcelAddContentType(builder, contentType): builder.PrependInt32Slot(2, contentType, 0)
def AddContentType(builder, contentType):
    return FarmingDungeonLocationManageExcelAddContentType(builder, contentType)
def FarmingDungeonLocationManageExcelAddOrder(builder, order): builder.PrependInt64Slot(3, order, 0)
def AddOrder(builder, order):
    return FarmingDungeonLocationManageExcelAddOrder(builder, order)
def FarmingDungeonLocationManageExcelAddOpenEndDateTime(builder, openEndDateTime): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(openEndDateTime), 0)
...
def FarmingDungeonLocationManageExcelAddLocalizeCodeInfo(builder, localizeCodeInfo): builder.PrependUint32Slot(5, localizeCodeInfo, 0)
...
def FarmingDungeonLocationManageExcelAddWeekDungeonType(builder, weekDungeonType): builder.PrependInt32Slot(6, weekDungeonType, 0)
...
def FarmingDungeonLocationManageExcelAddSchoolDungeonType(builder, schoolDungeonType): builder.PrependInt32Slot(7, schoolDungeonType, 0)
...
def FarmingDungeonLocationManageExcelAddLocationButtonImagePath(builder, locationButtonImagePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(locationButtonImagePath), 0)
