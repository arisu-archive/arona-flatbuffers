...
def FarmingDungeonLocationManageExcelAddSchoolDungeonType(builder, schoolDungeonType): builder.PrependInt32Slot(0, schoolDungeonType, 0)
...
def FarmingDungeonLocationManageExcelAddOpenStartDateTime(builder, openStartDateTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(openStartDateTime), 0)
...
def FarmingDungeonLocationManageExcelAddFarmingDungeonLocationId(builder, farmingDungeonLocationId): builder.PrependInt64Slot(6, farmingDungeonLocationId, 0)
...
def FarmingDungeonLocationManageExcelAddWeekDungeonType(builder, weekDungeonType): builder.PrependInt32Slot(8, weekDungeonType, 0)
...
def FarmingDungeonLocationManageExcelAddOrder(builder, order): builder.PrependInt64Slot(9, order, 0)
