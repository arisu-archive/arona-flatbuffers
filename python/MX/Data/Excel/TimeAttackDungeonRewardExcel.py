...
def TimeAttackDungeonRewardExcelAddRewardMinPoint(builder, rewardMinPoint): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardMinPoint), 0)
...
def TimeAttackDungeonRewardExcelAddRewardType(builder, rewardType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardType), 0)
...
def TimeAttackDungeonRewardExcelAddRewardParcelMaxAmount(builder, rewardParcelMaxAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelMaxAmount), 0)
...
def TimeAttackDungeonRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def TimeAttackDungeonRewardExcelAddRewardMaxPoint(builder, rewardMaxPoint): builder.PrependInt64Slot(4, rewardMaxPoint, 0)
def AddRewardMaxPoint(builder, rewardMaxPoint):
    return TimeAttackDungeonRewardExcelAddRewardMaxPoint(builder, rewardMaxPoint)
def TimeAttackDungeonRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def TimeAttackDungeonRewardExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return TimeAttackDungeonRewardExcelAddId(builder, id)
def TimeAttackDungeonRewardExcelAddRewardParcelDefaultAmount(builder, rewardParcelDefaultAmount): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelDefaultAmount), 0)
