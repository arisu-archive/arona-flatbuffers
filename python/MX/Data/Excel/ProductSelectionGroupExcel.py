...
def ProductSelectionGroupExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(0, displayOrder, 0)
...
def ProductSelectionGroupExcelAddParcelId(builder, parcelId): builder.PrependInt64Slot(2, parcelId, 0)
def AddParcelId(builder, parcelId):
    return ProductSelectionGroupExcelAddParcelId(builder, parcelId)
def ProductSelectionGroupExcelAddResultAmount(builder, resultAmount): builder.PrependInt64Slot(3, resultAmount, 0)
def AddResultAmount(builder, resultAmount):
    return ProductSelectionGroupExcelAddResultAmount(builder, resultAmount)
def ProductSelectionGroupExcelAddConditionParcelId(builder, conditionParcelId): builder.PrependInt64Slot(4, conditionParcelId, 0)
...
def ProductSelectionGroupExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(5, parcelType, 0)
