...
def CombatEmojiExcelAddEmojiDuration(builder, emojiDuration): builder.PrependBoolSlot(1, emojiDuration, 0)
...
def CombatEmojiExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(5, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return CombatEmojiExcelAddUniqueId(builder, uniqueId)
def CombatEmojiExcelAddEmojiReversal(builder, emojiReversal): builder.PrependBoolSlot(6, emojiReversal, 0)
def AddEmojiReversal(builder, emojiReversal):
    return CombatEmojiExcelAddEmojiReversal(builder, emojiReversal)
def CombatEmojiExcelAddEmojiEvent(builder, emojiEvent): builder.PrependInt32Slot(7, emojiEvent, 0)
