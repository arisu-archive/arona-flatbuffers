...
def LocalizeSkillExcelAddDescriptionKr(builder, descriptionKr): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionKr), 0)
def AddDescriptionKr(builder, descriptionKr):
    return LocalizeSkillExcelAddDescriptionKr(builder, descriptionKr)
def LocalizeSkillExcelAddDescriptionTw(builder, descriptionTw): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionTw), 0)
def AddDescriptionTw(builder, descriptionTw):
    return LocalizeSkillExcelAddDescriptionTw(builder, descriptionTw)
def LocalizeSkillExcelAddSkillInvokeLocalizeTh(builder, skillInvokeLocalizeTh): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeTh), 0)
...
def LocalizeSkillExcelAddKey(builder, key): builder.PrependUint32Slot(3, key, 0)
def AddKey(builder, key):
    return LocalizeSkillExcelAddKey(builder, key)
def LocalizeSkillExcelAddDescriptionEn(builder, descriptionEn): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionEn), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeEn(builder, skillInvokeLocalizeEn): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeEn), 0)
...
def LocalizeSkillExcelAddNameJp(builder, nameJp): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(nameJp), 0)
def AddNameJp(builder, nameJp):
    return LocalizeSkillExcelAddNameJp(builder, nameJp)
def LocalizeSkillExcelAddSkillInvokeLocalizeTw(builder, skillInvokeLocalizeTw): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeTw), 0)
...
def LocalizeSkillExcelAddNameTh(builder, nameTh): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(nameTh), 0)
...
def LocalizeSkillExcelAddDescriptionJp(builder, descriptionJp): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionJp), 0)
def AddDescriptionJp(builder, descriptionJp):
    return LocalizeSkillExcelAddDescriptionJp(builder, descriptionJp)
def LocalizeSkillExcelAddNameTw(builder, nameTw): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(nameTw), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeKr(builder, skillInvokeLocalizeKr): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeKr), 0)
...
def LocalizeSkillExcelAddDescriptionTh(builder, descriptionTh): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionTh), 0)
