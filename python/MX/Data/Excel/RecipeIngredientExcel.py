...
def RecipeIngredientExcelAddIngredientId(builder, ingredientId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientId), 0)
...
def RecipeIngredientExcelAddCostAmount(builder, costAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(costAmount), 0)
...
def RecipeIngredientExcelAddCostParcelType(builder, costParcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelType), 0)
...
def RecipeIngredientExcelAddIngredientAmount(builder, ingredientAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientAmount), 0)
...
def RecipeIngredientExcelAddRecipeType(builder, recipeType): builder.PrependInt32Slot(5, recipeType, 0)
def AddRecipeType(builder, recipeType):
    return RecipeIngredientExcelAddRecipeType(builder, recipeType)
def RecipeIngredientExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return RecipeIngredientExcelAddId(builder, id)
def RecipeIngredientExcelAddCostTimeInSecond(builder, costTimeInSecond): builder.PrependInt64Slot(7, costTimeInSecond, 0)
def AddCostTimeInSecond(builder, costTimeInSecond):
    return RecipeIngredientExcelAddCostTimeInSecond(builder, costTimeInSecond)
def RecipeIngredientExcelAddIngredientParcelType(builder, ingredientParcelType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientParcelType), 0)
