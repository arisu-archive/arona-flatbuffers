...
def GachaCraftNodeGroupExcelAddProbWeight(builder, probWeight): builder.PrependInt64Slot(1, probWeight, 0)
def AddProbWeight(builder, probWeight):
    return GachaCraftNodeGroupExcelAddProbWeight(builder, probWeight)
def GachaCraftNodeGroupExcelAddGachaGroupId(builder, gachaGroupId): builder.PrependInt64Slot(2, gachaGroupId, 0)
