...
def OpenConditionExcelAddContentsOpenShow(builder, contentsOpenShow): builder.PrependBoolSlot(0, contentsOpenShow, 0)
def AddContentsOpenShow(builder, contentsOpenShow):
    return OpenConditionExcelAddContentsOpenShow(builder, contentsOpenShow)
def OpenConditionExcelAddOpenedCafeId(builder, openedCafeId): builder.PrependInt64Slot(1, openedCafeId, 0)
def AddOpenedCafeId(builder, openedCafeId):
    return OpenConditionExcelAddOpenedCafeId(builder, openedCafeId)
def OpenConditionExcelAddCloseHour(builder, closeHour): builder.PrependInt64Slot(2, closeHour, 0)
def AddCloseHour(builder, closeHour):
    return OpenConditionExcelAddCloseHour(builder, closeHour)
def OpenConditionExcelAddShortcutPopupPriority(builder, shortcutPopupPriority): builder.PrependInt64Slot(3, shortcutPopupPriority, 0)
...
def OpenConditionExcelAddHideWhenLocked(builder, hideWhenLocked): builder.PrependBoolSlot(4, hideWhenLocked, 0)
def AddHideWhenLocked(builder, hideWhenLocked):
    return OpenConditionExcelAddHideWhenLocked(builder, hideWhenLocked)
def OpenConditionExcelAddLockUi(builder, lockUi): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(lockUi), 0)
...
def OpenConditionExcelAddOpenDayOfWeek(builder, openDayOfWeek): builder.PrependInt32Slot(7, openDayOfWeek, 0)
def AddOpenDayOfWeek(builder, openDayOfWeek):
    return OpenConditionExcelAddOpenDayOfWeek(builder, openDayOfWeek)
def OpenConditionExcelAddContentsOpenShortcutUi(builder, contentsOpenShortcutUi): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(contentsOpenShortcutUi), 0)
...
def OpenConditionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(9, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return OpenConditionExcelAddAccountLevel(builder, accountLevel)
def OpenConditionExcelAddCafeRank(builder, cafeRank): builder.PrependInt64Slot(10, cafeRank, 0)
def AddCafeRank(builder, cafeRank):
    return OpenConditionExcelAddCafeRank(builder, cafeRank)
def OpenConditionExcelAddShortcutParam(builder, shortcutParam): builder.PrependInt32Slot(11, shortcutParam, 0)
def AddShortcutParam(builder, shortcutParam):
    return OpenConditionExcelAddShortcutParam(builder, shortcutParam)
def OpenConditionExcelAddScenarioModeId(builder, scenarioModeId): builder.PrependInt64Slot(12, scenarioModeId, 0)
def AddScenarioModeId(builder, scenarioModeId):
    return OpenConditionExcelAddScenarioModeId(builder, scenarioModeId)
def OpenConditionExcelAddCafeIdforCafeRank(builder, cafeIdforCafeRank): builder.PrependInt64Slot(13, cafeIdforCafeRank, 0)
...
def OpenConditionExcelAddMultipleConditionCheckType(builder, multipleConditionCheckType): builder.PrependInt32Slot(15, multipleConditionCheckType, 0)
...
def OpenConditionExcelAddShortcutUiName(builder, shortcutUiName): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUiName), 0)
...
def OpenConditionExcelAddOpenConditionContentType(builder, openConditionContentType): builder.PrependInt32Slot(18, openConditionContentType, 0)
...
def OpenConditionExcelAddCampaignStageId(builder, campaignStageId): builder.PrependInt64Slot(19, campaignStageId, 0)
