...
def MinigameRoadPuzzleRoadRoundExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(0, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameRoadPuzzleRoadRoundExcelAddUniqueId(builder, uniqueId)
def MinigameRoadPuzzleRoadRoundExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependInt64Slot(1, enterScenarioGroupId, 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddEndScenarioGroupId(builder, endScenarioGroupId): builder.PrependInt64Slot(3, endScenarioGroupId, 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddRoundReward(builder, roundReward): builder.PrependInt64Slot(5, roundReward, 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddIsLoop(builder, isLoop): builder.PrependBoolSlot(7, isLoop, 0)
def AddIsLoop(builder, isLoop):
    return MinigameRoadPuzzleRoadRoundExcelAddIsLoop(builder, isLoop)
def MinigameRoadPuzzleRoadRoundExcelAddMapGroupId(builder, mapGroupId): builder.PrependInt64Slot(8, mapGroupId, 0)
def AddMapGroupId(builder, mapGroupId):
    return MinigameRoadPuzzleRoadRoundExcelAddMapGroupId(builder, mapGroupId)
def MinigameRoadPuzzleRoadRoundExcelAddAdditionalRewardId(builder, additionalRewardId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(additionalRewardId), 0)
