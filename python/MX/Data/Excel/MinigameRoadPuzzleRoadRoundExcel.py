...
def MinigameRoadPuzzleRoadRoundExcelAddAdditionalRewardId(builder, additionalRewardId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(additionalRewardId), 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddEndScenarioGroupId(builder, endScenarioGroupId): builder.PrependInt64Slot(1, endScenarioGroupId, 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddAdditionalRewardAmount(builder, additionalRewardAmount): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(additionalRewardAmount), 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameRoadPuzzleRoadRoundExcelAddEventContentId(builder, eventContentId)
def MinigameRoadPuzzleRoadRoundExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(4, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameRoadPuzzleRoadRoundExcelAddUniqueId(builder, uniqueId)
def MinigameRoadPuzzleRoadRoundExcelAddMapGroupId(builder, mapGroupId): builder.PrependInt64Slot(5, mapGroupId, 0)
def AddMapGroupId(builder, mapGroupId):
    return MinigameRoadPuzzleRoadRoundExcelAddMapGroupId(builder, mapGroupId)
def MinigameRoadPuzzleRoadRoundExcelAddRound(builder, round): builder.PrependInt32Slot(6, round, 0)
def AddRound(builder, round):
    return MinigameRoadPuzzleRoadRoundExcelAddRound(builder, round)
def MinigameRoadPuzzleRoadRoundExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependInt64Slot(7, enterScenarioGroupId, 0)
...
def MinigameRoadPuzzleRoadRoundExcelAddIsLoop(builder, isLoop): builder.PrependBoolSlot(8, isLoop, 0)
def AddIsLoop(builder, isLoop):
    return MinigameRoadPuzzleRoadRoundExcelAddIsLoop(builder, isLoop)
def MinigameRoadPuzzleRoadRoundExcelAddRoundReward(builder, roundReward): builder.PrependInt64Slot(9, roundReward, 0)
