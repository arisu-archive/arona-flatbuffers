...
def CharacterPotentialRewardExcelAddRequirePotentialStatLevel(builder, requirePotentialStatLevel): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(requirePotentialStatLevel), 0)
...
def CharacterPotentialRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(1, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return CharacterPotentialRewardExcelAddRewardParcelType(builder, rewardParcelType)
def CharacterPotentialRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependInt32Slot(2, rewardAmount, 0)
def AddRewardAmount(builder, rewardAmount):
    return CharacterPotentialRewardExcelAddRewardAmount(builder, rewardAmount)
def CharacterPotentialRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(3, rewardId, 0)
def AddRewardId(builder, rewardId):
    return CharacterPotentialRewardExcelAddRewardId(builder, rewardId)
def CharacterPotentialRewardExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return CharacterPotentialRewardExcelAddId(builder, id)
def CharacterPotentialRewardExcelAddRequirePotentialStatType(builder, requirePotentialStatType): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(requirePotentialStatType), 0)
