...
def CharacterPotentialRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(0, rewardParcelType, 0)
...
def CharacterPotentialRewardExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
