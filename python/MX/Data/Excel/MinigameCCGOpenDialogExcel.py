...
def MinigameCCGOpenDialogExcelAddDuration(builder, duration): builder.PrependInt64Slot(0, duration, 0)
def AddDuration(builder, duration):
    return MinigameCCGOpenDialogExcelAddDuration(builder, duration)
def MinigameCCGOpenDialogExcelAddDialogId(builder, dialogId): builder.PrependInt64Slot(1, dialogId, 0)
