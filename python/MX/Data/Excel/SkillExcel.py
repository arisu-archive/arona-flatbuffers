...
def SkillExcelAddSkillDataKey(builder, skillDataKey): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(skillDataKey), 0)
def AddSkillDataKey(builder, skillDataKey):
    return SkillExcelAddSkillDataKey(builder, skillDataKey)
def SkillExcelAddSkillCost(builder, skillCost): builder.PrependInt32Slot(1, skillCost, 0)
...
def SkillExcelAddExtraEnemySkillCost(builder, extraEnemySkillCost): builder.PrependInt32Slot(3, extraEnemySkillCost, 0)
...
def SkillExcelAddAdditionalToolTipId(builder, additionalToolTipId): builder.PrependInt64Slot(4, additionalToolTipId, 0)
...
def SkillExcelAddLocalizeSkillId(builder, localizeSkillId): builder.PrependUint32Slot(5, localizeSkillId, 0)
def AddLocalizeSkillId(builder, localizeSkillId):
    return SkillExcelAddLocalizeSkillId(builder, localizeSkillId)
def SkillExcelAddRequireLevelUpMaterial(builder, requireLevelUpMaterial): builder.PrependInt64Slot(6, requireLevelUpMaterial, 0)
...
def SkillExcelAddRequireCharacterLevel(builder, requireCharacterLevel): builder.PrependInt32Slot(8, requireCharacterLevel, 0)
...
def SkillExcelAddBulletType(builder, bulletType): builder.PrependInt32Slot(9, bulletType, 0)
...
def SkillExcelAddPublicSpeechDuration(builder, publicSpeechDuration): builder.PrependInt32Slot(11, publicSpeechDuration, 0)
...
def SkillExcelAddEnemySkillCost(builder, enemySkillCost): builder.PrependInt32Slot(12, enemySkillCost, 0)
def AddEnemySkillCost(builder, enemySkillCost):
    return SkillExcelAddEnemySkillCost(builder, enemySkillCost)
def SkillExcelAddEnemyStartCoolTime(builder, enemyStartCoolTime): builder.PrependInt32Slot(13, enemyStartCoolTime, 0)
def AddEnemyStartCoolTime(builder, enemyStartCoolTime):
    return SkillExcelAddEnemyStartCoolTime(builder, enemyStartCoolTime)
def SkillExcelAddStartCoolTime(builder, startCoolTime): builder.PrependInt32Slot(14, startCoolTime, 0)
def AddStartCoolTime(builder, startCoolTime):
    return SkillExcelAddStartCoolTime(builder, startCoolTime)
def SkillExcelAddIsShowSpeechbubble(builder, isShowSpeechbubble): builder.PrependBoolSlot(15, isShowSpeechbubble, 0)
def AddIsShowSpeechbubble(builder, isShowSpeechbubble):
    return SkillExcelAddIsShowSpeechbubble(builder, isShowSpeechbubble)
def SkillExcelAddLevel(builder, level): builder.PrependInt32Slot(16, level, 0)
...
def SkillExcelAddEnemyCoolTime(builder, enemyCoolTime): builder.PrependInt32Slot(18, enemyCoolTime, 0)
def AddEnemyCoolTime(builder, enemyCoolTime):
    return SkillExcelAddEnemyCoolTime(builder, enemyCoolTime)
def SkillExcelAddNpcStartCoolTime(builder, npcStartCoolTime): builder.PrependInt32Slot(19, npcStartCoolTime, 0)
def AddNpcStartCoolTime(builder, npcStartCoolTime):
    return SkillExcelAddNpcStartCoolTime(builder, npcStartCoolTime)
def SkillExcelAddIsShowInfo(builder, isShowInfo): builder.PrependBoolSlot(20, isShowInfo, 0)
def AddIsShowInfo(builder, isShowInfo):
    return SkillExcelAddIsShowInfo(builder, isShowInfo)
def SkillExcelAddSelectExSkillToolTipId(builder, selectExSkillToolTipId): builder.PrependInt64Slot(21, selectExSkillToolTipId, 0)
...
def SkillExcelAddCoolTime(builder, coolTime): builder.PrependInt32Slot(22, coolTime, 0)
def AddCoolTime(builder, coolTime):
    return SkillExcelAddCoolTime(builder, coolTime)
def SkillExcelAddVisualDataKey(builder, visualDataKey): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(visualDataKey), 0)
def AddVisualDataKey(builder, visualDataKey):
    return SkillExcelAddVisualDataKey(builder, visualDataKey)
def SkillExcelAddTextureSkillCardForFormConversion(builder, textureSkillCardForFormConversion): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(textureSkillCardForFormConversion), 0)
...
def SkillExcelAddExtraSkillCost(builder, extraSkillCost): builder.PrependInt32Slot(25, extraSkillCost, 0)
def AddExtraSkillCost(builder, extraSkillCost):
    return SkillExcelAddExtraSkillCost(builder, extraSkillCost)
def SkillExcelAddNpcCoolTime(builder, npcCoolTime): builder.PrependInt32Slot(26, npcCoolTime, 0)
def AddNpcCoolTime(builder, npcCoolTime):
    return SkillExcelAddNpcCoolTime(builder, npcCoolTime)
def SkillExcelAddUseAtg(builder, useAtg): builder.PrependInt32Slot(27, useAtg, 0)
