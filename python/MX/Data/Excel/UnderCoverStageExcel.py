...
def UnderCoverStageExcelAddSkipCount(builder, skipCount): builder.PrependInt32Slot(0, skipCount, 0)
def AddSkipCount(builder, skipCount):
    return UnderCoverStageExcelAddSkipCount(builder, skipCount)
def UnderCoverStageExcelAddApplySkip(builder, applySkip): builder.PrependBoolSlot(1, applySkip, 0)
...
def UnderCoverStageExcelAddStageName(builder, stageName): builder.PrependUint32Slot(3, stageName, 0)
def AddStageName(builder, stageName):
    return UnderCoverStageExcelAddStageName(builder, stageName)
def UnderCoverStageExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(4, groupId, 0)
def AddGroupId(builder, groupId):
    return UnderCoverStageExcelAddGroupId(builder, groupId)
def UnderCoverStageExcelAddStageTips(builder, stageTips): builder.PrependUint32Slot(5, stageTips, 0)
