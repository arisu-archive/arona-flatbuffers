...
def GachaSelectPickupGroupExcelAddGachaGroupId(builder, gachaGroupId): builder.PrependInt64Slot(0, gachaGroupId, 0)
def AddGachaGroupId(builder, gachaGroupId):
    return GachaSelectPickupGroupExcelAddGachaGroupId(builder, gachaGroupId)
def GachaSelectPickupGroupExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(1, characterId, 0)
