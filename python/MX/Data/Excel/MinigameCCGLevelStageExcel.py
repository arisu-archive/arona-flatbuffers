...
def MinigameCCGLevelStageExcelAddCampDiscardCardCount(builder, campDiscardCardCount): builder.PrependInt32Slot(0, campDiscardCardCount, 0)
...
def MinigameCCGLevelStageExcelAddCampSprPath(builder, campSprPath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(campSprPath), 0)
def AddCampSprPath(builder, campSprPath):
    return MinigameCCGLevelStageExcelAddCampSprPath(builder, campSprPath)
def MinigameCCGLevelStageExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
...
def MinigameCCGLevelStageExcelAddIsSkipOutroScenario(builder, isSkipOutroScenario): builder.PrependBoolSlot(4, isSkipOutroScenario, 0)
...
def MinigameCCGLevelStageExcelAddEnemyGroupId(builder, enemyGroupId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(enemyGroupId), 0)
...
def MinigameCCGLevelStageExcelAddIntroScenarioGroupId(builder, introScenarioGroupId): builder.PrependInt64Slot(6, introScenarioGroupId, 0)
...
def MinigameCCGLevelStageExcelAddIsSkipIntroScenario(builder, isSkipIntroScenario): builder.PrependBoolSlot(7, isSkipIntroScenario, 0)
...
def MinigameCCGLevelStageExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(8, groupId, 0)
def AddGroupId(builder, groupId):
    return MinigameCCGLevelStageExcelAddGroupId(builder, groupId)
def MinigameCCGLevelStageExcelAddRewardCount(builder, rewardCount): builder.PrependInt32Slot(9, rewardCount, 0)
...
def MinigameCCGLevelStageExcelAddCampBackgroundPath(builder, campBackgroundPath): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(campBackgroundPath), 0)
...
def MinigameCCGLevelStageExcelAddRewardType(builder, rewardType): builder.PrependInt32Slot(12, rewardType, 0)
def AddRewardType(builder, rewardType):
    return MinigameCCGLevelStageExcelAddRewardType(builder, rewardType)
def MinigameCCGLevelStageExcelAddRewardCardGroupId(builder, rewardCardGroupId): builder.PrependInt64Slot(13, rewardCardGroupId, 0)
...
def MinigameCCGLevelStageExcelAddCardRarityGroupId(builder, cardRarityGroupId): builder.PrependInt64Slot(14, cardRarityGroupId, 0)
