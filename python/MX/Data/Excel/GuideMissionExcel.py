...
def GuideMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def GuideMissionExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(1, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return GuideMissionExcelAddIsLegacy(builder, isLegacy)
def GuideMissionExcelAddIsAutoClearForScenario(builder, isAutoClearForScenario): builder.PrependBoolSlot(2, isAutoClearForScenario, 0)
...
def GuideMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def GuideMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return GuideMissionExcelAddToastImagePath(builder, toastImagePath)
def GuideMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def GuideMissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def GuideMissionExcelAddTabNumber(builder, tabNumber): builder.PrependInt64Slot(8, tabNumber, 0)
def AddTabNumber(builder, tabNumber):
    return GuideMissionExcelAddTabNumber(builder, tabNumber)
def GuideMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(9, completeConditionCount, 0)
...
def GuideMissionExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(10, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return GuideMissionExcelAddSeasonId(builder, seasonId)
def GuideMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(11, category, 0)
...
def GuideMissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def GuideMissionExcelAddId(builder, id): builder.PrependInt64Slot(14, id, 0)
def AddId(builder, id):
    return GuideMissionExcelAddId(builder, id)
def GuideMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(15, description, 0)
