...
def MinigameTBGObjectExcelAddObjectCostAmount(builder, objectCostAmount): builder.PrependInt32Slot(0, objectCostAmount, 0)
...
def MinigameTBGObjectExcelAddObjectCostType(builder, objectCostType): builder.PrependInt32Slot(2, objectCostType, 0)
...
def MinigameTBGObjectExcelAddReEncounterCost(builder, reEncounterCost): builder.PrependBoolSlot(4, reEncounterCost, 0)
def AddReEncounterCost(builder, reEncounterCost):
    return MinigameTBGObjectExcelAddReEncounterCost(builder, reEncounterCost)
def MinigameTBGObjectExcelAddKey(builder, key): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(key), 0)
def AddKey(builder, key):
    return MinigameTBGObjectExcelAddKey(builder, key)
def MinigameTBGObjectExcelAddObjectCostId(builder, objectCostId): builder.PrependInt64Slot(6, objectCostId, 0)
def AddObjectCostId(builder, objectCostId):
    return MinigameTBGObjectExcelAddObjectCostId(builder, objectCostId)
def MinigameTBGObjectExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
