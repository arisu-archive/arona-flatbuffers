...
def ProductSelectExcelStart(builder): builder.StartObject(12)
def Start(builder):
    return ProductSelectExcelStart(builder)
def ProductSelectExcelAddPrice(builder, price): builder.PrependInt64Slot(0, price, 0)
def AddPrice(builder, price):
    return ProductSelectExcelAddPrice(builder, price)
def ProductSelectExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def ProductSelectExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductSelectExcelAddProductId(builder, productId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(productId), 0)
def AddProductId(builder, productId):
    return ProductSelectExcelAddProductId(builder, productId)
def ProductSelectExcelAddPurchasePeriodType(builder, purchasePeriodType): builder.PrependInt32Slot(4, purchasePeriodType, 0)
...
def ProductSelectExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductSelectExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return ProductSelectExcelAddId(builder, id)
def ProductSelectExcelAddStoreType(builder, storeType): builder.PrependInt32Slot(7, storeType, 0)
def AddStoreType(builder, storeType):
    return ProductSelectExcelAddStoreType(builder, storeType)
def ProductSelectExcelAddTeenProductId(builder, teenProductId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(teenProductId), 0)
def AddTeenProductId(builder, teenProductId):
    return ProductSelectExcelAddTeenProductId(builder, teenProductId)
def ProductSelectExcelAddPurchasePeriodLimit(builder, purchasePeriodLimit): builder.PrependInt64Slot(9, purchasePeriodLimit, 0)
...
def ProductSelectExcelAddPriceReference(builder, priceReference): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(priceReference), 0)
