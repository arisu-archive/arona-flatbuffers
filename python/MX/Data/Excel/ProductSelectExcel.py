...
def ProductSelectExcelAddTeenProductId(builder, teenProductId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(teenProductId), 0)
def AddTeenProductId(builder, teenProductId):
    return ProductSelectExcelAddTeenProductId(builder, teenProductId)
def ProductSelectExcelAddStoreType(builder, storeType): builder.PrependInt32Slot(3, storeType, 0)
...
def ProductSelectExcelAddPurchasePeriodType(builder, purchasePeriodType): builder.PrependInt32Slot(6, purchasePeriodType, 0)
...
def ProductSelectExcelAddPurchasePeriodLimit(builder, purchasePeriodLimit): builder.PrependInt64Slot(7, purchasePeriodLimit, 0)
...
def ProductSelectExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def ProductSelectExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def ProductSelectExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def ProductSelectExcelAddProductSelectionSlot(builder, productSelectionSlot): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(productSelectionSlot), 0)
