...
def ProductBattlePassExcelAddProductId(builder, productId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(productId), 0)
def AddProductId(builder, productId):
    return ProductBattlePassExcelAddProductId(builder, productId)
def ProductBattlePassExcelAddPrice(builder, price): builder.PrependInt64Slot(1, price, 0)
...
def ProductBattlePassExcelAddTeenProductId(builder, teenProductId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(teenProductId), 0)
...
def ProductBattlePassExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return ProductBattlePassExcelAddId(builder, id)
def ProductBattlePassExcelAddStoreType(builder, storeType): builder.PrependInt32Slot(7, storeType, 0)
...
def ProductBattlePassExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
