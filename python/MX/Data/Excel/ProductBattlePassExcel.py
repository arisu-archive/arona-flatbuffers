...
def ProductBattlePassExcelAddPrice(builder, price): builder.PrependInt64Slot(4, price, 0)
def AddPrice(builder, price):
    return ProductBattlePassExcelAddPrice(builder, price)
def ProductBattlePassExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(5, purchaseCountLimit, 0)
...
def ProductBattlePassExcelAddBattlePassProductGroupId(builder, battlePassProductGroupId): builder.PrependInt64Slot(6, battlePassProductGroupId, 0)
