...
def GachaElementExcelAddRarity(builder, rarity): builder.PrependInt32Slot(0, rarity, 0)
def AddRarity(builder, rarity):
    return GachaElementExcelAddRarity(builder, rarity)
def GachaElementExcelAddParcelAmountMax(builder, parcelAmountMax): builder.PrependInt32Slot(1, parcelAmountMax, 0)
def AddParcelAmountMax(builder, parcelAmountMax):
    return GachaElementExcelAddParcelAmountMax(builder, parcelAmountMax)
def GachaElementExcelAddProb(builder, prob): builder.PrependInt32Slot(2, prob, 0)
def AddProb(builder, prob):
    return GachaElementExcelAddProb(builder, prob)
def GachaElementExcelAddGachaGroupId(builder, gachaGroupId): builder.PrependInt64Slot(3, gachaGroupId, 0)
def AddGachaGroupId(builder, gachaGroupId):
    return GachaElementExcelAddGachaGroupId(builder, gachaGroupId)
def GachaElementExcelAddState(builder, state): builder.PrependInt32Slot(4, state, 0)
def AddState(builder, state):
    return GachaElementExcelAddState(builder, state)
def GachaElementExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
def AddId(builder, id):
    return GachaElementExcelAddId(builder, id)
def GachaElementExcelAddParcelAmountMin(builder, parcelAmountMin): builder.PrependInt32Slot(6, parcelAmountMin, 0)
def AddParcelAmountMin(builder, parcelAmountMin):
    return GachaElementExcelAddParcelAmountMin(builder, parcelAmountMin)
def GachaElementExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(7, parcelType, 0)
def AddParcelType(builder, parcelType):
    return GachaElementExcelAddParcelType(builder, parcelType)
def GachaElementExcelAddParcelId(builder, parcelId): builder.PrependInt64Slot(8, parcelId, 0)
