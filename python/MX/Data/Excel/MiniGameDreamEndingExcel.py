...
def MiniGameDreamEndingExcelAddScenarioGroupId(builder, scenarioGroupId): builder.PrependInt64Slot(0, scenarioGroupId, 0)
...
def MiniGameDreamEndingExcelAddEndingConditionValue(builder, endingConditionValue): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(endingConditionValue), 0)
...
def MiniGameDreamEndingExcelAddOrder(builder, order): builder.PrependInt32Slot(6, order, 0)
