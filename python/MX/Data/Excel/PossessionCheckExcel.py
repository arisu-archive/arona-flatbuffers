...
def PossessionCheckExcelAddReplaceParcelType(builder, replaceParcelType): builder.PrependInt32Slot(0, replaceParcelType, 0)
...
def PossessionCheckExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(1, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return PossessionCheckExcelAddUniqueId(builder, uniqueId)
def PossessionCheckExcelAddDefaultParcelAmount(builder, defaultParcelAmount): builder.PrependInt32Slot(2, defaultParcelAmount, 0)
...
def PossessionCheckExcelAddDefaultParcelType(builder, defaultParcelType): builder.PrependInt32Slot(3, defaultParcelType, 0)
...
def PossessionCheckExcelAddReplaceParcelAmount(builder, replaceParcelAmount): builder.PrependInt32Slot(5, replaceParcelAmount, 0)
...
def PossessionCheckExcelAddReplaceParcelId(builder, replaceParcelId): builder.PrependInt64Slot(6, replaceParcelId, 0)
