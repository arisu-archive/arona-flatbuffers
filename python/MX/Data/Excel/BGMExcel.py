...
def BGMExcelAddLoopTranstionTime(builder, loopTranstionTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(loopTranstionTime), 0)
...
def BGMExcelAddLoopEndTime(builder, loopEndTime): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(loopEndTime), 0)
...
def BGMExcelAddVolume(builder, volume): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(volume), 0)
...
def BGMExcelAddLoopStartTime(builder, loopStartTime): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(loopStartTime), 0)
