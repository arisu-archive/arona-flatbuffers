...
def BGMExcelAddLoopTranstionTime(builder, loopTranstionTime): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(loopTranstionTime), 0)
...
def BGMExcelAddLoopOffsetTime(builder, loopOffsetTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(loopOffsetTime), 0)
...
def BGMExcelAddNation(builder, nation): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(nation), 0)
...
def BGMExcelAddLoopStartTime(builder, loopStartTime): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(loopStartTime), 0)
...
def BGMExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
