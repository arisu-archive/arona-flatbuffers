...
def StickerGroupExcelAddStickerGroupIconpath(builder, stickerGroupIconpath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(stickerGroupIconpath), 0)
...
def StickerGroupExcelAddLocalizeTitle(builder, localizeTitle): builder.PrependUint32Slot(1, localizeTitle, 0)
...
def StickerGroupExcelAddStickerGroupCoverpath(builder, stickerGroupCoverpath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(stickerGroupCoverpath), 0)
...
def StickerGroupExcelAddPageCompleteRewardAmount(builder, pageCompleteRewardAmount): builder.PrependInt32Slot(5, pageCompleteRewardAmount, 0)
...
def StickerGroupExcelAddPageCompleteRewardParcelType(builder, pageCompleteRewardParcelType): builder.PrependInt32Slot(8, pageCompleteRewardParcelType, 0)
