...
def WorldRaidStageExcelAddClearScenarioKey(builder, clearScenarioKey): builder.PrependInt64Slot(0, clearScenarioKey, 0)
def AddClearScenarioKey(builder, clearScenarioKey):
    return WorldRaidStageExcelAddClearScenarioKey(builder, clearScenarioKey)
def WorldRaidStageExcelAddWorldRaidDifficulty(builder, worldRaidDifficulty): builder.PrependInt32Slot(1, worldRaidDifficulty, 0)
...
def WorldRaidStageExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return WorldRaidStageExcelAddId(builder, id)
def WorldRaidStageExcelAddRaidEnterAmount(builder, raidEnterAmount): builder.PrependInt64Slot(3, raidEnterAmount, 0)
def AddRaidEnterAmount(builder, raidEnterAmount):
    return WorldRaidStageExcelAddRaidEnterAmount(builder, raidEnterAmount)
def WorldRaidStageExcelAddDifficultyOpenCondition(builder, difficultyOpenCondition): builder.PrependBoolSlot(4, difficultyOpenCondition, 0)
...
def WorldRaidStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(5, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return WorldRaidStageExcelAddBattleDuration(builder, battleDuration)
def WorldRaidStageExcelAddBattleReadyTimelinePath(builder, battleReadyTimelinePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePath), 0)
...
def WorldRaidStageExcelAddRaidRewardGroupId(builder, raidRewardGroupId): builder.PrependInt64Slot(8, raidRewardGroupId, 0)
...
def WorldRaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey): builder.PrependUint32Slot(9, bossBgInfoKey, 0)
def AddBossBgInfoKey(builder, bossBgInfoKey):
    return WorldRaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey)
def WorldRaidStageExcelAddBattleReadyTimelinePhaseStart(builder, battleReadyTimelinePhaseStart): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseStart), 0)
...
def WorldRaidStageExcelAddUseBossAiPhaseSync(builder, useBossAiPhaseSync): builder.PrependBoolSlot(11, useBossAiPhaseSync, 0)
...
def WorldRaidStageExcelAddAllyPassiveSkillLevel(builder, allyPassiveSkillLevel): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkillLevel), 0)
...
def WorldRaidStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(13, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return WorldRaidStageExcelAddFixedEchelonId(builder, fixedEchelonId)
def WorldRaidStageExcelAddWorldRaidBossGroupId(builder, worldRaidBossGroupId): builder.PrependInt64Slot(14, worldRaidBossGroupId, 0)
...
def WorldRaidStageExcelAddIsRaidScenarioBattle(builder, isRaidScenarioBattle): builder.PrependBoolSlot(15, isRaidScenarioBattle, 0)
...
def WorldRaidStageExcelAddPhaseChangeTimelinePath(builder, phaseChangeTimelinePath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(phaseChangeTimelinePath), 0)
...
def WorldRaidStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(17, groundId, 0)
def AddGroundId(builder, groundId):
    return WorldRaidStageExcelAddGroundId(builder, groundId)
def WorldRaidStageExcelAddAssistCharacterLimitCount(builder, assistCharacterLimitCount): builder.PrependInt64Slot(18, assistCharacterLimitCount, 0)
...
def WorldRaidStageExcelAddEnterScenarioKey(builder, enterScenarioKey): builder.PrependInt64Slot(19, enterScenarioKey, 0)
...
def WorldRaidStageExcelAddTimeLinePhase(builder, timeLinePhase): builder.PrependInt64Slot(21, timeLinePhase, 0)
def AddTimeLinePhase(builder, timeLinePhase):
    return WorldRaidStageExcelAddTimeLinePhase(builder, timeLinePhase)
def WorldRaidStageExcelAddRaidBattleEndRewardGroupId(builder, raidBattleEndRewardGroupId): builder.PrependInt64Slot(22, raidBattleEndRewardGroupId, 0)
...
def WorldRaidStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(23, echelonExtensionType, 0)
...
def WorldRaidStageExcelAddSaveCurrentLocalBossHp(builder, saveCurrentLocalBossHp): builder.PrependBoolSlot(24, saveCurrentLocalBossHp, 0)
...
def WorldRaidStageExcelAddUseBossIndex(builder, useBossIndex): builder.PrependBoolSlot(25, useBossIndex, 0)
def AddUseBossIndex(builder, useBossIndex):
    return WorldRaidStageExcelAddUseBossIndex(builder, useBossIndex)
def WorldRaidStageExcelAddBossCharacterId(builder, bossCharacterId): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(bossCharacterId), 0)
...
def WorldRaidStageExcelAddAllyPassiveSkill(builder, allyPassiveSkill): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkill), 0)
...
def WorldRaidStageExcelAddUseFixedEchelon(builder, useFixedEchelon): builder.PrependBoolSlot(29, useFixedEchelon, 0)
def AddUseFixedEchelon(builder, useFixedEchelon):
    return WorldRaidStageExcelAddUseFixedEchelon(builder, useFixedEchelon)
def WorldRaidStageExcelAddReEnterAmount(builder, reEnterAmount): builder.PrependInt64Slot(30, reEnterAmount, 0)
def AddReEnterAmount(builder, reEnterAmount):
    return WorldRaidStageExcelAddReEnterAmount(builder, reEnterAmount)
def WorldRaidStageExcelAddRaidCharacterId(builder, raidCharacterId): builder.PrependInt64Slot(31, raidCharacterId, 0)
def AddRaidCharacterId(builder, raidCharacterId):
    return WorldRaidStageExcelAddRaidCharacterId(builder, raidCharacterId)
def WorldRaidStageExcelAddBattleReadyTimelinePhaseEnd(builder, battleReadyTimelinePhaseEnd): builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseEnd), 0)
...
def WorldRaidStageExcelAddVictoryTimelinePath(builder, victoryTimelinePath): builder.PrependUOffsetTRelativeSlot(33, flatbuffers.number_types.UOffsetTFlags.py_type(victoryTimelinePath), 0)
...
def WorldRaidStageExcelAddDamageToWorldBoss(builder, damageToWorldBoss): builder.PrependInt64Slot(34, damageToWorldBoss, 0)
