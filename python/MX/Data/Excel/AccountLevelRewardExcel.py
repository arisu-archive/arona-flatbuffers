...
def AccountLevelRewardExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return AccountLevelRewardExcelAddId(builder, id)
def AccountLevelRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(3, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return AccountLevelRewardExcelAddRewardParcelType(builder, rewardParcelType)
def AccountLevelRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(4, rewardParcelId, 0)
