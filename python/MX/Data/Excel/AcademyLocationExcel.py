...
def AcademyLocationExcelAddOpenCondition(builder, openCondition): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(openCondition), 0)
...
def AcademyLocationExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(3, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return AcademyLocationExcelAddRewardParcelId(builder, rewardParcelId)
def AcademyLocationExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(4, rewardParcelType, 0)
...
def AcademyLocationExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
