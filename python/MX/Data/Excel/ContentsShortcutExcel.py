...
def ContentsShortcutExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(0, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ContentsShortcutExcelAddEventContentId(builder, eventContentId)
def ContentsShortcutExcelAddLocalize(builder, localize): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(localize), 0)
def AddLocalize(builder, localize):
    return ContentsShortcutExcelAddLocalize(builder, localize)
def ContentsShortcutExcelAddConditionContentId(builder, conditionContentId): builder.PrependInt64Slot(2, conditionContentId, 0)
...
def ContentsShortcutExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(3, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return ContentsShortcutExcelAddUniqueId(builder, uniqueId)
def ContentsShortcutExcelAddContentType(builder, contentType): builder.PrependInt32Slot(4, contentType, 0)
def AddContentType(builder, contentType):
    return ContentsShortcutExcelAddContentType(builder, contentType)
def ContentsShortcutExcelAddConquestMapDifficulty(builder, conquestMapDifficulty): builder.PrependInt32Slot(5, conquestMapDifficulty, 0)
...
def ContentsShortcutExcelAddShortcutUiName(builder, shortcutUiName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUiName), 0)
...
def ContentsShortcutExcelAddShortcutContentId(builder, shortcutContentId): builder.PrependInt64Slot(8, shortcutContentId, 0)
...
def ContentsShortcutExcelAddScenarioModeChapter(builder, scenarioModeChapter): builder.PrependInt64Slot(9, scenarioModeChapter, 0)
...
def ContentsShortcutExcelAddScenarioModeVolume(builder, scenarioModeVolume): builder.PrependInt64Slot(10, scenarioModeVolume, 0)
...
def ContentsShortcutExcelAddShortcutOpenTime(builder, shortcutOpenTime): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutOpenTime), 0)
def AddShortcutOpenTime(builder, shortcutOpenTime):
    return ContentsShortcutExcelAddShortcutOpenTime(builder, shortcutOpenTime)
def ContentsShortcutExcelAddConquestStepIndex(builder, conquestStepIndex): builder.PrependInt32Slot(12, conquestStepIndex, 0)
