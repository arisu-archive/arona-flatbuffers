...
def ContentsShortcutExcelAddShortcutOpenTime(builder, shortcutOpenTime): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutOpenTime), 0)
def AddShortcutOpenTime(builder, shortcutOpenTime):
    return ContentsShortcutExcelAddShortcutOpenTime(builder, shortcutOpenTime)
def ContentsShortcutExcelAddShortcutCloseTime(builder, shortcutCloseTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutCloseTime), 0)
...
def ContentsShortcutExcelAddConditionContentId(builder, conditionContentId): builder.PrependInt64Slot(6, conditionContentId, 0)
...
def ContentsShortcutExcelAddConquestStepIndex(builder, conquestStepIndex): builder.PrependInt32Slot(7, conquestStepIndex, 0)
...
def ContentsShortcutExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(11, eventContentId, 0)
