...
def ShopExcelAddShopUpdateGroupId(builder, shopUpdateGroupId): builder.PrependInt32Slot(3, shopUpdateGroupId, 0)
def AddShopUpdateGroupId(builder, shopUpdateGroupId):
    return ShopExcelAddShopUpdateGroupId(builder, shopUpdateGroupId)
def ShopExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(4, categoryType, 0)
def AddCategoryType(builder, categoryType):
    return ShopExcelAddCategoryType(builder, categoryType)
def ShopExcelAddSalePeriodFrom(builder, salePeriodFrom): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodFrom), 0)
def AddSalePeriodFrom(builder, salePeriodFrom):
    return ShopExcelAddSalePeriodFrom(builder, salePeriodFrom)
def ShopExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def ShopExcelAddDisplayTag(builder, displayTag): builder.PrependInt32Slot(7, displayTag, 0)
def AddDisplayTag(builder, displayTag):
    return ShopExcelAddDisplayTag(builder, displayTag)
def ShopExcelAddUseBigPopup(builder, useBigPopup): builder.PrependBoolSlot(8, useBigPopup, 0)
def AddUseBigPopup(builder, useBigPopup):
    return ShopExcelAddUseBigPopup(builder, useBigPopup)
def ShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(9, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return ShopExcelAddIsLegacy(builder, isLegacy)
def ShopExcelAddPurchaseCooltimeMin(builder, purchaseCooltimeMin): builder.PrependInt64Slot(10, purchaseCooltimeMin, 0)
...
def ShopExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(12, purchaseCountLimit, 0)
...
def ShopExcelAddId(builder, id): builder.PrependInt64Slot(14, id, 0)
def AddId(builder, id):
    return ShopExcelAddId(builder, id)
def ShopExcelAddRestrictBuyWhenInventoryFull(builder, restrictBuyWhenInventoryFull): builder.PrependBoolSlot(15, restrictBuyWhenInventoryFull, 0)
