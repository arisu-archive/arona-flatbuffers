...
def ShopInfoExcelAddShopUpdateGroupId1(builder, shopUpdateGroupId1): builder.PrependInt32Slot(1, shopUpdateGroupId1, 0)
def AddShopUpdateGroupId1(builder, shopUpdateGroupId1):
    return ShopInfoExcelAddShopUpdateGroupId1(builder, shopUpdateGroupId1)
def ShopInfoExcelAddIsRefresh(builder, isRefresh): builder.PrependBoolSlot(2, isRefresh, 0)
def AddIsRefresh(builder, isRefresh):
    return ShopInfoExcelAddIsRefresh(builder, isRefresh)
def ShopInfoExcelAddOpenPeriodFrom(builder, openPeriodFrom): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(openPeriodFrom), 0)
def AddOpenPeriodFrom(builder, openPeriodFrom):
    return ShopInfoExcelAddOpenPeriodFrom(builder, openPeriodFrom)
def ShopInfoExcelAddShopUpdateGroupId10(builder, shopUpdateGroupId10): builder.PrependInt32Slot(4, shopUpdateGroupId10, 0)
...
def ShopInfoExcelAddShopUpdateGroupId11(builder, shopUpdateGroupId11): builder.PrependInt32Slot(5, shopUpdateGroupId11, 0)
...
def ShopInfoExcelAddShopUpdateGroupId8(builder, shopUpdateGroupId8): builder.PrependInt32Slot(6, shopUpdateGroupId8, 0)
def AddShopUpdateGroupId8(builder, shopUpdateGroupId8):
    return ShopInfoExcelAddShopUpdateGroupId8(builder, shopUpdateGroupId8)
def ShopInfoExcelAddIsShopVisible(builder, isShopVisible): builder.PrependBoolSlot(7, isShopVisible, 0)
def AddIsShopVisible(builder, isShopVisible):
    return ShopInfoExcelAddIsShopVisible(builder, isShopVisible)
def ShopInfoExcelAddShopUpdateGroupId2(builder, shopUpdateGroupId2): builder.PrependInt32Slot(8, shopUpdateGroupId2, 0)
...
def ShopInfoExcelAddShopUpdateGroupId6(builder, shopUpdateGroupId6): builder.PrependInt32Slot(10, shopUpdateGroupId6, 0)
def AddShopUpdateGroupId6(builder, shopUpdateGroupId6):
    return ShopInfoExcelAddShopUpdateGroupId6(builder, shopUpdateGroupId6)
def ShopInfoExcelAddDisplayParcelId(builder, displayParcelId): builder.PrependInt64Slot(11, displayParcelId, 0)
def AddDisplayParcelId(builder, displayParcelId):
    return ShopInfoExcelAddDisplayParcelId(builder, displayParcelId)
def ShopInfoExcelAddIsSoldOutDimmed(builder, isSoldOutDimmed): builder.PrependBoolSlot(12, isSoldOutDimmed, 0)
def AddIsSoldOutDimmed(builder, isSoldOutDimmed):
    return ShopInfoExcelAddIsSoldOutDimmed(builder, isSoldOutDimmed)
def ShopInfoExcelAddCostParcelType(builder, costParcelType): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelType), 0)
...
def ShopInfoExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def ShopInfoExcelAddRefreshPeriodBaseTime(builder, refreshPeriodBaseTime): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(refreshPeriodBaseTime), 0)
...
def ShopInfoExcelAddRefreshAbleCount(builder, refreshAbleCount): builder.PrependInt64Slot(18, refreshAbleCount, 0)
...
def ShopInfoExcelAddOpenPeriodTo(builder, openPeriodTo): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(openPeriodTo), 0)
def AddOpenPeriodTo(builder, openPeriodTo):
    return ShopInfoExcelAddOpenPeriodTo(builder, openPeriodTo)
def ShopInfoExcelAddCostParcelId(builder, costParcelId): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelId), 0)
...
def ShopInfoExcelAddShopRefresherType(builder, shopRefresherType): builder.PrependInt32Slot(22, shopRefresherType, 0)
...
def ShopInfoExcelAddShopProductUpdateTime(builder, shopProductUpdateTime): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(shopProductUpdateTime), 0)
...
def ShopInfoExcelAddShopUpdateGroupId12(builder, shopUpdateGroupId12): builder.PrependInt32Slot(25, shopUpdateGroupId12, 0)
...
def ShopInfoExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(26, categoryType, 0)
...
def ShopInfoExcelAddShopUpdateGroupId5(builder, shopUpdateGroupId5): builder.PrependInt32Slot(28, shopUpdateGroupId5, 0)
def AddShopUpdateGroupId5(builder, shopUpdateGroupId5):
    return ShopInfoExcelAddShopUpdateGroupId5(builder, shopUpdateGroupId5)
def ShopInfoExcelAddShopUpdateGroupId7(builder, shopUpdateGroupId7): builder.PrependInt32Slot(29, shopUpdateGroupId7, 0)
def AddShopUpdateGroupId7(builder, shopUpdateGroupId7):
    return ShopInfoExcelAddShopUpdateGroupId7(builder, shopUpdateGroupId7)
def ShopInfoExcelAddShopUpdateDate(builder, shopUpdateDate): builder.PrependInt32Slot(30, shopUpdateDate, 0)
