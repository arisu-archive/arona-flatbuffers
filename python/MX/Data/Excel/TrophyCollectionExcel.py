...
def TrophyCollectionExcelAddLocalizeCodeId(builder, localizeCodeId): builder.PrependUint32Slot(0, localizeCodeId, 0)
def AddLocalizeCodeId(builder, localizeCodeId):
    return TrophyCollectionExcelAddLocalizeCodeId(builder, localizeCodeId)
def TrophyCollectionExcelAddFurnitureId(builder, furnitureId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(furnitureId), 0)
