...
def MiniGameShootingStageExcelAddDefaultBattleDuration(builder, defaultBattleDuration): builder.PrependInt64Slot(0, defaultBattleDuration, 0)
...
def MiniGameShootingStageExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(1, costGoodsId, 0)
def AddCostGoodsId(builder, costGoodsId):
    return MiniGameShootingStageExcelAddCostGoodsId(builder, costGoodsId)
def MiniGameShootingStageExcelAddEventContentStageRewardId(builder, eventContentStageRewardId): builder.PrependInt64Slot(2, eventContentStageRewardId, 0)
...
def MiniGameShootingStageExcelAddBgmId(builder, bgmId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(bgmId), 0)
...
def MiniGameShootingStageExcelAddCameraSizeRate(builder, cameraSizeRate): builder.PrependFloat32Slot(4, cameraSizeRate, 0.0)
...
def MiniGameShootingStageExcelAddArtLevel(builder, artLevel): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(artLevel), 0)
def AddArtLevel(builder, artLevel):
    return MiniGameShootingStageExcelAddArtLevel(builder, artLevel)
def MiniGameShootingStageExcelAddDifficulty(builder, difficulty): builder.PrependInt32Slot(8, difficulty, 0)
