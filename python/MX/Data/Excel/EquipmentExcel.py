...
def EquipmentExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def EquipmentExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def EquipmentExcelAddMaxLevel(builder, maxLevel): builder.PrependInt32Slot(3, maxLevel, 0)
...
def EquipmentExcelAddNextTierEquipment(builder, nextTierEquipment): builder.PrependInt64Slot(5, nextTierEquipment, 0)
def AddNextTierEquipment(builder, nextTierEquipment):
    return EquipmentExcelAddNextTierEquipment(builder, nextTierEquipment)
def EquipmentExcelAddShiftingCraftQuality(builder, shiftingCraftQuality): builder.PrependInt64Slot(6, shiftingCraftQuality, 0)
...
def EquipmentExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(7, craftQualityTier2, 0)
def AddCraftQualityTier2(builder, craftQualityTier2):
    return EquipmentExcelAddCraftQualityTier2(builder, craftQualityTier2)
def EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(8, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId)
def EquipmentExcelAddWear(builder, wear): builder.PrependBoolSlot(9, wear, 0)
def AddWear(builder, wear):
    return EquipmentExcelAddWear(builder, wear)
def EquipmentExcelAddRecipeId(builder, recipeId): builder.PrependInt32Slot(10, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return EquipmentExcelAddRecipeId(builder, recipeId)
def EquipmentExcelAddRarity(builder, rarity): builder.PrependInt32Slot(11, rarity, 0)
def AddRarity(builder, rarity):
    return EquipmentExcelAddRarity(builder, rarity)
def EquipmentExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(12, craftQualityTier1, 0)
def AddCraftQualityTier1(builder, craftQualityTier1):
    return EquipmentExcelAddCraftQualityTier1(builder, craftQualityTier1)
def EquipmentExcelAddId(builder, id): builder.PrependInt64Slot(13, id, 0)
...
def EquipmentExcelAddImageName(builder, imageName): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(imageName), 0)
def AddImageName(builder, imageName):
    return EquipmentExcelAddImageName(builder, imageName)
def EquipmentExcelAddTierInit(builder, tierInit): builder.PrependInt64Slot(16, tierInit, 0)
def AddTierInit(builder, tierInit):
    return EquipmentExcelAddTierInit(builder, tierInit)
def EquipmentExcelAddStackableMax(builder, stackableMax): builder.PrependInt32Slot(17, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return EquipmentExcelAddStackableMax(builder, stackableMax)
def EquipmentExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(18, craftQualityTier0, 0)
