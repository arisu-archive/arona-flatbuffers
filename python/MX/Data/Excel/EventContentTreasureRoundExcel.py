...
def EventContentTreasureRoundExcelAddTreasureRound(builder, treasureRound): builder.PrependInt32Slot(3, treasureRound, 0)
def AddTreasureRound(builder, treasureRound):
    return EventContentTreasureRoundExcelAddTreasureRound(builder, treasureRound)
def EventContentTreasureRoundExcelAddTreasureCellImagePath(builder, treasureCellImagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(treasureCellImagePath), 0)
...
def EventContentTreasureRoundExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def EventContentTreasureRoundExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(6, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentTreasureRoundExcelAddEventContentId(builder, eventContentId)
def EventContentTreasureRoundExcelAddTreasureRoundSize(builder, treasureRoundSize): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(treasureRoundSize), 0)
...
def EventContentTreasureRoundExcelAddCellVisualSortUnstructed(builder, cellVisualSortUnstructed): builder.PrependBoolSlot(8, cellVisualSortUnstructed, 0)
