...
def MultiFloorRaidRewardExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(1, rewardGroupId, 0)
def AddRewardGroupId(builder, rewardGroupId):
    return MultiFloorRaidRewardExcelAddRewardGroupId(builder, rewardGroupId)
def MultiFloorRaidRewardExcelAddClearStageRewardProb(builder, clearStageRewardProb): builder.PrependInt64Slot(2, clearStageRewardProb, 0)
...
def MultiFloorRaidRewardExcelAddClearStageRewardParcelType(builder, clearStageRewardParcelType): builder.PrependInt32Slot(4, clearStageRewardParcelType, 0)
