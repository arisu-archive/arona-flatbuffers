...
def MinigameTBGDiceExcelAddProb(builder, prob): builder.PrependInt32Slot(1, prob, 0)
def AddProb(builder, prob):
    return MinigameTBGDiceExcelAddProb(builder, prob)
def MinigameTBGDiceExcelAddDiceResult(builder, diceResult): builder.PrependInt32Slot(2, diceResult, 0)
def AddDiceResult(builder, diceResult):
    return MinigameTBGDiceExcelAddDiceResult(builder, diceResult)
def MinigameTBGDiceExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(3, uniqueId, 0)
...
def MinigameTBGDiceExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameTBGDiceExcelAddEventContentId(builder, eventContentId)
def MinigameTBGDiceExcelAddDiceGroup(builder, diceGroup): builder.PrependInt32Slot(6, diceGroup, 0)
def AddDiceGroup(builder, diceGroup):
    return MinigameTBGDiceExcelAddDiceGroup(builder, diceGroup)
def MinigameTBGDiceExcelAddProbModifyValue(builder, probModifyValue): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(probModifyValue), 0)
