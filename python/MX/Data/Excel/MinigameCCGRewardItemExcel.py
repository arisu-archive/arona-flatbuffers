...
def MinigameCCGRewardItemExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(0, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return MinigameCCGRewardItemExcelAddRewardParcelId(builder, rewardParcelId)
def MinigameCCGRewardItemExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(1, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return MinigameCCGRewardItemExcelAddRewardParcelType(builder, rewardParcelType)
def MinigameCCGRewardItemExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt32Slot(2, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return MinigameCCGRewardItemExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def MinigameCCGRewardItemExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
def AddId(builder, id):
    return MinigameCCGRewardItemExcelAddId(builder, id)
def MinigameCCGRewardItemExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(4, displayOrder, 0)
...
def MinigameCCGRewardItemExcelAddMinPoint(builder, minPoint): builder.PrependInt32Slot(6, minPoint, 0)
