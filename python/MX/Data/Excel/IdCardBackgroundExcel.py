...
def IdCardBackgroundExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return IdCardBackgroundExcelAddId(builder, id)
def IdCardBackgroundExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return IdCardBackgroundExcelAddIcon(builder, icon)
def IdCardBackgroundExcelAddRarity(builder, rarity): builder.PrependInt32Slot(3, rarity, 0)
...
def IdCardBackgroundExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(5, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return IdCardBackgroundExcelAddLocalizeEtcId(builder, localizeEtcId)
def IdCardBackgroundExcelAddIsDefault(builder, isDefault): builder.PrependBoolSlot(6, isDefault, 0)
def AddIsDefault(builder, isDefault):
    return IdCardBackgroundExcelAddIsDefault(builder, isDefault)
def IdCardBackgroundExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(7, displayOrder, 0)
