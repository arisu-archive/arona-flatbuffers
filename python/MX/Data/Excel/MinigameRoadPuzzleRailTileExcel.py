...
def MinigameRoadPuzzleRailTileExcelAddOriginalTile(builder, originalTile): builder.PrependBoolSlot(1, originalTile, 0)
def AddOriginalTile(builder, originalTile):
    return MinigameRoadPuzzleRailTileExcelAddOriginalTile(builder, originalTile)
def MinigameRoadPuzzleRailTileExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return MinigameRoadPuzzleRailTileExcelAddPrefabName(builder, prefabName)
def MinigameRoadPuzzleRailTileExcelAddRailTileType(builder, railTileType): builder.PrependInt32Slot(3, railTileType, 0)
def AddRailTileType(builder, railTileType):
    return MinigameRoadPuzzleRailTileExcelAddRailTileType(builder, railTileType)
def MinigameRoadPuzzleRailTileExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(4, groupId, 0)
