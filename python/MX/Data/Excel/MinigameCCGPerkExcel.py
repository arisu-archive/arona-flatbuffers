...
def MinigameCCGPerkExcelAddRequiredPerkId(builder, requiredPerkId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(requiredPerkId), 0)
...
def MinigameCCGPerkExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return MinigameCCGPerkExcelAddId(builder, id)
def MinigameCCGPerkExcelAddRerollPoint(builder, rerollPoint): builder.PrependInt32Slot(2, rerollPoint, 0)
def AddRerollPoint(builder, rerollPoint):
    return MinigameCCGPerkExcelAddRerollPoint(builder, rerollPoint)
def MinigameCCGPerkExcelAddShopLocalizeDesc(builder, shopLocalizeDesc): builder.PrependUint32Slot(3, shopLocalizeDesc, 0)
...
def MinigameCCGPerkExcelAddShopOrder(builder, shopOrder): builder.PrependInt32Slot(5, shopOrder, 0)
def AddShopOrder(builder, shopOrder):
    return MinigameCCGPerkExcelAddShopOrder(builder, shopOrder)
def MinigameCCGPerkExcelAddCcgId(builder, ccgId): builder.PrependInt64Slot(6, ccgId, 0)
def AddCcgId(builder, ccgId):
    return MinigameCCGPerkExcelAddCcgId(builder, ccgId)
def MinigameCCGPerkExcelAddCostParcelAmount(builder, costParcelAmount): builder.PrependInt32Slot(7, costParcelAmount, 0)
...
def MinigameCCGPerkExcelAddEnvironmentLogicEffectId(builder, environmentLogicEffectId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(environmentLogicEffectId), 0)
...
def MinigameCCGPerkExcelAddShopLocalizeTitle(builder, shopLocalizeTitle): builder.PrependUint32Slot(10, shopLocalizeTitle, 0)
