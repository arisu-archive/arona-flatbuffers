...
def SkillSelectExTooltipExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(1, groupId, 0)
def AddGroupId(builder, groupId):
    return SkillSelectExTooltipExcelAddGroupId(builder, groupId)
def SkillSelectExTooltipExcelAddSelectableExSkillGroupId(builder, selectableExSkillGroupId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(selectableExSkillGroupId), 0)
