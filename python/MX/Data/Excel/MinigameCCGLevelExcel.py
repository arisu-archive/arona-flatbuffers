...
def MinigameCCGLevelExcelAddFloorIndex(builder, floorIndex): builder.PrependInt32Slot(0, floorIndex, 0)
def AddFloorIndex(builder, floorIndex):
    return MinigameCCGLevelExcelAddFloorIndex(builder, floorIndex)
def MinigameCCGLevelExcelAddLevelId(builder, levelId): builder.PrependInt64Slot(1, levelId, 0)
def AddLevelId(builder, levelId):
    return MinigameCCGLevelExcelAddLevelId(builder, levelId)
def MinigameCCGLevelExcelAddBackgroundPath(builder, backgroundPath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(backgroundPath), 0)
