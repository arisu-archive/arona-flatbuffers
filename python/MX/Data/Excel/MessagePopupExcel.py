...
def MessagePopupExcelAddButton(builder, button): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(button), 0)
...
def MessagePopupExcelAddMessageText(builder, messageText): builder.PrependUint32Slot(1, messageText, 0)
def AddMessageText(builder, messageText):
    return MessagePopupExcelAddMessageText(builder, messageText)
def MessagePopupExcelAddImage(builder, image): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(image), 0)
def AddImage(builder, image):
    return MessagePopupExcelAddImage(builder, image)
def MessagePopupExcelAddSubTitleText(builder, subTitleText): builder.PrependUint32Slot(3, subTitleText, 0)
def AddSubTitleText(builder, subTitleText):
    return MessagePopupExcelAddSubTitleText(builder, subTitleText)
def MessagePopupExcelAddButtonCommand(builder, buttonCommand): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(buttonCommand), 0)
...
def MessagePopupExcelAddOrderType(builder, orderType): builder.PrependInt32Slot(5, orderType, 0)
...
def MessagePopupExcelAddButtonText(builder, buttonText): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(buttonText), 0)
...
def MessagePopupExcelAddDisplayXButton(builder, displayXButton): builder.PrependBoolSlot(9, displayXButton, 0)
def AddDisplayXButton(builder, displayXButton):
    return MessagePopupExcelAddDisplayXButton(builder, displayXButton)
def MessagePopupExcelAddButtonParameter(builder, buttonParameter): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(buttonParameter), 0)
...
def MessagePopupExcelAddConditionText(builder, conditionText): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(conditionText), 0)
