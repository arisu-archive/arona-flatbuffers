...
def CafeInteractionExcelAddFavorEmoticonRewardAmount(builder, favorEmoticonRewardAmount): builder.PrependInt64Slot(0, favorEmoticonRewardAmount, 0)
...
def CafeInteractionExcelAddIgnoreIfUnobtainedEndDate(builder, ignoreIfUnobtainedEndDate): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(ignoreIfUnobtainedEndDate), 0)
...
def CafeInteractionExcelAddIgnoreIfUnobtained(builder, ignoreIfUnobtained): builder.PrependBoolSlot(6, ignoreIfUnobtained, 0)
...
def CafeInteractionExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(7, characterId, 0)
def AddCharacterId(builder, characterId):
    return CafeInteractionExcelAddCharacterId(builder, characterId)
def CafeInteractionExcelAddBubbleType(builder, bubbleType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(bubbleType), 0)
