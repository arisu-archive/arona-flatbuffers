...
def EventContentSeasonExcelAddEventItemId(builder, eventItemId): builder.PrependInt64Slot(0, eventItemId, 0)
def AddEventItemId(builder, eventItemId):
    return EventContentSeasonExcelAddEventItemId(builder, eventItemId)
def EventContentSeasonExcelAddIsReturn(builder, isReturn): builder.PrependBoolSlot(1, isReturn, 0)
def AddIsReturn(builder, isReturn):
    return EventContentSeasonExcelAddIsReturn(builder, isReturn)
def EventContentSeasonExcelAddIconOrder(builder, iconOrder): builder.PrependInt32Slot(2, iconOrder, 0)
def AddIconOrder(builder, iconOrder):
    return EventContentSeasonExcelAddIconOrder(builder, iconOrder)
def EventContentSeasonExcelAddExtensionTime(builder, extensionTime): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(extensionTime), 0)
def AddExtensionTime(builder, extensionTime):
    return EventContentSeasonExcelAddExtensionTime(builder, extensionTime)
def EventContentSeasonExcelAddSubEvent(builder, subEvent): builder.PrependBoolSlot(4, subEvent, 0)
def AddSubEvent(builder, subEvent):
    return EventContentSeasonExcelAddSubEvent(builder, subEvent)
def EventContentSeasonExcelAddBeforehandBgImagePath(builder, beforehandBgImagePath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(beforehandBgImagePath), 0)
...
def EventContentSeasonExcelAddMinigameLobbyPrefabName(builder, minigameLobbyPrefabName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(minigameLobbyPrefabName), 0)
...
def EventContentSeasonExcelAddSubIconParcelPath(builder, subIconParcelPath): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(subIconParcelPath), 0)
...
def EventContentSeasonExcelAddEventDisplay(builder, eventDisplay): builder.PrependBoolSlot(8, eventDisplay, 0)
def AddEventDisplay(builder, eventDisplay):
    return EventContentSeasonExcelAddEventDisplay(builder, eventDisplay)
def EventContentSeasonExcelAddEventAssist(builder, eventAssist): builder.PrependBoolSlot(9, eventAssist, 0)
def AddEventAssist(builder, eventAssist):
    return EventContentSeasonExcelAddEventAssist(builder, eventAssist)
def EventContentSeasonExcelAddMiniEventShortCutScenarioModeId(builder, miniEventShortCutScenarioModeId): builder.PrependInt64Slot(10, miniEventShortCutScenarioModeId, 0)
...
def EventContentSeasonExcelAddRewardTagPermanent(builder, rewardTagPermanent): builder.PrependInt32Slot(11, rewardTagPermanent, 0)
...
def EventContentSeasonExcelAddMinigameMissionBgImagePath(builder, minigameMissionBgImagePath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(minigameMissionBgImagePath), 0)
...
def EventContentSeasonExcelAddEventContentStageRewardIdPermanent(builder, eventContentStageRewardIdPermanent): builder.PrependInt64Slot(13, eventContentStageRewardIdPermanent, 0)
...
def EventContentSeasonExcelAddMainBgImagePath(builder, mainBgImagePath): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(mainBgImagePath), 0)
def AddMainBgImagePath(builder, mainBgImagePath):
    return EventContentSeasonExcelAddMainBgImagePath(builder, mainBgImagePath)
def EventContentSeasonExcelAddMinigameMissionBgPrefabName(builder, minigameMissionBgPrefabName): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(minigameMissionBgPrefabName), 0)
...
def EventContentSeasonExcelAddMainIconParcelPath(builder, mainIconParcelPath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(mainIconParcelPath), 0)
...
def EventContentSeasonExcelAddBeforehandScenarioGroupId(builder, beforehandScenarioGroupId): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(beforehandScenarioGroupId), 0)
...
def EventContentSeasonExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(18, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentSeasonExcelAddEventContentId(builder, eventContentId)
def EventContentSeasonExcelAddScenarioContentCollectionGroupId(builder, scenarioContentCollectionGroupId): builder.PrependInt64Slot(19, scenarioContentCollectionGroupId, 0)
...
def EventContentSeasonExcelAddSubEventType(builder, subEventType): builder.PrependInt32Slot(21, subEventType, 0)
def AddSubEventType(builder, subEventType):
    return EventContentSeasonExcelAddSubEventType(builder, subEventType)
def EventContentSeasonExcelAddShiftMainBgImagePath(builder, shiftMainBgImagePath): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(shiftMainBgImagePath), 0)
...
def EventContentSeasonExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return EventContentSeasonExcelAddName(builder, name)
def EventContentSeasonExcelAddOriginalEventContentId(builder, originalEventContentId): builder.PrependInt64Slot(25, originalEventContentId, 0)
...
def EventContentSeasonExcelAddBeforehandExposedTime(builder, beforehandExposedTime): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(beforehandExposedTime), 0)
...
def EventContentSeasonExcelAddEventChangeOpenCondition(builder, eventChangeOpenCondition): builder.PrependInt64Slot(27, eventChangeOpenCondition, 0)
...
def EventContentSeasonExcelAddEventContentType(builder, eventContentType): builder.PrependInt32Slot(28, eventContentType, 0)
...
def EventContentSeasonExcelAddEventContentCloseTime(builder, eventContentCloseTime): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentCloseTime), 0)
...
def EventContentSeasonExcelAddEventContentOpenTime(builder, eventContentOpenTime): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(eventContentOpenTime), 0)
...
def EventContentSeasonExcelAddOpenConditionContent(builder, openConditionContent): builder.PrependInt32Slot(31, openConditionContent, 0)
...
def EventContentSeasonExcelAddShiftTriggerStageId(builder, shiftTriggerStageId): builder.PrependInt64Slot(32, shiftTriggerStageId, 0)
...
def EventContentSeasonExcelAddMinigameVictoryPrefabName(builder, minigameVictoryPrefabName): builder.PrependUOffsetTRelativeSlot(33, flatbuffers.number_types.UOffsetTFlags.py_type(minigameVictoryPrefabName), 0)
...
def EventContentSeasonExcelAddCardBgImagePath(builder, cardBgImagePath): builder.PrependUOffsetTRelativeSlot(34, flatbuffers.number_types.UOffsetTFlags.py_type(cardBgImagePath), 0)
def AddCardBgImagePath(builder, cardBgImagePath):
    return EventContentSeasonExcelAddCardBgImagePath(builder, cardBgImagePath)
def EventContentSeasonExcelAddEventContentReleaseType(builder, eventContentReleaseType): builder.PrependInt32Slot(35, eventContentReleaseType, 0)
...
def EventContentSeasonExcelAddMinigamePrologScenarioGroupId(builder, minigamePrologScenarioGroupId): builder.PrependInt64Slot(36, minigamePrologScenarioGroupId, 0)
