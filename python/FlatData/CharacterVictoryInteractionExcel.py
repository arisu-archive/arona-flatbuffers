...
def CharacterVictoryInteractionExcelAddVictoryStartAnimationPath01(builder, victoryStartAnimationPath01): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(victoryStartAnimationPath01), 0)
...
def CharacterVictoryInteractionExcelAddVictoryStartAnimationPath05(builder, victoryStartAnimationPath05): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(victoryStartAnimationPath05), 0)
...
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath03(builder, victoryEndAnimationPath03): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath03), 0)
...
def CharacterVictoryInteractionExcelAddCostumeId01(builder, costumeId01): builder.PrependInt64Slot(3, costumeId01, 0)
def AddCostumeId01(builder, costumeId01):
    return CharacterVictoryInteractionExcelAddCostumeId01(builder, costumeId01)
def CharacterVictoryInteractionExcelAddPositionIndex03(builder, positionIndex03): builder.PrependInt32Slot(4, positionIndex03, 0)
...
def CharacterVictoryInteractionExcelAddCostumeId02(builder, costumeId02): builder.PrependInt64Slot(5, costumeId02, 0)
def AddCostumeId02(builder, costumeId02):
    return CharacterVictoryInteractionExcelAddCostumeId02(builder, costumeId02)
def CharacterVictoryInteractionExcelAddVictoryStartAnimationPath02(builder, victoryStartAnimationPath02): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(victoryStartAnimationPath02), 0)
...
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath01(builder, victoryEndAnimationPath01): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath01), 0)
...
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath06(builder, victoryEndAnimationPath06): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath06), 0)
...
def CharacterVictoryInteractionExcelAddCostumeId04(builder, costumeId04): builder.PrependInt64Slot(9, costumeId04, 0)
def AddCostumeId04(builder, costumeId04):
    return CharacterVictoryInteractionExcelAddCostumeId04(builder, costumeId04)
def CharacterVictoryInteractionExcelAddPositionIndex02(builder, positionIndex02): builder.PrependInt32Slot(10, positionIndex02, 0)
...
def CharacterVictoryInteractionExcelAddVictoryStartAnimationPath03(builder, victoryStartAnimationPath03): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(victoryStartAnimationPath03), 0)
...
def CharacterVictoryInteractionExcelAddInteractionId(builder, interactionId): builder.PrependInt64Slot(12, interactionId, 0)
def AddInteractionId(builder, interactionId):
    return CharacterVictoryInteractionExcelAddInteractionId(builder, interactionId)
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath02(builder, victoryEndAnimationPath02): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath02), 0)
...
def CharacterVictoryInteractionExcelAddPositionIndex06(builder, positionIndex06): builder.PrependInt32Slot(14, positionIndex06, 0)
...
def CharacterVictoryInteractionExcelAddVictoryStartAnimationPath06(builder, victoryStartAnimationPath06): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(victoryStartAnimationPath06), 0)
...
def CharacterVictoryInteractionExcelAddVoiceEvent04(builder, voiceEvent04): builder.PrependInt32Slot(17, voiceEvent04, 0)
...
def CharacterVictoryInteractionExcelAddPositionIndex04(builder, positionIndex04): builder.PrependInt32Slot(19, positionIndex04, 0)
...
def CharacterVictoryInteractionExcelAddCostumeId05(builder, costumeId05): builder.PrependInt64Slot(20, costumeId05, 0)
def AddCostumeId05(builder, costumeId05):
    return CharacterVictoryInteractionExcelAddCostumeId05(builder, costumeId05)
def CharacterVictoryInteractionExcelAddVoiceEvent02(builder, voiceEvent02): builder.PrependInt32Slot(21, voiceEvent02, 0)
def AddVoiceEvent02(builder, voiceEvent02):
    return CharacterVictoryInteractionExcelAddVoiceEvent02(builder, voiceEvent02)
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath05(builder, victoryEndAnimationPath05): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath05), 0)
...
def CharacterVictoryInteractionExcelAddVoiceEvent05(builder, voiceEvent05): builder.PrependInt32Slot(23, voiceEvent05, 0)
def AddVoiceEvent05(builder, voiceEvent05):
    return CharacterVictoryInteractionExcelAddVoiceEvent05(builder, voiceEvent05)
def CharacterVictoryInteractionExcelAddPositionIndex01(builder, positionIndex01): builder.PrependInt32Slot(24, positionIndex01, 0)
...
def CharacterVictoryInteractionExcelAddCostumeId03(builder, costumeId03): builder.PrependInt64Slot(25, costumeId03, 0)
def AddCostumeId03(builder, costumeId03):
    return CharacterVictoryInteractionExcelAddCostumeId03(builder, costumeId03)
def CharacterVictoryInteractionExcelAddVoiceEvent01(builder, voiceEvent01): builder.PrependInt32Slot(26, voiceEvent01, 0)
def AddVoiceEvent01(builder, voiceEvent01):
    return CharacterVictoryInteractionExcelAddVoiceEvent01(builder, voiceEvent01)
def CharacterVictoryInteractionExcelAddVictoryEndAnimationPath04(builder, victoryEndAnimationPath04): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(victoryEndAnimationPath04), 0)
...
def CharacterVictoryInteractionExcelAddCostumeId06(builder, costumeId06): builder.PrependInt64Slot(28, costumeId06, 0)
def AddCostumeId06(builder, costumeId06):
    return CharacterVictoryInteractionExcelAddCostumeId06(builder, costumeId06)
def CharacterVictoryInteractionExcelAddVoiceEvent06(builder, voiceEvent06): builder.PrependInt32Slot(29, voiceEvent06, 0)
def AddVoiceEvent06(builder, voiceEvent06):
    return CharacterVictoryInteractionExcelAddVoiceEvent06(builder, voiceEvent06)
def CharacterVictoryInteractionExcelAddPositionIndex05(builder, positionIndex05): builder.PrependInt32Slot(30, positionIndex05, 0)
