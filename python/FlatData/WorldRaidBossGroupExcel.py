...
def WorldRaidBossGroupExcelAddWorldBossHp(builder, worldBossHp): builder.PrependInt64Slot(0, worldBossHp, 0)
def AddWorldBossHp(builder, worldBossHp):
    return WorldRaidBossGroupExcelAddWorldBossHp(builder, worldBossHp)
def WorldRaidBossGroupExcelAddWorldBossListParcel(builder, worldBossListParcel): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossListParcel), 0)
...
def WorldRaidBossGroupExcelAddHideAnotherBossKilled(builder, hideAnotherBossKilled): builder.PrependBoolSlot(2, hideAnotherBossKilled, 0)
...
def WorldRaidBossGroupExcelAddWorldBossName(builder, worldBossName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(worldBossName), 0)
def AddWorldBossName(builder, worldBossName):
    return WorldRaidBossGroupExcelAddWorldBossName(builder, worldBossName)
def WorldRaidBossGroupExcelAddWorldBossClearRewardGroupId(builder, worldBossClearRewardGroupId): builder.PrependInt64Slot(4, worldBossClearRewardGroupId, 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpAsia(builder, worldBossHpAsia): builder.PrependInt64Slot(5, worldBossHpAsia, 0)
def AddWorldBossHpAsia(builder, worldBossHpAsia):
    return WorldRaidBossGroupExcelAddWorldBossHpAsia(builder, worldBossHpAsia)
def WorldRaidBossGroupExcelAddExclusiveOperatorBossDamaged(builder, exclusiveOperatorBossDamaged): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorBossDamaged), 0)
...
def WorldRaidBossGroupExcelAddExclusiveOperatorBossSpawn(builder, exclusiveOperatorBossSpawn): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorBossSpawn), 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpGlobal(builder, worldBossHpGlobal): builder.PrependInt64Slot(8, worldBossHpGlobal, 0)
def AddWorldBossHpGlobal(builder, worldBossHpGlobal):
    return WorldRaidBossGroupExcelAddWorldBossHpGlobal(builder, worldBossHpGlobal)
...
def AddWorldBossHpNa(builder, worldBossHpNa):
    return WorldRaidBossGroupExcelAddWorldBossHpNa(builder, worldBossHpNa)
def WorldRaidBossGroupExcelAddWorldRaidBossGroupId(builder, worldRaidBossGroupId): builder.PrependInt64Slot(11, worldRaidBossGroupId, 0)
...
def WorldRaidBossGroupExcelAddWorldBossHpTw(builder, worldBossHpTw): builder.PrependInt64Slot(14, worldBossHpTw, 0)
def AddWorldBossHpTw(builder, worldBossHpTw):
    return WorldRaidBossGroupExcelAddWorldBossHpTw(builder, worldBossHpTw)
def WorldRaidBossGroupExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
...
def WorldRaidBossGroupExcelAddExclusiveOperatorScenarioBattle(builder, exclusiveOperatorScenarioBattle): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorScenarioBattle), 0)
...
def WorldRaidBossGroupExcelAddBossGroupOpenCondition(builder, bossGroupOpenCondition): builder.PrependInt64Slot(18, bossGroupOpenCondition, 0)
...
def WorldRaidBossGroupExcelAddExclusiveOperatorBossKill(builder, exclusiveOperatorBossKill): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(exclusiveOperatorBossKill), 0)
...
def WorldRaidBossGroupExcelAddAnotherBossKilled(builder, anotherBossKilled): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(anotherBossKilled), 0)
...
def WorldRaidBossGroupExcelAddEchelonConstraintGroupId(builder, echelonConstraintGroupId): builder.PrependInt64Slot(21, echelonConstraintGroupId, 0)
