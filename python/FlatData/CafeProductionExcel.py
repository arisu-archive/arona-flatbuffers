...
def CafeProductionExcelAddRank(builder, rank): builder.PrependInt64Slot(0, rank, 0)
def AddRank(builder, rank):
    return CafeProductionExcelAddRank(builder, rank)
def CafeProductionExcelAddParcelStorageMax(builder, parcelStorageMax): builder.PrependInt64Slot(1, parcelStorageMax, 0)
def AddParcelStorageMax(builder, parcelStorageMax):
    return CafeProductionExcelAddParcelStorageMax(builder, parcelStorageMax)
def CafeProductionExcelAddCafeProductionParcelId(builder, cafeProductionParcelId): builder.PrependInt64Slot(2, cafeProductionParcelId, 0)
...
def CafeProductionExcelAddCafeProductionParcelType(builder, cafeProductionParcelType): builder.PrependInt32Slot(5, cafeProductionParcelType, 0)
