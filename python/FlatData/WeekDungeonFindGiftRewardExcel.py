...
def WeekDungeonFindGiftRewardExcelAddRewardParcelProbability(builder, rewardParcelProbability): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelProbability), 0)
...
def WeekDungeonFindGiftRewardExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(1, stageRewardId, 0)
...
def WeekDungeonFindGiftRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def WeekDungeonFindGiftRewardExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return WeekDungeonFindGiftRewardExcelAddDevName(builder, devName)
def WeekDungeonFindGiftRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
