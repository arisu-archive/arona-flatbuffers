...
def NormalSkillTemplateExcelAddMultiAni(builder, multiAni): builder.PrependBoolSlot(1, multiAni, 0)
...
def NormalSkillTemplateExcelAddCoolTime(builder, coolTime): builder.PrependFloat32Slot(3, coolTime, 0.0)
