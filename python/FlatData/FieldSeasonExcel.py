...
def FieldSeasonExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
...
def FieldSeasonExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
...
def FieldSeasonExcelAddMasteryImagePath(builder, masteryImagePath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(masteryImagePath), 0)
...
def FieldSeasonExcelAddFieldLobbyTitleImagePath(builder, fieldLobbyTitleImagePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(fieldLobbyTitleImagePath), 0)
