...
def EventContentBuffExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
def AddSpriteName(builder, spriteName):
    return EventContentBuffExcelAddSpriteName(builder, spriteName)
def EventContentBuffExcelAddSkillGroupId(builder, skillGroupId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(skillGroupId), 0)
def AddSkillGroupId(builder, skillGroupId):
    return EventContentBuffExcelAddSkillGroupId(builder, skillGroupId)
def EventContentBuffExcelAddIsBuff(builder, isBuff): builder.PrependBoolSlot(2, isBuff, 0)
def AddIsBuff(builder, isBuff):
    return EventContentBuffExcelAddIsBuff(builder, isBuff)
def EventContentBuffExcelAddEventContentBuffId(builder, eventContentBuffId): builder.PrependInt64Slot(3, eventContentBuffId, 0)
...
def EventContentBuffExcelAddBuffDescriptionLocalizeCodeId(builder, buffDescriptionLocalizeCodeId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(buffDescriptionLocalizeCodeId), 0)
...
def EventContentBuffExcelAddCharacterTag(builder, characterTag): builder.PrependInt32Slot(5, characterTag, 0)
...
def EventContentBuffExcelAddEnumType(builder, enumType): builder.PrependInt32Slot(7, enumType, 0)
def AddEnumType(builder, enumType):
    return EventContentBuffExcelAddEnumType(builder, enumType)
def EventContentBuffExcelAddEnumTypeValue(builder, enumTypeValue): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(enumTypeValue), 0)
