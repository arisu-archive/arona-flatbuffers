...
def ShiftingCraftRecipeExcelAddResultParcel(builder, resultParcel): builder.PrependInt32Slot(0, resultParcel, 0)
...
def ShiftingCraftRecipeExcelAddRequireItemId(builder, requireItemId): builder.PrependInt64Slot(2, requireItemId, 0)
def AddRequireItemId(builder, requireItemId):
    return ShiftingCraftRecipeExcelAddRequireItemId(builder, requireItemId)
def ShiftingCraftRecipeExcelAddRequireGold(builder, requireGold): builder.PrependInt64Slot(3, requireGold, 0)
def AddRequireGold(builder, requireGold):
    return ShiftingCraftRecipeExcelAddRequireGold(builder, requireGold)
def ShiftingCraftRecipeExcelAddIngredientExp(builder, ingredientExp): builder.PrependInt64Slot(4, ingredientExp, 0)
def AddIngredientExp(builder, ingredientExp):
    return ShiftingCraftRecipeExcelAddIngredientExp(builder, ingredientExp)
def ShiftingCraftRecipeExcelAddResultId(builder, resultId): builder.PrependInt64Slot(5, resultId, 0)
def AddResultId(builder, resultId):
    return ShiftingCraftRecipeExcelAddResultId(builder, resultId)
def ShiftingCraftRecipeExcelAddNotificationId(builder, notificationId): builder.PrependInt32Slot(6, notificationId, 0)
def AddNotificationId(builder, notificationId):
    return ShiftingCraftRecipeExcelAddNotificationId(builder, notificationId)
def ShiftingCraftRecipeExcelAddResultAmount(builder, resultAmount): builder.PrependInt64Slot(7, resultAmount, 0)
def AddResultAmount(builder, resultAmount):
    return ShiftingCraftRecipeExcelAddResultAmount(builder, resultAmount)
def ShiftingCraftRecipeExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
...
def ShiftingCraftRecipeExcelAddRequireItemAmount(builder, requireItemAmount): builder.PrependInt64Slot(10, requireItemAmount, 0)
