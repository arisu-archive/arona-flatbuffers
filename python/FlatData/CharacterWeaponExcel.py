...
def CharacterWeaponExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def CharacterWeaponExcelAddUnlock(builder, unlock): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(unlock), 0)
