...
def CharacterWeaponExcelAddLearnSkillSlot(builder, learnSkillSlot):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(learnSkillSlot), 0)
...
def CharacterWeaponExcelAddMaxLevel(builder, maxLevel):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(maxLevel), 0)
...
def CharacterWeaponExcelAddRecipeId(builder, recipeId):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(recipeId), 0)
...
def CharacterWeaponExcelAddStatLevelUpType(builder, statLevelUpType):
    builder.PrependInt32Slot(12, statLevelUpType, 0)
...
def CharacterWeaponExcelAddStatType(builder, statType):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def CharacterWeaponExcelAddStatValue(builder, statValue):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(statValue), 0)
...
def CharacterWeaponExcelAddUnlock(builder, unlock):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(unlock), 0)
