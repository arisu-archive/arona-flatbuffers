...
def CharacterWeaponExcelAddMaxLevel(builder, maxLevel): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(maxLevel), 0)
...
def CharacterWeaponExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(2, statLevelUpType, 0)
def AddStatLevelUpType(builder, statLevelUpType):
    return CharacterWeaponExcelAddStatLevelUpType(builder, statLevelUpType)
def CharacterWeaponExcelAddAttackPower(builder, attackPower): builder.PrependInt64Slot(3, attackPower, 0)
def AddAttackPower(builder, attackPower):
    return CharacterWeaponExcelAddAttackPower(builder, attackPower)
def CharacterWeaponExcelAddImagePath(builder, imagePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(imagePath), 0)
...
def CharacterWeaponExcelAddLearnSkillSlot(builder, learnSkillSlot): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(learnSkillSlot), 0)
...
def CharacterWeaponExcelAddAttackPower100(builder, attackPower100): builder.PrependInt64Slot(11, attackPower100, 0)
def AddAttackPower100(builder, attackPower100):
    return CharacterWeaponExcelAddAttackPower100(builder, attackPower100)
def CharacterWeaponExcelAddSetRecipe(builder, setRecipe): builder.PrependInt64Slot(12, setRecipe, 0)
...
def CharacterWeaponExcelAddMaxHp100(builder, maxHp100): builder.PrependInt64Slot(14, maxHp100, 0)
def AddMaxHp100(builder, maxHp100):
    return CharacterWeaponExcelAddMaxHp100(builder, maxHp100)
def CharacterWeaponExcelAddHealPower(builder, healPower): builder.PrependInt64Slot(15, healPower, 0)
def AddHealPower(builder, healPower):
    return CharacterWeaponExcelAddHealPower(builder, healPower)
def CharacterWeaponExcelAddId(builder, id): builder.PrependInt64Slot(16, id, 0)
