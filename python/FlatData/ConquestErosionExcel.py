...
def ConquestErosionExcelAddPhaseBeforeExposeConditionType(builder, phaseBeforeExposeConditionType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(phaseBeforeExposeConditionType), 0)
...
def ConquestErosionExcelAddConquestRewardId(builder, conquestRewardId): builder.PrependInt64Slot(1, conquestRewardId, 0)
def AddConquestRewardId(builder, conquestRewardId):
    return ConquestErosionExcelAddConquestRewardId(builder, conquestRewardId)
def ConquestErosionExcelAddErosionBattleConditionParcelAmount(builder, erosionBattleConditionParcelAmount): builder.PrependInt64Slot(2, erosionBattleConditionParcelAmount, 0)
...
def ConquestErosionExcelAddStepIndex(builder, stepIndex): builder.PrependInt32Slot(3, stepIndex, 0)
...
def ConquestErosionExcelAddPhaseAlarm(builder, phaseAlarm): builder.PrependBoolSlot(6, phaseAlarm, 0)
...
def ConquestErosionExcelAddPhaseStartConditionType(builder, phaseStartConditionType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(phaseStartConditionType), 0)
...
def ConquestErosionExcelAddPhaseStartConditionParameter(builder, phaseStartConditionParameter): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(phaseStartConditionParameter), 0)
...
def ConquestErosionExcelAddErosionType(builder, erosionType): builder.PrependInt32Slot(10, erosionType, 0)
def AddErosionType(builder, erosionType):
    return ConquestErosionExcelAddErosionType(builder, erosionType)
def ConquestErosionExcelAddErosionBattleConditionParcelType(builder, erosionBattleConditionParcelType): builder.PrependInt32Slot(11, erosionBattleConditionParcelType, 0)
...
def ConquestErosionExcelAddErosionBattleConditionParcelUniqueId(builder, erosionBattleConditionParcelUniqueId): builder.PrependInt64Slot(13, erosionBattleConditionParcelUniqueId, 0)
