...
def BGMExcelAddLoopEndTime(builder, loopEndTime):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(loopEndTime), 0)
...
def BGMExcelAddLoopOffsetTime(builder, loopOffsetTime):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(loopOffsetTime), 0)
...
def BGMExcelAddLoopStartTime(builder, loopStartTime):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(loopStartTime), 0)
...
def BGMExcelAddLoopTranstionTime(builder, loopTranstionTime):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(loopTranstionTime), 0)
...
def BGMExcelAddNation(builder, nation):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(nation), 0)
...
def BGMExcelAddPath(builder, path):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(path), 0)
...
def BGMExcelAddVolume(builder, volume):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(volume), 0)
