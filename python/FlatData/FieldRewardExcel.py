...
def FieldRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(2, groupId, 0)
...
def FieldRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(4, rewardId, 0)
