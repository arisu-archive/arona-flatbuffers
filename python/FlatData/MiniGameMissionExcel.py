...
def MiniGameMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def MiniGameMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MiniGameMissionExcelAddCompleteConditionType(builder, completeConditionType):
    builder.PrependInt32Slot(6, completeConditionType, 0)
...
def MiniGameMissionExcelAddDescription(builder, description):
    builder.PrependUint32Slot(7, description, 0)
...
def MiniGameMissionExcelAddGroupName(builder, groupName):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
...
def MiniGameMissionExcelAddIsCompleteExtensionTime(builder, isCompleteExtensionTime):
    builder.PrependBoolSlot(13, isCompleteExtensionTime, 0)
...
def MiniGameMissionExcelAddMissionRewardAmount(builder, missionRewardAmount):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MiniGameMissionExcelAddPreMissionId(builder, preMissionId):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def MiniGameMissionExcelAddResetType(builder, resetType):
    builder.PrependInt32Slot(18, resetType, 0)
...
def MiniGameMissionExcelAddRewardIcon(builder, rewardIcon):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
...
def MiniGameMissionExcelAddShortcutUi(builder, shortcutUi):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MiniGameMissionExcelAddToastDisplayType(builder, toastDisplayType):
    builder.PrependInt32Slot(21, toastDisplayType, 0)
...
def MiniGameMissionExcelAddToastImagePath(builder, toastImagePath):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
...
def MiniGameMissionExcelAddViewFlag(builder, viewFlag):
    builder.PrependBoolSlot(23, viewFlag, 0)
