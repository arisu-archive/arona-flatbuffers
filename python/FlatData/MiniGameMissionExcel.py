...
def MiniGameMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def MiniGameMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MiniGameMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(6, completeConditionType, 0)
...
def MiniGameMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(7, description, 0)
def AddDescription(builder, description):
    return MiniGameMissionExcelAddDescription(builder, description)
def MiniGameMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(8, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MiniGameMissionExcelAddDisplayOrder(builder, displayOrder)
def MiniGameMissionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(9, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameMissionExcelAddEventContentId(builder, eventContentId)
def MiniGameMissionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(10, groupId, 0)
def AddGroupId(builder, groupId):
    return MiniGameMissionExcelAddGroupId(builder, groupId)
def MiniGameMissionExcelAddGroupName(builder, groupName): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
def AddGroupName(builder, groupName):
    return MiniGameMissionExcelAddGroupName(builder, groupName)
def MiniGameMissionExcelAddId(builder, id): builder.PrependInt64Slot(12, id, 0)
def AddId(builder, id):
    return MiniGameMissionExcelAddId(builder, id)
def MiniGameMissionExcelAddIsCompleteExtensionTime(builder, isCompleteExtensionTime): builder.PrependBoolSlot(13, isCompleteExtensionTime, 0)
...
def MiniGameMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MiniGameMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def MiniGameMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(18, resetType, 0)
def AddResetType(builder, resetType):
    return MiniGameMissionExcelAddResetType(builder, resetType)
def MiniGameMissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return MiniGameMissionExcelAddRewardIcon(builder, rewardIcon)
def MiniGameMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MiniGameMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return MiniGameMissionExcelAddToastImagePath(builder, toastImagePath)
def MiniGameMissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(23, viewFlag, 0)
