...
def SchoolDungeonStageExcelAddDungeonType(builder, dungeonType):
    builder.PrependInt32Slot(2, dungeonType, 0)
...
def SchoolDungeonStageExcelAddEchelonExtensionType(builder, echelonExtensionType):
    builder.PrependInt32Slot(3, echelonExtensionType, 0)
...
def SchoolDungeonStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostAmount), 0)
...
def SchoolDungeonStageExcelAddStageEnterCostId(builder, stageEnterCostId):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostId), 0)
...
def SchoolDungeonStageExcelAddStageEnterCostMinimumAmount(builder, stageEnterCostMinimumAmount):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostMinimumAmount), 0)
...
def SchoolDungeonStageExcelAddStageEnterCostType(builder, stageEnterCostType):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostType), 0)
...
def SchoolDungeonStageExcelAddStarGoalAmount(builder, starGoalAmount):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def SchoolDungeonStageExcelAddStarGoal(builder, starGoal):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
