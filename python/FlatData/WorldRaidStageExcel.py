...
def WorldRaidStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(0, fixedEchelonId, 0)
...
def WorldRaidStageExcelAddSaveCurrentLocalBossHp(builder, saveCurrentLocalBossHp): builder.PrependBoolSlot(2, saveCurrentLocalBossHp, 0)
...
def WorldRaidStageExcelAddBattleReadyTimelinePhaseEnd(builder, battleReadyTimelinePhaseEnd): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseEnd), 0)
...
def WorldRaidStageExcelAddRaidEnterAmount(builder, raidEnterAmount): builder.PrependInt64Slot(4, raidEnterAmount, 0)
def AddRaidEnterAmount(builder, raidEnterAmount):
    return WorldRaidStageExcelAddRaidEnterAmount(builder, raidEnterAmount)
def WorldRaidStageExcelAddRaidBattleEndRewardGroupId(builder, raidBattleEndRewardGroupId): builder.PrependInt64Slot(5, raidBattleEndRewardGroupId, 0)
...
def WorldRaidStageExcelAddPhaseChangeTimelinePath(builder, phaseChangeTimelinePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(phaseChangeTimelinePath), 0)
...
def WorldRaidStageExcelAddTimeLinePhase(builder, timeLinePhase): builder.PrependInt64Slot(7, timeLinePhase, 0)
def AddTimeLinePhase(builder, timeLinePhase):
    return WorldRaidStageExcelAddTimeLinePhase(builder, timeLinePhase)
def WorldRaidStageExcelAddDamageToWorldBoss(builder, damageToWorldBoss): builder.PrependInt64Slot(8, damageToWorldBoss, 0)
...
def WorldRaidStageExcelAddBattleReadyTimelinePhaseStart(builder, battleReadyTimelinePhaseStart): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePhaseStart), 0)
...
def WorldRaidStageExcelAddEnterScenarioKey(builder, enterScenarioKey): builder.PrependInt64Slot(10, enterScenarioKey, 0)
def AddEnterScenarioKey(builder, enterScenarioKey):
    return WorldRaidStageExcelAddEnterScenarioKey(builder, enterScenarioKey)
def WorldRaidStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(11, echelonExtensionType, 0)
...
def WorldRaidStageExcelAddShowSkillCard(builder, showSkillCard): builder.PrependBoolSlot(12, showSkillCard, 0)
def AddShowSkillCard(builder, showSkillCard):
    return WorldRaidStageExcelAddShowSkillCard(builder, showSkillCard)
def WorldRaidStageExcelAddUseBossIndex(builder, useBossIndex): builder.PrependBoolSlot(13, useBossIndex, 0)
...
def WorldRaidStageExcelAddVictoryTimelinePath(builder, victoryTimelinePath): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(victoryTimelinePath), 0)
...
def WorldRaidStageExcelAddAssistCharacterLimitCount(builder, assistCharacterLimitCount): builder.PrependInt64Slot(16, assistCharacterLimitCount, 0)
...
def WorldRaidStageExcelAddAllyPassiveSkill(builder, allyPassiveSkill): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(allyPassiveSkill), 0)
...
def WorldRaidStageExcelAddUseBossAiPhaseSync(builder, useBossAiPhaseSync): builder.PrependBoolSlot(18, useBossAiPhaseSync, 0)
...
def WorldRaidStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(19, groundId, 0)
def AddGroundId(builder, groundId):
    return WorldRaidStageExcelAddGroundId(builder, groundId)
def WorldRaidStageExcelAddRaidRewardGroupId(builder, raidRewardGroupId): builder.PrependInt64Slot(20, raidRewardGroupId, 0)
...
def WorldRaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey): builder.PrependUint32Slot(22, bossBgInfoKey, 0)
def AddBossBgInfoKey(builder, bossBgInfoKey):
    return WorldRaidStageExcelAddBossBgInfoKey(builder, bossBgInfoKey)
def WorldRaidStageExcelAddBossCharacterId(builder, bossCharacterId): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(bossCharacterId), 0)
...
def WorldRaidStageExcelAddWorldRaidDifficulty(builder, worldRaidDifficulty): builder.PrependInt32Slot(24, worldRaidDifficulty, 0)
...
def WorldRaidStageExcelAddBgPath(builder, bgPath): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(bgPath), 0)
...
def WorldRaidStageExcelAddClearScenarioKey(builder, clearScenarioKey): builder.PrependInt64Slot(28, clearScenarioKey, 0)
def AddClearScenarioKey(builder, clearScenarioKey):
    return WorldRaidStageExcelAddClearScenarioKey(builder, clearScenarioKey)
def WorldRaidStageExcelAddDifficultyOpenCondition(builder, difficultyOpenCondition): builder.PrependBoolSlot(29, difficultyOpenCondition, 0)
...
def WorldRaidStageExcelAddReEnterAmount(builder, reEnterAmount): builder.PrependInt64Slot(31, reEnterAmount, 0)
def AddReEnterAmount(builder, reEnterAmount):
    return WorldRaidStageExcelAddReEnterAmount(builder, reEnterAmount)
def WorldRaidStageExcelAddBattleReadyTimelinePath(builder, battleReadyTimelinePath): builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(battleReadyTimelinePath), 0)
...
def WorldRaidStageExcelAddId(builder, id): builder.PrependInt64Slot(33, id, 0)
def AddId(builder, id):
    return WorldRaidStageExcelAddId(builder, id)
def WorldRaidStageExcelAddRaidCharacterId(builder, raidCharacterId): builder.PrependInt64Slot(34, raidCharacterId, 0)
