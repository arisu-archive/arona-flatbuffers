...
def FieldDateExcelAddEndConditionType(builder, endConditionType): builder.PrependInt32Slot(2, endConditionType, 0)
...
def FieldDateExcelAddEndReadyConditionId(builder, endReadyConditionId): builder.PrependInt64Slot(6, endReadyConditionId, 0)
...
def FieldDateExcelAddDateLocalizeKey(builder, dateLocalizeKey): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(dateLocalizeKey), 0)
...
def FieldDateExcelAddOpenDate(builder, openDate): builder.PrependInt64Slot(9, openDate, 0)
def AddOpenDate(builder, openDate):
    return FieldDateExcelAddOpenDate(builder, openDate)
def FieldDateExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(10, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return FieldDateExcelAddSeasonId(builder, seasonId)
def FieldDateExcelAddStartConditionId(builder, startConditionId): builder.PrependInt64Slot(11, startConditionId, 0)
def AddStartConditionId(builder, startConditionId):
    return FieldDateExcelAddStartConditionId(builder, startConditionId)
def FieldDateExcelAddDateResultSpineOffsetX(builder, dateResultSpineOffsetX): builder.PrependFloat32Slot(12, dateResultSpineOffsetX, 0.0)
