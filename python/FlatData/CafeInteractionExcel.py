...
def CafeInteractionExcelAddIgnoreIfUnobtained(builder, ignoreIfUnobtained): builder.PrependBoolSlot(0, ignoreIfUnobtained, 0)
...
def CafeInteractionExcelAddIgnoreIfUnobtainedStartDate(builder, ignoreIfUnobtainedStartDate): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(ignoreIfUnobtainedStartDate), 0)
...
def CafeInteractionExcelAddFavorEmoticonRewardAmount(builder, favorEmoticonRewardAmount): builder.PrependInt64Slot(2, favorEmoticonRewardAmount, 0)
...
def CafeInteractionExcelAddBubbleType(builder, bubbleType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(bubbleType), 0)
...
def CafeInteractionExcelAddFavorEmoticonRewardId(builder, favorEmoticonRewardId): builder.PrependInt64Slot(4, favorEmoticonRewardId, 0)
...
def CafeInteractionExcelAddCafeCharacterState(builder, cafeCharacterState): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(cafeCharacterState), 0)
...
def CafeInteractionExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(8, characterId, 0)
def AddCharacterId(builder, characterId):
    return CafeInteractionExcelAddCharacterId(builder, characterId)
def CafeInteractionExcelAddIgnoreIfUnobtainedEndDate(builder, ignoreIfUnobtainedEndDate): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(ignoreIfUnobtainedEndDate), 0)
