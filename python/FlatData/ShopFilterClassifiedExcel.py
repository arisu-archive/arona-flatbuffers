...
def ShopFilterClassifiedExcelAddConsumeParcelType(builder, consumeParcelType): builder.PrependInt32Slot(1, consumeParcelType, 0)
...
def ShopFilterClassifiedExcelAddGoodsId(builder, goodsId): builder.PrependInt64Slot(2, goodsId, 0)
def AddGoodsId(builder, goodsId):
    return ShopFilterClassifiedExcelAddGoodsId(builder, goodsId)
def ShopFilterClassifiedExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(3, categoryType, 0)
