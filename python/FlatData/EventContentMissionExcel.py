...
def EventContentMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def EventContentMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def EventContentMissionExcelAddGroupName(builder, groupName): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
def AddGroupName(builder, groupName):
    return EventContentMissionExcelAddGroupName(builder, groupName)
def EventContentMissionExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentMissionExcelAddEventContentId(builder, eventContentId)
def EventContentMissionExcelAddIsCompleteExtensionTime(builder, isCompleteExtensionTime): builder.PrependBoolSlot(4, isCompleteExtensionTime, 0)
...
def EventContentMissionExcelAddConditionRewardParcelId(builder, conditionRewardParcelId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelId), 0)
...
def EventContentMissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(7, viewFlag, 0)
def AddViewFlag(builder, viewFlag):
    return EventContentMissionExcelAddViewFlag(builder, viewFlag)
def EventContentMissionExcelAddConditionRewardParcelType(builder, conditionRewardParcelType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelType), 0)
...
def EventContentMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(9, category, 0)
...
def EventContentMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(11, description, 0)
def AddDescription(builder, description):
    return EventContentMissionExcelAddDescription(builder, description)
def EventContentMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def EventContentMissionExcelAddCompleteConditionMissionId(builder, completeConditionMissionId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionMissionId), 0)
...
def EventContentMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(14, completeConditionType, 0)
...
def EventContentMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(15, resetType, 0)
def AddResetType(builder, resetType):
    return EventContentMissionExcelAddResetType(builder, resetType)
def EventContentMissionExcelAddChallengeStageShortcut(builder, challengeStageShortcut): builder.PrependInt64Slot(16, challengeStageShortcut, 0)
...
def EventContentMissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(17, toastDisplayType, 0)
...
def EventContentMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return EventContentMissionExcelAddToastImagePath(builder, toastImagePath)
def EventContentMissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def EventContentMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(21, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return EventContentMissionExcelAddDisplayOrder(builder, displayOrder)
def EventContentMissionExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(22, groupId, 0)
def AddGroupId(builder, groupId):
    return EventContentMissionExcelAddGroupId(builder, groupId)
def EventContentMissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return EventContentMissionExcelAddRewardIcon(builder, rewardIcon)
def EventContentMissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(24, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return EventContentMissionExcelAddAccountLevel(builder, accountLevel)
def EventContentMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def EventContentMissionExcelAddId(builder, id): builder.PrependInt64Slot(26, id, 0)
def AddId(builder, id):
    return EventContentMissionExcelAddId(builder, id)
def EventContentMissionExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(27, accountType, 0)
def AddAccountType(builder, accountType):
    return EventContentMissionExcelAddAccountType(builder, accountType)
def EventContentMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def EventContentMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(29, completeConditionCount, 0)
