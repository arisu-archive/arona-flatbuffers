...
def EventContentMissionExcelAddCompleteConditionMissionId(builder, completeConditionMissionId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionMissionId), 0)
...
def EventContentMissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def EventContentMissionExcelAddConditionRewardParcelId(builder, conditionRewardParcelId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelId), 0)
...
def EventContentMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(3, completeConditionCount, 0)
...
def EventContentMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(4, completeConditionType, 0)
...
def EventContentMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def EventContentMissionExcelAddId(builder, id): builder.PrependInt64Slot(6, id, 0)
def AddId(builder, id):
    return EventContentMissionExcelAddId(builder, id)
def EventContentMissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(7, resetType, 0)
def AddResetType(builder, resetType):
    return EventContentMissionExcelAddResetType(builder, resetType)
def EventContentMissionExcelAddGroupName(builder, groupName): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(groupName), 0)
def AddGroupName(builder, groupName):
    return EventContentMissionExcelAddGroupName(builder, groupName)
def EventContentMissionExcelAddCompleteConditionMissionCount(builder, completeConditionMissionCount): builder.PrependInt64Slot(9, completeConditionMissionCount, 0)
...
def EventContentMissionExcelAddDescription(builder, description): builder.PrependUint32Slot(10, description, 0)
def AddDescription(builder, description):
    return EventContentMissionExcelAddDescription(builder, description)
def EventContentMissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(11, accountLevel, 0)
def AddAccountLevel(builder, accountLevel):
    return EventContentMissionExcelAddAccountLevel(builder, accountLevel)
def EventContentMissionExcelAddConditionRewardAmount(builder, conditionRewardAmount): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardAmount), 0)
...
def EventContentMissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def EventContentMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def EventContentMissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(15, toastDisplayType, 0)
...
def EventContentMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
...
def EventContentMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(18, category, 0)
...
def EventContentMissionExcelAddConditionRewardParcelType(builder, conditionRewardParcelType): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(conditionRewardParcelType), 0)
...
def EventContentMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def EventContentMissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return EventContentMissionExcelAddRewardIcon(builder, rewardIcon)
def EventContentMissionExcelAddChallengeStageShortcut(builder, challengeStageShortcut): builder.PrependInt64Slot(23, challengeStageShortcut, 0)
...
def EventContentMissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(24, viewFlag, 0)
def AddViewFlag(builder, viewFlag):
    return EventContentMissionExcelAddViewFlag(builder, viewFlag)
def EventContentMissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def EventContentMissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def EventContentMissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(29, displayOrder, 0)
