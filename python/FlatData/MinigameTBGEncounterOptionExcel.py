...
def MinigameTBGEncounterOptionExcelAddSlotIndex(builder, slotIndex): builder.PrependInt32Slot(0, slotIndex, 0)
...
def MinigameTBGEncounterOptionExcelAddOptionTitleLocalize(builder, optionTitleLocalize): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(optionTitleLocalize), 0)
...
def MinigameTBGEncounterOptionExcelAddOptionSuccessLocalize(builder, optionSuccessLocalize): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(optionSuccessLocalize), 0)
...
def MinigameTBGEncounterOptionExcelAddRewardHide(builder, rewardHide): builder.PrependBoolSlot(4, rewardHide, 0)
def AddRewardHide(builder, rewardHide):
    return MinigameTBGEncounterOptionExcelAddRewardHide(builder, rewardHide)
def MinigameTBGEncounterOptionExcelAddOptionFailLessDiceCount(builder, optionFailLessDiceCount): builder.PrependInt32Slot(5, optionFailLessDiceCount, 0)
...
def MinigameTBGEncounterOptionExcelAddOptionSuccessRewardGroupId(builder, optionSuccessRewardGroupId): builder.PrependInt64Slot(7, optionSuccessRewardGroupId, 0)
...
def MinigameTBGEncounterOptionExcelAddRunawayOrHigherDiceCount(builder, runawayOrHigherDiceCount): builder.PrependInt32Slot(8, runawayOrHigherDiceCount, 0)
...
def MinigameTBGEncounterOptionExcelAddOptionFailLocalize(builder, optionFailLocalize): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(optionFailLocalize), 0)
...
def MinigameTBGEncounterOptionExcelAddOptionGroupId(builder, optionGroupId): builder.PrependInt64Slot(10, optionGroupId, 0)
def AddOptionGroupId(builder, optionGroupId):
    return MinigameTBGEncounterOptionExcelAddOptionGroupId(builder, optionGroupId)
def MinigameTBGEncounterOptionExcelAddOptionGreatSuccessOrHigherDiceCount(builder, optionGreatSuccessOrHigherDiceCount): builder.PrependInt32Slot(11, optionGreatSuccessOrHigherDiceCount, 0)
