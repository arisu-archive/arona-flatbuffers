...
def MinigameTBGItemExcelAddDiceEffectAniClip(builder, diceEffectAniClip): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(diceEffectAniClip), 0)
...
def MinigameTBGItemExcelAddItemParameter(builder, itemParameter): builder.PrependInt32Slot(1, itemParameter, 0)
def AddItemParameter(builder, itemParameter):
    return MinigameTBGItemExcelAddItemParameter(builder, itemParameter)
def MinigameTBGItemExcelAddBuffIconHudVisible(builder, buffIconHudVisible): builder.PrependBoolSlot(2, buffIconHudVisible, 0)
...
def MinigameTBGItemExcelAddItemType(builder, itemType): builder.PrependInt32Slot(3, itemType, 0)
def AddItemType(builder, itemType):
    return MinigameTBGItemExcelAddItemType(builder, itemType)
def MinigameTBGItemExcelAddTbgItemEffectType(builder, tbgItemEffectType): builder.PrependInt32Slot(4, tbgItemEffectType, 0)
...
def MinigameTBGItemExcelAddEncounterCount(builder, encounterCount): builder.PrependInt32Slot(5, encounterCount, 0)
...
def MinigameTBGItemExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
