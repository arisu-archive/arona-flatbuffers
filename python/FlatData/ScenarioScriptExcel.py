...
def ScenarioScriptExcelAddTeenMode(builder, teenMode): builder.PrependBoolSlot(8, teenMode, 0)
...
def ScenarioScriptExcelAddTextTh(builder, textTh): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(textTh), 0)
def AddTextTh(builder, textTh):
    return ScenarioScriptExcelAddTextTh(builder, textTh)
def ScenarioScriptExcelAddTextTw(builder, textTw): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(textTw), 0)
def AddTextTw(builder, textTw):
    return ScenarioScriptExcelAddTextTw(builder, textTw)
def ScenarioScriptExcelAddTransition(builder, transition): builder.PrependUint32Slot(13, transition, 0)
def AddTransition(builder, transition):
    return ScenarioScriptExcelAddTransition(builder, transition)
def ScenarioScriptExcelAddVoiceId(builder, voiceId): builder.PrependUint32Slot(14, voiceId, 0)
