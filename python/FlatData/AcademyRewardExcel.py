...
def AcademyRewardExcelAddExtraRewardAmount(builder, extraRewardAmount): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardAmount), 0)
...
def AcademyRewardExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
def AddId(builder, id):
    return AcademyRewardExcelAddId(builder, id)
def AcademyRewardExcelAddExtraRewardParcelId(builder, extraRewardParcelId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardParcelId), 0)
...
def AcademyRewardExcelAddExtraRewardProb(builder, extraRewardProb): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardProb), 0)
...
def AcademyRewardExcelAddExtraFavorExpProb(builder, extraFavorExpProb): builder.PrependInt64Slot(4, extraFavorExpProb, 0)
...
def AcademyRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardAmount), 0)
...
def AcademyRewardExcelAddExtraRewardParcelType(builder, extraRewardParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(extraRewardParcelType), 0)
...
def AcademyRewardExcelAddOrderInGroup(builder, orderInGroup): builder.PrependInt64Slot(7, orderInGroup, 0)
def AddOrderInGroup(builder, orderInGroup):
    return AcademyRewardExcelAddOrderInGroup(builder, orderInGroup)
def AcademyRewardExcelAddFavorExp(builder, favorExp): builder.PrependInt64Slot(8, favorExp, 0)
def AddFavorExp(builder, favorExp):
    return AcademyRewardExcelAddFavorExp(builder, favorExp)
def AcademyRewardExcelAddSecretStoneAmount(builder, secretStoneAmount): builder.PrependInt64Slot(9, secretStoneAmount, 0)
...
def AcademyRewardExcelAddLocationRank(builder, locationRank): builder.PrependInt64Slot(10, locationRank, 0)
def AddLocationRank(builder, locationRank):
    return AcademyRewardExcelAddLocationRank(builder, locationRank)
def AcademyRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def AcademyRewardExcelAddExtraFavorExp(builder, extraFavorExp): builder.PrependInt64Slot(12, extraFavorExp, 0)
def AddExtraFavorExp(builder, extraFavorExp):
    return AcademyRewardExcelAddExtraFavorExp(builder, extraFavorExp)
def AcademyRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def AcademyRewardExcelAddIsExtraRewardDisplayed(builder, isExtraRewardDisplayed): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(isExtraRewardDisplayed), 0)
...
def AcademyRewardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(15, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return AcademyRewardExcelAddLocalizeEtcId(builder, localizeEtcId)
def AcademyRewardExcelAddSecretStoneProb(builder, secretStoneProb): builder.PrependInt64Slot(16, secretStoneProb, 0)
def AddSecretStoneProb(builder, secretStoneProb):
    return AcademyRewardExcelAddSecretStoneProb(builder, secretStoneProb)
def AcademyRewardExcelAddLocation(builder, location): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(location), 0)
def AddLocation(builder, location):
    return AcademyRewardExcelAddLocation(builder, location)
def AcademyRewardExcelAddProgressTexture(builder, progressTexture): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(progressTexture), 0)
def AddProgressTexture(builder, progressTexture):
    return AcademyRewardExcelAddProgressTexture(builder, progressTexture)
def AcademyRewardExcelAddScheduleGroupId(builder, scheduleGroupId): builder.PrependInt64Slot(19, scheduleGroupId, 0)
