...
def MissionExcelAddToastDisplayType(builder, toastDisplayType): builder.PrependInt32Slot(0, toastDisplayType, 0)
def AddToastDisplayType(builder, toastDisplayType):
    return MissionExcelAddToastDisplayType(builder, toastDisplayType)
def MissionExcelAddViewFlag(builder, viewFlag): builder.PrependBoolSlot(1, viewFlag, 0)
def AddViewFlag(builder, viewFlag):
    return MissionExcelAddViewFlag(builder, viewFlag)
def MissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
def AddToastImagePath(builder, toastImagePath):
    return MissionExcelAddToastImagePath(builder, toastImagePath)
def MissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(3, completeConditionType, 0)
...
def MissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def MissionExcelAddDescription(builder, description): builder.PrependUint32Slot(5, description, 0)
def AddDescription(builder, description):
    return MissionExcelAddDescription(builder, description)
def MissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def MissionExcelAddDateAutoRefer(builder, dateAutoRefer): builder.PrependInt32Slot(7, dateAutoRefer, 0)
def AddDateAutoRefer(builder, dateAutoRefer):
    return MissionExcelAddDateAutoRefer(builder, dateAutoRefer)
def MissionExcelAddCompleteConditionParameterTag(builder, completeConditionParameterTag): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameterTag), 0)
...
def MissionExcelAddRewardIcon(builder, rewardIcon): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(rewardIcon), 0)
def AddRewardIcon(builder, rewardIcon):
    return MissionExcelAddRewardIcon(builder, rewardIcon)
def MissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def MissionExcelAddCategory(builder, category): builder.PrependInt32Slot(11, category, 0)
def AddCategory(builder, category):
    return MissionExcelAddCategory(builder, category)
def MissionExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return MissionExcelAddStartDate(builder, startDate)
def MissionExcelAddStartableEndDate(builder, startableEndDate): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(startableEndDate), 0)
def AddStartableEndDate(builder, startableEndDate):
    return MissionExcelAddStartableEndDate(builder, startableEndDate)
def MissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def MissionExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
def AddId(builder, id):
    return MissionExcelAddId(builder, id)
def MissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(16, completeConditionCount, 0)
...
def MissionExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(17, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return MissionExcelAddDisplayOrder(builder, displayOrder)
def MissionExcelAddLimit(builder, limit): builder.PrependBoolSlot(18, limit, 0)
def AddLimit(builder, limit):
    return MissionExcelAddLimit(builder, limit)
def MissionExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(19, accountType, 0)
def AddAccountType(builder, accountType):
    return MissionExcelAddAccountType(builder, accountType)
def MissionExcelAddContentTags(builder, contentTags): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(contentTags), 0)
...
def MissionExcelAddShortcutUi(builder, shortcutUi): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(shortcutUi), 0)
...
def MissionExcelAddResetType(builder, resetType): builder.PrependInt32Slot(22, resetType, 0)
def AddResetType(builder, resetType):
    return MissionExcelAddResetType(builder, resetType)
def MissionExcelAddMissionRewardParcelId(builder, missionRewardParcelId): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelId), 0)
...
def MissionExcelAddChallengeStageShortcut(builder, challengeStageShortcut): builder.PrependInt64Slot(24, challengeStageShortcut, 0)
...
def MissionExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return MissionExcelAddEndDate(builder, endDate)
def MissionExcelAddEndDay(builder, endDay): builder.PrependInt64Slot(26, endDay, 0)
def AddEndDay(builder, endDay):
    return MissionExcelAddEndDay(builder, endDay)
def MissionExcelAddAccountLevel(builder, accountLevel): builder.PrependInt64Slot(27, accountLevel, 0)
