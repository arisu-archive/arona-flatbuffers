...
def AcademyLocationExcelAddPrefabPath(builder, prefabPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(prefabPath), 0)
def AddPrefabPath(builder, prefabPath):
    return AcademyLocationExcelAddPrefabPath(builder, prefabPath)
def AcademyLocationExcelAddOpenConditionCount(builder, openConditionCount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(openConditionCount), 0)
...
def AcademyLocationExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(2, rewardParcelId, 0)
def AddRewardParcelId(builder, rewardParcelId):
    return AcademyLocationExcelAddRewardParcelId(builder, rewardParcelId)
def AcademyLocationExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(3, rewardParcelType, 0)
...
def AcademyLocationExcelAddId(builder, id): builder.PrependInt64Slot(5, id, 0)
def AddId(builder, id):
    return AcademyLocationExcelAddId(builder, id)
def AcademyLocationExcelAddIconImagePath(builder, iconImagePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(iconImagePath), 0)
