...
def MinigameTBGDiceExcelAddProbModifyCondition(builder, probModifyCondition): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(probModifyCondition), 0)
...
def MinigameTBGDiceExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameTBGDiceExcelAddEventContentId(builder, eventContentId)
def MinigameTBGDiceExcelAddProbModifyValue(builder, probModifyValue): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(probModifyValue), 0)
...
def MinigameTBGDiceExcelAddDiceGroup(builder, diceGroup): builder.PrependInt32Slot(3, diceGroup, 0)
...
def MinigameTBGDiceExcelAddProb(builder, prob): builder.PrependInt32Slot(6, prob, 0)
