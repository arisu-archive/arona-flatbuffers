...
def CampaignStageExcelAddFirstClearReportEventName(builder, firstClearReportEventName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearReportEventName), 0)
...
def CampaignStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(2, stageEnterCostId, 0)
def AddStageEnterCostId(builder, stageEnterCostId):
    return CampaignStageExcelAddStageEnterCostId(builder, stageEnterCostId)
def CampaignStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(3, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return CampaignStageExcelAddStageTopography(builder, stageTopography)
def CampaignStageExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return CampaignStageExcelAddStrategyMap(builder, strategyMap)
def CampaignStageExcelAddStrategyMapBg(builder, strategyMapBg): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMapBg), 0)
def AddStrategyMapBg(builder, strategyMapBg):
    return CampaignStageExcelAddStrategyMapBg(builder, strategyMapBg)
def CampaignStageExcelAddFirstClearFunnelMessage(builder, firstClearFunnelMessage): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearFunnelMessage), 0)
...
def CampaignStageExcelAddFirstClearEventMessage(builder, firstClearEventMessage): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(firstClearEventMessage), 0)
...
def CampaignStageExcelAddTacticRewardExp(builder, tacticRewardExp): builder.PrependInt64Slot(8, tacticRewardExp, 0)
def AddTacticRewardExp(builder, tacticRewardExp):
    return CampaignStageExcelAddTacticRewardExp(builder, tacticRewardExp)
def CampaignStageExcelAddCleardScenarioId(builder, cleardScenarioId): builder.PrependInt64Slot(9, cleardScenarioId, 0)
def AddCleardScenarioId(builder, cleardScenarioId):
    return CampaignStageExcelAddCleardScenarioId(builder, cleardScenarioId)
def CampaignStageExcelAddStarConditionTurnCount(builder, starConditionTurnCount): builder.PrependInt64Slot(10, starConditionTurnCount, 0)
...
def CampaignStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(11, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return CampaignStageExcelAddRecommandLevel(builder, recommandLevel)
def CampaignStageExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(12, bgmId, 0)
def AddBgmId(builder, bgmId):
    return CampaignStageExcelAddBgmId(builder, bgmId)
def CampaignStageExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(13, stageEnterEchelonCount, 0)
...
def CampaignStageExcelAddDeprecated(builder, deprecated): builder.PrependBoolSlot(14, deprecated, 0)
def AddDeprecated(builder, deprecated):
    return CampaignStageExcelAddDeprecated(builder, deprecated)
def CampaignStageExcelAddId(builder, id): builder.PrependInt64Slot(15, id, 0)
def AddId(builder, id):
    return CampaignStageExcelAddId(builder, id)
def CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(16, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return CampaignStageExcelAddFixedEchelonId(builder, fixedEchelonId)
def CampaignStageExcelAddCampaignStageRewardId(builder, campaignStageRewardId): builder.PrependInt64Slot(17, campaignStageRewardId, 0)
...
def CampaignStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(18, stageEnterCostAmount, 0)
...
def CampaignStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return CampaignStageExcelAddName(builder, name)
def CampaignStageExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def CampaignStageExcelAddStarConditionTacticRankSCount(builder, starConditionTacticRankSCount): builder.PrependInt64Slot(21, starConditionTacticRankSCount, 0)
...
def CampaignStageExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
...
def CampaignStageExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(23, echelonExtensionType, 0)
...
def CampaignStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(25, stageEnterCostType, 0)
...
def CampaignStageExcelAddStageNumber(builder, stageNumber): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(stageNumber), 0)
...
def CampaignStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(28, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return CampaignStageExcelAddBattleDuration(builder, battleDuration)
def CampaignStageExcelAddBgmIdD0807648(builder, bgmIdD0807648): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(bgmIdD0807648), 0)
def AddBgmIdD0807648(builder, bgmIdD0807648):
    return CampaignStageExcelAddBgmIdD0807648(builder, bgmIdD0807648)
def CampaignStageExcelAddStrategySkipGroundId(builder, strategySkipGroundId): builder.PrependInt32Slot(30, strategySkipGroundId, 0)
