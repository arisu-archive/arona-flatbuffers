...
def FieldMasteryLevelExcelAddLevel(builder, level): builder.PrependInt32Slot(1, level, 0)
def AddLevel(builder, level):
    return FieldMasteryLevelExcelAddLevel(builder, level)
def FieldMasteryLevelExcelAddTotalExp(builder, totalExp): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(totalExp), 0)
...
def FieldMasteryLevelExcelAddId(builder, id): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)
