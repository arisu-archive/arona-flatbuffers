...
def CharacterWeaponExpBonusExcelAddWeaponType(builder, weaponType): builder.PrependInt32Slot(1, weaponType, 0)
...
def CharacterWeaponExpBonusExcelAddWeaponExpGrowthB(builder, weaponExpGrowthB): builder.PrependInt32Slot(3, weaponExpGrowthB, 0)
