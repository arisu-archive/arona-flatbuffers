...
def SystemMailExcelAddExpiredDay(builder, expiredDay): builder.PrependInt64Slot(0, expiredDay, 0)
def AddExpiredDay(builder, expiredDay):
    return SystemMailExcelAddExpiredDay(builder, expiredDay)
def SystemMailExcelAddComment(builder, comment): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(comment), 0)
