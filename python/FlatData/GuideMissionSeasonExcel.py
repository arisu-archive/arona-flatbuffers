...
def GuideMissionSeasonExcelAddMaximumLoginCount(builder, maximumLoginCount): builder.PrependInt64Slot(0, maximumLoginCount, 0)
...
def GuideMissionSeasonExcelAddInfomationLocalizeCode(builder, infomationLocalizeCode): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(infomationLocalizeCode), 0)
...
def GuideMissionSeasonExcelAddAccountType(builder, accountType): builder.PrependInt32Slot(2, accountType, 0)
def AddAccountType(builder, accountType):
    return GuideMissionSeasonExcelAddAccountType(builder, accountType)
def GuideMissionSeasonExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return GuideMissionSeasonExcelAddStartDate(builder, startDate)
def GuideMissionSeasonExcelAddStartableEndDate(builder, startableEndDate): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(startableEndDate), 0)
...
def GuideMissionSeasonExcelAddRewardImage(builder, rewardImage): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardImage), 0)
def AddRewardImage(builder, rewardImage):
    return GuideMissionSeasonExcelAddRewardImage(builder, rewardImage)
def GuideMissionSeasonExcelAddRequirementParcelType(builder, requirementParcelType): builder.PrependInt32Slot(6, requirementParcelType, 0)
...
def GuideMissionSeasonExcelAddIsPermanent(builder, isPermanent): builder.PrependBoolSlot(8, isPermanent, 0)
def AddIsPermanent(builder, isPermanent):
    return GuideMissionSeasonExcelAddIsPermanent(builder, isPermanent)
def GuideMissionSeasonExcelAddCloseBannerAfterCompletion(builder, closeBannerAfterCompletion): builder.PrependBoolSlot(9, closeBannerAfterCompletion, 0)
...
def GuideMissionSeasonExcelAddRequirementParcelAmount(builder, requirementParcelAmount): builder.PrependInt32Slot(10, requirementParcelAmount, 0)
...
def GuideMissionSeasonExcelAddEnabled(builder, enabled): builder.PrependBoolSlot(11, enabled, 0)
def AddEnabled(builder, enabled):
    return GuideMissionSeasonExcelAddEnabled(builder, enabled)
def GuideMissionSeasonExcelAddId(builder, id): builder.PrependInt64Slot(12, id, 0)
def AddId(builder, id):
    return GuideMissionSeasonExcelAddId(builder, id)
def GuideMissionSeasonExcelAddPreSeasonId(builder, preSeasonId): builder.PrependInt64Slot(13, preSeasonId, 0)
def AddPreSeasonId(builder, preSeasonId):
    return GuideMissionSeasonExcelAddPreSeasonId(builder, preSeasonId)
def GuideMissionSeasonExcelAddTabType(builder, tabType): builder.PrependInt32Slot(14, tabType, 0)
...
def GuideMissionSeasonExcelAddExpiryDate(builder, expiryDate): builder.PrependInt64Slot(17, expiryDate, 0)
def AddExpiryDate(builder, expiryDate):
    return GuideMissionSeasonExcelAddExpiryDate(builder, expiryDate)
def GuideMissionSeasonExcelAddSpineCharacterId(builder, spineCharacterId): builder.PrependInt64Slot(18, spineCharacterId, 0)
...
def GuideMissionSeasonExcelAddEndDate(builder, endDate): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(endDate), 0)
def AddEndDate(builder, endDate):
    return GuideMissionSeasonExcelAddEndDate(builder, endDate)
def GuideMissionSeasonExcelAddBannerOpenDate(builder, bannerOpenDate): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(bannerOpenDate), 0)
def AddBannerOpenDate(builder, bannerOpenDate):
    return GuideMissionSeasonExcelAddBannerOpenDate(builder, bannerOpenDate)
def GuideMissionSeasonExcelAddTitleLocalizeCode(builder, titleLocalizeCode): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(titleLocalizeCode), 0)
...
def GuideMissionSeasonExcelAddRequirementParcelId(builder, requirementParcelId): builder.PrependInt64Slot(24, requirementParcelId, 0)
