...
def ShopInfoExcelAddRefreshAbleCount(builder, refreshAbleCount): builder.PrependInt64Slot(0, refreshAbleCount, 0)
def AddRefreshAbleCount(builder, refreshAbleCount):
    return ShopInfoExcelAddRefreshAbleCount(builder, refreshAbleCount)
def ShopInfoExcelAddShopUpdateGroupId10(builder, shopUpdateGroupId10): builder.PrependInt32Slot(1, shopUpdateGroupId10, 0)
...
def ShopInfoExcelAddCostParcelType(builder, costParcelType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelType), 0)
...
def ShopInfoExcelAddOpenPeriodTo(builder, openPeriodTo): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(openPeriodTo), 0)
def AddOpenPeriodTo(builder, openPeriodTo):
    return ShopInfoExcelAddOpenPeriodTo(builder, openPeriodTo)
def ShopInfoExcelAddShopUpdateGroupId4(builder, shopUpdateGroupId4): builder.PrependInt32Slot(4, shopUpdateGroupId4, 0)
def AddShopUpdateGroupId4(builder, shopUpdateGroupId4):
    return ShopInfoExcelAddShopUpdateGroupId4(builder, shopUpdateGroupId4)
def ShopInfoExcelAddShopUpdateGroupId5(builder, shopUpdateGroupId5): builder.PrependInt32Slot(5, shopUpdateGroupId5, 0)
def AddShopUpdateGroupId5(builder, shopUpdateGroupId5):
    return ShopInfoExcelAddShopUpdateGroupId5(builder, shopUpdateGroupId5)
def ShopInfoExcelAddShopUpdateGroupId2(builder, shopUpdateGroupId2): builder.PrependInt32Slot(6, shopUpdateGroupId2, 0)
def AddShopUpdateGroupId2(builder, shopUpdateGroupId2):
    return ShopInfoExcelAddShopUpdateGroupId2(builder, shopUpdateGroupId2)
def ShopInfoExcelAddShopUpdateGroupId11(builder, shopUpdateGroupId11): builder.PrependInt32Slot(7, shopUpdateGroupId11, 0)
...
def ShopInfoExcelAddShopUpdateGroupId7(builder, shopUpdateGroupId7): builder.PrependInt32Slot(9, shopUpdateGroupId7, 0)
def AddShopUpdateGroupId7(builder, shopUpdateGroupId7):
    return ShopInfoExcelAddShopUpdateGroupId7(builder, shopUpdateGroupId7)
def ShopInfoExcelAddShopUpdateGroupId1(builder, shopUpdateGroupId1): builder.PrependInt32Slot(10, shopUpdateGroupId1, 0)
def AddShopUpdateGroupId1(builder, shopUpdateGroupId1):
    return ShopInfoExcelAddShopUpdateGroupId1(builder, shopUpdateGroupId1)
def ShopInfoExcelAddAutoRefreshCoolTime(builder, autoRefreshCoolTime): builder.PrependInt64Slot(11, autoRefreshCoolTime, 0)
...
def ShopInfoExcelAddShopUpdateGroupId6(builder, shopUpdateGroupId6): builder.PrependInt32Slot(12, shopUpdateGroupId6, 0)
def AddShopUpdateGroupId6(builder, shopUpdateGroupId6):
    return ShopInfoExcelAddShopUpdateGroupId6(builder, shopUpdateGroupId6)
def ShopInfoExcelAddDisplayParcelId(builder, displayParcelId): builder.PrependInt64Slot(13, displayParcelId, 0)
def AddDisplayParcelId(builder, displayParcelId):
    return ShopInfoExcelAddDisplayParcelId(builder, displayParcelId)
def ShopInfoExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
...
def ShopInfoExcelAddShopUpdateGroupId8(builder, shopUpdateGroupId8): builder.PrependInt32Slot(15, shopUpdateGroupId8, 0)
def AddShopUpdateGroupId8(builder, shopUpdateGroupId8):
    return ShopInfoExcelAddShopUpdateGroupId8(builder, shopUpdateGroupId8)
def ShopInfoExcelAddShopUpdateDate(builder, shopUpdateDate): builder.PrependInt32Slot(16, shopUpdateDate, 0)
def AddShopUpdateDate(builder, shopUpdateDate):
    return ShopInfoExcelAddShopUpdateDate(builder, shopUpdateDate)
def ShopInfoExcelAddDisplayParcelType(builder, displayParcelType): builder.PrependInt32Slot(17, displayParcelType, 0)
def AddDisplayParcelType(builder, displayParcelType):
    return ShopInfoExcelAddDisplayParcelType(builder, displayParcelType)
def ShopInfoExcelAddCostParcelId(builder, costParcelId): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelId), 0)
...
def ShopInfoExcelAddShopUpdateGroupId12(builder, shopUpdateGroupId12): builder.PrependInt32Slot(19, shopUpdateGroupId12, 0)
...
def ShopInfoExcelAddShopProductUpdateTime(builder, shopProductUpdateTime): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(shopProductUpdateTime), 0)
...
def ShopInfoExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(21, categoryType, 0)
def AddCategoryType(builder, categoryType):
    return ShopInfoExcelAddCategoryType(builder, categoryType)
def ShopInfoExcelAddShopUpdateGroupId9(builder, shopUpdateGroupId9): builder.PrependInt32Slot(22, shopUpdateGroupId9, 0)
def AddShopUpdateGroupId9(builder, shopUpdateGroupId9):
    return ShopInfoExcelAddShopUpdateGroupId9(builder, shopUpdateGroupId9)
def ShopInfoExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt32Slot(23, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return ShopInfoExcelAddDisplayOrder(builder, displayOrder)
def ShopInfoExcelAddIsShopVisible(builder, isShopVisible): builder.PrependBoolSlot(24, isShopVisible, 0)
def AddIsShopVisible(builder, isShopVisible):
    return ShopInfoExcelAddIsShopVisible(builder, isShopVisible)
def ShopInfoExcelAddShopUpdateGroupId3(builder, shopUpdateGroupId3): builder.PrependInt32Slot(25, shopUpdateGroupId3, 0)
def AddShopUpdateGroupId3(builder, shopUpdateGroupId3):
    return ShopInfoExcelAddShopUpdateGroupId3(builder, shopUpdateGroupId3)
def ShopInfoExcelAddIsSoldOutDimmed(builder, isSoldOutDimmed): builder.PrependBoolSlot(26, isSoldOutDimmed, 0)
def AddIsSoldOutDimmed(builder, isSoldOutDimmed):
    return ShopInfoExcelAddIsSoldOutDimmed(builder, isSoldOutDimmed)
def ShopInfoExcelAddOpenPeriodFrom(builder, openPeriodFrom): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(openPeriodFrom), 0)
