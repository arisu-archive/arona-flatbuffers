...
def ConquestStepExcelAddMapDifficulty(builder, mapDifficulty): builder.PrependInt32Slot(0, mapDifficulty, 0)
def AddMapDifficulty(builder, mapDifficulty):
    return ConquestStepExcelAddMapDifficulty(builder, mapDifficulty)
def ConquestStepExcelAddUnexpectedEventPrefab(builder, unexpectedEventPrefab): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(unexpectedEventPrefab), 0)
...
def ConquestStepExcelAddTreasureBoxObjectId(builder, treasureBoxObjectId): builder.PrependInt64Slot(2, treasureBoxObjectId, 0)
...
def ConquestStepExcelAddStepEnterScenarioGroupId(builder, stepEnterScenarioGroupId): builder.PrependInt64Slot(3, stepEnterScenarioGroupId, 0)
...
def ConquestStepExcelAddStepEnterItemUniqueId(builder, stepEnterItemUniqueId): builder.PrependInt64Slot(4, stepEnterItemUniqueId, 0)
...
def ConquestStepExcelAddStepEnterItemAmount(builder, stepEnterItemAmount): builder.PrependInt64Slot(5, stepEnterItemAmount, 0)
...
def ConquestStepExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(6, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestStepExcelAddEventContentId(builder, eventContentId)
def ConquestStepExcelAddUnexpectedEventUnitId(builder, unexpectedEventUnitId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(unexpectedEventUnitId), 0)
...
def ConquestStepExcelAddStepGoalLocalize(builder, stepGoalLocalize): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(stepGoalLocalize), 0)
def AddStepGoalLocalize(builder, stepGoalLocalize):
    return ConquestStepExcelAddStepGoalLocalize(builder, stepGoalLocalize)
def ConquestStepExcelAddStepEnterItemType(builder, stepEnterItemType): builder.PrependInt32Slot(11, stepEnterItemType, 0)
