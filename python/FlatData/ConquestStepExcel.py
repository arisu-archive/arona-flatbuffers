...
def ConquestStepExcelAddStepEnterItemType(builder, stepEnterItemType): builder.PrependInt32Slot(1, stepEnterItemType, 0)
...
def ConquestStepExcelAddTreasureBoxCountPerStepOpen(builder, treasureBoxCountPerStepOpen): builder.PrependInt32Slot(4, treasureBoxCountPerStepOpen, 0)
...
def ConquestStepExcelAddTreasureBoxObjectId(builder, treasureBoxObjectId): builder.PrependInt64Slot(5, treasureBoxObjectId, 0)
...
def ConquestStepExcelAddStepGoalLocalize(builder, stepGoalLocalize): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(stepGoalLocalize), 0)
def AddStepGoalLocalize(builder, stepGoalLocalize):
    return ConquestStepExcelAddStepGoalLocalize(builder, stepGoalLocalize)
def ConquestStepExcelAddStepEnterItemUniqueId(builder, stepEnterItemUniqueId): builder.PrependInt64Slot(7, stepEnterItemUniqueId, 0)
...
def ConquestStepExcelAddStepEnterItemAmount(builder, stepEnterItemAmount): builder.PrependInt64Slot(8, stepEnterItemAmount, 0)
...
def ConquestStepExcelAddStepEnterScenarioGroupId(builder, stepEnterScenarioGroupId): builder.PrependInt64Slot(9, stepEnterScenarioGroupId, 0)
...
def ConquestStepExcelAddStep(builder, step): builder.PrependInt32Slot(11, step, 0)
