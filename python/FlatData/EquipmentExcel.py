...
def EquipmentExcelAddRarity(builder, rarity): builder.PrependInt32Slot(0, rarity, 0)
def AddRarity(builder, rarity):
    return EquipmentExcelAddRarity(builder, rarity)
def EquipmentExcelAddShortcutTypeId(builder, shortcutTypeId): builder.PrependInt64Slot(1, shortcutTypeId, 0)
def AddShortcutTypeId(builder, shortcutTypeId):
    return EquipmentExcelAddShortcutTypeId(builder, shortcutTypeId)
def EquipmentExcelAddRecipeId(builder, recipeId): builder.PrependInt32Slot(2, recipeId, 0)
def AddRecipeId(builder, recipeId):
    return EquipmentExcelAddRecipeId(builder, recipeId)
def EquipmentExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return EquipmentExcelAddIcon(builder, icon)
def EquipmentExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def EquipmentExcelAddShiftingCraftQuality(builder, shiftingCraftQuality): builder.PrependInt64Slot(9, shiftingCraftQuality, 0)
...
def EquipmentExcelAddMaxLevel(builder, maxLevel): builder.PrependInt32Slot(10, maxLevel, 0)
...
def EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(12, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EquipmentExcelAddLocalizeEtcId(builder, localizeEtcId)
def EquipmentExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(13, craftQualityTier1, 0)
...
def EquipmentExcelAddId(builder, id): builder.PrependInt64Slot(16, id, 0)
def AddId(builder, id):
    return EquipmentExcelAddId(builder, id)
def EquipmentExcelAddImageName(builder, imageName): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(imageName), 0)
def AddImageName(builder, imageName):
    return EquipmentExcelAddImageName(builder, imageName)
def EquipmentExcelAddEquipmentCategory(builder, equipmentCategory): builder.PrependInt32Slot(18, equipmentCategory, 0)
