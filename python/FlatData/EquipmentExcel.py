...
def EquipmentExcelAddEquipmentCategory(builder, equipmentCategory):
    builder.PrependInt32Slot(3, equipmentCategory, 0)
...
def EquipmentExcelAddImageName(builder, imageName):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(imageName), 0)
...
def EquipmentExcelAddRarity(builder, rarity):
    builder.PrependInt32Slot(10, rarity, 0)
...
def EquipmentExcelAddShopCategory(builder, shopCategory):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def EquipmentExcelAddWear(builder, wear):
    builder.PrependBoolSlot(18, wear, 0)
