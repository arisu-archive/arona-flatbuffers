...
def AcademyMessangerExcelAddMessageEn(builder, messageEn): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(messageEn), 0)
def AddMessageEn(builder, messageEn):
    return AcademyMessangerExcelAddMessageEn(builder, messageEn)
def AcademyMessangerExcelAddMessageGroupId(builder, messageGroupId): builder.PrependInt64Slot(8, messageGroupId, 0)
def AddMessageGroupId(builder, messageGroupId):
    return AcademyMessangerExcelAddMessageGroupId(builder, messageGroupId)
def AcademyMessangerExcelAddMessageJp(builder, messageJp): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(messageJp), 0)
def AddMessageJp(builder, messageJp):
    return AcademyMessangerExcelAddMessageJp(builder, messageJp)
def AcademyMessangerExcelAddMessageKr(builder, messageKr): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(messageKr), 0)
def AddMessageKr(builder, messageKr):
    return AcademyMessangerExcelAddMessageKr(builder, messageKr)
def AcademyMessangerExcelAddMessageTh(builder, messageTh): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(messageTh), 0)
def AddMessageTh(builder, messageTh):
    return AcademyMessangerExcelAddMessageTh(builder, messageTh)
def AcademyMessangerExcelAddMessageTw(builder, messageTw): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(messageTw), 0)
def AddMessageTw(builder, messageTw):
    return AcademyMessangerExcelAddMessageTw(builder, messageTw)
def AcademyMessangerExcelAddMessageType(builder, messageType): builder.PrependInt32Slot(13, messageType, 0)
def AddMessageType(builder, messageType):
    return AcademyMessangerExcelAddMessageType(builder, messageType)
def AcademyMessangerExcelAddNextGroupId(builder, nextGroupId): builder.PrependInt64Slot(14, nextGroupId, 0)
def AddNextGroupId(builder, nextGroupId):
    return AcademyMessangerExcelAddNextGroupId(builder, nextGroupId)
def AcademyMessangerExcelAddPreConditionFavorScheduleId(builder, preConditionFavorScheduleId): builder.PrependInt64Slot(15, preConditionFavorScheduleId, 0)
...
def AcademyMessangerExcelAddPreConditionGroupId(builder, preConditionGroupId): builder.PrependInt64Slot(16, preConditionGroupId, 0)
