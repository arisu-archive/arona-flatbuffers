...
def FieldCurtainCallFreeModeExcelAddSetFieldDateId(builder, setFieldDateId): builder.PrependInt64Slot(0, setFieldDateId, 0)
def AddSetFieldDateId(builder, setFieldDateId):
    return FieldCurtainCallFreeModeExcelAddSetFieldDateId(builder, setFieldDateId)
def FieldCurtainCallFreeModeExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(1, uniqueId, 0)
