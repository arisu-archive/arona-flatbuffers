...
def MinigameTBGSeasonExcelAddMapNameLocalize(builder, mapNameLocalize): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(mapNameLocalize), 0)
def AddMapNameLocalize(builder, mapNameLocalize):
    return MinigameTBGSeasonExcelAddMapNameLocalize(builder, mapNameLocalize)
def MinigameTBGSeasonExcelAddMaxHp(builder, maxHp): builder.PrependInt32Slot(2, maxHp, 0)
def AddMaxHp(builder, maxHp):
    return MinigameTBGSeasonExcelAddMaxHp(builder, maxHp)
def MinigameTBGSeasonExcelAddEchelonRevivalCostAmount(builder, echelonRevivalCostAmount): builder.PrependInt32Slot(3, echelonRevivalCostAmount, 0)
...
def MinigameTBGSeasonExcelAddDefaultEchelonHp(builder, defaultEchelonHp): builder.PrependInt32Slot(4, defaultEchelonHp, 0)
...
def MinigameTBGSeasonExcelAddDefaultItemDiceId(builder, defaultItemDiceId): builder.PrependInt64Slot(5, defaultItemDiceId, 0)
...
def MinigameTBGSeasonExcelAddItemSlot(builder, itemSlot): builder.PrependInt32Slot(8, itemSlot, 0)
def AddItemSlot(builder, itemSlot):
    return MinigameTBGSeasonExcelAddItemSlot(builder, itemSlot)
def MinigameTBGSeasonExcelAddLoopThemaIndex(builder, loopThemaIndex): builder.PrependInt32Slot(9, loopThemaIndex, 0)
def AddLoopThemaIndex(builder, loopThemaIndex):
    return MinigameTBGSeasonExcelAddLoopThemaIndex(builder, loopThemaIndex)
def MinigameTBGSeasonExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(10, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameTBGSeasonExcelAddEventContentId(builder, eventContentId)
def MinigameTBGSeasonExcelAddEventUseCostId(builder, eventUseCostId): builder.PrependInt64Slot(11, eventUseCostId, 0)
def AddEventUseCostId(builder, eventUseCostId):
    return MinigameTBGSeasonExcelAddEventUseCostId(builder, eventUseCostId)
def MinigameTBGSeasonExcelAddMapImagePath(builder, mapImagePath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(mapImagePath), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot1CharacterId(builder, echelonSlot1CharacterId): builder.PrependInt64Slot(14, echelonSlot1CharacterId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot4Portrait(builder, echelonSlot4Portrait): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot4Portrait), 0)
...
def MinigameTBGSeasonExcelAddStartThemaIndex(builder, startThemaIndex): builder.PrependInt32Slot(17, startThemaIndex, 0)
def AddStartThemaIndex(builder, startThemaIndex):
    return MinigameTBGSeasonExcelAddStartThemaIndex(builder, startThemaIndex)
def MinigameTBGSeasonExcelAddEchelonSlot2CharacterId(builder, echelonSlot2CharacterId): builder.PrependInt64Slot(18, echelonSlot2CharacterId, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot4CharacterId(builder, echelonSlot4CharacterId): builder.PrependInt64Slot(20, echelonSlot4CharacterId, 0)
...
def MinigameTBGSeasonExcelAddAttackDamage(builder, attackDamage): builder.PrependInt32Slot(21, attackDamage, 0)
def AddAttackDamage(builder, attackDamage):
    return MinigameTBGSeasonExcelAddAttackDamage(builder, attackDamage)
def MinigameTBGSeasonExcelAddEchelonRevivalCostType(builder, echelonRevivalCostType): builder.PrependInt32Slot(22, echelonRevivalCostType, 0)
...
def MinigameTBGSeasonExcelAddEventUseCostType(builder, eventUseCostType): builder.PrependInt32Slot(23, eventUseCostType, 0)
...
def MinigameTBGSeasonExcelAddInstantClearRound(builder, instantClearRound): builder.PrependInt32Slot(24, instantClearRound, 0)
...
def MinigameTBGSeasonExcelAddCriticalAttackDamage(builder, criticalAttackDamage): builder.PrependInt32Slot(25, criticalAttackDamage, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot1Portrait(builder, echelonSlot1Portrait): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot1Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonRevivalCostId(builder, echelonRevivalCostId): builder.PrependInt64Slot(27, echelonRevivalCostId, 0)
...
def MinigameTBGSeasonExcelAddEnemyMinionHp(builder, enemyMinionHp): builder.PrependInt32Slot(28, enemyMinionHp, 0)
