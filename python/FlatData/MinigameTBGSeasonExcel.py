...
def MinigameTBGSeasonExcelAddEchelonRevivalCostType(builder, echelonRevivalCostType):
    builder.PrependInt32Slot(6, echelonRevivalCostType, 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot2Portrait(builder, echelonSlot2Portrait):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot2Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot3Portrait(builder, echelonSlot3Portrait):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot3Portrait), 0)
...
def MinigameTBGSeasonExcelAddEchelonSlot4Portrait(builder, echelonSlot4Portrait):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(echelonSlot4Portrait), 0)
...
def MinigameTBGSeasonExcelAddEventUseCostType(builder, eventUseCostType):
    builder.PrependInt32Slot(19, eventUseCostType, 0)
...
def MinigameTBGSeasonExcelAddMapImagePath(builder, mapImagePath):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(mapImagePath), 0)
...
def MinigameTBGSeasonExcelAddMapNameLocalize(builder, mapNameLocalize):
    builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(mapNameLocalize), 0)
