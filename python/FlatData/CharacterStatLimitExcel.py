...
def CharacterStatLimitExcelAddStatRatioMaxValue(builder, statRatioMaxValue): builder.PrependInt64Slot(1, statRatioMaxValue, 0)
...
def CharacterStatLimitExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(2, tacticEntityType, 0)
