...
def CharacterAcademyTagsExcelAddForbiddenTags(builder, forbiddenTags): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(forbiddenTags), 0)
...
def CharacterAcademyTagsExcelAddFavorItemTags(builder, favorItemTags): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(favorItemTags), 0)
...
def CharacterAcademyTagsExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return CharacterAcademyTagsExcelAddId(builder, id)
def CharacterAcademyTagsExcelAddZoneWhiteListTags(builder, zoneWhiteListTags): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(zoneWhiteListTags), 0)
...
def CharacterAcademyTagsExcelAddFavorItemUniqueTags(builder, favorItemUniqueTags): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(favorItemUniqueTags), 0)
...
def CharacterAcademyTagsExcelAddFavorTags(builder, favorTags): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(favorTags), 0)
