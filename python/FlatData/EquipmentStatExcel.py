...
def EquipmentStatExcelAddLevelUpFeedCostAmount(builder, levelUpFeedCostAmount): builder.PrependInt64Slot(0, levelUpFeedCostAmount, 0)
...
def EquipmentStatExcelAddStatType(builder, statType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
...
def EquipmentStatExcelAddLevelUpInsertLimit(builder, levelUpInsertLimit): builder.PrependInt32Slot(2, levelUpInsertLimit, 0)
...
def EquipmentStatExcelAddLevelUpFeedCostCurrency(builder, levelUpFeedCostCurrency): builder.PrependInt32Slot(3, levelUpFeedCostCurrency, 0)
...
def EquipmentStatExcelAddMaxStat(builder, maxStat): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(maxStat), 0)
...
def EquipmentStatExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(6, statLevelUpType, 0)
def AddStatLevelUpType(builder, statLevelUpType):
    return EquipmentStatExcelAddStatLevelUpType(builder, statLevelUpType)
def EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax): builder.PrependInt32Slot(7, transcendenceMax, 0)
def AddTranscendenceMax(builder, transcendenceMax):
    return EquipmentStatExcelAddTranscendenceMax(builder, transcendenceMax)
def EquipmentStatExcelAddLevelUpFeedExp(builder, levelUpFeedExp): builder.PrependInt64Slot(8, levelUpFeedExp, 0)
def AddLevelUpFeedExp(builder, levelUpFeedExp):
    return EquipmentStatExcelAddLevelUpFeedExp(builder, levelUpFeedExp)
def EquipmentStatExcelAddDamageFactorGroupId(builder, damageFactorGroupId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(damageFactorGroupId), 0)
...
def EquipmentStatExcelAddEquipmentId(builder, equipmentId): builder.PrependInt64Slot(10, equipmentId, 0)
...
def EquipmentStatExcelAddEquipmentCategory(builder, equipmentCategory): builder.PrependInt32Slot(12, equipmentCategory, 0)
...
def EquipmentStatExcelAddMinStat(builder, minStat): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(minStat), 0)
