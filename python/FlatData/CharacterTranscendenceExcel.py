...
def CharacterTranscendenceExcelAddSkillSlotC(builder, skillSlotC): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(skillSlotC), 0)
...
def CharacterTranscendenceExcelAddSkillSlotB(builder, skillSlotB): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(skillSlotB), 0)
...
def CharacterTranscendenceExcelAddMaxFavorLevel(builder, maxFavorLevel): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(maxFavorLevel), 0)
...
def CharacterTranscendenceExcelAddStatBonusRateHp(builder, statBonusRateHp): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(statBonusRateHp), 0)
...
def CharacterTranscendenceExcelAddMaxlevelStar(builder, maxlevelStar): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(maxlevelStar), 0)
...
def CharacterTranscendenceExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(6, characterId, 0)
def AddCharacterId(builder, characterId):
    return CharacterTranscendenceExcelAddCharacterId(builder, characterId)
def CharacterTranscendenceExcelAddStatBonusRateHeal(builder, statBonusRateHeal): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(statBonusRateHeal), 0)
...
def CharacterTranscendenceExcelAddSkillSlotA(builder, skillSlotA): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(skillSlotA), 0)
...
def CharacterTranscendenceExcelAddRecipeId(builder, recipeId): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(recipeId), 0)
