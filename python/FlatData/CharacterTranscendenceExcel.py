...
def CharacterTranscendenceExcelAddStatBonusRateHp(builder, statBonusRateHp): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(statBonusRateHp), 0)
...
def CharacterTranscendenceExcelAddRecipeId(builder, recipeId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(recipeId), 0)
...
def CharacterTranscendenceExcelAddStatBonusRateAttack(builder, statBonusRateAttack): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(statBonusRateAttack), 0)
...
def CharacterTranscendenceExcelAddSkillSlotC(builder, skillSlotC): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(skillSlotC), 0)
...
def CharacterTranscendenceExcelAddMaxFavorLevel(builder, maxFavorLevel): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(maxFavorLevel), 0)
