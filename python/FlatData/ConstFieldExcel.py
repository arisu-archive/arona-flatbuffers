...
def ConstFieldExcelAddIdleThinkDelayMax(builder, idleThinkDelayMax): builder.PrependInt32Slot(3, idleThinkDelayMax, 0)
def AddIdleThinkDelayMax(builder, idleThinkDelayMax):
    return ConstFieldExcelAddIdleThinkDelayMax(builder, idleThinkDelayMax)
def ConstFieldExcelAddTalkDialogDurationDefault(builder, talkDialogDurationDefault): builder.PrependInt32Slot(4, talkDialogDurationDefault, 0)
