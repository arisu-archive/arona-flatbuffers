...
def FieldQuestExcelAddIsDaily(builder, isDaily): builder.PrependBoolSlot(0, isDaily, 0)
...
def FieldQuestExcelAddAssetPath(builder, assetPath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(assetPath), 0)
def AddAssetPath(builder, assetPath):
    return FieldQuestExcelAddAssetPath(builder, assetPath)
def FieldQuestExcelAddOpendate(builder, opendate): builder.PrependInt64Slot(3, opendate, 0)
def AddOpendate(builder, opendate):
    return FieldQuestExcelAddOpendate(builder, opendate)
def FieldQuestExcelAddProb(builder, prob): builder.PrependInt32Slot(4, prob, 0)
def AddProb(builder, prob):
    return FieldQuestExcelAddProb(builder, prob)
def FieldQuestExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(5, rewardId, 0)
def AddRewardId(builder, rewardId):
    return FieldQuestExcelAddRewardId(builder, rewardId)
def FieldQuestExcelAddFieldSeasonId(builder, fieldSeasonId): builder.PrependInt64Slot(6, fieldSeasonId, 0)
def AddFieldSeasonId(builder, fieldSeasonId):
    return FieldQuestExcelAddFieldSeasonId(builder, fieldSeasonId)
def FieldQuestExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(7, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return FieldQuestExcelAddUniqueId(builder, uniqueId)
def FieldQuestExcelAddFieldDateId(builder, fieldDateId): builder.PrependInt64Slot(8, fieldDateId, 0)
