...
def FieldQuestExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(0, rewardId, 0)
def AddRewardId(builder, rewardId):
    return FieldQuestExcelAddRewardId(builder, rewardId)
def FieldQuestExcelAddOpendate(builder, opendate): builder.PrependInt64Slot(1, opendate, 0)
def AddOpendate(builder, opendate):
    return FieldQuestExcelAddOpendate(builder, opendate)
def FieldQuestExcelAddQuestDescKey(builder, questDescKey): builder.PrependUint32Slot(2, questDescKey, 0)
...
def FieldQuestExcelAddFieldDateId(builder, fieldDateId): builder.PrependInt64Slot(5, fieldDateId, 0)
def AddFieldDateId(builder, fieldDateId):
    return FieldQuestExcelAddFieldDateId(builder, fieldDateId)
def FieldQuestExcelAddProb(builder, prob): builder.PrependInt32Slot(6, prob, 0)
def AddProb(builder, prob):
    return FieldQuestExcelAddProb(builder, prob)
def FieldQuestExcelAddFieldSeasonId(builder, fieldSeasonId): builder.PrependInt64Slot(7, fieldSeasonId, 0)
