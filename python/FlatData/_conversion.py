...
_ACTIVE_TABLE_KEY = ContextVar("arona_flatbuffer_table_key", default=None)
...
def install_object_api(model_type, table_name: str, fields) -> None:
    ...
    if getattr(model_type, "_arona_conversion_installed", False):
        return
    ...
    model_type._arona_conversion_installed = True
