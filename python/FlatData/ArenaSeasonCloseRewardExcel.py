...
def ArenaSeasonCloseRewardExcelAddRankStart(builder, rankStart): builder.PrependInt64Slot(0, rankStart, 0)
def AddRankStart(builder, rankStart):
    return ArenaSeasonCloseRewardExcelAddRankStart(builder, rankStart)
def ArenaSeasonCloseRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(1, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return ArenaSeasonCloseRewardExcelAddRankEnd(builder, rankEnd)
def ArenaSeasonCloseRewardExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(2, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return ArenaSeasonCloseRewardExcelAddSeasonId(builder, seasonId)
def ArenaSeasonCloseRewardExcelAddRewardParcelUniqueName(builder, rewardParcelUniqueName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueName), 0)
...
def ArenaSeasonCloseRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def ArenaSeasonCloseRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def ArenaSeasonCloseRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
