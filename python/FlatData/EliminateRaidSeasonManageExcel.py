...
def EliminateRaidSeasonManageExcelAddMaxSeasonRewardGauage(builder, maxSeasonRewardGauage): builder.PrependInt32Slot(0, maxSeasonRewardGauage, 0)
...
def EliminateRaidSeasonManageExcelAddRankingRewardGroupId(builder, rankingRewardGroupId): builder.PrependInt64Slot(1, rankingRewardGroupId, 0)
...
def EliminateRaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay): builder.PrependInt64Slot(2, seasonDisplay, 0)
def AddSeasonDisplay(builder, seasonDisplay):
    return EliminateRaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay)
def EliminateRaidSeasonManageExcelAddLimitedRewardIdExtreme(builder, limitedRewardIdExtreme): builder.PrependInt64Slot(3, limitedRewardIdExtreme, 0)
...
def EliminateRaidSeasonManageExcelAddSeasonRewardId(builder, seasonRewardId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(seasonRewardId), 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdHardcore(builder, limitedRewardIdHardcore): builder.PrependInt64Slot(5, limitedRewardIdHardcore, 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdInsane(builder, limitedRewardIdInsane): builder.PrependInt64Slot(7, limitedRewardIdInsane, 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdVeryhard(builder, limitedRewardIdVeryhard): builder.PrependInt64Slot(8, limitedRewardIdVeryhard, 0)
...
def EliminateRaidSeasonManageExcelAddSettlementEndDate(builder, settlementEndDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(settlementEndDate), 0)
...
def EliminateRaidSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def EliminateRaidSeasonManageExcelAddLimitedRewardIdNormal(builder, limitedRewardIdNormal): builder.PrependInt64Slot(12, limitedRewardIdNormal, 0)
...
def EliminateRaidSeasonManageExcelAddSeasonEndData(builder, seasonEndData): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(seasonEndData), 0)
def AddSeasonEndData(builder, seasonEndData):
    return EliminateRaidSeasonManageExcelAddSeasonEndData(builder, seasonEndData)
def EliminateRaidSeasonManageExcelAddLimitedRewardIdHard(builder, limitedRewardIdHard): builder.PrependInt64Slot(14, limitedRewardIdHard, 0)
...
def EliminateRaidSeasonManageExcelAddOpenRaidBossGroup03(builder, openRaidBossGroup03): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup03), 0)
...
def EliminateRaidSeasonManageExcelAddOpenRaidBossGroup02(builder, openRaidBossGroup02): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup02), 0)
...
def EliminateRaidSeasonManageExcelAddSeasonStartData(builder, seasonStartData): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(seasonStartData), 0)
...
def EliminateRaidSeasonManageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(18, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return EliminateRaidSeasonManageExcelAddSeasonId(builder, seasonId)
def EliminateRaidSeasonManageExcelAddStackedSeasonRewardGauge(builder, stackedSeasonRewardGauge): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(stackedSeasonRewardGauge), 0)
...
def EliminateRaidSeasonManageExcelAddOpenRaidBossGroup01(builder, openRaidBossGroup01): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup01), 0)
