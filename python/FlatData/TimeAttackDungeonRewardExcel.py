...
def TimeAttackDungeonRewardExcelAddRewardMinPoint(builder, rewardMinPoint):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rewardMinPoint), 0)
...
def TimeAttackDungeonRewardExcelAddRewardParcelDefaultAmount(builder, rewardParcelDefaultAmount):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelDefaultAmount), 0)
...
def TimeAttackDungeonRewardExcelAddRewardParcelMaxAmount(builder, rewardParcelMaxAmount):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelMaxAmount), 0)
...
def TimeAttackDungeonRewardExcelAddRewardType(builder, rewardType):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardType), 0)
