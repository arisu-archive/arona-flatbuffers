...
def EventContentBuffGroupExcelAddEventContentBuffId2(builder, eventContentBuffId2): builder.PrependInt64Slot(0, eventContentBuffId2, 0)
...
def EventContentBuffGroupExcelAddBuffGroupProb(builder, buffGroupProb): builder.PrependInt64Slot(3, buffGroupProb, 0)
def AddBuffGroupProb(builder, buffGroupProb):
    return EventContentBuffGroupExcelAddBuffGroupProb(builder, buffGroupProb)
def EventContentBuffGroupExcelAddBuffNameLocalizeCodeId2(builder, buffNameLocalizeCodeId2): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(buffNameLocalizeCodeId2), 0)
...
def EventContentBuffGroupExcelAddEventContentDebuffId(builder, eventContentDebuffId): builder.PrependInt64Slot(5, eventContentDebuffId, 0)
...
def EventContentBuffGroupExcelAddEventContentBuffId1(builder, eventContentBuffId1): builder.PrependInt64Slot(6, eventContentBuffId1, 0)
...
def EventContentBuffGroupExcelAddBuffContentId(builder, buffContentId): builder.PrependInt64Slot(7, buffContentId, 0)
...
def EventContentBuffGroupExcelAddBuffNameLocalizeCodeId1(builder, buffNameLocalizeCodeId1): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(buffNameLocalizeCodeId1), 0)
...
def EventContentBuffGroupExcelAddBuffDescriptionIconPath2(builder, buffDescriptionIconPath2): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(buffDescriptionIconPath2), 0)
...
def EventContentBuffGroupExcelAddBuffGroupNameLocalizeCodeId(builder, buffGroupNameLocalizeCodeId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(buffGroupNameLocalizeCodeId), 0)
...
def EventContentBuffGroupExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(12, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentBuffGroupExcelAddEventContentId(builder, eventContentId)
def EventContentBuffGroupExcelAddDebuffNameLocalizeCodeId(builder, debuffNameLocalizeCodeId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(debuffNameLocalizeCodeId), 0)
