...
def ItemExcelAddRarity(builder, rarity): builder.PrependInt32Slot(0, rarity, 0)
def AddRarity(builder, rarity):
    return ItemExcelAddRarity(builder, rarity)
def ItemExcelAddExpiryChangeParcelType(builder, expiryChangeParcelType): builder.PrependInt32Slot(1, expiryChangeParcelType, 0)
...
def ItemExcelAddCraftQualityTier2(builder, craftQualityTier2): builder.PrependInt64Slot(2, craftQualityTier2, 0)
def AddCraftQualityTier2(builder, craftQualityTier2):
    return ItemExcelAddCraftQualityTier2(builder, craftQualityTier2)
def ItemExcelAddSpriteName(builder, spriteName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(spriteName), 0)
...
def ItemExcelAddExpiryChangeAmount(builder, expiryChangeAmount): builder.PrependInt64Slot(5, expiryChangeAmount, 0)
...
def ItemExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(7, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return ItemExcelAddProductionStep(builder, productionStep)
def ItemExcelAddExpirationNotifyDateIn(builder, expirationNotifyDateIn): builder.PrependInt32Slot(8, expirationNotifyDateIn, 0)
...
def ItemExcelAddImmediateUse(builder, immediateUse): builder.PrependBoolSlot(9, immediateUse, 0)
def AddImmediateUse(builder, immediateUse):
    return ItemExcelAddImmediateUse(builder, immediateUse)
def ItemExcelAddCraftQualityTier1(builder, craftQualityTier1): builder.PrependInt64Slot(10, craftQualityTier1, 0)
def AddCraftQualityTier1(builder, craftQualityTier1):
    return ItemExcelAddCraftQualityTier1(builder, craftQualityTier1)
def ItemExcelAddMaxGiftTags(builder, maxGiftTags): builder.PrependInt32Slot(11, maxGiftTags, 0)
def AddMaxGiftTags(builder, maxGiftTags):
    return ItemExcelAddMaxGiftTags(builder, maxGiftTags)
def ItemExcelAddStackableFunction(builder, stackableFunction): builder.PrependInt32Slot(12, stackableFunction, 0)
def AddStackableFunction(builder, stackableFunction):
    return ItemExcelAddStackableFunction(builder, stackableFunction)
def ItemExcelAddTierUpgradeRecipeCraftId(builder, tierUpgradeRecipeCraftId): builder.PrependInt64Slot(13, tierUpgradeRecipeCraftId, 0)
...
def ItemExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return ItemExcelAddIcon(builder, icon)
def ItemExcelAddShopCategory(builder, shopCategory): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(shopCategory), 0)
...
def ItemExcelAddUsingResultId(builder, usingResultId): builder.PrependInt64Slot(17, usingResultId, 0)
def AddUsingResultId(builder, usingResultId):
    return ItemExcelAddUsingResultId(builder, usingResultId)
def ItemExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def ItemExcelAddCraftQualityTier0(builder, craftQualityTier0): builder.PrependInt64Slot(19, craftQualityTier0, 0)
def AddCraftQualityTier0(builder, craftQualityTier0):
    return ItemExcelAddCraftQualityTier0(builder, craftQualityTier0)
def ItemExcelAddStackableMax(builder, stackableMax): builder.PrependInt32Slot(20, stackableMax, 0)
def AddStackableMax(builder, stackableMax):
    return ItemExcelAddStackableMax(builder, stackableMax)
def ItemExcelAddGachaTicket(builder, gachaTicket): builder.PrependInt32Slot(21, gachaTicket, 0)
def AddGachaTicket(builder, gachaTicket):
    return ItemExcelAddGachaTicket(builder, gachaTicket)
def ItemExcelAddCanTierUpgrade(builder, canTierUpgrade): builder.PrependBoolSlot(22, canTierUpgrade, 0)
def AddCanTierUpgrade(builder, canTierUpgrade):
    return ItemExcelAddCanTierUpgrade(builder, canTierUpgrade)
def ItemExcelAddExpiryChangeId(builder, expiryChangeId): builder.PrependInt64Slot(23, expiryChangeId, 0)
def AddExpiryChangeId(builder, expiryChangeId):
    return ItemExcelAddExpiryChangeId(builder, expiryChangeId)
def ItemExcelAddMailType(builder, mailType): builder.PrependInt32Slot(24, mailType, 0)
def AddMailType(builder, mailType):
    return ItemExcelAddMailType(builder, mailType)
def ItemExcelAddExpirationDateTime(builder, expirationDateTime): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(expirationDateTime), 0)
def AddExpirationDateTime(builder, expirationDateTime):
    return ItemExcelAddExpirationDateTime(builder, expirationDateTime)
def ItemExcelAddQuality(builder, quality): builder.PrependInt64Slot(26, quality, 0)
def AddQuality(builder, quality):
    return ItemExcelAddQuality(builder, quality)
def ItemExcelAddShortcutTypeId(builder, shortcutTypeId): builder.PrependInt64Slot(27, shortcutTypeId, 0)
def AddShortcutTypeId(builder, shortcutTypeId):
    return ItemExcelAddShortcutTypeId(builder, shortcutTypeId)
def ItemExcelAddId(builder, id): builder.PrependInt64Slot(28, id, 0)
def AddId(builder, id):
    return ItemExcelAddId(builder, id)
def ItemExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(29, groupId, 0)
def AddGroupId(builder, groupId):
    return ItemExcelAddGroupId(builder, groupId)
def ItemExcelAddItemCategory(builder, itemCategory): builder.PrependInt32Slot(30, itemCategory, 0)
