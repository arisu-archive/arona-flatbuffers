...
def WebEventSeasonExcelAddStartDate(builder, startDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(startDate), 0)
def AddStartDate(builder, startDate):
    return WebEventSeasonExcelAddStartDate(builder, startDate)
def WebEventSeasonExcelAddStageEventUrl(builder, stageEventUrl): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(stageEventUrl), 0)
def AddStageEventUrl(builder, stageEventUrl):
    return WebEventSeasonExcelAddStageEventUrl(builder, stageEventUrl)
def WebEventSeasonExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
...
def WebEventSeasonExcelAddPopupTitleLocalizeKey(builder, popupTitleLocalizeKey): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(popupTitleLocalizeKey), 0)
...
def WebEventSeasonExcelAddEnabled(builder, enabled): builder.PrependBoolSlot(6, enabled, 0)
def AddEnabled(builder, enabled):
    return WebEventSeasonExcelAddEnabled(builder, enabled)
def WebEventSeasonExcelAddLobbyBannerImage(builder, lobbyBannerImage): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(lobbyBannerImage), 0)
