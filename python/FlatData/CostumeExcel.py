...
def CostumeExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleEndDate), 0)
...
def CostumeExcelAddModelPrefabName(builder, modelPrefabName): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
def AddModelPrefabName(builder, modelPrefabName):
    return CostumeExcelAddModelPrefabName(builder, modelPrefabName)
def CostumeExcelAddAnimationValidator(builder, animationValidator): builder.PrependBoolSlot(3, animationValidator, 0)
def AddAnimationValidator(builder, animationValidator):
    return CostumeExcelAddAnimationValidator(builder, animationValidator)
def CostumeExcelAddCollectionBgTexturePath(builder, collectionBgTexturePath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(collectionBgTexturePath), 0)
...
def CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId): builder.PrependInt64Slot(5, costumeUniqueId, 0)
def AddCostumeUniqueId(builder, costumeUniqueId):
    return CostumeExcelAddCostumeUniqueId(builder, costumeUniqueId)
def CostumeExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(6, characterSkillListGroupId, 0)
...
def CostumeExcelAddReleaseDate(builder, releaseDate): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(releaseDate), 0)
def AddReleaseDate(builder, releaseDate):
    return CostumeExcelAddReleaseDate(builder, releaseDate)
def CostumeExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return CostumeExcelAddDevName(builder, devName)
def CostumeExcelAddAnimationSsr(builder, animationSsr): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(animationSsr), 0)
def AddAnimationSsr(builder, animationSsr):
    return CostumeExcelAddAnimationSsr(builder, animationSsr)
def CostumeExcelAddUseObjectHpbar(builder, useObjectHpbar): builder.PrependBoolSlot(10, useObjectHpbar, 0)
def AddUseObjectHpbar(builder, useObjectHpbar):
    return CostumeExcelAddUseObjectHpbar(builder, useObjectHpbar)
def CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus): builder.PrependBoolSlot(11, showObjectHpStatus, 0)
def AddShowObjectHpStatus(builder, showObjectHpStatus):
    return CostumeExcelAddShowObjectHpStatus(builder, showObjectHpStatus)
def CostumeExcelAddCombatStyleTexturePath(builder, combatStyleTexturePath): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(combatStyleTexturePath), 0)
...
def CostumeExcelAddEntityMaterialType(builder, entityMaterialType): builder.PrependInt32Slot(13, entityMaterialType, 0)
def AddEntityMaterialType(builder, entityMaterialType):
    return CostumeExcelAddEntityMaterialType(builder, entityMaterialType)
def CostumeExcelAddInformationPacel(builder, informationPacel): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(informationPacel), 0)
...
def CostumeExcelAddTextureDir(builder, textureDir): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(textureDir), 0)
def AddTextureDir(builder, textureDir):
    return CostumeExcelAddTextureDir(builder, textureDir)
def CostumeExcelAddIsDefault(builder, isDefault): builder.PrependBoolSlot(17, isDefault, 0)
def AddIsDefault(builder, isDefault):
    return CostumeExcelAddIsDefault(builder, isDefault)
def CostumeExcelAddCafeModelPrefabName(builder, cafeModelPrefabName): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(cafeModelPrefabName), 0)
...
def CostumeExcelAddEnterStrategyAnimationName(builder, enterStrategyAnimationName): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(enterStrategyAnimationName), 0)
...
def CostumeExcelAddTextureBoss(builder, textureBoss): builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(textureBoss), 0)
def AddTextureBoss(builder, textureBoss):
    return CostumeExcelAddTextureBoss(builder, textureBoss)
def CostumeExcelAddSpineResourceNameDiorama(builder, spineResourceNameDiorama): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceNameDiorama), 0)
...
def CostumeExcelAddSpineResourceNameDioramaForFormConversion(builder, spineResourceNameDioramaForFormConversion): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceNameDioramaForFormConversion), 0)
...
def CostumeExcelAddTextureSkillCard(builder, textureSkillCard): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(textureSkillCard), 0)
...
def CostumeExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleStartDate), 0)
...
def CostumeExcelAddStrategyModelPrefabName(builder, strategyModelPrefabName): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(strategyModelPrefabName), 0)
...
def CostumeExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(26, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CostumeExcelAddProductionStep(builder, productionStep)
def CostumeExcelAddCollectionTexturePath(builder, collectionTexturePath): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(collectionTexturePath), 0)
...
def CostumeExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(28, collectionVisible, 0)
def AddCollectionVisible(builder, collectionVisible):
    return CostumeExcelAddCollectionVisible(builder, collectionVisible)
def CostumeExcelAddCharacterVoiceGroupId(builder, characterVoiceGroupId): builder.PrependInt64Slot(29, characterVoiceGroupId, 0)
...
def CostumeExcelAddRarity(builder, rarity): builder.PrependInt32Slot(30, rarity, 0)
def AddRarity(builder, rarity):
    return CostumeExcelAddRarity(builder, rarity)
def CostumeExcelAddSpineResourceName(builder, spineResourceName): builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceName), 0)
