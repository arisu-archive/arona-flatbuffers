...
def WeekDungeonRewardExcelAddIsDisplayed(builder, isDisplayed): builder.PrependBoolSlot(0, isDisplayed, 0)
def AddIsDisplayed(builder, isDisplayed):
    return WeekDungeonRewardExcelAddIsDisplayed(builder, isDisplayed)
def WeekDungeonRewardExcelAddRewardParcelProbability(builder, rewardParcelProbability): builder.PrependInt64Slot(1, rewardParcelProbability, 0)
...
def WeekDungeonRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(2, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return WeekDungeonRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def WeekDungeonRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(3, groupId, 0)
def AddGroupId(builder, groupId):
    return WeekDungeonRewardExcelAddGroupId(builder, groupId)
def WeekDungeonRewardExcelAddDropItemModelPrefabPath(builder, dropItemModelPrefabPath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(dropItemModelPrefabPath), 0)
...
def WeekDungeonRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependInt64Slot(7, rewardParcelId, 0)
