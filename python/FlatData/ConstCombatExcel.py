...
def ConstCombatExcelAddEchelonMaxOverloadCost(builder, echelonMaxOverloadCost):
    builder.PrependInt64Slot(92, echelonMaxOverloadCost, 0)
...
def ConstCombatExcelAddEchelonExtensionMaxOverloadCost(builder, echelonExtensionMaxOverloadCost):
    builder.PrependInt64Slot(93, echelonExtensionMaxOverloadCost, 0)
...
def ConstCombatExcelAddEchelonExtensionEchelonInitCommonCost(builder, echelonExtensionEchelonInitCommonCost):
    builder.PrependInt32Slot(94, echelonExtensionEchelonInitCommonCost, 0)
...
def ConstCombatExcelAddEchelonExtensionCostRegenRatio(builder, echelonExtensionCostRegenRatio):
    builder.PrependInt64Slot(95, echelonExtensionCostRegenRatio, 0)
...
def ConstCombatExcelAddEchelonOverloadCostRegenRatio(builder, echelonOverloadCostRegenRatio):
    builder.PrependInt64Slot(96, echelonOverloadCostRegenRatio, 0)
...
def ConstCombatExcelAddEchelonExtensionOverloadCostRegenRatio(builder, echelonExtensionOverloadCostRegenRatio):
    builder.PrependInt64Slot(97, echelonExtensionOverloadCostRegenRatio, 0)
...
def ConstCombatExcelAddCheckCheaterMaxUseCostMultiFloorRaid(builder, checkCheaterMaxUseCostMultiFloorRaid):
    builder.PrependInt32Slot(98, checkCheaterMaxUseCostMultiFloorRaid, 0)
...
def ConstCombatExcelAddExcessiveTouchCheckTime(builder, excessiveTouchCheckTime):
    builder.PrependFloat32Slot(99, excessiveTouchCheckTime, 0.0)
...
def ConstCombatExcelAddCampaignAlertPopupLevelGap(builder, campaignAlertPopupLevelGap):
    builder.PrependInt32Slot(101, campaignAlertPopupLevelGap, 0)
...
def ConstCombatExcelAddMoveCorrectionSkipRatio(builder, moveCorrectionSkipRatio):
    builder.PrependInt32Slot(102, moveCorrectionSkipRatio, 0)
...
def ConstCombatExcelAddObstacleColliderHeightJumpable(builder, obstacleColliderHeightJumpable):
    builder.PrependFloat32Slot(103, obstacleColliderHeightJumpable, 0.0)
...
def ConstCombatExcelAddObstacleColliderHeightNotJumpable(builder, obstacleColliderHeightNotJumpable):
    builder.PrependFloat32Slot(104, obstacleColliderHeightNotJumpable, 0.0)
...
class ConstCombatExcelT(object):
    ...
    def __init__(
        ...
        self.worldbossbattlelittleTw = worldbossbattlelittleTw  # type: int
        self.worldbossbattlelittleAsia = worldbossbattlelittleAsia  # type: int
        self.worldbossbattlelittleNa = worldbossbattlelittleNa  # type: int
        self.worldbossbattlelittleGlobal = worldbossbattlelittleGlobal  # type: int
        self.worldbossbattlemiddle = worldbossbattlemiddle  # type: int
        self.worldbossbattlemiddleTw = worldbossbattlemiddleTw  # type: int
        self.worldbossbattlemiddleAsia = worldbossbattlemiddleAsia  # type: int
        self.worldbossbattlemiddleNa = worldbossbattlemiddleNa  # type: int
        self.worldbossbattlemiddleGlobal = worldbossbattlemiddleGlobal  # type: int
        self.worldbossbattlehigh = worldbossbattlehigh  # type: int
        self.worldbossbattlehighTw = worldbossbattlehighTw  # type: int
        self.worldbossbattlehighAsia = worldbossbattlehighAsia  # type: int
        self.worldbossbattlehighNa = worldbossbattlehighNa  # type: int
        self.worldbossbattlehighGlobal = worldbossbattlehighGlobal  # type: int
        self.worldbossbattleveryhigh = worldbossbattleveryhigh  # type: int
        self.worldbossbattleveryhighTw = worldbossbattleveryhighTw  # type: int
        self.worldbossbattleveryhighAsia = worldbossbattleveryhighAsia  # type: int
        self.worldbossbattleveryhighNa = worldbossbattleveryhighNa  # type: int
        self.worldbossbattleveryhighGlobal = worldbossbattleveryhighGlobal  # type: int
    ...
    def _UnPack(self, constCombatExcel):
        ...
        self.worldbossbattlelittleTw = constCombatExcel.WorldbossbattlelittleTw()
        self.worldbossbattlelittleAsia = constCombatExcel.WorldbossbattlelittleAsia()
        self.worldbossbattlelittleNa = constCombatExcel.WorldbossbattlelittleNa()
        self.worldbossbattlelittleGlobal = constCombatExcel.WorldbossbattlelittleGlobal()
        self.worldbossbattlemiddle = constCombatExcel.Worldbossbattlemiddle()
        self.worldbossbattlemiddleTw = constCombatExcel.WorldbossbattlemiddleTw()
        self.worldbossbattlemiddleAsia = constCombatExcel.WorldbossbattlemiddleAsia()
        self.worldbossbattlemiddleNa = constCombatExcel.WorldbossbattlemiddleNa()
        self.worldbossbattlemiddleGlobal = constCombatExcel.WorldbossbattlemiddleGlobal()
        self.worldbossbattlehigh = constCombatExcel.Worldbossbattlehigh()
        self.worldbossbattlehighTw = constCombatExcel.WorldbossbattlehighTw()
        self.worldbossbattlehighAsia = constCombatExcel.WorldbossbattlehighAsia()
        self.worldbossbattlehighNa = constCombatExcel.WorldbossbattlehighNa()
        self.worldbossbattlehighGlobal = constCombatExcel.WorldbossbattlehighGlobal()
        self.worldbossbattleveryhigh = constCombatExcel.Worldbossbattleveryhigh()
        self.worldbossbattleveryhighTw = constCombatExcel.WorldbossbattleveryhighTw()
        self.worldbossbattleveryhighAsia = constCombatExcel.WorldbossbattleveryhighAsia()
        self.worldbossbattleveryhighNa = constCombatExcel.WorldbossbattleveryhighNa()
        self.worldbossbattleveryhighGlobal = constCombatExcel.WorldbossbattleveryhighGlobal()
    ...
    def Pack(self, builder):
        ...
        ConstCombatExcelAddWorldbossbattlelittleTw(builder, self.worldbossbattlelittleTw)
        ConstCombatExcelAddWorldbossbattlelittleAsia(builder, self.worldbossbattlelittleAsia)
        ConstCombatExcelAddWorldbossbattlelittleNa(builder, self.worldbossbattlelittleNa)
        ConstCombatExcelAddWorldbossbattlelittleGlobal(builder, self.worldbossbattlelittleGlobal)
        ConstCombatExcelAddWorldbossbattlemiddle(builder, self.worldbossbattlemiddle)
        ConstCombatExcelAddWorldbossbattlemiddleTw(builder, self.worldbossbattlemiddleTw)
        ConstCombatExcelAddWorldbossbattlemiddleAsia(builder, self.worldbossbattlemiddleAsia)
        ConstCombatExcelAddWorldbossbattlemiddleNa(builder, self.worldbossbattlemiddleNa)
        ConstCombatExcelAddWorldbossbattlemiddleGlobal(builder, self.worldbossbattlemiddleGlobal)
        ConstCombatExcelAddWorldbossbattlehigh(builder, self.worldbossbattlehigh)
        ConstCombatExcelAddWorldbossbattlehighTw(builder, self.worldbossbattlehighTw)
        ConstCombatExcelAddWorldbossbattlehighAsia(builder, self.worldbossbattlehighAsia)
        ConstCombatExcelAddWorldbossbattlehighNa(builder, self.worldbossbattlehighNa)
        ConstCombatExcelAddWorldbossbattlehighGlobal(builder, self.worldbossbattlehighGlobal)
        ConstCombatExcelAddWorldbossbattleveryhigh(builder, self.worldbossbattleveryhigh)
        ConstCombatExcelAddWorldbossbattleveryhighTw(builder, self.worldbossbattleveryhighTw)
        ConstCombatExcelAddWorldbossbattleveryhighAsia(builder, self.worldbossbattleveryhighAsia)
        ConstCombatExcelAddWorldbossbattleveryhighNa(builder, self.worldbossbattleveryhighNa)
        ConstCombatExcelAddWorldbossbattleveryhighGlobal(builder, self.worldbossbattleveryhighGlobal)
