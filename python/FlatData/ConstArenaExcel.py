...
def ConstArenaExcelAddDefenseCoolTime(builder, defenseCoolTime): builder.PrependInt64Slot(0, defenseCoolTime, 0)
def AddDefenseCoolTime(builder, defenseCoolTime):
    return ConstArenaExcelAddDefenseCoolTime(builder, defenseCoolTime)
def ConstArenaExcelAddMapSlotHideRank(builder, mapSlotHideRank): builder.PrependInt64Slot(1, mapSlotHideRank, 0)
def AddMapSlotHideRank(builder, mapSlotHideRank):
    return ConstArenaExcelAddMapSlotHideRank(builder, mapSlotHideRank)
def ConstArenaExcelAddTicketCost(builder, ticketCost): builder.PrependInt64Slot(2, ticketCost, 0)
def AddTicketCost(builder, ticketCost):
    return ConstArenaExcelAddTicketCost(builder, ticketCost)
def ConstArenaExcelAddShowSeasonId(builder, showSeasonId): builder.PrependInt64Slot(3, showSeasonId, 0)
def AddShowSeasonId(builder, showSeasonId):
    return ConstArenaExcelAddShowSeasonId(builder, showSeasonId)
def ConstArenaExcelAddDefenseVictoryRewardMaxCount(builder, defenseVictoryRewardMaxCount): builder.PrependInt64Slot(4, defenseVictoryRewardMaxCount, 0)
...
def ConstArenaExcelAddNpcMainCharacterCount(builder, npcMainCharacterCount): builder.PrependInt64Slot(5, npcMainCharacterCount, 0)
...
def ConstArenaExcelAddHiddenCharacterImagePath(builder, hiddenCharacterImagePath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(hiddenCharacterImagePath), 0)
...
def ConstArenaExcelAddShowSeasonChangeInfoEndTime(builder, showSeasonChangeInfoEndTime): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(showSeasonChangeInfoEndTime), 0)
...
def ConstArenaExcelAddAttackCoolTime(builder, attackCoolTime): builder.PrependInt64Slot(9, attackCoolTime, 0)
def AddAttackCoolTime(builder, attackCoolTime):
    return ConstArenaExcelAddAttackCoolTime(builder, attackCoolTime)
def ConstArenaExcelAddRelativeOpponentRankStart(builder, relativeOpponentRankStart): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(relativeOpponentRankStart), 0)
...
def ConstArenaExcelAddDailyRewardResetTime(builder, dailyRewardResetTime): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(dailyRewardResetTime), 0)
...
def ConstArenaExcelAddNpcName(builder, npcName): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(npcName), 0)
...
def ConstArenaExcelAddEnterCostId(builder, enterCostId): builder.PrependInt64Slot(13, enterCostId, 0)
def AddEnterCostId(builder, enterCostId):
    return ConstArenaExcelAddEnterCostId(builder, enterCostId)
def ConstArenaExcelAddShowSeasonChangeInfoStartTime(builder, showSeasonChangeInfoStartTime): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(showSeasonChangeInfoStartTime), 0)
...
def ConstArenaExcelAddNpcSupportCharacterCount(builder, npcSupportCharacterCount): builder.PrependInt64Slot(15, npcSupportCharacterCount, 0)
...
def ConstArenaExcelAddRelativeOpponentRankEnd(builder, relativeOpponentRankEnd): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(relativeOpponentRankEnd), 0)
...
def ConstArenaExcelAddStatSumFactor(builder, statSumFactor): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(statSumFactor), 0)
...
def ConstArenaExcelAddTopRankerCountLimit(builder, topRankerCountLimit): builder.PrependInt64Slot(19, topRankerCountLimit, 0)
...
def ConstArenaExcelAddNpcCharacterSkillLevel(builder, npcCharacterSkillLevel): builder.PrependInt64Slot(20, npcCharacterSkillLevel, 0)
...
def ConstArenaExcelAddAutoRefreshIntervalMilliSeconds(builder, autoRefreshIntervalMilliSeconds): builder.PrependInt64Slot(21, autoRefreshIntervalMilliSeconds, 0)
...
def ConstArenaExcelAddEnterCostType(builder, enterCostType): builder.PrependInt32Slot(22, enterCostType, 0)
def AddEnterCostType(builder, enterCostType):
    return ConstArenaExcelAddEnterCostType(builder, enterCostType)
def ConstArenaExcelAddCharacterSlotHideRank(builder, characterSlotHideRank): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(characterSlotHideRank), 0)
...
def ConstArenaExcelAddArenaHistoryQueryLimitDays(builder, arenaHistoryQueryLimitDays): builder.PrependInt32Slot(25, arenaHistoryQueryLimitDays, 0)
...
def ConstArenaExcelAddTimeRewardMaxAmount(builder, timeRewardMaxAmount): builder.PrependInt64Slot(26, timeRewardMaxAmount, 0)
...
def ConstArenaExcelAddModifiedStatType(builder, modifiedStatType): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(modifiedStatType), 0)
...
def ConstArenaExcelAddSkipAllowedTimeMilliSeconds(builder, skipAllowedTimeMilliSeconds): builder.PrependInt64Slot(29, skipAllowedTimeMilliSeconds, 0)
