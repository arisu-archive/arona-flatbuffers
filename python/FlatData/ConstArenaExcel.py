...
def ConstArenaExcelAddTicketCost(builder, ticketCost): builder.PrependInt64Slot(0, ticketCost, 0)
def AddTicketCost(builder, ticketCost):
    return ConstArenaExcelAddTicketCost(builder, ticketCost)
def ConstArenaExcelAddArenaHistoryQueryLimitDays(builder, arenaHistoryQueryLimitDays): builder.PrependInt32Slot(1, arenaHistoryQueryLimitDays, 0)
...
def ConstArenaExcelAddTimeRewardMaxAmount(builder, timeRewardMaxAmount): builder.PrependInt64Slot(2, timeRewardMaxAmount, 0)
...
def ConstArenaExcelAddNpcName(builder, npcName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(npcName), 0)
...
def ConstArenaExcelAddShowSeasonChangeInfoStartTime(builder, showSeasonChangeInfoStartTime): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(showSeasonChangeInfoStartTime), 0)
...
def ConstArenaExcelAddRelativeOpponentRankStart(builder, relativeOpponentRankStart): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(relativeOpponentRankStart), 0)
...
def ConstArenaExcelAddSkipAllowedTimeMilliSeconds(builder, skipAllowedTimeMilliSeconds): builder.PrependInt64Slot(7, skipAllowedTimeMilliSeconds, 0)
...
def ConstArenaExcelAddNpcCharacterSkillLevel(builder, npcCharacterSkillLevel): builder.PrependInt64Slot(8, npcCharacterSkillLevel, 0)
...
def ConstArenaExcelAddModifiedStatType(builder, modifiedStatType): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(modifiedStatType), 0)
...
def ConstArenaExcelAddCharacterSlotHideRank(builder, characterSlotHideRank): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(characterSlotHideRank), 0)
...
def ConstArenaExcelAddNpcMainCharacterCount(builder, npcMainCharacterCount): builder.PrependInt64Slot(11, npcMainCharacterCount, 0)
...
def ConstArenaExcelAddTimeSpanInDaysForBattleHistory(builder, timeSpanInDaysForBattleHistory): builder.PrependInt64Slot(12, timeSpanInDaysForBattleHistory, 0)
...
def ConstArenaExcelAddAutoRefreshIntervalMilliSeconds(builder, autoRefreshIntervalMilliSeconds): builder.PrependInt64Slot(13, autoRefreshIntervalMilliSeconds, 0)
...
def ConstArenaExcelAddStatMulFactor(builder, statMulFactor): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(statMulFactor), 0)
...
def ConstArenaExcelAddShowSeasonChangeInfoEndTime(builder, showSeasonChangeInfoEndTime): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(showSeasonChangeInfoEndTime), 0)
...
def ConstArenaExcelAddDefenseVictoryRewardMaxCount(builder, defenseVictoryRewardMaxCount): builder.PrependInt64Slot(16, defenseVictoryRewardMaxCount, 0)
...
def ConstArenaExcelAddAttackCoolTime(builder, attackCoolTime): builder.PrependInt64Slot(17, attackCoolTime, 0)
def AddAttackCoolTime(builder, attackCoolTime):
    return ConstArenaExcelAddAttackCoolTime(builder, attackCoolTime)
def ConstArenaExcelAddEnterCostId(builder, enterCostId): builder.PrependInt64Slot(18, enterCostId, 0)
def AddEnterCostId(builder, enterCostId):
    return ConstArenaExcelAddEnterCostId(builder, enterCostId)
def ConstArenaExcelAddEnterCostType(builder, enterCostType): builder.PrependInt32Slot(19, enterCostType, 0)
def AddEnterCostType(builder, enterCostType):
    return ConstArenaExcelAddEnterCostType(builder, enterCostType)
def ConstArenaExcelAddEndAlarm(builder, endAlarm): builder.PrependInt64Slot(20, endAlarm, 0)
def AddEndAlarm(builder, endAlarm):
    return ConstArenaExcelAddEndAlarm(builder, endAlarm)
def ConstArenaExcelAddShowSeasonId(builder, showSeasonId): builder.PrependInt64Slot(21, showSeasonId, 0)
def AddShowSeasonId(builder, showSeasonId):
    return ConstArenaExcelAddShowSeasonId(builder, showSeasonId)
def ConstArenaExcelAddHiddenCharacterImagePath(builder, hiddenCharacterImagePath): builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(hiddenCharacterImagePath), 0)
...
def ConstArenaExcelAddStatSumFactor(builder, statSumFactor): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(statSumFactor), 0)
...
def ConstArenaExcelAddOpenScenarioId(builder, openScenarioId): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(openScenarioId), 0)
def AddOpenScenarioId(builder, openScenarioId):
    return ConstArenaExcelAddOpenScenarioId(builder, openScenarioId)
def ConstArenaExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(25, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return ConstArenaExcelAddBattleDuration(builder, battleDuration)
def ConstArenaExcelAddRelativeOpponentRankEnd(builder, relativeOpponentRankEnd): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(relativeOpponentRankEnd), 0)
...
def ConstArenaExcelAddTopRankerCountLimit(builder, topRankerCountLimit): builder.PrependInt64Slot(28, topRankerCountLimit, 0)
...
def ConstArenaExcelAddDefenseCoolTime(builder, defenseCoolTime): builder.PrependInt64Slot(29, defenseCoolTime, 0)
def AddDefenseCoolTime(builder, defenseCoolTime):
    return ConstArenaExcelAddDefenseCoolTime(builder, defenseCoolTime)
def ConstArenaExcelAddDailyRewardResetTime(builder, dailyRewardResetTime): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(dailyRewardResetTime), 0)
...
def ConstArenaExcelAddNpcSupportCharacterCount(builder, npcSupportCharacterCount): builder.PrependInt64Slot(31, npcSupportCharacterCount, 0)
...
def ConstArenaExcelAddMapSlotHideRank(builder, mapSlotHideRank): builder.PrependInt64Slot(32, mapSlotHideRank, 0)
