...
def MultiFloorRaidStatChangeExcelAddApplyCharacterId(builder, applyCharacterId):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(applyCharacterId), 0)
...
def MultiFloorRaidStatChangeExcelAddStatAdd(builder, statAdd):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(statAdd), 0)
...
def MultiFloorRaidStatChangeExcelAddStatType(builder, statType):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(statType), 0)
