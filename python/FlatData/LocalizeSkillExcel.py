...
def LocalizeSkillExcelAddDescriptionEn(builder, descriptionEn): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionEn), 0)
...
def LocalizeSkillExcelAddDescriptionTh(builder, descriptionTh): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionTh), 0)
def AddDescriptionTh(builder, descriptionTh):
    return LocalizeSkillExcelAddDescriptionTh(builder, descriptionTh)
def LocalizeSkillExcelAddDescriptionTw(builder, descriptionTw): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionTw), 0)
def AddDescriptionTw(builder, descriptionTw):
    return LocalizeSkillExcelAddDescriptionTw(builder, descriptionTw)
def LocalizeSkillExcelAddKey(builder, key): builder.PrependUint32Slot(5, key, 0)
def AddKey(builder, key):
    return LocalizeSkillExcelAddKey(builder, key)
def LocalizeSkillExcelAddNameEn(builder, nameEn): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(nameEn), 0)
...
def LocalizeSkillExcelAddNameKr(builder, nameKr): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(nameKr), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeEn(builder, skillInvokeLocalizeEn): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeEn), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeJp(builder, skillInvokeLocalizeJp): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeJp), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeKr(builder, skillInvokeLocalizeKr): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeKr), 0)
...
def LocalizeSkillExcelAddSkillInvokeLocalizeTh(builder, skillInvokeLocalizeTh): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(skillInvokeLocalizeTh), 0)
