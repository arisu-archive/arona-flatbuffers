...
def ConstCommonExcelAddExtraPassiveSkillLevelMax(builder, extraPassiveSkillLevelMax): builder.PrependInt32Slot(0, extraPassiveSkillLevelMax, 0)
...
def ConstCommonExcelAddAccountExpRatio(builder, accountExpRatio): builder.PrependInt32Slot(1, accountExpRatio, 0)
def AddAccountExpRatio(builder, accountExpRatio):
    return ConstCommonExcelAddAccountExpRatio(builder, accountExpRatio)
def ConstCommonExcelAddBeforehandGachaShopId(builder, beforehandGachaShopId): builder.PrependInt32Slot(2, beforehandGachaShopId, 0)
...
def ConstCommonExcelAddPotentialBonusStatMaxLevelAttackPower(builder, potentialBonusStatMaxLevelAttackPower): builder.PrependInt32Slot(3, potentialBonusStatMaxLevelAttackPower, 0)
...
def ConstCommonExcelAddRankBracketPercentage6(builder, rankBracketPercentage6): builder.PrependInt32Slot(4, rankBracketPercentage6, 0)
...
def ConstCommonExcelAddPostExpiredDayGameManager(builder, postExpiredDayGameManager): builder.PrependInt32Slot(5, postExpiredDayGameManager, 0)
...
def ConstCommonExcelAddRankBracketPercentage5(builder, rankBracketPercentage5): builder.PrependInt32Slot(6, rankBracketPercentage5, 0)
...
def ConstCommonExcelAddCraftLeafNodeGenerateLv1Count(builder, craftLeafNodeGenerateLv1Count): builder.PrependInt32Slot(7, craftLeafNodeGenerateLv1Count, 0)
...
def ConstCommonExcelAddUiLabelCharacterWrap(builder, uiLabelCharacterWrap): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(uiLabelCharacterWrap), 0)
...
def ConstCommonExcelAddTutorialSpeedButtonStage(builder, tutorialSpeedButtonStage): builder.PrependInt64Slot(9, tutorialSpeedButtonStage, 0)
...
def ConstCommonExcelAddBaseTimeScale(builder, baseTimeScale): builder.PrependInt64Slot(10, baseTimeScale, 0)
def AddBaseTimeScale(builder, baseTimeScale):
    return ConstCommonExcelAddBaseTimeScale(builder, baseTimeScale)
def ConstCommonExcelAddTimeAttackDungeonEnterCost(builder, timeAttackDungeonEnterCost): builder.PrependInt64Slot(11, timeAttackDungeonEnterCost, 0)
...
def ConstCommonExcelAddCharacterMaxLevel(builder, characterMaxLevel): builder.PrependInt32Slot(12, characterMaxLevel, 0)
def AddCharacterMaxLevel(builder, characterMaxLevel):
    return ConstCommonExcelAddCharacterMaxLevel(builder, characterMaxLevel)
def ConstCommonExcelAddShiftingCraftSlotMaxCapacity(builder, shiftingCraftSlotMaxCapacity): builder.PrependInt32Slot(13, shiftingCraftSlotMaxCapacity, 0)
...
def ConstCommonExcelAddClearDeckAverageDeckCount(builder, clearDeckAverageDeckCount): builder.PrependInt32Slot(14, clearDeckAverageDeckCount, 0)
...
def ConstCommonExcelAddShiftingCraftTicketConsumeAmount(builder, shiftingCraftTicketConsumeAmount): builder.PrependInt32Slot(15, shiftingCraftTicketConsumeAmount, 0)
...
def ConstCommonExcelAddLimitedStageEntryTimeLimit(builder, limitedStageEntryTimeLimit): builder.PrependInt64Slot(16, limitedStageEntryTimeLimit, 0)
...
def ConstCommonExcelAddMailStorageSoftCap(builder, mailStorageSoftCap): builder.PrependInt32Slot(17, mailStorageSoftCap, 0)
...
def ConstCommonExcelAddCallnameLengthKr(builder, callnameLengthKr): builder.PrependInt32Slot(18, callnameLengthKr, 0)
def AddCallnameLengthKr(builder, callnameLengthKr):
    return ConstCommonExcelAddCallnameLengthKr(builder, callnameLengthKr)
def ConstCommonExcelAddExpiryBattlePassItemReceiveDay(builder, expiryBattlePassItemReceiveDay): builder.PrependInt32Slot(19, expiryBattlePassItemReceiveDay, 0)
...
def ConstCommonExcelAddClearDeckWorldRaidSaveConditionCoefficient(builder, clearDeckWorldRaidSaveConditionCoefficient): builder.PrependInt32Slot(20, clearDeckWorldRaidSaveConditionCoefficient, 0)
...
def ConstCommonExcelAddFormationPresetNumberOfEchelon(builder, formationPresetNumberOfEchelon): builder.PrependInt32Slot(21, formationPresetNumberOfEchelon, 0)
...
def ConstCommonExcelAddFriendIdCardCommentMaxLength(builder, friendIdCardCommentMaxLength): builder.PrependInt64Slot(22, friendIdCardCommentMaxLength, 0)
...
def ConstCommonExcelAddExpEquipInsertLimit(builder, expEquipInsertLimit): builder.PrependInt32Slot(23, expEquipInsertLimit, 0)
...
def ConstCommonExcelAddAcademyTicketCost(builder, academyTicketCost): builder.PrependInt32Slot(24, academyTicketCost, 0)
def AddAcademyTicketCost(builder, academyTicketCost):
    return ConstCommonExcelAddAcademyTicketCost(builder, academyTicketCost)
def ConstCommonExcelAddFriendsSearchRequestCount(builder, friendsSearchRequestCount): builder.PrependInt32Slot(25, friendsSearchRequestCount, 0)
...
def ConstCommonExcelAddRankBracketPercentage7(builder, rankBracketPercentage7): builder.PrependInt32Slot(26, rankBracketPercentage7, 0)
...
def ConstCommonExcelAddExpItemInsertLimit(builder, expItemInsertLimit): builder.PrependInt32Slot(27, expItemInsertLimit, 0)
...
def ConstCommonExcelAddCafePresetSlotCount(builder, cafePresetSlotCount): builder.PrependInt32Slot(28, cafePresetSlotCount, 0)
...
def ConstCommonExcelAddTutorialHardStage11(builder, tutorialHardStage11): builder.PrependInt64Slot(29, tutorialHardStage11, 0)
...
def ConstCommonExcelAddTutorialGachaShopId(builder, tutorialGachaShopId): builder.PrependInt32Slot(30, tutorialGachaShopId, 0)
...
def ConstCommonExcelAddCharProfilePopupRowIntervalJp(builder, charProfilePopupRowIntervalJp): builder.PrependInt32Slot(31, charProfilePopupRowIntervalJp, 0)
...
def ConstCommonExcelAddBirthdayMailParcelAmount(builder, birthdayMailParcelAmount): builder.PrependInt32Slot(32, birthdayMailParcelAmount, 0)
...
def ConstCommonExcelAddPrologueScenarioId01(builder, prologueScenarioId01): builder.PrependInt64Slot(33, prologueScenarioId01, 0)
...
def ConstCommonExcelAddClanSearchResultCount(builder, clanSearchResultCount): builder.PrependInt64Slot(34, clanSearchResultCount, 0)
...
def ConstCommonExcelAddClanMaxApplicant(builder, clanMaxApplicant): builder.PrependInt64Slot(35, clanMaxApplicant, 0)
def AddClanMaxApplicant(builder, clanMaxApplicant):
    return ConstCommonExcelAddClanMaxApplicant(builder, clanMaxApplicant)
def ConstCommonExcelAddWeekDungeonFindGiftRewardLimitCount(builder, weekDungeonFindGiftRewardLimitCount): builder.PrependInt32Slot(36, weekDungeonFindGiftRewardLimitCount, 0)
...
def ConstCommonExcelAddBirthdayMailStartDate(builder, birthdayMailStartDate): builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(birthdayMailStartDate), 0)
...
def ConstCommonExcelAddNicknameLength(builder, nicknameLength): builder.PrependInt32Slot(38, nicknameLength, 0)
def AddNicknameLength(builder, nicknameLength):
    return ConstCommonExcelAddNicknameLength(builder, nicknameLength)
def ConstCommonExcelAddFormationPresetEchelonTabTextLengthKr(builder, formationPresetEchelonTabTextLengthKr): builder.PrependInt32Slot(39, formationPresetEchelonTabTextLengthKr, 0)
...
def ConstCommonExcelAddTimeAttackDungeonEnterCostType(builder, timeAttackDungeonEnterCostType): builder.PrependInt32Slot(40, timeAttackDungeonEnterCostType, 0)
...
def ConstCommonExcelAddHardStageCount(builder, hardStageCount): builder.PrependInt32Slot(41, hardStageCount, 0)
def AddHardStageCount(builder, hardStageCount):
    return ConstCommonExcelAddHardStageCount(builder, hardStageCount)
def ConstCommonExcelAddPotentialOpenConditionCharacterLevel(builder, potentialOpenConditionCharacterLevel): builder.PrependInt32Slot(42, potentialOpenConditionCharacterLevel, 0)
...
def ConstCommonExcelAddTutorialShopCategoryType(builder, tutorialShopCategoryType): builder.PrependInt32Slot(43, tutorialShopCategoryType, 0)
...
def ConstCommonExcelAddTimeAttackDungeonEnterCostId(builder, timeAttackDungeonEnterCostId): builder.PrependInt64Slot(44, timeAttackDungeonEnterCostId, 0)
...
def ConstCommonExcelAddEnterDeposit(builder, enterDeposit): builder.PrependInt32Slot(45, enterDeposit, 0)
...
def ConstCommonExcelAddClanNameLength(builder, clanNameLength): builder.PrependInt32Slot(47, clanNameLength, 0)
def AddClanNameLength(builder, clanNameLength):
    return ConstCommonExcelAddClanNameLength(builder, clanNameLength)
def ConstCommonExcelAddTimeAttackDungoenPlayCountPerTicket(builder, timeAttackDungoenPlayCountPerTicket): builder.PrependInt32Slot(48, timeAttackDungoenPlayCountPerTicket, 0)
...
def ConstCommonExcelAddClanChattingNoticeCautionDelay(builder, clanChattingNoticeCautionDelay): builder.PrependFloat32Slot(49, clanChattingNoticeCautionDelay, 0.0)
...
def ConstCommonExcelAddCraftOpenExpTier1(builder, craftOpenExpTier1): builder.PrependInt64Slot(50, craftOpenExpTier1, 0)
def AddCraftOpenExpTier1(builder, craftOpenExpTier1):
    return ConstCommonExcelAddCraftOpenExpTier1(builder, craftOpenExpTier1)
def ConstCommonExcelAddClanRejoinCoolTimeFromSecond(builder, clanRejoinCoolTimeFromSecond): builder.PrependInt64Slot(51, clanRejoinCoolTimeFromSecond, 0)
...
def ConstCommonExcelAddMonthlyProductRepurchasePopupLimit(builder, monthlyProductRepurchasePopupLimit): builder.PrependInt32Slot(52, monthlyProductRepurchasePopupLimit, 0)
...
def ConstCommonExcelAddRankBracketPercentage2(builder, rankBracketPercentage2): builder.PrependInt32Slot(53, rankBracketPercentage2, 0)
...
def ConstCommonExcelAddBeforehandGachaCount(builder, beforehandGachaCount): builder.PrependInt32Slot(54, beforehandGachaCount, 0)
...
def ConstCommonExcelAddTacticRankClearTime(builder, tacticRankClearTime): builder.PrependInt32Slot(55, tacticRankClearTime, 0)
...
def ConstCommonExcelAddTimeAttackDungeonScenarioId(builder, timeAttackDungeonScenarioId): builder.PrependUOffsetTRelativeSlot(56, flatbuffers.number_types.UOffsetTFlags.py_type(timeAttackDungeonScenarioId), 0)
...
def ConstCommonExcelAddRequestTimeOut(builder, requestTimeOut): builder.PrependFloat32Slot(57, requestTimeOut, 0.0)
def AddRequestTimeOut(builder, requestTimeOut):
    return ConstCommonExcelAddRequestTimeOut(builder, requestTimeOut)
def ConstCommonExcelAddAdventureStrategyPlayTimeLimitInSeconds(builder, adventureStrategyPlayTimeLimitInSeconds): builder.PrependInt64Slot(58, adventureStrategyPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddLimitedStagePointAmount(builder, limitedStagePointAmount): builder.PrependInt64Slot(59, limitedStagePointAmount, 0)
...
def ConstCommonExcelAddCraftOpenExpTier3(builder, craftOpenExpTier3): builder.PrependInt64Slot(60, craftOpenExpTier3, 0)
def AddCraftOpenExpTier3(builder, craftOpenExpTier3):
    return ConstCommonExcelAddCraftOpenExpTier3(builder, craftOpenExpTier3)
def ConstCommonExcelAddDDosCheckIntervalInSeconds(builder, dDosCheckIntervalInSeconds): builder.PrependInt32Slot(61, dDosCheckIntervalInSeconds, 0)
...
def ConstCommonExcelAddAccountLinkReward(builder, accountLinkReward): builder.PrependInt32Slot(62, accountLinkReward, 0)
def AddAccountLinkReward(builder, accountLinkReward):
    return ConstCommonExcelAddAccountLinkReward(builder, accountLinkReward)
def ConstCommonExcelAddCraftBaseGoldRequired(builder, craftBaseGoldRequired): builder.PrependUOffsetTRelativeSlot(63, flatbuffers.number_types.UOffsetTFlags.py_type(craftBaseGoldRequired), 0)
...
def ConstCommonExcelAddCraftDuration(builder, craftDuration): builder.PrependUOffsetTRelativeSlot(64, flatbuffers.number_types.UOffsetTFlags.py_type(craftDuration), 0)
...
def ConstCommonExcelAddRaidEnterCostType(builder, raidEnterCostType): builder.PrependInt32Slot(65, raidEnterCostType, 0)
def AddRaidEnterCostType(builder, raidEnterCostType):
    return ConstCommonExcelAddRaidEnterCostType(builder, raidEnterCostType)
def ConstCommonExcelAddAccountCommentMaxLength(builder, accountCommentMaxLength): builder.PrependInt32Slot(66, accountCommentMaxLength, 0)
...
def ConstCommonExcelAddAcademyEnterCostType(builder, academyEnterCostType): builder.PrependInt32Slot(67, academyEnterCostType, 0)
...
def ConstCommonExcelAddShowRaidMyListCount(builder, showRaidMyListCount): builder.PrependInt32Slot(68, showRaidMyListCount, 0)
...
def ConstCommonExcelAddScenarioAutoDelayMillisec(builder, scenarioAutoDelayMillisec): builder.PrependFloat32Slot(69, scenarioAutoDelayMillisec, 0.0)
...
def ConstCommonExcelAddLimitedStageDailyClearCount(builder, limitedStageDailyClearCount): builder.PrependInt64Slot(70, limitedStageDailyClearCount, 0)
...
def ConstCommonExcelAddLobbyToScreenModeWaitTime(builder, lobbyToScreenModeWaitTime): builder.PrependInt64Slot(71, lobbyToScreenModeWaitTime, 0)
...
def ConstCommonExcelAddMaxBlockedUserCount(builder, maxBlockedUserCount): builder.PrependInt32Slot(72, maxBlockedUserCount, 0)
...
def ConstCommonExcelAddCharacterEquipmentGearSlot(builder, characterEquipmentGearSlot): builder.PrependInt64Slot(73, characterEquipmentGearSlot, 0)
...
def ConstCommonExcelAddCallNameWaitTimeGl(builder, callNameWaitTimeGl): builder.PrependFloat32Slot(74, callNameWaitTimeGl, 0.0)
...
def ConstCommonExcelAddCafeProductionDecimalPosition(builder, cafeProductionDecimalPosition): builder.PrependInt32Slot(75, cafeProductionDecimalPosition, 0)
...
def ConstCommonExcelAddPotentialBonusStatMaxLevelMaxHp(builder, potentialBonusStatMaxLevelMaxHp): builder.PrependInt32Slot(76, potentialBonusStatMaxLevelMaxHp, 0)
...
def ConstCommonExcelAddCallNameMaximumLength(builder, callNameMaximumLength): builder.PrependInt64Slot(77, callNameMaximumLength, 0)
...
def ConstCommonExcelAddIdCardDefaultCharacterId(builder, idCardDefaultCharacterId): builder.PrependInt64Slot(78, idCardDefaultCharacterId, 0)
...
def ConstCommonExcelAddMissionToastLifeTime(builder, missionToastLifeTime): builder.PrependInt32Slot(79, missionToastLifeTime, 0)
...
def ConstCommonExcelAddPostExpiredDayAttendance(builder, postExpiredDayAttendance): builder.PrependInt32Slot(80, postExpiredDayAttendance, 0)
...
def ConstCommonExcelAddEquipmentLvUpCoefficient(builder, equipmentLvUpCoefficient): builder.PrependInt32Slot(81, equipmentLvUpCoefficient, 0)
...
def ConstCommonExcelAddRaidOpponentListAmount(builder, raidOpponentListAmount): builder.PrependInt64Slot(82, raidOpponentListAmount, 0)
...
def ConstCommonExcelAddBattlePassEndImminentDay(builder, battlePassEndImminentDay): builder.PrependInt32Slot(83, battlePassEndImminentDay, 0)
...
def ConstCommonExcelAddWorldRaidGemEnterAmout(builder, worldRaidGemEnterAmout): builder.PrependInt64Slot(85, worldRaidGemEnterAmout, 0)
...
def ConstCommonExcelAddNicknameLengthKr(builder, nicknameLengthKr): builder.PrependInt32Slot(86, nicknameLengthKr, 0)
def AddNicknameLengthKr(builder, nicknameLengthKr):
    return ConstCommonExcelAddNicknameLengthKr(builder, nicknameLengthKr)
def ConstCommonExcelAddCraftOpenExpTier2(builder, craftOpenExpTier2): builder.PrependInt64Slot(87, craftOpenExpTier2, 0)
def AddCraftOpenExpTier2(builder, craftOpenExpTier2):
    return ConstCommonExcelAddCraftOpenExpTier2(builder, craftOpenExpTier2)
def ConstCommonExcelAddCraftTicketConsumeAmount(builder, craftTicketConsumeAmount): builder.PrependInt32Slot(88, craftTicketConsumeAmount, 0)
...
def ConstCommonExcelAddTutorialGachaGoodsId(builder, tutorialGachaGoodsId): builder.PrependInt32Slot(89, tutorialGachaGoodsId, 0)
...
def ConstCommonExcelAddStageFailedCurrencyRefundRate(builder, stageFailedCurrencyRefundRate): builder.PrependInt32Slot(90, stageFailedCurrencyRefundRate, 0)
...
def ConstCommonExcelAddMailStorageHardCap(builder, mailStorageHardCap): builder.PrependInt32Slot(91, mailStorageHardCap, 0)
...
def ConstCommonExcelAddEquipmentSlotOpenLevel(builder, equipmentSlotOpenLevel): builder.PrependUOffsetTRelativeSlot(92, flatbuffers.number_types.UOffsetTFlags.py_type(equipmentSlotOpenLevel), 0)
...
def ConstCommonExcelAddPassiveSkillLevelMax(builder, passiveSkillLevelMax): builder.PrependInt32Slot(93, passiveSkillLevelMax, 0)
...
def ConstCommonExcelAddGachaPercentage(builder, gachaPercentage): builder.PrependInt32Slot(94, gachaPercentage, 0)
def AddGachaPercentage(builder, gachaPercentage):
    return ConstCommonExcelAddGachaPercentage(builder, gachaPercentage)
def ConstCommonExcelAddCraftLeafNodeGenerateLv2Count(builder, craftLeafNodeGenerateLv2Count): builder.PrependInt32Slot(95, craftLeafNodeGenerateLv2Count, 0)
...
def ConstCommonExcelAddAssistStrangerMinLevel(builder, assistStrangerMinLevel): builder.PrependInt32Slot(96, assistStrangerMinLevel, 0)
...
def ConstCommonExcelAddFormationPresetNumberOfEchelonTab(builder, formationPresetNumberOfEchelonTab): builder.PrependInt32Slot(97, formationPresetNumberOfEchelonTab, 0)
...
def ConstCommonExcelAddExpItemInsertAccelTime(builder, expItemInsertAccelTime): builder.PrependInt32Slot(98, expItemInsertAccelTime, 0)
...
def ConstCommonExcelAddCafeRandomVisitMinLastLogin(builder, cafeRandomVisitMinLastLogin): builder.PrependInt32Slot(99, cafeRandomVisitMinLastLogin, 0)
...
def ConstCommonExcelAddShiftingCraftDuration(builder, shiftingCraftDuration): builder.PrependUOffsetTRelativeSlot(100, flatbuffers.number_types.UOffsetTFlags.py_type(shiftingCraftDuration), 0)
...
def ConstCommonExcelAddFriendsMaxApplicant(builder, friendsMaxApplicant): builder.PrependInt32Slot(101, friendsMaxApplicant, 0)
...
def ConstCommonExcelAddRecommendedFriendsLvDifferenceLimit(builder, recommendedFriendsLvDifferenceLimit): builder.PrependInt32Slot(102, recommendedFriendsLvDifferenceLimit, 0)
...
def ConstCommonExcelAddMaxFriendsCount(builder, maxFriendsCount): builder.PrependInt32Slot(103, maxFriendsCount, 0)
def AddMaxFriendsCount(builder, maxFriendsCount):
    return ConstCommonExcelAddMaxFriendsCount(builder, maxFriendsCount)
def ConstCommonExcelAddCafeTravelSyncIntervalByMillisec(builder, cafeTravelSyncIntervalByMillisec): builder.PrependInt32Slot(104, cafeTravelSyncIntervalByMillisec, 0)
...
def ConstCommonExcelAddPurchaseMailExpiredDayGl(builder, purchaseMailExpiredDayGl): builder.PrependInt32Slot(105, purchaseMailExpiredDayGl, 0)
...
def ConstCommonExcelAddFormationPresetRecentNumberOfEchelon(builder, formationPresetRecentNumberOfEchelon): builder.PrependInt32Slot(106, formationPresetRecentNumberOfEchelon, 0)
...
def ConstCommonExcelAddScreenshotToLobbyButtonHideDelay(builder, screenshotToLobbyButtonHideDelay): builder.PrependInt64Slot(107, screenshotToLobbyButtonHideDelay, 0)
...
def ConstCommonExcelAddExSkillLevelMax(builder, exSkillLevelMax): builder.PrependInt32Slot(108, exSkillLevelMax, 0)
def AddExSkillLevelMax(builder, exSkillLevelMax):
    return ConstCommonExcelAddExSkillLevelMax(builder, exSkillLevelMax)
def ConstCommonExcelAddAcademyFavorZoneId(builder, academyFavorZoneId): builder.PrependInt64Slot(109, academyFavorZoneId, 0)
...
def ConstCommonExcelAddAssistStrangerMaxLevel(builder, assistStrangerMaxLevel): builder.PrependInt32Slot(110, assistStrangerMaxLevel, 0)
...
def ConstCommonExcelAddCharProfileRowIntervalKr(builder, charProfileRowIntervalKr): builder.PrependInt32Slot(111, charProfileRowIntervalKr, 0)
...
def ConstCommonExcelAddRankBracketPercentage3(builder, rankBracketPercentage3): builder.PrependInt32Slot(112, rankBracketPercentage3, 0)
...
def ConstCommonExcelAddPrologueScenarioId02(builder, prologueScenarioId02): builder.PrependInt64Slot(113, prologueScenarioId02, 0)
...
def ConstCommonExcelAddLimitedStageEntryTimeBuffer(builder, limitedStageEntryTimeBuffer): builder.PrependInt64Slot(114, limitedStageEntryTimeBuffer, 0)
...
def ConstCommonExcelAddCallnameLengthEn(builder, callnameLengthEn): builder.PrependInt32Slot(115, callnameLengthEn, 0)
def AddCallnameLengthEn(builder, callnameLengthEn):
    return ConstCommonExcelAddCallnameLengthEn(builder, callnameLengthEn)
def ConstCommonExcelAddRankBracketPercentage1(builder, rankBracketPercentage1): builder.PrependInt32Slot(116, rankBracketPercentage1, 0)
...
def ConstCommonExcelAddClearDeck3StarViewCount(builder, clearDeck3StarViewCount): builder.PrependInt32Slot(117, clearDeck3StarViewCount, 0)
...
def ConstCommonExcelAddCallNameRenameCoolTimeFromHour(builder, callNameRenameCoolTimeFromHour): builder.PrependInt64Slot(119, callNameRenameCoolTimeFromHour, 0)
...
def ConstCommonExcelAddRaidEnterCostId(builder, raidEnterCostId): builder.PrependInt64Slot(120, raidEnterCostId, 0)
def AddRaidEnterCostId(builder, raidEnterCostId):
    return ConstCommonExcelAddRaidEnterCostId(builder, raidEnterCostId)
def ConstCommonExcelAddCharProfilePopupRowIntervalKr(builder, charProfilePopupRowIntervalKr): builder.PrependInt32Slot(121, charProfilePopupRowIntervalKr, 0)
...
def ConstCommonExcelAddCraftTicketItemUniqueId(builder, craftTicketItemUniqueId): builder.PrependInt32Slot(122, craftTicketItemUniqueId, 0)
...
def ConstCommonExcelAddRaidTacticPlayTimeLimitInSeconds(builder, raidTacticPlayTimeLimitInSeconds): builder.PrependInt64Slot(123, raidTacticPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddCampaignMainStageBestRecord(builder, campaignMainStageBestRecord): builder.PrependInt32Slot(124, campaignMainStageBestRecord, 0)
...
def ConstCommonExcelAddCafeSetGroupApplyCount(builder, cafeSetGroupApplyCount): builder.PrependInt32Slot(125, cafeSetGroupApplyCount, 0)
...
def ConstCommonExcelAddEmblemDefaultId(builder, emblemDefaultId): builder.PrependInt64Slot(126, emblemDefaultId, 0)
def AddEmblemDefaultId(builder, emblemDefaultId):
    return ConstCommonExcelAddEmblemDefaultId(builder, emblemDefaultId)
def ConstCommonExcelAddCafeCameraDragThreshold(builder, cafeCameraDragThreshold): builder.PrependFloat32Slot(127, cafeCameraDragThreshold, 0.0)
...
def ConstCommonExcelAddBirthdayMailParcelType(builder, birthdayMailParcelType): builder.PrependInt32Slot(128, birthdayMailParcelType, 0)
...
def ConstCommonExcelAddWorldRaidGemEnterCost(builder, worldRaidGemEnterCost): builder.PrependInt64Slot(129, worldRaidGemEnterCost, 0)
...
def ConstCommonExcelAddBattlePassFlavorTextIdleDurationMilliSec(builder, battlePassFlavorTextIdleDurationMilliSec): builder.PrependInt64Slot(130, battlePassFlavorTextIdleDurationMilliSec, 0)
...
def ConstCommonExcelAddLimitedStagePointPerApMax(builder, limitedStagePointPerApMax): builder.PrependInt64Slot(131, limitedStagePointPerApMax, 0)
...
def ConstCommonExcelAddPotentialBonusStatMaxLevelHealPower(builder, potentialBonusStatMaxLevelHealPower): builder.PrependInt32Slot(132, potentialBonusStatMaxLevelHealPower, 0)
...
def ConstCommonExcelAddDDosDetectCount(builder, dDosDetectCount): builder.PrependInt32Slot(134, dDosDetectCount, 0)
def AddDDosDetectCount(builder, dDosDetectCount):
    return ConstCommonExcelAddDDosDetectCount(builder, dDosDetectCount)
def ConstCommonExcelAddAccountMaxLevel(builder, accountMaxLevel): builder.PrependInt32Slot(135, accountMaxLevel, 0)
def AddAccountMaxLevel(builder, accountMaxLevel):
    return ConstCommonExcelAddAccountMaxLevel(builder, accountMaxLevel)
def ConstCommonExcelAddClearDeckNoStarViewCount(builder, clearDeckNoStarViewCount): builder.PrependInt32Slot(136, clearDeckNoStarViewCount, 0)
...
def ConstCommonExcelAddCallNameMinimumLength(builder, callNameMinimumLength): builder.PrependInt64Slot(137, callNameMinimumLength, 0)
...
def ConstCommonExcelAddBattlePassNotifyDateGl(builder, battlePassNotifyDateGl): builder.PrependInt32Slot(138, battlePassNotifyDateGl, 0)
...
def ConstCommonExcelAddSupportSquadExpBonus(builder, supportSquadExpBonus): builder.PrependInt32Slot(139, supportSquadExpBonus, 0)
...
def ConstCommonExcelAddLowMemorySizeGl(builder, lowMemorySizeGl): builder.PrependInt64Slot(140, lowMemorySizeGl, 0)
def AddLowMemorySizeGl(builder, lowMemorySizeGl):
    return ConstCommonExcelAddLowMemorySizeGl(builder, lowMemorySizeGl)
def ConstCommonExcelAddCharacterLvUpCoefficient(builder, characterLvUpCoefficient): builder.PrependInt32Slot(141, characterLvUpCoefficient, 0)
...
def ConstCommonExcelAddBirthDayDDay(builder, birthDayDDay): builder.PrependInt32Slot(142, birthDayDDay, 0)
def AddBirthDayDDay(builder, birthDayDDay):
    return ConstCommonExcelAddBirthDayDDay(builder, birthDayDDay)
def ConstCommonExcelAddIdCardDefaultBgId(builder, idCardDefaultBgId): builder.PrependInt64Slot(143, idCardDefaultBgId, 0)
def AddIdCardDefaultBgId(builder, idCardDefaultBgId):
    return ConstCommonExcelAddIdCardDefaultBgId(builder, idCardDefaultBgId)
def ConstCommonExcelAddCafeMonologueDefaultDuration(builder, cafeMonologueDefaultDuration): builder.PrependInt64Slot(144, cafeMonologueDefaultDuration, 0)
...
def ConstCommonExcelAddRaidTicketCost(builder, raidTicketCost): builder.PrependInt64Slot(145, raidTicketCost, 0)
def AddRaidTicketCost(builder, raidTicketCost):
    return ConstCommonExcelAddRaidTicketCost(builder, raidTicketCost)
def ConstCommonExcelAddCafeBubbleIdleDurationMilliSec(builder, cafeBubbleIdleDurationMilliSec): builder.PrependInt64Slot(146, cafeBubbleIdleDurationMilliSec, 0)
...
def ConstCommonExcelAddCharProfileRowIntervalJp(builder, charProfileRowIntervalJp): builder.PrependInt32Slot(147, charProfileRowIntervalJp, 0)
...
def ConstCommonExcelAddRankBracketPercentage4(builder, rankBracketPercentage4): builder.PrependInt32Slot(148, rankBracketPercentage4, 0)
...
def ConstCommonExcelAddEquipLvUpCoefficient(builder, equipLvUpCoefficient): builder.PrependInt32Slot(149, equipLvUpCoefficient, 0)
...
def ConstCommonExcelAddBeforehandGachaGroupId(builder, beforehandGachaGroupId): builder.PrependInt32Slot(151, beforehandGachaGroupId, 0)
...
def ConstCommonExcelAddFormationPresetEchelonTabTextLength(builder, formationPresetEchelonTabTextLength): builder.PrependInt32Slot(152, formationPresetEchelonTabTextLength, 0)
...
def ConstCommonExcelAddWeekDungoenTacticPlayTimeLimitInSeconds(builder, weekDungoenTacticPlayTimeLimitInSeconds): builder.PrependInt64Slot(153, weekDungoenTacticPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddCafeRandomVisitMinComfortBonus(builder, cafeRandomVisitMinComfortBonus): builder.PrependInt64Slot(154, cafeRandomVisitMinComfortBonus, 0)
...
def ConstCommonExcelAddMainSquadExpBonus(builder, mainSquadExpBonus): builder.PrependInt32Slot(155, mainSquadExpBonus, 0)
def AddMainSquadExpBonus(builder, mainSquadExpBonus):
    return ConstCommonExcelAddMainSquadExpBonus(builder, mainSquadExpBonus)
def ConstCommonExcelAddCraftLimitTime(builder, craftLimitTime): builder.PrependInt32Slot(156, craftLimitTime, 0)
def AddCraftLimitTime(builder, craftLimitTime):
    return ConstCommonExcelAddCraftLimitTime(builder, craftLimitTime)
def ConstCommonExcelAddMonthlyProductCheckDays(builder, monthlyProductCheckDays): builder.PrependInt32Slot(157, monthlyProductCheckDays, 0)
...
def ConstCommonExcelAddPostExpiredDayInventoryOverflow(builder, postExpiredDayInventoryOverflow): builder.PrependInt32Slot(158, postExpiredDayInventoryOverflow, 0)
...
def ConstCommonExcelAddTutorialCharacterDefaultCount(builder, tutorialCharacterDefaultCount): builder.PrependInt64Slot(159, tutorialCharacterDefaultCount, 0)
...
def ConstCommonExcelAddFormationPresetEchelonSlotTextLengthKr(builder, formationPresetEchelonSlotTextLengthKr): builder.PrependInt32Slot(160, formationPresetEchelonSlotTextLengthKr, 0)
...
def ConstCommonExcelAddClanMaxMember(builder, clanMaxMember): builder.PrependInt64Slot(161, clanMaxMember, 0)
def AddClanMaxMember(builder, clanMaxMember):
    return ConstCommonExcelAddClanMaxMember(builder, clanMaxMember)
def ConstCommonExcelAddAcademyEnterCostId(builder, academyEnterCostId): builder.PrependInt64Slot(162, academyEnterCostId, 0)
...
def ConstCommonExcelAddCafePresetEditNameLength(builder, cafePresetEditNameLength): builder.PrependInt32Slot(163, cafePresetEditNameLength, 0)
...
def ConstCommonExcelAddClearDeck1StarViewCount(builder, clearDeck1StarViewCount): builder.PrependInt32Slot(164, clearDeck1StarViewCount, 0)
...
def ConstCommonExcelAddMassangerMessageExpireDay(builder, massangerMessageExpireDay): builder.PrependInt32Slot(165, massangerMessageExpireDay, 0)
...
def ConstCommonExcelAddCafeMonologueIntervalMillisec(builder, cafeMonologueIntervalMillisec): builder.PrependInt64Slot(166, cafeMonologueIntervalMillisec, 0)
...
def ConstCommonExcelAddMaxApMasterCoinPerWeek(builder, maxApMasterCoinPerWeek): builder.PrependInt64Slot(167, maxApMasterCoinPerWeek, 0)
...
def ConstCommonExcelAddLimitedStagePointPerApMin(builder, limitedStagePointPerApMin): builder.PrependInt64Slot(168, limitedStagePointPerApMin, 0)
...
def ConstCommonExcelAddWeaponLvUpCoefficient(builder, weaponLvUpCoefficient): builder.PrependInt32Slot(169, weaponLvUpCoefficient, 0)
...
def ConstCommonExcelAddClearDeckStorageSize(builder, clearDeckStorageSize): builder.PrependInt32Slot(170, clearDeckStorageSize, 0)
...
def ConstCommonExcelAddCafeAutoChargePeriodInMsc(builder, cafeAutoChargePeriodInMsc): builder.PrependInt32Slot(171, cafeAutoChargePeriodInMsc, 0)
...
def ConstCommonExcelAddBirthdayMailRemainDate(builder, birthdayMailRemainDate): builder.PrependInt32Slot(172, birthdayMailRemainDate, 0)
...
def ConstCommonExcelAddMaxFriendsRequest(builder, maxFriendsRequest): builder.PrependInt32Slot(173, maxFriendsRequest, 0)
def AddMaxFriendsRequest(builder, maxFriendsRequest):
    return ConstCommonExcelAddMaxFriendsRequest(builder, maxFriendsRequest)
def ConstCommonExcelAddRenewalDisplayOrderDay(builder, renewalDisplayOrderDay): builder.PrependInt32Slot(174, renewalDisplayOrderDay, 0)
...
def ConstCommonExcelAddJoinOrCreateClanCoolTimeFromHour(builder, joinOrCreateClanCoolTimeFromHour): builder.PrependInt64Slot(175, joinOrCreateClanCoolTimeFromHour, 0)
...
def ConstCommonExcelAddCafeSummonCoolTimeFromHour(builder, cafeSummonCoolTimeFromHour): builder.PrependInt32Slot(176, cafeSummonCoolTimeFromHour, 0)
...
def ConstCommonExcelAddFindGiftTimeLimit(builder, findGiftTimeLimit): builder.PrependInt32Slot(177, findGiftTimeLimit, 0)
def AddFindGiftTimeLimit(builder, findGiftTimeLimit):
    return ConstCommonExcelAddFindGiftTimeLimit(builder, findGiftTimeLimit)
def ConstCommonExcelAddClearDeck2StarViewCount(builder, clearDeck2StarViewCount): builder.PrependInt32Slot(178, clearDeck2StarViewCount, 0)
...
def ConstCommonExcelAddHardAdventurePlayCountRecoverDailyNumber(builder, hardAdventurePlayCountRecoverDailyNumber): builder.PrependInt32Slot(179, hardAdventurePlayCountRecoverDailyNumber, 0)
...
def ConstCommonExcelAddBattlePassExpIconPath(builder, battlePassExpIconPath): builder.PrependUOffsetTRelativeSlot(180, flatbuffers.number_types.UOffsetTFlags.py_type(battlePassExpIconPath), 0)
...
def ConstCommonExcelAddBirthdayMailParcelId(builder, birthdayMailParcelId): builder.PrependInt64Slot(181, birthdayMailParcelId, 0)
...
def ConstCommonExcelAddClearDeckShowCount(builder, clearDeckShowCount): builder.PrependInt32Slot(182, clearDeckShowCount, 0)
...
def ConstCommonExcelAddClanLeaderTransferLastLoginLimit(builder, clanLeaderTransferLastLoginLimit): builder.PrependInt64Slot(183, clanLeaderTransferLastLoginLimit, 0)
