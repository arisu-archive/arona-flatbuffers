...
def ConstCommonExcelAddRankBracketPercentage5(builder, rankBracketPercentage5): builder.PrependInt32Slot(0, rankBracketPercentage5, 0)
...
def ConstCommonExcelAddTimeAttackDungeonEnterCostType(builder, timeAttackDungeonEnterCostType): builder.PrependInt32Slot(1, timeAttackDungeonEnterCostType, 0)
...
def ConstCommonExcelAddBattlePassNotifyDateGl(builder, battlePassNotifyDateGl): builder.PrependInt32Slot(2, battlePassNotifyDateGl, 0)
...
def ConstCommonExcelAddEnterDeposit(builder, enterDeposit): builder.PrependInt32Slot(3, enterDeposit, 0)
def AddEnterDeposit(builder, enterDeposit):
    return ConstCommonExcelAddEnterDeposit(builder, enterDeposit)
def ConstCommonExcelAddIdCardDefaultCharacterId(builder, idCardDefaultCharacterId): builder.PrependInt64Slot(4, idCardDefaultCharacterId, 0)
...
def ConstCommonExcelAddCommonFavorItemTags(builder, commonFavorItemTags): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(commonFavorItemTags), 0)
...
def ConstCommonExcelAddCampaignMainStageMaxRank(builder, campaignMainStageMaxRank): builder.PrependInt32Slot(6, campaignMainStageMaxRank, 0)
...
def ConstCommonExcelAddUiLabelCharacterWrap(builder, uiLabelCharacterWrap): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(uiLabelCharacterWrap), 0)
...
def ConstCommonExcelAddFriendsMaxApplicant(builder, friendsMaxApplicant): builder.PrependInt32Slot(8, friendsMaxApplicant, 0)
...
def ConstCommonExcelAddLobbyToScreenModeWaitTime(builder, lobbyToScreenModeWaitTime): builder.PrependInt64Slot(9, lobbyToScreenModeWaitTime, 0)
...
def ConstCommonExcelAddClearDeckNoStarViewCount(builder, clearDeckNoStarViewCount): builder.PrependInt32Slot(10, clearDeckNoStarViewCount, 0)
...
def ConstCommonExcelAddCharProfileRowIntervalJp(builder, charProfileRowIntervalJp): builder.PrependInt32Slot(11, charProfileRowIntervalJp, 0)
...
def ConstCommonExcelAddClanMaxMember(builder, clanMaxMember): builder.PrependInt64Slot(12, clanMaxMember, 0)
def AddClanMaxMember(builder, clanMaxMember):
    return ConstCommonExcelAddClanMaxMember(builder, clanMaxMember)
def ConstCommonExcelAddMaxFriendsCount(builder, maxFriendsCount): builder.PrependInt32Slot(13, maxFriendsCount, 0)
...
def ConstCommonExcelAddRankBracketPercentage4(builder, rankBracketPercentage4): builder.PrependInt32Slot(15, rankBracketPercentage4, 0)
...
def ConstCommonExcelAddClearDeck3StarViewCount(builder, clearDeck3StarViewCount): builder.PrependInt32Slot(16, clearDeck3StarViewCount, 0)
...
def ConstCommonExcelAddCafePresetEditNameLength(builder, cafePresetEditNameLength): builder.PrependInt32Slot(17, cafePresetEditNameLength, 0)
...
def ConstCommonExcelAddHardStageCount(builder, hardStageCount): builder.PrependInt32Slot(18, hardStageCount, 0)
def AddHardStageCount(builder, hardStageCount):
    return ConstCommonExcelAddHardStageCount(builder, hardStageCount)
def ConstCommonExcelAddAcademyEnterCostId(builder, academyEnterCostId): builder.PrependInt64Slot(19, academyEnterCostId, 0)
...
def ConstCommonExcelAddPrologueScenarioId01(builder, prologueScenarioId01): builder.PrependInt64Slot(20, prologueScenarioId01, 0)
...
def ConstCommonExcelAddNicknameLength(builder, nicknameLength): builder.PrependInt32Slot(21, nicknameLength, 0)
def AddNicknameLength(builder, nicknameLength):
    return ConstCommonExcelAddNicknameLength(builder, nicknameLength)
def ConstCommonExcelAddTimeAttackDungeonEnterCostId(builder, timeAttackDungeonEnterCostId): builder.PrependInt64Slot(22, timeAttackDungeonEnterCostId, 0)
...
def ConstCommonExcelAddDDosCheckIntervalInSeconds(builder, dDosCheckIntervalInSeconds): builder.PrependInt32Slot(23, dDosCheckIntervalInSeconds, 0)
...
def ConstCommonExcelAddClearDeckWorldRaidSaveConditionCoefficient(builder, clearDeckWorldRaidSaveConditionCoefficient): builder.PrependInt32Slot(24, clearDeckWorldRaidSaveConditionCoefficient, 0)
...
def ConstCommonExcelAddLowMemorySizeGl(builder, lowMemorySizeGl): builder.PrependInt64Slot(25, lowMemorySizeGl, 0)
def AddLowMemorySizeGl(builder, lowMemorySizeGl):
    return ConstCommonExcelAddLowMemorySizeGl(builder, lowMemorySizeGl)
def ConstCommonExcelAddPotentialOpenConditionCharacterLevel(builder, potentialOpenConditionCharacterLevel): builder.PrependInt32Slot(26, potentialOpenConditionCharacterLevel, 0)
...
def ConstCommonExcelAddMissionToastLifeTime(builder, missionToastLifeTime): builder.PrependInt32Slot(27, missionToastLifeTime, 0)
...
def ConstCommonExcelAddAccountCommentMaxLength(builder, accountCommentMaxLength): builder.PrependInt32Slot(28, accountCommentMaxLength, 0)
...
def ConstCommonExcelAddCafeMonologueIntervalMillisec(builder, cafeMonologueIntervalMillisec): builder.PrependInt64Slot(29, cafeMonologueIntervalMillisec, 0)
...
def ConstCommonExcelAddRaidTacticPlayTimeLimitInSeconds(builder, raidTacticPlayTimeLimitInSeconds): builder.PrependInt64Slot(30, raidTacticPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddClanSearchResultCount(builder, clanSearchResultCount): builder.PrependInt64Slot(31, clanSearchResultCount, 0)
...
def ConstCommonExcelAddAdventureStrategyPlayTimeLimitInSeconds(builder, adventureStrategyPlayTimeLimitInSeconds): builder.PrependInt64Slot(32, adventureStrategyPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddFormationPresetEchelonSlotTextLength(builder, formationPresetEchelonSlotTextLength): builder.PrependInt32Slot(33, formationPresetEchelonSlotTextLength, 0)
...
def ConstCommonExcelAddMonthlyProductRepurchasePopupLimit(builder, monthlyProductRepurchasePopupLimit): builder.PrependInt32Slot(34, monthlyProductRepurchasePopupLimit, 0)
...
def ConstCommonExcelAddScreenshotToLobbyButtonHideDelay(builder, screenshotToLobbyButtonHideDelay): builder.PrependInt64Slot(35, screenshotToLobbyButtonHideDelay, 0)
...
def ConstCommonExcelAddBirthdayMailParcelId(builder, birthdayMailParcelId): builder.PrependInt64Slot(36, birthdayMailParcelId, 0)
...
def ConstCommonExcelAddRankBracketPercentage6(builder, rankBracketPercentage6): builder.PrependInt32Slot(37, rankBracketPercentage6, 0)
...
def ConstCommonExcelAddCraftOpenExpTier2(builder, craftOpenExpTier2): builder.PrependInt64Slot(38, craftOpenExpTier2, 0)
def AddCraftOpenExpTier2(builder, craftOpenExpTier2):
    return ConstCommonExcelAddCraftOpenExpTier2(builder, craftOpenExpTier2)
def ConstCommonExcelAddPostExpiredDayAttendance(builder, postExpiredDayAttendance): builder.PrependInt32Slot(39, postExpiredDayAttendance, 0)
...
def ConstCommonExcelAddEquipmentLvUpCoefficient(builder, equipmentLvUpCoefficient): builder.PrependInt32Slot(40, equipmentLvUpCoefficient, 0)
...
def ConstCommonExcelAddCharProfileRowIntervalKr(builder, charProfileRowIntervalKr): builder.PrependInt32Slot(41, charProfileRowIntervalKr, 0)
...
def ConstCommonExcelAddWeekDungoenTacticPlayTimeLimitInSeconds(builder, weekDungoenTacticPlayTimeLimitInSeconds): builder.PrependInt64Slot(42, weekDungoenTacticPlayTimeLimitInSeconds, 0)
...
def ConstCommonExcelAddWeaponLvUpCoefficient(builder, weaponLvUpCoefficient): builder.PrependInt32Slot(43, weaponLvUpCoefficient, 0)
...
def ConstCommonExcelAddPrologueScenarioId02(builder, prologueScenarioId02): builder.PrependInt64Slot(44, prologueScenarioId02, 0)
...
def ConstCommonExcelAddTimeAttackDungeonScenarioId(builder, timeAttackDungeonScenarioId): builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(timeAttackDungeonScenarioId), 0)
...
def ConstCommonExcelAddStageFailedCurrencyRefundRate(builder, stageFailedCurrencyRefundRate): builder.PrependInt32Slot(46, stageFailedCurrencyRefundRate, 0)
...
def ConstCommonExcelAddCafeBubbleIdleDurationMilliSec(builder, cafeBubbleIdleDurationMilliSec): builder.PrependInt64Slot(47, cafeBubbleIdleDurationMilliSec, 0)
...
def ConstCommonExcelAddCafeTravelSyncIntervalByMillisec(builder, cafeTravelSyncIntervalByMillisec): builder.PrependInt32Slot(48, cafeTravelSyncIntervalByMillisec, 0)
...
def ConstCommonExcelAddTacticRankClearTime(builder, tacticRankClearTime): builder.PrependInt32Slot(49, tacticRankClearTime, 0)
...
def ConstCommonExcelAddSupportSquadExpBonus(builder, supportSquadExpBonus): builder.PrependInt32Slot(50, supportSquadExpBonus, 0)
...
def ConstCommonExcelAddMainSquadExpBonus(builder, mainSquadExpBonus): builder.PrependInt32Slot(51, mainSquadExpBonus, 0)
def AddMainSquadExpBonus(builder, mainSquadExpBonus):
    return ConstCommonExcelAddMainSquadExpBonus(builder, mainSquadExpBonus)
def ConstCommonExcelAddBattlePassFlavorTextIdleDurationMilliSec(builder, battlePassFlavorTextIdleDurationMilliSec): builder.PrependInt64Slot(52, battlePassFlavorTextIdleDurationMilliSec, 0)
...
def ConstCommonExcelAddWorldRaidGemEnterAmout(builder, worldRaidGemEnterAmout): builder.PrependInt64Slot(53, worldRaidGemEnterAmout, 0)
...
def ConstCommonExcelAddWeekDungeonFindGiftRewardLimitCount(builder, weekDungeonFindGiftRewardLimitCount): builder.PrependInt32Slot(54, weekDungeonFindGiftRewardLimitCount, 0)
...
def ConstCommonExcelAddBeforehandGachaShopId(builder, beforehandGachaShopId): builder.PrependInt32Slot(55, beforehandGachaShopId, 0)
...
def ConstCommonExcelAddIdCardDefaultBgId(builder, idCardDefaultBgId): builder.PrependInt64Slot(57, idCardDefaultBgId, 0)
def AddIdCardDefaultBgId(builder, idCardDefaultBgId):
    return ConstCommonExcelAddIdCardDefaultBgId(builder, idCardDefaultBgId)
def ConstCommonExcelAddAssistStrangerMaxLevel(builder, assistStrangerMaxLevel): builder.PrependInt32Slot(58, assistStrangerMaxLevel, 0)
...
def ConstCommonExcelAddBaseTimeScale(builder, baseTimeScale): builder.PrependInt64Slot(59, baseTimeScale, 0)
def AddBaseTimeScale(builder, baseTimeScale):
    return ConstCommonExcelAddBaseTimeScale(builder, baseTimeScale)
def ConstCommonExcelAddAcademyTicketCost(builder, academyTicketCost): builder.PrependInt32Slot(60, academyTicketCost, 0)
def AddAcademyTicketCost(builder, academyTicketCost):
    return ConstCommonExcelAddAcademyTicketCost(builder, academyTicketCost)
def ConstCommonExcelAddWorldRaidGemEnterCost(builder, worldRaidGemEnterCost): builder.PrependInt64Slot(61, worldRaidGemEnterCost, 0)
...
def ConstCommonExcelAddShiftingCraftTicketConsumeAmount(builder, shiftingCraftTicketConsumeAmount): builder.PrependInt32Slot(62, shiftingCraftTicketConsumeAmount, 0)
...
def ConstCommonExcelAddClearDeckStorageSize(builder, clearDeckStorageSize): builder.PrependInt32Slot(63, clearDeckStorageSize, 0)
...
def ConstCommonExcelAddFormationPresetNumberOfEchelon(builder, formationPresetNumberOfEchelon): builder.PrependInt32Slot(64, formationPresetNumberOfEchelon, 0)
...
def ConstCommonExcelAddCafeSetGroupApplyCount(builder, cafeSetGroupApplyCount): builder.PrependInt32Slot(65, cafeSetGroupApplyCount, 0)
...
def ConstCommonExcelAddAccountLinkReward(builder, accountLinkReward): builder.PrependInt32Slot(67, accountLinkReward, 0)
def AddAccountLinkReward(builder, accountLinkReward):
    return ConstCommonExcelAddAccountLinkReward(builder, accountLinkReward)
def ConstCommonExcelAddLimitedStagePointAmount(builder, limitedStagePointAmount): builder.PrependInt64Slot(68, limitedStagePointAmount, 0)
...
def ConstCommonExcelAddFriendsSearchRequestCount(builder, friendsSearchRequestCount): builder.PrependInt32Slot(69, friendsSearchRequestCount, 0)
...
def ConstCommonExcelAddCraftOpenExpTier1(builder, craftOpenExpTier1): builder.PrependInt64Slot(70, craftOpenExpTier1, 0)
def AddCraftOpenExpTier1(builder, craftOpenExpTier1):
    return ConstCommonExcelAddCraftOpenExpTier1(builder, craftOpenExpTier1)
def ConstCommonExcelAddFormationPresetRecentNumberOfEchelon(builder, formationPresetRecentNumberOfEchelon): builder.PrependInt32Slot(71, formationPresetRecentNumberOfEchelon, 0)
...
def ConstCommonExcelAddPotentialBonusStatMaxLevelHealPower(builder, potentialBonusStatMaxLevelHealPower): builder.PrependInt32Slot(72, potentialBonusStatMaxLevelHealPower, 0)
...
def ConstCommonExcelAddCallNameMinimumLength(builder, callNameMinimumLength): builder.PrependInt64Slot(73, callNameMinimumLength, 0)
...
def ConstCommonExcelAddTimeAttackDungoenPlayCountPerTicket(builder, timeAttackDungoenPlayCountPerTicket): builder.PrependInt32Slot(74, timeAttackDungoenPlayCountPerTicket, 0)
...
def ConstCommonExcelAddFindGiftTimeLimit(builder, findGiftTimeLimit): builder.PrependInt32Slot(75, findGiftTimeLimit, 0)
def AddFindGiftTimeLimit(builder, findGiftTimeLimit):
    return ConstCommonExcelAddFindGiftTimeLimit(builder, findGiftTimeLimit)
def ConstCommonExcelAddCharacterMaxLevel(builder, characterMaxLevel): builder.PrependInt32Slot(76, characterMaxLevel, 0)
def AddCharacterMaxLevel(builder, characterMaxLevel):
    return ConstCommonExcelAddCharacterMaxLevel(builder, characterMaxLevel)
def ConstCommonExcelAddLimitedStageEntryTimeBuffer(builder, limitedStageEntryTimeBuffer): builder.PrependInt64Slot(77, limitedStageEntryTimeBuffer, 0)
...
def ConstCommonExcelAddAcademyEnterCostType(builder, academyEnterCostType): builder.PrependInt32Slot(78, academyEnterCostType, 0)
...
def ConstCommonExcelAddLimitedStageDailyClearCount(builder, limitedStageDailyClearCount): builder.PrependInt64Slot(79, limitedStageDailyClearCount, 0)
...
def ConstCommonExcelAddDDosDetectCount(builder, dDosDetectCount): builder.PrependInt32Slot(80, dDosDetectCount, 0)
...
def ConstCommonExcelAddClanRejoinCoolTimeFromSecond(builder, clanRejoinCoolTimeFromSecond): builder.PrependInt64Slot(82, clanRejoinCoolTimeFromSecond, 0)
...
def ConstCommonExcelAddFormationPresetEchelonSlotTextLengthKr(builder, formationPresetEchelonSlotTextLengthKr): builder.PrependInt32Slot(83, formationPresetEchelonSlotTextLengthKr, 0)
...
def ConstCommonExcelAddClanMaxApplicant(builder, clanMaxApplicant): builder.PrependInt64Slot(84, clanMaxApplicant, 0)
def AddClanMaxApplicant(builder, clanMaxApplicant):
    return ConstCommonExcelAddClanMaxApplicant(builder, clanMaxApplicant)
def ConstCommonExcelAddCraftLimitTime(builder, craftLimitTime): builder.PrependInt32Slot(85, craftLimitTime, 0)
def AddCraftLimitTime(builder, craftLimitTime):
    return ConstCommonExcelAddCraftLimitTime(builder, craftLimitTime)
def ConstCommonExcelAddCharacterEquipmentGearSlot(builder, characterEquipmentGearSlot): builder.PrependInt64Slot(86, characterEquipmentGearSlot, 0)
...
def ConstCommonExcelAddRequestTimeOut(builder, requestTimeOut): builder.PrependFloat32Slot(87, requestTimeOut, 0.0)
def AddRequestTimeOut(builder, requestTimeOut):
    return ConstCommonExcelAddRequestTimeOut(builder, requestTimeOut)
def ConstCommonExcelAddMaxFriendsRequest(builder, maxFriendsRequest): builder.PrependInt32Slot(88, maxFriendsRequest, 0)
def AddMaxFriendsRequest(builder, maxFriendsRequest):
    return ConstCommonExcelAddMaxFriendsRequest(builder, maxFriendsRequest)
def ConstCommonExcelAddPotentialBonusStatMaxLevelAttackPower(builder, potentialBonusStatMaxLevelAttackPower): builder.PrependInt32Slot(89, potentialBonusStatMaxLevelAttackPower, 0)
...
def ConstCommonExcelAddEquipLvUpCoefficient(builder, equipLvUpCoefficient): builder.PrependInt32Slot(90, equipLvUpCoefficient, 0)
...
def ConstCommonExcelAddCharProfilePopupRowIntervalKr(builder, charProfilePopupRowIntervalKr): builder.PrependInt32Slot(91, charProfilePopupRowIntervalKr, 0)
...
def ConstCommonExcelAddShiftingCraftDuration(builder, shiftingCraftDuration): builder.PrependUOffsetTRelativeSlot(92, flatbuffers.number_types.UOffsetTFlags.py_type(shiftingCraftDuration), 0)
...
def ConstCommonExcelAddTutorialGachaShopId(builder, tutorialGachaShopId): builder.PrependInt32Slot(93, tutorialGachaShopId, 0)
...
def ConstCommonExcelAddClanNameLength(builder, clanNameLength): builder.PrependInt32Slot(94, clanNameLength, 0)
def AddClanNameLength(builder, clanNameLength):
    return ConstCommonExcelAddClanNameLength(builder, clanNameLength)
def ConstCommonExcelAddBirthdayMailRemainDate(builder, birthdayMailRemainDate): builder.PrependInt32Slot(95, birthdayMailRemainDate, 0)
...
def ConstCommonExcelAddRankBracketPercentage1(builder, rankBracketPercentage1): builder.PrependInt32Slot(96, rankBracketPercentage1, 0)
...
def ConstCommonExcelAddShiftingCraftSlotMaxCapacity(builder, shiftingCraftSlotMaxCapacity): builder.PrependInt32Slot(98, shiftingCraftSlotMaxCapacity, 0)
...
def ConstCommonExcelAddRaidTicketCost(builder, raidTicketCost): builder.PrependInt64Slot(99, raidTicketCost, 0)
def AddRaidTicketCost(builder, raidTicketCost):
    return ConstCommonExcelAddRaidTicketCost(builder, raidTicketCost)
def ConstCommonExcelAddCraftOpenExpTier3(builder, craftOpenExpTier3): builder.PrependInt64Slot(100, craftOpenExpTier3, 0)
def AddCraftOpenExpTier3(builder, craftOpenExpTier3):
    return ConstCommonExcelAddCraftOpenExpTier3(builder, craftOpenExpTier3)
def ConstCommonExcelAddRankBracketPercentage7(builder, rankBracketPercentage7): builder.PrependInt32Slot(101, rankBracketPercentage7, 0)
...
def ConstCommonExcelAddBeforehandGachaCount(builder, beforehandGachaCount): builder.PrependInt32Slot(102, beforehandGachaCount, 0)
...
def ConstCommonExcelAddEquipmentSlotOpenLevel(builder, equipmentSlotOpenLevel): builder.PrependUOffsetTRelativeSlot(103, flatbuffers.number_types.UOffsetTFlags.py_type(equipmentSlotOpenLevel), 0)
...
def ConstCommonExcelAddClanWordBalloonMaxCharacter(builder, clanWordBalloonMaxCharacter): builder.PrependInt32Slot(104, clanWordBalloonMaxCharacter, 0)
...
def ConstCommonExcelAddCraftBaseGoldRequired(builder, craftBaseGoldRequired): builder.PrependUOffsetTRelativeSlot(105, flatbuffers.number_types.UOffsetTFlags.py_type(craftBaseGoldRequired), 0)
...
def ConstCommonExcelAddAcademyFavorZoneId(builder, academyFavorZoneId): builder.PrependInt64Slot(106, academyFavorZoneId, 0)
...
def ConstCommonExcelAddCraftLeafNodeGenerateLv2Count(builder, craftLeafNodeGenerateLv2Count): builder.PrependInt32Slot(107, craftLeafNodeGenerateLv2Count, 0)
...
def ConstCommonExcelAddExpItemInsertLimit(builder, expItemInsertLimit): builder.PrependInt32Slot(108, expItemInsertLimit, 0)
...
def ConstCommonExcelAddCafeMonologueDefaultDuration(builder, cafeMonologueDefaultDuration): builder.PrependInt64Slot(109, cafeMonologueDefaultDuration, 0)
...
def ConstCommonExcelAddFriendIdCardCommentMaxLength(builder, friendIdCardCommentMaxLength): builder.PrependInt64Slot(110, friendIdCardCommentMaxLength, 0)
...
def ConstCommonExcelAddPostExpiredDayInventoryOverflow(builder, postExpiredDayInventoryOverflow): builder.PrependInt32Slot(111, postExpiredDayInventoryOverflow, 0)
...
def ConstCommonExcelAddJoinOrCreateClanCoolTimeFromHour(builder, joinOrCreateClanCoolTimeFromHour): builder.PrependInt64Slot(112, joinOrCreateClanCoolTimeFromHour, 0)
...
def ConstCommonExcelAddPublicSkillLevelMax(builder, publicSkillLevelMax): builder.PrependInt32Slot(113, publicSkillLevelMax, 0)
...
def ConstCommonExcelAddLimitedStagePointPerApMin(builder, limitedStagePointPerApMin): builder.PrependInt64Slot(114, limitedStagePointPerApMin, 0)
...
def ConstCommonExcelAddFormationPresetEchelonTabTextLength(builder, formationPresetEchelonTabTextLength): builder.PrependInt32Slot(115, formationPresetEchelonTabTextLength, 0)
...
def ConstCommonExcelAddExtraPassiveSkillLevelMax(builder, extraPassiveSkillLevelMax): builder.PrependInt32Slot(116, extraPassiveSkillLevelMax, 0)
...
def ConstCommonExcelAddMailStorageSoftCap(builder, mailStorageSoftCap): builder.PrependInt32Slot(117, mailStorageSoftCap, 0)
...
def ConstCommonExcelAddCallNameWaitTimeGl(builder, callNameWaitTimeGl): builder.PrependFloat32Slot(118, callNameWaitTimeGl, 0.0)
...
def ConstCommonExcelAddBeforehandGachaGroupId(builder, beforehandGachaGroupId): builder.PrependInt32Slot(119, beforehandGachaGroupId, 0)
...
def ConstCommonExcelAddClanLeaderTransferLastLoginLimit(builder, clanLeaderTransferLastLoginLimit): builder.PrependInt64Slot(120, clanLeaderTransferLastLoginLimit, 0)
...
def ConstCommonExcelAddClearDeckShowCount(builder, clearDeckShowCount): builder.PrependInt32Slot(121, clearDeckShowCount, 0)
...
def ConstCommonExcelAddClearDeckAverageDeckCount(builder, clearDeckAverageDeckCount): builder.PrependInt32Slot(122, clearDeckAverageDeckCount, 0)
...
def ConstCommonExcelAddBirthdayMailStartDate(builder, birthdayMailStartDate): builder.PrependUOffsetTRelativeSlot(123, flatbuffers.number_types.UOffsetTFlags.py_type(birthdayMailStartDate), 0)
...
def ConstCommonExcelAddExpiryBattlePassItemReceiveDay(builder, expiryBattlePassItemReceiveDay): builder.PrependInt32Slot(124, expiryBattlePassItemReceiveDay, 0)
...
def ConstCommonExcelAddRankBracketPercentage2(builder, rankBracketPercentage2): builder.PrependInt32Slot(125, rankBracketPercentage2, 0)
...
def ConstCommonExcelAddRaidEnterCostType(builder, raidEnterCostType): builder.PrependInt32Slot(126, raidEnterCostType, 0)
...
def ConstCommonExcelAddMaxBlockedUserCount(builder, maxBlockedUserCount): builder.PrependInt32Slot(128, maxBlockedUserCount, 0)
...
def ConstCommonExcelAddClearDeck1StarViewCount(builder, clearDeck1StarViewCount): builder.PrependInt32Slot(129, clearDeck1StarViewCount, 0)
...
def ConstCommonExcelAddRaidOpponentListAmount(builder, raidOpponentListAmount): builder.PrependInt64Slot(130, raidOpponentListAmount, 0)
...
def ConstCommonExcelAddExpItemInsertAccelTime(builder, expItemInsertAccelTime): builder.PrependInt32Slot(131, expItemInsertAccelTime, 0)
...
def ConstCommonExcelAddTutorialShopCategoryType(builder, tutorialShopCategoryType): builder.PrependInt32Slot(132, tutorialShopCategoryType, 0)
...
def ConstCommonExcelAddTutorialSpeedButtonStage(builder, tutorialSpeedButtonStage): builder.PrependInt64Slot(133, tutorialSpeedButtonStage, 0)
...
def ConstCommonExcelAddCharProfilePopupRowIntervalJp(builder, charProfilePopupRowIntervalJp): builder.PrependInt32Slot(134, charProfilePopupRowIntervalJp, 0)
...
def ConstCommonExcelAddMassangerMessageExpireDay(builder, massangerMessageExpireDay): builder.PrependInt32Slot(135, massangerMessageExpireDay, 0)
...
def ConstCommonExcelAddBattlePassEndImminentDay(builder, battlePassEndImminentDay): builder.PrependInt32Slot(136, battlePassEndImminentDay, 0)
...
def ConstCommonExcelAddCafeCameraDragThreshold(builder, cafeCameraDragThreshold): builder.PrependFloat32Slot(137, cafeCameraDragThreshold, 0.0)
...
def ConstCommonExcelAddScenarioAutoDelayMillisec(builder, scenarioAutoDelayMillisec): builder.PrependFloat32Slot(139, scenarioAutoDelayMillisec, 0.0)
...
def ConstCommonExcelAddPurchaseMailExpiredDayGl(builder, purchaseMailExpiredDayGl): builder.PrependInt32Slot(140, purchaseMailExpiredDayGl, 0)
...
def ConstCommonExcelAddRankBracketPercentage3(builder, rankBracketPercentage3): builder.PrependInt32Slot(141, rankBracketPercentage3, 0)
...
def ConstCommonExcelAddAccountMaxLevel(builder, accountMaxLevel): builder.PrependInt32Slot(142, accountMaxLevel, 0)
...
def ConstCommonExcelAddExSkillLevelMax(builder, exSkillLevelMax): builder.PrependInt32Slot(144, exSkillLevelMax, 0)
def AddExSkillLevelMax(builder, exSkillLevelMax):
    return ConstCommonExcelAddExSkillLevelMax(builder, exSkillLevelMax)
def ConstCommonExcelAddAccountExpRatio(builder, accountExpRatio): builder.PrependInt32Slot(145, accountExpRatio, 0)
def AddAccountExpRatio(builder, accountExpRatio):
    return ConstCommonExcelAddAccountExpRatio(builder, accountExpRatio)
def ConstCommonExcelAddFormationPresetNumberOfEchelonTab(builder, formationPresetNumberOfEchelonTab): builder.PrependInt32Slot(146, formationPresetNumberOfEchelonTab, 0)
...
def ConstCommonExcelAddBattlePassExpIconPath(builder, battlePassExpIconPath): builder.PrependUOffsetTRelativeSlot(147, flatbuffers.number_types.UOffsetTFlags.py_type(battlePassExpIconPath), 0)
...
def ConstCommonExcelAddPassiveSkillLevelMax(builder, passiveSkillLevelMax): builder.PrependInt32Slot(148, passiveSkillLevelMax, 0)
...
def ConstCommonExcelAddNicknameLengthKr(builder, nicknameLengthKr): builder.PrependInt32Slot(149, nicknameLengthKr, 0)
def AddNicknameLengthKr(builder, nicknameLengthKr):
    return ConstCommonExcelAddNicknameLengthKr(builder, nicknameLengthKr)
def ConstCommonExcelAddCafeSummonCoolTimeFromHour(builder, cafeSummonCoolTimeFromHour): builder.PrependInt32Slot(150, cafeSummonCoolTimeFromHour, 0)
...
def ConstCommonExcelAddLimitedStagePointPerApMax(builder, limitedStagePointPerApMax): builder.PrependInt64Slot(151, limitedStagePointPerApMax, 0)
...
def ConstCommonExcelAddCafeRandomVisitMinComfortBonus(builder, cafeRandomVisitMinComfortBonus): builder.PrependInt64Slot(152, cafeRandomVisitMinComfortBonus, 0)
...
def ConstCommonExcelAddCallNameRenameCoolTimeFromHour(builder, callNameRenameCoolTimeFromHour): builder.PrependInt64Slot(153, callNameRenameCoolTimeFromHour, 0)
...
def ConstCommonExcelAddCafeRandomVisitMinLastLogin(builder, cafeRandomVisitMinLastLogin): builder.PrependInt32Slot(155, cafeRandomVisitMinLastLogin, 0)
...
def ConstCommonExcelAddGachaPercentage(builder, gachaPercentage): builder.PrependInt32Slot(156, gachaPercentage, 0)
def AddGachaPercentage(builder, gachaPercentage):
    return ConstCommonExcelAddGachaPercentage(builder, gachaPercentage)
def ConstCommonExcelAddBirthDayDDay(builder, birthDayDDay): builder.PrependInt32Slot(157, birthDayDDay, 0)
def AddBirthDayDDay(builder, birthDayDDay):
    return ConstCommonExcelAddBirthDayDDay(builder, birthDayDDay)
def ConstCommonExcelAddCraftDuration(builder, craftDuration): builder.PrependUOffsetTRelativeSlot(158, flatbuffers.number_types.UOffsetTFlags.py_type(craftDuration), 0)
...
def ConstCommonExcelAddPostExpiredDayGameManager(builder, postExpiredDayGameManager): builder.PrependInt32Slot(159, postExpiredDayGameManager, 0)
...
def ConstCommonExcelAddBirthdayMailParcelAmount(builder, birthdayMailParcelAmount): builder.PrependInt32Slot(160, birthdayMailParcelAmount, 0)
...
def ConstCommonExcelAddCafeAutoChargePeriodInMsc(builder, cafeAutoChargePeriodInMsc): builder.PrependInt32Slot(161, cafeAutoChargePeriodInMsc, 0)
...
def ConstCommonExcelAddMonthlyProductCheckDays(builder, monthlyProductCheckDays): builder.PrependInt32Slot(162, monthlyProductCheckDays, 0)
...
def ConstCommonExcelAddMailStorageHardCap(builder, mailStorageHardCap): builder.PrependInt32Slot(163, mailStorageHardCap, 0)
...
def ConstCommonExcelAddExpEquipInsertLimit(builder, expEquipInsertLimit): builder.PrependInt32Slot(164, expEquipInsertLimit, 0)
...
def ConstCommonExcelAddCharacterLvUpCoefficient(builder, characterLvUpCoefficient): builder.PrependInt32Slot(165, characterLvUpCoefficient, 0)
...
def ConstCommonExcelAddPotentialBonusStatMaxLevelMaxHp(builder, potentialBonusStatMaxLevelMaxHp): builder.PrependInt32Slot(166, potentialBonusStatMaxLevelMaxHp, 0)
...
def ConstCommonExcelAddEmblemDefaultId(builder, emblemDefaultId): builder.PrependInt64Slot(168, emblemDefaultId, 0)
def AddEmblemDefaultId(builder, emblemDefaultId):
    return ConstCommonExcelAddEmblemDefaultId(builder, emblemDefaultId)
def ConstCommonExcelAddFormationPresetEchelonTabTextLengthKr(builder, formationPresetEchelonTabTextLengthKr): builder.PrependInt32Slot(169, formationPresetEchelonTabTextLengthKr, 0)
...
def ConstCommonExcelAddCraftTicketConsumeAmount(builder, craftTicketConsumeAmount): builder.PrependInt32Slot(170, craftTicketConsumeAmount, 0)
...
def ConstCommonExcelAddCallnameLengthEn(builder, callnameLengthEn): builder.PrependInt32Slot(171, callnameLengthEn, 0)
def AddCallnameLengthEn(builder, callnameLengthEn):
    return ConstCommonExcelAddCallnameLengthEn(builder, callnameLengthEn)
def ConstCommonExcelAddClanChattingNoticeCautionDelay(builder, clanChattingNoticeCautionDelay): builder.PrependFloat32Slot(172, clanChattingNoticeCautionDelay, 0.0)
...
def ConstCommonExcelAddShowRaidMyListCount(builder, showRaidMyListCount): builder.PrependInt32Slot(173, showRaidMyListCount, 0)
...
def ConstCommonExcelAddCampaignMainStageBestRecord(builder, campaignMainStageBestRecord): builder.PrependInt32Slot(174, campaignMainStageBestRecord, 0)
...
def ConstCommonExcelAddTutorialCharacterDefaultCount(builder, tutorialCharacterDefaultCount): builder.PrependInt64Slot(175, tutorialCharacterDefaultCount, 0)
...
def ConstCommonExcelAddAssistStrangerMinLevel(builder, assistStrangerMinLevel): builder.PrependInt32Slot(176, assistStrangerMinLevel, 0)
...
def ConstCommonExcelAddCafePresetSlotCount(builder, cafePresetSlotCount): builder.PrependInt32Slot(177, cafePresetSlotCount, 0)
...
def ConstCommonExcelAddTimeAttackDungeonEnterCost(builder, timeAttackDungeonEnterCost): builder.PrependInt64Slot(178, timeAttackDungeonEnterCost, 0)
...
def ConstCommonExcelAddCraftTicketItemUniqueId(builder, craftTicketItemUniqueId): builder.PrependInt32Slot(179, craftTicketItemUniqueId, 0)
...
def ConstCommonExcelAddMaxApMasterCoinPerWeek(builder, maxApMasterCoinPerWeek): builder.PrependInt64Slot(180, maxApMasterCoinPerWeek, 0)
...
def ConstCommonExcelAddCallnameLengthKr(builder, callnameLengthKr): builder.PrependInt32Slot(181, callnameLengthKr, 0)
def AddCallnameLengthKr(builder, callnameLengthKr):
    return ConstCommonExcelAddCallnameLengthKr(builder, callnameLengthKr)
def ConstCommonExcelAddCallNameMaximumLength(builder, callNameMaximumLength): builder.PrependInt64Slot(182, callNameMaximumLength, 0)
...
def ConstCommonExcelAddRaidEnterCostId(builder, raidEnterCostId): builder.PrependInt64Slot(183, raidEnterCostId, 0)
