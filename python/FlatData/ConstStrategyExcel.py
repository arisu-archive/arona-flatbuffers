...
def ConstStrategyExcelAddTacticSkipFramePerSecond(builder, tacticSkipFramePerSecond): builder.PrependInt32Slot(1, tacticSkipFramePerSecond, 0)
...
def ConstStrategyExcelAddWorldRaidEchelonCount(builder, worldRaidEchelonCount): builder.PrependInt32Slot(2, worldRaidEchelonCount, 0)
...
def ConstStrategyExcelAddStoryEchelonCount(builder, storyEchelonCount): builder.PrependInt32Slot(3, storyEchelonCount, 0)
...
def ConstStrategyExcelAddTacticSkipClearTimeSeconds(builder, tacticSkipClearTimeSeconds): builder.PrependInt32Slot(4, tacticSkipClearTimeSeconds, 0)
...
def ConstStrategyExcelAddHexaMapStartCameraOffset(builder, hexaMapStartCameraOffset): builder.PrependFloat32Slot(5, hexaMapStartCameraOffset, 0.0)
...
def ConstStrategyExcelAddMultiSweepPresetNameMaxLengthKr(builder, multiSweepPresetNameMaxLengthKr): builder.PrependInt32Slot(7, multiSweepPresetNameMaxLengthKr, 0)
...
def ConstStrategyExcelAddMultiSweepPresetNameMaxLength(builder, multiSweepPresetNameMaxLength): builder.PrependInt32Slot(8, multiSweepPresetNameMaxLength, 0)
...
def ConstStrategyExcelAddAdventureEchelonCount(builder, adventureEchelonCount): builder.PrependInt32Slot(10, adventureEchelonCount, 0)
...
def ConstStrategyExcelAddMultiSweepPresetSelectStageMaxCount(builder, multiSweepPresetSelectStageMaxCount): builder.PrependInt32Slot(11, multiSweepPresetSelectStageMaxCount, 0)
...
def ConstStrategyExcelAddMultiSweepPresetSelectParcelMaxCount(builder, multiSweepPresetSelectParcelMaxCount): builder.PrependInt32Slot(13, multiSweepPresetSelectParcelMaxCount, 0)
...
def ConstStrategyExcelAddCameraZoomMax(builder, cameraZoomMax): builder.PrependFloat32Slot(14, cameraZoomMax, 0.0)
def AddCameraZoomMax(builder, cameraZoomMax):
    return ConstStrategyExcelAddCameraZoomMax(builder, cameraZoomMax)
def ConstStrategyExcelAddCameraZoomMin(builder, cameraZoomMin): builder.PrependFloat32Slot(15, cameraZoomMin, 0.0)
def AddCameraZoomMin(builder, cameraZoomMin):
    return ConstStrategyExcelAddCameraZoomMin(builder, cameraZoomMin)
def ConstStrategyExcelAddMultiSweepPresetCount(builder, multiSweepPresetCount): builder.PrependInt32Slot(16, multiSweepPresetCount, 0)
...
def ConstStrategyExcelAddConquestEchelonCount(builder, conquestEchelonCount): builder.PrependInt32Slot(18, conquestEchelonCount, 0)
...
def ConstStrategyExcelAddHealCostType(builder, healCostType): builder.PrependInt32Slot(19, healCostType, 0)
def AddHealCostType(builder, healCostType):
    return ConstStrategyExcelAddHealCostType(builder, healCostType)
def ConstStrategyExcelAddEventContentEchelonCount(builder, eventContentEchelonCount): builder.PrependInt32Slot(20, eventContentEchelonCount, 0)
...
def ConstStrategyExcelAddMultiSweepPresetMaxSweepCount(builder, multiSweepPresetMaxSweepCount): builder.PrependInt32Slot(21, multiSweepPresetMaxSweepCount, 0)
...
def ConstStrategyExcelAddCameraZoomDefault(builder, cameraZoomDefault): builder.PrependFloat32Slot(22, cameraZoomDefault, 0.0)
...
def ConstStrategyExcelAddCanHealHpRate(builder, canHealHpRate): builder.PrependInt32Slot(23, canHealHpRate, 0)
