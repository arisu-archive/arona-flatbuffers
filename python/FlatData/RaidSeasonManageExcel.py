...
def RaidSeasonManageExcelAddSeasonDisplay(builder, seasonDisplay): builder.PrependInt64Slot(2, seasonDisplay, 0)
...
def RaidSeasonManageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(4, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return RaidSeasonManageExcelAddSeasonId(builder, seasonId)
def RaidSeasonManageExcelAddMaxSeasonRewardGauage(builder, maxSeasonRewardGauage): builder.PrependInt32Slot(5, maxSeasonRewardGauage, 0)
...
def RaidSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def RaidSeasonManageExcelAddOpenRaidBossGroup(builder, openRaidBossGroup): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroup), 0)
...
def RaidSeasonManageExcelAddSeasonStartData(builder, seasonStartData): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(seasonStartData), 0)
