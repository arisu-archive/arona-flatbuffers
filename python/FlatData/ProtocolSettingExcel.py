...
def ProtocolSettingExcelAddInventory(builder, inventory): builder.PrependBoolSlot(0, inventory, 0)
def AddInventory(builder, inventory):
    return ProtocolSettingExcelAddInventory(builder, inventory)
def ProtocolSettingExcelAddCurrency(builder, currency): builder.PrependBoolSlot(1, currency, 0)
def AddCurrency(builder, currency):
    return ProtocolSettingExcelAddCurrency(builder, currency)
def ProtocolSettingExcelAddProtocol(builder, protocol): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(protocol), 0)
def AddProtocol(builder, protocol):
    return ProtocolSettingExcelAddProtocol(builder, protocol)
def ProtocolSettingExcelAddMail(builder, mail): builder.PrependBoolSlot(3, mail, 0)
def AddMail(builder, mail):
    return ProtocolSettingExcelAddMail(builder, mail)
def ProtocolSettingExcelAddOpenConditionContent(builder, openConditionContent): builder.PrependInt32Slot(4, openConditionContent, 0)
