...
def ConstMiniGameShootingExcelAddNormalSectionCount(builder, normalSectionCount): builder.PrependInt32Slot(0, normalSectionCount, 0)
...
def ConstMiniGameShootingExcelAddNormalStageId(builder, normalStageId): builder.PrependInt64Slot(1, normalStageId, 0)
...
def ConstMiniGameShootingExcelAddFreeSectionCount(builder, freeSectionCount): builder.PrependInt32Slot(3, freeSectionCount, 0)
...
def ConstMiniGameShootingExcelAddSpawnEffectPath(builder, spawnEffectPath): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(spawnEffectPath), 0)
...
def ConstMiniGameShootingExcelAddCameraSmoothTime(builder, cameraSmoothTime): builder.PrependFloat32Slot(5, cameraSmoothTime, 0.0)
...
def ConstMiniGameShootingExcelAddHardSectionCount(builder, hardSectionCount): builder.PrependInt32Slot(6, hardSectionCount, 0)
...
def ConstMiniGameShootingExcelAddWaitTimeAfterSpawn(builder, waitTimeAfterSpawn): builder.PrependFloat32Slot(7, waitTimeAfterSpawn, 0.0)
...
def ConstMiniGameShootingExcelAddHiddenPlayerCharacterId(builder, hiddenPlayerCharacterId): builder.PrependInt64Slot(8, hiddenPlayerCharacterId, 0)
...
def ConstMiniGameShootingExcelAddFreeGearInterval(builder, freeGearInterval): builder.PrependInt32Slot(9, freeGearInterval, 0)
...
def ConstMiniGameShootingExcelAddFreeStageId(builder, freeStageId): builder.PrependInt64Slot(10, freeStageId, 0)
def AddFreeStageId(builder, freeStageId):
    return ConstMiniGameShootingExcelAddFreeStageId(builder, freeStageId)
def ConstMiniGameShootingExcelAddPlayerCharacterId(builder, playerCharacterId): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(playerCharacterId), 0)
