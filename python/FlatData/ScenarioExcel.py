...
def ScenarioExcelAddEnterConver(builder, enterConver): builder.PrependInt32Slot(0, enterConver, 0)
...
def ScenarioExcelAddPrologue(builder, prologue): builder.PrependInt32Slot(4, prologue, 0)
def AddPrologue(builder, prologue):
    return ScenarioExcelAddPrologue(builder, prologue)
def ScenarioExcelAddCafe(builder, cafe): builder.PrependInt32Slot(5, cafe, 0)
def AddCafe(builder, cafe):
    return ScenarioExcelAddCafe(builder, cafe)
def ScenarioExcelAddIdle(builder, idle): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(idle), 0)
...
def ScenarioExcelAddOpen(builder, open): builder.PrependInt32Slot(7, open, 0)
