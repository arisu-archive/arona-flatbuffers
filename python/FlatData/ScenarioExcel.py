...
def ScenarioExcelAddEnterConver(builder, enterConver): builder.PrependInt32Slot(1, enterConver, 0)
def AddEnterConver(builder, enterConver):
    return ScenarioExcelAddEnterConver(builder, enterConver)
def ScenarioExcelAddIdle(builder, idle): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(idle), 0)
...
def ScenarioExcelAddCafe(builder, cafe): builder.PrependInt32Slot(3, cafe, 0)
def AddCafe(builder, cafe):
    return ScenarioExcelAddCafe(builder, cafe)
def ScenarioExcelAddCenter(builder, center): builder.PrependInt32Slot(4, center, 0)
def AddCenter(builder, center):
    return ScenarioExcelAddCenter(builder, center)
def ScenarioExcelAddInstant(builder, instant): builder.PrependInt32Slot(5, instant, 0)
def AddInstant(builder, instant):
    return ScenarioExcelAddInstant(builder, instant)
def ScenarioExcelAddTalk(builder, talk): builder.PrependInt32Slot(6, talk, 0)
...
def ScenarioExcelAddOpen(builder, open): builder.PrependInt32Slot(8, open, 0)
