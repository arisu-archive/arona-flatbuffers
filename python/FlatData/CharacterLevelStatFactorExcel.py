...
def CharacterLevelStatFactorExcelAddCriticalFactor(builder, criticalFactor): builder.PrependInt64Slot(2, criticalFactor, 0)
def AddCriticalFactor(builder, criticalFactor):
    return CharacterLevelStatFactorExcelAddCriticalFactor(builder, criticalFactor)
def CharacterLevelStatFactorExcelAddAccuracyFactor(builder, accuracyFactor): builder.PrependInt64Slot(3, accuracyFactor, 0)
