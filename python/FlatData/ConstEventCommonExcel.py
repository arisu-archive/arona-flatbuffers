...
def ConstEventCommonExcelAddTreasureLimitVariationLoopCount(builder, treasureLimitVariationLoopCount): builder.PrependInt32Slot(4, treasureLimitVariationLoopCount, 0)
...
def ConstEventCommonExcelAddTreasureNormalVariationAmount(builder, treasureNormalVariationAmount): builder.PrependInt32Slot(5, treasureNormalVariationAmount, 0)
...
def ConstEventCommonExcelAddMeetupScenarioReplayTitleLocalize(builder, meetupScenarioReplayTitleLocalize): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(meetupScenarioReplayTitleLocalize), 0)
...
def ConstEventCommonExcelAddMeetupScenarioReplayResource(builder, meetupScenarioReplayResource): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(meetupScenarioReplayResource), 0)
...
def ConstEventCommonExcelAddCardShopProbWeightRarity(builder, cardShopProbWeightRarity): builder.PrependInt32Slot(12, cardShopProbWeightRarity, 0)
