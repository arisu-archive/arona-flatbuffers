...
def ConstEventCommonExcelAddSubEventInstantClear(builder, subEventInstantClear): builder.PrependBoolSlot(0, subEventInstantClear, 0)
...
def ConstEventCommonExcelAddEventStoryReplayHideEventContentId(builder, eventStoryReplayHideEventContentId): builder.PrependInt32Slot(1, eventStoryReplayHideEventContentId, 0)
...
def ConstEventCommonExcelAddMeetupScenarioReplayResource(builder, meetupScenarioReplayResource): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(meetupScenarioReplayResource), 0)
...
def ConstEventCommonExcelAddTreasureLimitVariationLoopCount(builder, treasureLimitVariationLoopCount): builder.PrependInt32Slot(3, treasureLimitVariationLoopCount, 0)
...
def ConstEventCommonExcelAddSubEventChangeLimitSeconds(builder, subEventChangeLimitSeconds): builder.PrependInt64Slot(4, subEventChangeLimitSeconds, 0)
...
def ConstEventCommonExcelAddTreasureLimitVariationClearLoopCount(builder, treasureLimitVariationClearLoopCount): builder.PrependInt32Slot(7, treasureLimitVariationClearLoopCount, 0)
...
def ConstEventCommonExcelAddTreasureLoopVariationAmount(builder, treasureLoopVariationAmount): builder.PrependInt32Slot(8, treasureLoopVariationAmount, 0)
...
def ConstEventCommonExcelAddCardShopProbWeightRarity(builder, cardShopProbWeightRarity): builder.PrependInt32Slot(9, cardShopProbWeightRarity, 0)
...
def ConstEventCommonExcelAddCardShopProbWeightCount(builder, cardShopProbWeightCount): builder.PrependInt64Slot(10, cardShopProbWeightCount, 0)
...
def ConstEventCommonExcelAddTreasureNormalVariationAmount(builder, treasureNormalVariationAmount): builder.PrependInt32Slot(11, treasureNormalVariationAmount, 0)
...
def ConstEventCommonExcelAddEventContentHardStageCount(builder, eventContentHardStageCount): builder.PrependInt32Slot(12, eventContentHardStageCount, 0)
...
def ConstEventCommonExcelAddEventStrategyPlayTimeLimitInSeconds(builder, eventStrategyPlayTimeLimitInSeconds): builder.PrependInt64Slot(13, eventStrategyPlayTimeLimitInSeconds, 0)
