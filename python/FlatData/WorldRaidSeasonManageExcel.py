...
def WorldRaidSeasonManageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(1, seasonId, 0)
...
def WorldRaidSeasonManageExcelAddEnterTicket(builder, enterTicket): builder.PrependInt32Slot(3, enterTicket, 0)
def AddEnterTicket(builder, enterTicket):
    return WorldRaidSeasonManageExcelAddEnterTicket(builder, enterTicket)
def WorldRaidSeasonManageExcelAddWorldRaidLobbyScene(builder, worldRaidLobbyScene): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyScene), 0)
...
def WorldRaidSeasonManageExcelAddSeasonOpenCondition(builder, seasonOpenCondition): builder.PrependInt64Slot(5, seasonOpenCondition, 0)
...
def WorldRaidSeasonManageExcelAddBossSpawnTime(builder, bossSpawnTime): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(bossSpawnTime), 0)
...
def WorldRaidSeasonManageExcelAddHideWorldRaidTicketUi(builder, hideWorldRaidTicketUi): builder.PrependBoolSlot(7, hideWorldRaidTicketUi, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidUniqueThemeLobbyUi(builder, worldRaidUniqueThemeLobbyUi): builder.PrependBoolSlot(8, worldRaidUniqueThemeLobbyUi, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBanner(builder, worldRaidLobbyBanner): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyBanner), 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidMapEnterOperator(builder, worldRaidMapEnterOperator): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidMapEnterOperator), 0)
...
def WorldRaidSeasonManageExcelAddHideWorldRaidBossCompleteRewardUi(builder, hideWorldRaidBossCompleteRewardUi): builder.PrependBoolSlot(12, hideWorldRaidBossCompleteRewardUi, 0)
...
def WorldRaidSeasonManageExcelAddConditionScenarioGroupid(builder, conditionScenarioGroupid): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(conditionScenarioGroupid), 0)
...
def WorldRaidSeasonManageExcelAddEliminateTime(builder, eliminateTime): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(eliminateTime), 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyEnterScenario(builder, worldRaidLobbyEnterScenario): builder.PrependInt64Slot(16, worldRaidLobbyEnterScenario, 0)
...
def WorldRaidSeasonManageExcelAddOpenRaidBossGroupId(builder, openRaidBossGroupId): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(openRaidBossGroupId), 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBg(builder, worldRaidLobbyBg): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidLobbyBg), 0)
...
def WorldRaidSeasonManageExcelAddUseWorldRaidCommonToast(builder, useWorldRaidCommonToast): builder.PrependBoolSlot(19, useWorldRaidCommonToast, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidLobbyBannerShow(builder, worldRaidLobbyBannerShow): builder.PrependBoolSlot(20, worldRaidLobbyBannerShow, 0)
...
def WorldRaidSeasonManageExcelAddWorldRaidUniqueThemeName(builder, worldRaidUniqueThemeName): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(worldRaidUniqueThemeName), 0)
...
def WorldRaidSeasonManageExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(22, eventContentId, 0)
