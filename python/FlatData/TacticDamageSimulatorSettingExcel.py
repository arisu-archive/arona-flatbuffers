...
def TacticDamageSimulatorSettingExcelAddTestPreset(builder, testPreset): builder.PrependInt64Slot(0, testPreset, 0)
def AddTestPreset(builder, testPreset):
    return TacticDamageSimulatorSettingExcelAddTestPreset(builder, testPreset)
def TacticDamageSimulatorSettingExcelAddOrder(builder, order): builder.PrependInt32Slot(1, order, 0)
...
def TacticDamageSimulatorSettingExcelAddOverrideOutdoorAdaptation(builder, overrideOutdoorAdaptation): builder.PrependInt32Slot(3, overrideOutdoorAdaptation, 0)
...
def TacticDamageSimulatorSettingExcelAddReplaceCostRegenValue(builder, replaceCostRegenValue): builder.PrependInt32Slot(4, replaceCostRegenValue, 0)
...
def TacticDamageSimulatorSettingExcelAddApplyOverrideAdaptation(builder, applyOverrideAdaptation): builder.PrependBoolSlot(5, applyOverrideAdaptation, 0)
...
def TacticDamageSimulatorSettingExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(6, groundId, 0)
def AddGroundId(builder, groundId):
    return TacticDamageSimulatorSettingExcelAddGroundId(builder, groundId)
def TacticDamageSimulatorSettingExcelAddReplaceCharacterCostRegen(builder, replaceCharacterCostRegen): builder.PrependBoolSlot(7, replaceCharacterCostRegen, 0)
...
def TacticDamageSimulatorSettingExcelAddFixedCharacter(builder, fixedCharacter): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(fixedCharacter), 0)
...
def TacticDamageSimulatorSettingExcelAddApplyOverrideFavorLevel(builder, applyOverrideFavorLevel): builder.PrependBoolSlot(10, applyOverrideFavorLevel, 0)
...
def TacticDamageSimulatorSettingExcelAddOverrideStreetAdaptation(builder, overrideStreetAdaptation): builder.PrependInt32Slot(11, overrideStreetAdaptation, 0)
...
def TacticDamageSimulatorSettingExcelAddOverrideFavorLevel(builder, overrideFavorLevel): builder.PrependInt32Slot(12, overrideFavorLevel, 0)
...
def TacticDamageSimulatorSettingExcelAddOverrideIndoorAdaptation(builder, overrideIndoorAdaptation): builder.PrependInt32Slot(13, overrideIndoorAdaptation, 0)
...
def TacticDamageSimulatorSettingExcelAddSpecialSquard(builder, specialSquard): builder.PrependInt64Slot(15, specialSquard, 0)
def AddSpecialSquard(builder, specialSquard):
    return TacticDamageSimulatorSettingExcelAddSpecialSquard(builder, specialSquard)
def TacticDamageSimulatorSettingExcelAddRepeat(builder, repeat): builder.PrependInt32Slot(16, repeat, 0)
