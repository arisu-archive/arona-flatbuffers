...
def TacticTimeAttackSimulatorConfigExcelAddPresetGroupId(builder, presetGroupId): builder.PrependInt64Slot(0, presetGroupId, 0)
...
def TacticTimeAttackSimulatorConfigExcelAddAttackSpecialNum(builder, attackSpecialNum): builder.PrependInt64Slot(2, attackSpecialNum, 0)
...
def TacticTimeAttackSimulatorConfigExcelAddGeasId(builder, geasId): builder.PrependInt64Slot(4, geasId, 0)
