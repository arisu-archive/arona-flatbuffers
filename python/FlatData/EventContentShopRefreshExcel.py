...
def EventContentShopRefreshExcelAddId(builder, id): builder.PrependInt64Slot(0, id, 0)
def AddId(builder, id):
    return EventContentShopRefreshExcelAddId(builder, id)
def EventContentShopRefreshExcelAddGoodsId(builder, goodsId): builder.PrependInt64Slot(1, goodsId, 0)
...
def EventContentShopRefreshExcelAddProb(builder, prob): builder.PrependInt32Slot(3, prob, 0)
def AddProb(builder, prob):
    return EventContentShopRefreshExcelAddProb(builder, prob)
def EventContentShopRefreshExcelAddRefreshGroup(builder, refreshGroup): builder.PrependInt32Slot(4, refreshGroup, 0)
def AddRefreshGroup(builder, refreshGroup):
    return EventContentShopRefreshExcelAddRefreshGroup(builder, refreshGroup)
def EventContentShopRefreshExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(5, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentShopRefreshExcelAddEventContentId(builder, eventContentId)
def EventContentShopRefreshExcelAddBuyReportEventName(builder, buyReportEventName): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(buyReportEventName), 0)
...
def EventContentShopRefreshExcelAddDisplayOrder(builder, displayOrder): builder.PrependInt64Slot(7, displayOrder, 0)
def AddDisplayOrder(builder, displayOrder):
    return EventContentShopRefreshExcelAddDisplayOrder(builder, displayOrder)
def EventContentShopRefreshExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(8, categoryType, 0)
def AddCategoryType(builder, categoryType):
    return EventContentShopRefreshExcelAddCategoryType(builder, categoryType)
def EventContentShopRefreshExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(9, isLegacy, 0)
