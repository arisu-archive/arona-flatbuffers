...
def EventContentCardShopExcelAddProbWeight1(builder, probWeight1): builder.PrependInt32Slot(0, probWeight1, 0)
def AddProbWeight1(builder, probWeight1):
    return EventContentCardShopExcelAddProbWeight1(builder, probWeight1)
def EventContentCardShopExcelAddProb(builder, prob): builder.PrependInt32Slot(1, prob, 0)
...
def EventContentCardShopExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentCardShopExcelAddCardGroupId(builder, cardGroupId): builder.PrependInt32Slot(8, cardGroupId, 0)
