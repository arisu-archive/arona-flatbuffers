...
def EventContentFortuneGachaShopExcelAddId(builder, id): builder.PrependInt64Slot(0, id, 0)
...
def EventContentFortuneGachaShopExcelAddCostGoodsId(builder, costGoodsId): builder.PrependInt64Slot(2, costGoodsId, 0)
def AddCostGoodsId(builder, costGoodsId):
    return EventContentFortuneGachaShopExcelAddCostGoodsId(builder, costGoodsId)
def EventContentFortuneGachaShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(3, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return EventContentFortuneGachaShopExcelAddIsLegacy(builder, isLegacy)
def EventContentFortuneGachaShopExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentFortuneGachaShopExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def EventContentFortuneGachaShopExcelAddGrade(builder, grade): builder.PrependInt32Slot(8, grade, 0)
def AddGrade(builder, grade):
    return EventContentFortuneGachaShopExcelAddGrade(builder, grade)
def EventContentFortuneGachaShopExcelAddProbModifyLimit(builder, probModifyLimit): builder.PrependInt32Slot(9, probModifyLimit, 0)
...
def EventContentFortuneGachaShopExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentFortuneGachaShopExcelAddProb(builder, prob): builder.PrependInt32Slot(11, prob, 0)
