...
def ConquestCalculateExcelAddCalculateConditionParcelType(builder, calculateConditionParcelType): builder.PrependInt32Slot(0, calculateConditionParcelType, 0)
...
def ConquestCalculateExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestCalculateExcelAddEventContentId(builder, eventContentId)
def ConquestCalculateExcelAddCalculateConditionParcelAmount(builder, calculateConditionParcelAmount): builder.PrependInt64Slot(2, calculateConditionParcelAmount, 0)
...
def ConquestCalculateExcelAddCalculateConditionParcelUniqueId(builder, calculateConditionParcelUniqueId): builder.PrependInt64Slot(3, calculateConditionParcelUniqueId, 0)
