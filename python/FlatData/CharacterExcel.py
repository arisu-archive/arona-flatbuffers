...
def CharacterExcelAddIsPlayable(builder, isPlayable): builder.PrependBoolSlot(0, isPlayable, 0)
def AddIsPlayable(builder, isPlayable):
    return CharacterExcelAddIsPlayable(builder, isPlayable)
def CharacterExcelAddJumpable(builder, jumpable): builder.PrependBoolSlot(1, jumpable, 0)
def AddJumpable(builder, jumpable):
    return CharacterExcelAddJumpable(builder, jumpable)
def CharacterExcelAddHighlightFloaterHeight(builder, highlightFloaterHeight): builder.PrependFloat32Slot(2, highlightFloaterHeight, 0.0)
...
def CharacterExcelAddIsAirUnit(builder, isAirUnit): builder.PrependBoolSlot(3, isAirUnit, 0)
def AddIsAirUnit(builder, isAirUnit):
    return CharacterExcelAddIsAirUnit(builder, isAirUnit)
def CharacterExcelAddCanCrowdControl(builder, canCrowdControl): builder.PrependBoolSlot(4, canCrowdControl, 0)
def AddCanCrowdControl(builder, canCrowdControl):
    return CharacterExcelAddCanCrowdControl(builder, canCrowdControl)
def CharacterExcelAddHpBarHeight(builder, hpBarHeight): builder.PrependFloat32Slot(5, hpBarHeight, 0.0)
def AddHpBarHeight(builder, hpBarHeight):
    return CharacterExcelAddHpBarHeight(builder, hpBarHeight)
def CharacterExcelAddMoveStartFrame(builder, moveStartFrame): builder.PrependInt32Slot(6, moveStartFrame, 0)
def AddMoveStartFrame(builder, moveStartFrame):
    return CharacterExcelAddMoveStartFrame(builder, moveStartFrame)
def CharacterExcelAddAirUnitHeight(builder, airUnitHeight): builder.PrependInt64Slot(7, airUnitHeight, 0)
def AddAirUnitHeight(builder, airUnitHeight):
    return CharacterExcelAddAirUnitHeight(builder, airUnitHeight)
def CharacterExcelAddReleaseDate(builder, releaseDate): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(releaseDate), 0)
def AddReleaseDate(builder, releaseDate):
    return CharacterExcelAddReleaseDate(builder, releaseDate)
def CharacterExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def CharacterExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleStartDate), 0)
...
def CharacterExcelAddSubPartsCount(builder, subPartsCount): builder.PrependInt32Slot(11, subPartsCount, 0)
def AddSubPartsCount(builder, subPartsCount):
    return CharacterExcelAddSubPartsCount(builder, subPartsCount)
def CharacterExcelAddIsPlayableCharacter(builder, isPlayableCharacter): builder.PrependBoolSlot(12, isPlayableCharacter, 0)
...
def CharacterExcelAddCanBattleItemMove(builder, canBattleItemMove): builder.PrependBoolSlot(13, canBattleItemMove, 0)
def AddCanBattleItemMove(builder, canBattleItemMove):
    return CharacterExcelAddCanBattleItemMove(builder, canBattleItemMove)
def CharacterExcelAddAimIkType(builder, aimIkType): builder.PrependInt32Slot(14, aimIkType, 0)
def AddAimIkType(builder, aimIkType):
    return CharacterExcelAddAimIkType(builder, aimIkType)
def CharacterExcelAddFavorLevelupType(builder, favorLevelupType): builder.PrependInt32Slot(15, favorLevelupType, 0)
def AddFavorLevelupType(builder, favorLevelupType):
    return CharacterExcelAddFavorLevelupType(builder, favorLevelupType)
def CharacterExcelAddSpawnTemplateId(builder, spawnTemplateId): builder.PrependUint32Slot(16, spawnTemplateId, 0)
def AddSpawnTemplateId(builder, spawnTemplateId):
    return CharacterExcelAddSpawnTemplateId(builder, spawnTemplateId)
def CharacterExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(17, statLevelUpType, 0)
def AddStatLevelUpType(builder, statLevelUpType):
    return CharacterExcelAddStatLevelUpType(builder, statLevelUpType)
def CharacterExcelAddIsNpc(builder, isNpc): builder.PrependBoolSlot(18, isNpc, 0)
def AddIsNpc(builder, isNpc):
    return CharacterExcelAddIsNpc(builder, isNpc)
def CharacterExcelAddClub(builder, club): builder.PrependInt32Slot(19, club, 0)
def AddClub(builder, club):
    return CharacterExcelAddClub(builder, club)
def CharacterExcelAddSecretStoneItemId(builder, secretStoneItemId): builder.PrependInt64Slot(20, secretStoneItemId, 0)
def AddSecretStoneItemId(builder, secretStoneItemId):
    return CharacterExcelAddSecretStoneItemId(builder, secretStoneItemId)
def CharacterExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return CharacterExcelAddDevName(builder, devName)
def CharacterExcelAddTacticRole(builder, tacticRole): builder.PrependInt32Slot(22, tacticRole, 0)
def AddTacticRole(builder, tacticRole):
    return CharacterExcelAddTacticRole(builder, tacticRole)
def CharacterExcelAddRarity(builder, rarity): builder.PrependInt32Slot(23, rarity, 0)
def AddRarity(builder, rarity):
    return CharacterExcelAddRarity(builder, rarity)
def CharacterExcelAddEmojiOffsetY(builder, emojiOffsetY): builder.PrependFloat32Slot(24, emojiOffsetY, 0.0)
def AddEmojiOffsetY(builder, emojiOffsetY):
    return CharacterExcelAddEmojiOffsetY(builder, emojiOffsetY)
def CharacterExcelAddCombatStyleIndex(builder, combatStyleIndex): builder.PrependInt32Slot(25, combatStyleIndex, 0)
def AddCombatStyleIndex(builder, combatStyleIndex):
    return CharacterExcelAddCombatStyleIndex(builder, combatStyleIndex)
def CharacterExcelAddCanMove(builder, canMove): builder.PrependBoolSlot(26, canMove, 0)
def AddCanMove(builder, canMove):
    return CharacterExcelAddCanMove(builder, canMove)
def CharacterExcelAddAppearFrame(builder, appearFrame): builder.PrependInt32Slot(27, appearFrame, 0)
def AddAppearFrame(builder, appearFrame):
    return CharacterExcelAddAppearFrame(builder, appearFrame)
def CharacterExcelAddTacticRange(builder, tacticRange): builder.PrependInt32Slot(28, tacticRange, 0)
def AddTacticRange(builder, tacticRange):
    return CharacterExcelAddTacticRange(builder, tacticRange)
def CharacterExcelAddWeaponType(builder, weaponType): builder.PrependInt32Slot(29, weaponType, 0)
def AddWeaponType(builder, weaponType):
    return CharacterExcelAddWeaponType(builder, weaponType)
def CharacterExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleEndDate), 0)
...
def CharacterExcelAddSecretStoneItemAmount(builder, secretStoneItemAmount): builder.PrependInt32Slot(31, secretStoneItemAmount, 0)
...
def CharacterExcelAddIgnoreObstacle(builder, ignoreObstacle): builder.PrependBoolSlot(32, ignoreObstacle, 0)
...
def CharacterExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(34, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return CharacterExcelAddLocalizeEtcId(builder, localizeEtcId)
def CharacterExcelAddDisplayEnemyInfo(builder, displayEnemyInfo): builder.PrependBoolSlot(35, displayEnemyInfo, 0)
def AddDisplayEnemyInfo(builder, displayEnemyInfo):
    return CharacterExcelAddDisplayEnemyInfo(builder, displayEnemyInfo)
def CharacterExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(36, tacticEntityType, 0)
def AddTacticEntityType(builder, tacticEntityType):
    return CharacterExcelAddTacticEntityType(builder, tacticEntityType)
def CharacterExcelAddHpBarHide(builder, hpBarHide): builder.PrependBoolSlot(37, hpBarHide, 0)
def AddHpBarHide(builder, hpBarHide):
    return CharacterExcelAddHpBarHide(builder, hpBarHide)
def CharacterExcelAddMainCombatStyleId(builder, mainCombatStyleId): builder.PrependInt64Slot(38, mainCombatStyleId, 0)
def AddMainCombatStyleId(builder, mainCombatStyleId):
    return CharacterExcelAddMainCombatStyleId(builder, mainCombatStyleId)
def CharacterExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(39, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CharacterExcelAddProductionStep(builder, productionStep)
def CharacterExcelAddSchool(builder, school): builder.PrependInt32Slot(40, school, 0)
def AddSchool(builder, school):
    return CharacterExcelAddSchool(builder, school)
def CharacterExcelAddCharacterPieceItemAmount(builder, characterPieceItemAmount): builder.PrependInt32Slot(41, characterPieceItemAmount, 0)
...
def CharacterExcelAddPersonalityId(builder, personalityId): builder.PrependInt64Slot(42, personalityId, 0)
def AddPersonalityId(builder, personalityId):
    return CharacterExcelAddPersonalityId(builder, personalityId)
def CharacterExcelAddDefaultStarGrade(builder, defaultStarGrade): builder.PrependInt32Slot(43, defaultStarGrade, 0)
def AddDefaultStarGrade(builder, defaultStarGrade):
    return CharacterExcelAddDefaultStarGrade(builder, defaultStarGrade)
def CharacterExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(44, collectionVisible, 0)
def AddCollectionVisible(builder, collectionVisible):
    return CharacterExcelAddCollectionVisible(builder, collectionVisible)
def CharacterExcelAddEquipmentSlot(builder, equipmentSlot): builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(equipmentSlot), 0)
...
def CharacterExcelAddWeaponLocalizeId(builder, weaponLocalizeId): builder.PrependUint32Slot(46, weaponLocalizeId, 0)
def AddWeaponLocalizeId(builder, weaponLocalizeId):
    return CharacterExcelAddWeaponLocalizeId(builder, weaponLocalizeId)
def CharacterExcelAddArmorType(builder, armorType): builder.PrependInt32Slot(47, armorType, 0)
def AddArmorType(builder, armorType):
    return CharacterExcelAddArmorType(builder, armorType)
def CharacterExcelAddSquadType(builder, squadType): builder.PrependInt32Slot(48, squadType, 0)
def AddSquadType(builder, squadType):
    return CharacterExcelAddSquadType(builder, squadType)
def CharacterExcelAddCombineRecipeId(builder, combineRecipeId): builder.PrependInt64Slot(49, combineRecipeId, 0)
def AddCombineRecipeId(builder, combineRecipeId):
    return CharacterExcelAddCombineRecipeId(builder, combineRecipeId)
def CharacterExcelAddExternalBtId(builder, externalBtId): builder.PrependInt64Slot(50, externalBtId, 0)
def AddExternalBtId(builder, externalBtId):
    return CharacterExcelAddExternalBtId(builder, externalBtId)
def CharacterExcelAddMaxStarGrade(builder, maxStarGrade): builder.PrependInt32Slot(51, maxStarGrade, 0)
def AddMaxStarGrade(builder, maxStarGrade):
    return CharacterExcelAddMaxStarGrade(builder, maxStarGrade)
def CharacterExcelAddBulletType(builder, bulletType): builder.PrependInt32Slot(52, bulletType, 0)
def AddBulletType(builder, bulletType):
    return CharacterExcelAddBulletType(builder, bulletType)
def CharacterExcelAddRandomEffectRadius(builder, randomEffectRadius): builder.PrependInt64Slot(53, randomEffectRadius, 0)
...
def CharacterExcelAddCanSurvive(builder, canSurvive): builder.PrependBoolSlot(54, canSurvive, 0)
def AddCanSurvive(builder, canSurvive):
    return CharacterExcelAddCanSurvive(builder, canSurvive)
def CharacterExcelAddScenarioCharacter(builder, scenarioCharacter): builder.PrependUOffsetTRelativeSlot(55, flatbuffers.number_types.UOffsetTFlags.py_type(scenarioCharacter), 0)
def AddScenarioCharacter(builder, scenarioCharacter):
    return CharacterExcelAddScenarioCharacter(builder, scenarioCharacter)
def CharacterExcelAddCanFix(builder, canFix): builder.PrependBoolSlot(56, canFix, 0)
def AddCanFix(builder, canFix):
    return CharacterExcelAddCanFix(builder, canFix)
def CharacterExcelAddCostumeGroupId(builder, costumeGroupId): builder.PrependInt64Slot(57, costumeGroupId, 0)
def AddCostumeGroupId(builder, costumeGroupId):
    return CharacterExcelAddCostumeGroupId(builder, costumeGroupId)
def CharacterExcelAddMoveEndFrame(builder, moveEndFrame): builder.PrependInt32Slot(58, moveEndFrame, 0)
def AddMoveEndFrame(builder, moveEndFrame):
    return CharacterExcelAddMoveEndFrame(builder, moveEndFrame)
def CharacterExcelAddIsDummy(builder, isDummy): builder.PrependBoolSlot(59, isDummy, 0)
def AddIsDummy(builder, isDummy):
    return CharacterExcelAddIsDummy(builder, isDummy)
def CharacterExcelAddCharacterPieceItemId(builder, characterPieceItemId): builder.PrependInt64Slot(60, characterPieceItemId, 0)
...
def CharacterExcelAddJumpMotionFrame(builder, jumpMotionFrame): builder.PrependInt32Slot(61, jumpMotionFrame, 0)
def AddJumpMotionFrame(builder, jumpMotionFrame):
    return CharacterExcelAddJumpMotionFrame(builder, jumpMotionFrame)
def CharacterExcelAddEmojiOffsetX(builder, emojiOffsetX): builder.PrependFloat32Slot(62, emojiOffsetX, 0.0)
def AddEmojiOffsetX(builder, emojiOffsetX):
    return CharacterExcelAddEmojiOffsetX(builder, emojiOffsetX)
def CharacterExcelAddBodyRadius(builder, bodyRadius): builder.PrependInt64Slot(63, bodyRadius, 0)
