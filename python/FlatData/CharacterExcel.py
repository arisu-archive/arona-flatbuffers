...
def CharacterExcelAddMaxStarGrade(builder, maxStarGrade): builder.PrependInt32Slot(1, maxStarGrade, 0)
def AddMaxStarGrade(builder, maxStarGrade):
    return CharacterExcelAddMaxStarGrade(builder, maxStarGrade)
def CharacterExcelAddCanFix(builder, canFix): builder.PrependBoolSlot(2, canFix, 0)
def AddCanFix(builder, canFix):
    return CharacterExcelAddCanFix(builder, canFix)
def CharacterExcelAddCombatStyleIndex(builder, combatStyleIndex): builder.PrependInt32Slot(3, combatStyleIndex, 0)
def AddCombatStyleIndex(builder, combatStyleIndex):
    return CharacterExcelAddCombatStyleIndex(builder, combatStyleIndex)
def CharacterExcelAddCostumeGroupId(builder, costumeGroupId): builder.PrependInt64Slot(4, costumeGroupId, 0)
def AddCostumeGroupId(builder, costumeGroupId):
    return CharacterExcelAddCostumeGroupId(builder, costumeGroupId)
def CharacterExcelAddCollectionVisibleEndDate(builder, collectionVisibleEndDate): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleEndDate), 0)
...
def CharacterExcelAddSpawnTemplateId(builder, spawnTemplateId): builder.PrependUint32Slot(6, spawnTemplateId, 0)
def AddSpawnTemplateId(builder, spawnTemplateId):
    return CharacterExcelAddSpawnTemplateId(builder, spawnTemplateId)
def CharacterExcelAddReleaseDate(builder, releaseDate): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(releaseDate), 0)
def AddReleaseDate(builder, releaseDate):
    return CharacterExcelAddReleaseDate(builder, releaseDate)
def CharacterExcelAddProductionStep(builder, productionStep): builder.PrependInt32Slot(8, productionStep, 0)
def AddProductionStep(builder, productionStep):
    return CharacterExcelAddProductionStep(builder, productionStep)
def CharacterExcelAddDefaultStarGrade(builder, defaultStarGrade): builder.PrependInt32Slot(9, defaultStarGrade, 0)
def AddDefaultStarGrade(builder, defaultStarGrade):
    return CharacterExcelAddDefaultStarGrade(builder, defaultStarGrade)
def CharacterExcelAddHpBarHide(builder, hpBarHide): builder.PrependBoolSlot(10, hpBarHide, 0)
def AddHpBarHide(builder, hpBarHide):
    return CharacterExcelAddHpBarHide(builder, hpBarHide)
def CharacterExcelAddCombineRecipeId(builder, combineRecipeId): builder.PrependInt64Slot(11, combineRecipeId, 0)
def AddCombineRecipeId(builder, combineRecipeId):
    return CharacterExcelAddCombineRecipeId(builder, combineRecipeId)
def CharacterExcelAddPersonalityId(builder, personalityId): builder.PrependInt64Slot(12, personalityId, 0)
...
def CharacterExcelAddJumpable(builder, jumpable): builder.PrependBoolSlot(15, jumpable, 0)
def AddJumpable(builder, jumpable):
    return CharacterExcelAddJumpable(builder, jumpable)
def CharacterExcelAddCharacterAiId(builder, characterAiId): builder.PrependInt64Slot(16, characterAiId, 0)
def AddCharacterAiId(builder, characterAiId):
    return CharacterExcelAddCharacterAiId(builder, characterAiId)
def CharacterExcelAddScenarioCharacter(builder, scenarioCharacter): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(scenarioCharacter), 0)
def AddScenarioCharacter(builder, scenarioCharacter):
    return CharacterExcelAddScenarioCharacter(builder, scenarioCharacter)
def CharacterExcelAddWeaponLocalizeId(builder, weaponLocalizeId): builder.PrependUint32Slot(18, weaponLocalizeId, 0)
def AddWeaponLocalizeId(builder, weaponLocalizeId):
    return CharacterExcelAddWeaponLocalizeId(builder, weaponLocalizeId)
def CharacterExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def CharacterExcelAddIsPlayableCharacter(builder, isPlayableCharacter): builder.PrependBoolSlot(20, isPlayableCharacter, 0)
...
def CharacterExcelAddTacticRange(builder, tacticRange): builder.PrependInt32Slot(21, tacticRange, 0)
def AddTacticRange(builder, tacticRange):
    return CharacterExcelAddTacticRange(builder, tacticRange)
def CharacterExcelAddAirUnitHeight(builder, airUnitHeight): builder.PrependInt64Slot(22, airUnitHeight, 0)
def AddAirUnitHeight(builder, airUnitHeight):
    return CharacterExcelAddAirUnitHeight(builder, airUnitHeight)
def CharacterExcelAddAppearFrame(builder, appearFrame): builder.PrependInt32Slot(23, appearFrame, 0)
def AddAppearFrame(builder, appearFrame):
    return CharacterExcelAddAppearFrame(builder, appearFrame)
def CharacterExcelAddJumpMotionFrame(builder, jumpMotionFrame): builder.PrependInt32Slot(24, jumpMotionFrame, 0)
def AddJumpMotionFrame(builder, jumpMotionFrame):
    return CharacterExcelAddJumpMotionFrame(builder, jumpMotionFrame)
def CharacterExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(25, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return CharacterExcelAddLocalizeEtcId(builder, localizeEtcId)
def CharacterExcelAddEmojiOffsetX(builder, emojiOffsetX): builder.PrependFloat32Slot(26, emojiOffsetX, 0.0)
def AddEmojiOffsetX(builder, emojiOffsetX):
    return CharacterExcelAddEmojiOffsetX(builder, emojiOffsetX)
def CharacterExcelAddCollectionVisible(builder, collectionVisible): builder.PrependBoolSlot(27, collectionVisible, 0)
def AddCollectionVisible(builder, collectionVisible):
    return CharacterExcelAddCollectionVisible(builder, collectionVisible)
def CharacterExcelAddSecretStoneItemId(builder, secretStoneItemId): builder.PrependInt64Slot(28, secretStoneItemId, 0)
def AddSecretStoneItemId(builder, secretStoneItemId):
    return CharacterExcelAddSecretStoneItemId(builder, secretStoneItemId)
def CharacterExcelAddIgnoreObstacle(builder, ignoreObstacle): builder.PrependBoolSlot(29, ignoreObstacle, 0)
def AddIgnoreObstacle(builder, ignoreObstacle):
    return CharacterExcelAddIgnoreObstacle(builder, ignoreObstacle)
def CharacterExcelAddTacticRole(builder, tacticRole): builder.PrependInt32Slot(30, tacticRole, 0)
def AddTacticRole(builder, tacticRole):
    return CharacterExcelAddTacticRole(builder, tacticRole)
def CharacterExcelAddWeaponType(builder, weaponType): builder.PrependInt32Slot(31, weaponType, 0)
def AddWeaponType(builder, weaponType):
    return CharacterExcelAddWeaponType(builder, weaponType)
def CharacterExcelAddStatLevelUpType(builder, statLevelUpType): builder.PrependInt32Slot(32, statLevelUpType, 0)
def AddStatLevelUpType(builder, statLevelUpType):
    return CharacterExcelAddStatLevelUpType(builder, statLevelUpType)
def CharacterExcelAddBulletType(builder, bulletType): builder.PrependInt32Slot(33, bulletType, 0)
def AddBulletType(builder, bulletType):
    return CharacterExcelAddBulletType(builder, bulletType)
def CharacterExcelAddMoveEndFrame(builder, moveEndFrame): builder.PrependInt32Slot(34, moveEndFrame, 0)
def AddMoveEndFrame(builder, moveEndFrame):
    return CharacterExcelAddMoveEndFrame(builder, moveEndFrame)
def CharacterExcelAddRandomEffectRadius(builder, randomEffectRadius): builder.PrependInt64Slot(35, randomEffectRadius, 0)
...
def CharacterExcelAddEquipmentSlot(builder, equipmentSlot): builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(equipmentSlot), 0)
...
def CharacterExcelAddBodyRadius(builder, bodyRadius): builder.PrependInt64Slot(37, bodyRadius, 0)
def AddBodyRadius(builder, bodyRadius):
    return CharacterExcelAddBodyRadius(builder, bodyRadius)
def CharacterExcelAddCanBattleItemMove(builder, canBattleItemMove): builder.PrependBoolSlot(38, canBattleItemMove, 0)
def AddCanBattleItemMove(builder, canBattleItemMove):
    return CharacterExcelAddCanBattleItemMove(builder, canBattleItemMove)
def CharacterExcelAddCollectionVisibleStartDate(builder, collectionVisibleStartDate): builder.PrependUOffsetTRelativeSlot(39, flatbuffers.number_types.UOffsetTFlags.py_type(collectionVisibleStartDate), 0)
...
def CharacterExcelAddHpBarHeight(builder, hpBarHeight): builder.PrependFloat32Slot(40, hpBarHeight, 0.0)
def AddHpBarHeight(builder, hpBarHeight):
    return CharacterExcelAddHpBarHeight(builder, hpBarHeight)
def CharacterExcelAddSquadType(builder, squadType): builder.PrependInt32Slot(41, squadType, 0)
def AddSquadType(builder, squadType):
    return CharacterExcelAddSquadType(builder, squadType)
def CharacterExcelAddSubPartsCount(builder, subPartsCount): builder.PrependInt32Slot(42, subPartsCount, 0)
...
def CharacterExcelAddId(builder, id): builder.PrependInt64Slot(44, id, 0)
def AddId(builder, id):
    return CharacterExcelAddId(builder, id)
def CharacterExcelAddRarity(builder, rarity): builder.PrependInt32Slot(45, rarity, 0)
def AddRarity(builder, rarity):
    return CharacterExcelAddRarity(builder, rarity)
def CharacterExcelAddIsPlayable(builder, isPlayable): builder.PrependBoolSlot(46, isPlayable, 0)
...
def CharacterExcelAddIsAirUnit(builder, isAirUnit): builder.PrependBoolSlot(48, isAirUnit, 0)
def AddIsAirUnit(builder, isAirUnit):
    return CharacterExcelAddIsAirUnit(builder, isAirUnit)
def CharacterExcelAddMainCombatStyleId(builder, mainCombatStyleId): builder.PrependInt64Slot(49, mainCombatStyleId, 0)
...
def CharacterExcelAddClub(builder, club): builder.PrependInt32Slot(51, club, 0)
def AddClub(builder, club):
    return CharacterExcelAddClub(builder, club)
def CharacterExcelAddFavorLevelupType(builder, favorLevelupType): builder.PrependInt32Slot(52, favorLevelupType, 0)
def AddFavorLevelupType(builder, favorLevelupType):
    return CharacterExcelAddFavorLevelupType(builder, favorLevelupType)
def CharacterExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(53, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return CharacterExcelAddDevName(builder, devName)
def CharacterExcelAddDisplayEnemyInfo(builder, displayEnemyInfo): builder.PrependBoolSlot(54, displayEnemyInfo, 0)
def AddDisplayEnemyInfo(builder, displayEnemyInfo):
    return CharacterExcelAddDisplayEnemyInfo(builder, displayEnemyInfo)
def CharacterExcelAddCanMove(builder, canMove): builder.PrependBoolSlot(55, canMove, 0)
def AddCanMove(builder, canMove):
    return CharacterExcelAddCanMove(builder, canMove)
def CharacterExcelAddIsDummy(builder, isDummy): builder.PrependBoolSlot(56, isDummy, 0)
def AddIsDummy(builder, isDummy):
    return CharacterExcelAddIsDummy(builder, isDummy)
def CharacterExcelAddExternalBtId(builder, externalBtId): builder.PrependInt64Slot(57, externalBtId, 0)
def AddExternalBtId(builder, externalBtId):
    return CharacterExcelAddExternalBtId(builder, externalBtId)
def CharacterExcelAddCanCrowdControl(builder, canCrowdControl): builder.PrependBoolSlot(58, canCrowdControl, 0)
def AddCanCrowdControl(builder, canCrowdControl):
    return CharacterExcelAddCanCrowdControl(builder, canCrowdControl)
def CharacterExcelAddCharacterPieceItemAmount(builder, characterPieceItemAmount): builder.PrependInt32Slot(59, characterPieceItemAmount, 0)
...
def CharacterExcelAddIsNpc(builder, isNpc): builder.PrependBoolSlot(60, isNpc, 0)
def AddIsNpc(builder, isNpc):
    return CharacterExcelAddIsNpc(builder, isNpc)
def CharacterExcelAddEmojiOffsetY(builder, emojiOffsetY): builder.PrependFloat32Slot(61, emojiOffsetY, 0.0)
def AddEmojiOffsetY(builder, emojiOffsetY):
    return CharacterExcelAddEmojiOffsetY(builder, emojiOffsetY)
def CharacterExcelAddSchool(builder, school): builder.PrependInt32Slot(62, school, 0)
...
def CharacterExcelAddTacticEntityType(builder, tacticEntityType): builder.PrependInt32Slot(64, tacticEntityType, 0)
