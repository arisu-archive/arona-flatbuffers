...
def GoodsExcelAddConsumeGachaTicketType(builder, consumeGachaTicketType): builder.PrependInt32Slot(3, consumeGachaTicketType, 0)
...
def GoodsExcelAddConsumeGachaTicketTypeAmount(builder, consumeGachaTicketTypeAmount): builder.PrependInt64Slot(4, consumeGachaTicketTypeAmount, 0)
...
def GoodsExcelAddProductIdOne(builder, productIdOne): builder.PrependInt64Slot(15, productIdOne, 0)
def AddProductIdOne(builder, productIdOne):
    return GoodsExcelAddProductIdOne(builder, productIdOne)
def GoodsExcelAddProductIdSgs(builder, productIdSgs): builder.PrependInt64Slot(16, productIdSgs, 0)
def AddProductIdSgs(builder, productIdSgs):
    return GoodsExcelAddProductIdSgs(builder, productIdSgs)
def GoodsExcelAddRarity(builder, rarity): builder.PrependInt32Slot(17, rarity, 0)
...
def GoodsExcelAddType(builder, type): builder.PrependInt32Slot(19, type, 0)
