...
def FieldContentStageRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(1, rewardId, 0)
...
def FieldContentStageRewardExcelAddIsDisplayed(builder, isDisplayed): builder.PrependBoolSlot(3, isDisplayed, 0)
def AddIsDisplayed(builder, isDisplayed):
    return FieldContentStageRewardExcelAddIsDisplayed(builder, isDisplayed)
def FieldContentStageRewardExcelAddRewardTag(builder, rewardTag): builder.PrependInt32Slot(4, rewardTag, 0)
def AddRewardTag(builder, rewardTag):
    return FieldContentStageRewardExcelAddRewardTag(builder, rewardTag)
def FieldContentStageRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(5, rewardParcelType, 0)
def AddRewardParcelType(builder, rewardParcelType):
    return FieldContentStageRewardExcelAddRewardParcelType(builder, rewardParcelType)
def FieldContentStageRewardExcelAddRewardProb(builder, rewardProb): builder.PrependInt32Slot(6, rewardProb, 0)
