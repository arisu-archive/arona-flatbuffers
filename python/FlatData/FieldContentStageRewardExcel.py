...
def FieldContentStageRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(0, rewardParcelType, 0)
...
def FieldContentStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(2, groupId, 0)
...
def FieldContentStageRewardExcelAddIsDisplayed(builder, isDisplayed): builder.PrependBoolSlot(5, isDisplayed, 0)
