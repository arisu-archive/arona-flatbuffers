...
def ObstacleExcelAddJumpAble(builder, jumpAble): builder.PrependBoolSlot(0, jumpAble, 0)
def AddJumpAble(builder, jumpAble):
    return ObstacleExcelAddJumpAble(builder, jumpAble)
def ObstacleExcelAddPoint1Offeset(builder, point1Offeset): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(point1Offeset), 0)
...
def ObstacleExcelAddIndex(builder, index): builder.PrependInt64Slot(2, index, 0)
...
def ObstacleExcelAddMaxHp(builder, maxHp): builder.PrependInt64Slot(4, maxHp, 0)
...
def ObstacleExcelAddEnemyPoint2Osset(builder, enemyPoint2Osset): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(enemyPoint2Osset), 0)
...
def ObstacleExcelAddHp(builder, hp): builder.PrependInt64Slot(8, hp, 0)
def AddHp(builder, hp):
    return ObstacleExcelAddHp(builder, hp)
def ObstacleExcelAddZ(builder, z): builder.PrependFloat32Slot(9, z, 0.0)
def AddZ(builder, z):
    return ObstacleExcelAddZ(builder, z)
def ObstacleExcelAddX(builder, x): builder.PrependFloat32Slot(10, x, 0.0)
def AddX(builder, x):
    return ObstacleExcelAddX(builder, x)
def ObstacleExcelAddSubOffset(builder, subOffset): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(subOffset), 0)
...
def ObstacleExcelAddPrefabName(builder, prefabName): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(prefabName), 0)
def AddPrefabName(builder, prefabName):
    return ObstacleExcelAddPrefabName(builder, prefabName)
def ObstacleExcelAddBlockRate(builder, blockRate): builder.PrependInt32Slot(13, blockRate, 0)
def AddBlockRate(builder, blockRate):
    return ObstacleExcelAddBlockRate(builder, blockRate)
def ObstacleExcelAddPoint2Offeset(builder, point2Offeset): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(point2Offeset), 0)
