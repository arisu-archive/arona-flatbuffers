...
def MiniGameShootingStageRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def MiniGameShootingStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(3, groupId, 0)
def AddGroupId(builder, groupId):
    return MiniGameShootingStageRewardExcelAddGroupId(builder, groupId)
def MiniGameShootingStageRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
