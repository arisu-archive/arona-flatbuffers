...
def LimitedStageRewardExcelAddRewardAmount(builder, rewardAmount): builder.PrependInt32Slot(0, rewardAmount, 0)
def AddRewardAmount(builder, rewardAmount):
    return LimitedStageRewardExcelAddRewardAmount(builder, rewardAmount)
def LimitedStageRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(1, rewardId, 0)
...
def LimitedStageRewardExcelAddIsDisplayed(builder, isDisplayed): builder.PrependBoolSlot(3, isDisplayed, 0)
def AddIsDisplayed(builder, isDisplayed):
    return LimitedStageRewardExcelAddIsDisplayed(builder, isDisplayed)
def LimitedStageRewardExcelAddGroupId(builder, groupId): builder.PrependInt64Slot(4, groupId, 0)
