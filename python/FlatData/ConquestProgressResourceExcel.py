...
def ConquestProgressResourceExcelAddProgressResource(builder, progressResource): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(progressResource), 0)
...
def ConquestProgressResourceExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestProgressResourceExcelAddEventContentId(builder, eventContentId)
def ConquestProgressResourceExcelAddVoiceId(builder, voiceId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(voiceId), 0)
...
def ConquestProgressResourceExcelAddProgressLocalizeCode(builder, progressLocalizeCode): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(progressLocalizeCode), 0)
