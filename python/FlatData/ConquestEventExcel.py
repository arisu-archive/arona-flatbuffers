...
def ConquestEventExcelAddLocalizeUpgrade(builder, localizeUpgrade): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(localizeUpgrade), 0)
def AddLocalizeUpgrade(builder, localizeUpgrade):
    return ConquestEventExcelAddLocalizeUpgrade(builder, localizeUpgrade)
def ConquestEventExcelAddUseErosion(builder, useErosion): builder.PrependBoolSlot(1, useErosion, 0)
def AddUseErosion(builder, useErosion):
    return ConquestEventExcelAddUseErosion(builder, useErosion)
def ConquestEventExcelAddLocalizeTreasureBox(builder, localizeTreasureBox): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(localizeTreasureBox), 0)
...
def ConquestEventExcelAddEvnetMapGoalLocalize(builder, evnetMapGoalLocalize): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(evnetMapGoalLocalize), 0)
...
def ConquestEventExcelAddUseConquestObject(builder, useConquestObject): builder.PrependBoolSlot(4, useConquestObject, 0)
...
def ConquestEventExcelAddLocalizeMapInfo(builder, localizeMapInfo): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(localizeMapInfo), 0)
def AddLocalizeMapInfo(builder, localizeMapInfo):
    return ConquestEventExcelAddLocalizeMapInfo(builder, localizeMapInfo)
def ConquestEventExcelAddUseCalculate(builder, useCalculate): builder.PrependBoolSlot(8, useCalculate, 0)
def AddUseCalculate(builder, useCalculate):
    return ConquestEventExcelAddUseCalculate(builder, useCalculate)
def ConquestEventExcelAddAssistCount(builder, assistCount): builder.PrependInt32Slot(9, assistCount, 0)
def AddAssistCount(builder, assistCount):
    return ConquestEventExcelAddAssistCount(builder, assistCount)
def ConquestEventExcelAddMapEnterScenarioGroupId(builder, mapEnterScenarioGroupId): builder.PrependInt64Slot(10, mapEnterScenarioGroupId, 0)
...
def ConquestEventExcelAddPlayTimeLimitInSeconds(builder, playTimeLimitInSeconds): builder.PrependInt32Slot(11, playTimeLimitInSeconds, 0)
...
def ConquestEventExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(12, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestEventExcelAddEventContentId(builder, eventContentId)
def ConquestEventExcelAddLocalizeManage(builder, localizeManage): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(localizeManage), 0)
def AddLocalizeManage(builder, localizeManage):
    return ConquestEventExcelAddLocalizeManage(builder, localizeManage)
def ConquestEventExcelAddUseUnexpectedEvent(builder, useUnexpectedEvent): builder.PrependBoolSlot(14, useUnexpectedEvent, 0)
...
def ConquestEventExcelAddAnimationUnitDelay(builder, animationUnitDelay): builder.PrependFloat32Slot(15, animationUnitDelay, 0.0)
...
def ConquestEventExcelAddAnimationUnitAmountMin(builder, animationUnitAmountMin): builder.PrependInt32Slot(17, animationUnitAmountMin, 0)
...
def ConquestEventExcelAddLocalizeErosions(builder, localizeErosions): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(localizeErosions), 0)
def AddLocalizeErosions(builder, localizeErosions):
    return ConquestEventExcelAddLocalizeErosions(builder, localizeErosions)
def ConquestEventExcelAddManageUnitChange(builder, manageUnitChange): builder.PrependInt32Slot(20, manageUnitChange, 0)
def AddManageUnitChange(builder, manageUnitChange):
    return ConquestEventExcelAddManageUnitChange(builder, manageUnitChange)
def ConquestEventExcelAddAnimationUnitAmountMax(builder, animationUnitAmountMax): builder.PrependInt32Slot(21, animationUnitAmountMax, 0)
...
def ConquestEventExcelAddIndividualErosionDailyCount(builder, individualErosionDailyCount): builder.PrependInt64Slot(22, individualErosionDailyCount, 0)
...
def ConquestEventExcelAddLocalizeStep(builder, localizeStep): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(localizeStep), 0)
def AddLocalizeStep(builder, localizeStep):
    return ConquestEventExcelAddLocalizeStep(builder, localizeStep)
def ConquestEventExcelAddEvnetScenarioBg(builder, evnetScenarioBg): builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(evnetScenarioBg), 0)
