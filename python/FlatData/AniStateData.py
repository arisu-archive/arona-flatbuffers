...
def AniStateDataAddStateName(builder, stateName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(stateName), 0)
...
def AniStateDataAddStatePrefix(builder, statePrefix): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(statePrefix), 0)
def AddStatePrefix(builder, statePrefix):
    return AniStateDataAddStatePrefix(builder, statePrefix)
def AniStateDataAddLength(builder, length): builder.PrependFloat32Slot(7, length, 0.0)
def AddLength(builder, length):
    return AniStateDataAddLength(builder, length)
def AniStateDataAddSpeedParamter(builder, speedParamter): builder.PrependFloat32Slot(8, speedParamter, 0.0)
...
def AniStateDataAddFrameRate(builder, frameRate): builder.PrependFloat32Slot(10, frameRate, 0.0)
def AddFrameRate(builder, frameRate):
    return AniStateDataAddFrameRate(builder, frameRate)
def AniStateDataAddClipName(builder, clipName): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(clipName), 0)
