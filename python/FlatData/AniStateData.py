...
def AniStateDataAddStateSpeed(builder, stateSpeed): builder.PrependFloat32Slot(0, stateSpeed, 0.0)
...
def AniStateDataAddTag(builder, tag): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tag), 0)
def AddTag(builder, tag):
    return AniStateDataAddTag(builder, tag)
def AniStateDataAddFrameRate(builder, frameRate): builder.PrependFloat32Slot(3, frameRate, 0.0)
def AddFrameRate(builder, frameRate):
    return AniStateDataAddFrameRate(builder, frameRate)
def AniStateDataAddStateName(builder, stateName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(stateName), 0)
def AddStateName(builder, stateName):
    return AniStateDataAddStateName(builder, stateName)
def AniStateDataAddStatePrefix(builder, statePrefix): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(statePrefix), 0)
def AddStatePrefix(builder, statePrefix):
    return AniStateDataAddStatePrefix(builder, statePrefix)
def AniStateDataAddEvents(builder, events): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(events), 0)
...
def AniStateDataAddStateNameWithPrefix(builder, stateNameWithPrefix): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(stateNameWithPrefix), 0)
...
def AniStateDataAddClipName(builder, clipName): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(clipName), 0)
def AddClipName(builder, clipName):
    return AniStateDataAddClipName(builder, clipName)
def AniStateDataAddSpeedParameterName(builder, speedParameterName): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(speedParameterName), 0)
def AddSpeedParameterName(builder, speedParameterName):
    return AniStateDataAddSpeedParameterName(builder, speedParameterName)
def AniStateDataAddSpeedParamter(builder, speedParamter): builder.PrependFloat32Slot(10, speedParamter, 0.0)
def AddSpeedParamter(builder, speedParamter):
    return AniStateDataAddSpeedParamter(builder, speedParamter)
def AniStateDataAddLength(builder, length): builder.PrependFloat32Slot(11, length, 0.0)
