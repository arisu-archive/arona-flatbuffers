...
def FurnitureGroupExcelAddComfortBonus(builder, comfortBonus): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(comfortBonus), 0)
