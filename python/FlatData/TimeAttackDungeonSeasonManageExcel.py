...
def TimeAttackDungeonSeasonManageExcelAddEndNoteLabelStartDate(builder, endNoteLabelStartDate): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(endNoteLabelStartDate), 0)
...
def TimeAttackDungeonSeasonManageExcelAddId(builder, id): builder.PrependInt64Slot(3, id, 0)
...
def TimeAttackDungeonSeasonManageExcelAddDungeonId(builder, dungeonId): builder.PrependInt64Slot(7, dungeonId, 0)
