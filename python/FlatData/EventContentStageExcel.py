...
def EventContentStageExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(1, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentStageExcelAddEventContentId(builder, eventContentId)
def EventContentStageExcelAddStageHint(builder, stageHint): builder.PrependUint32Slot(2, stageHint, 0)
...
def EventContentStageExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return EventContentStageExcelAddStrategyMap(builder, strategyMap)
def EventContentStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(5, stageEnterCostId, 0)
...
def EventContentStageExcelAddBgmId(builder, bgmId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(bgmId), 0)
def AddBgmId(builder, bgmId):
    return EventContentStageExcelAddBgmId(builder, bgmId)
def EventContentStageExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(7, prevStageId, 0)
def AddPrevStageId(builder, prevStageId):
    return EventContentStageExcelAddPrevStageId(builder, prevStageId)
def EventContentStageExcelAddStageNumber(builder, stageNumber): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(stageNumber), 0)
def AddStageNumber(builder, stageNumber):
    return EventContentStageExcelAddStageNumber(builder, stageNumber)
def EventContentStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(9, groundId, 0)
def AddGroundId(builder, groundId):
    return EventContentStageExcelAddGroundId(builder, groundId)
def EventContentStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return EventContentStageExcelAddName(builder, name)
def EventContentStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(11, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return EventContentStageExcelAddStageTopography(builder, stageTopography)
def EventContentStageExcelAddOpenDate(builder, openDate): builder.PrependInt64Slot(12, openDate, 0)
def AddOpenDate(builder, openDate):
    return EventContentStageExcelAddOpenDate(builder, openDate)
def EventContentStageExcelAddStrategyMapBg(builder, strategyMapBg): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMapBg), 0)
def AddStrategyMapBg(builder, strategyMapBg):
    return EventContentStageExcelAddStrategyMapBg(builder, strategyMapBg)
def EventContentStageExcelAddStrategyEnvironment(builder, strategyEnvironment): builder.PrependInt32Slot(14, strategyEnvironment, 0)
...
def EventContentStageExcelAddBuffContentId(builder, buffContentId): builder.PrependInt64Slot(15, buffContentId, 0)
def AddBuffContentId(builder, buffContentId):
    return EventContentStageExcelAddBuffContentId(builder, buffContentId)
def EventContentStageExcelAddBgmIdC9738509(builder, bgmIdC9738509): builder.PrependInt64Slot(16, bgmIdC9738509, 0)
def AddBgmIdC9738509(builder, bgmIdC9738509):
    return EventContentStageExcelAddBgmIdC9738509(builder, bgmIdC9738509)
def EventContentStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(17, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return EventContentStageExcelAddBattleDuration(builder, battleDuration)
def EventContentStageExcelAddFixedEchelonId(builder, fixedEchelonId): builder.PrependInt64Slot(18, fixedEchelonId, 0)
def AddFixedEchelonId(builder, fixedEchelonId):
    return EventContentStageExcelAddFixedEchelonId(builder, fixedEchelonId)
def EventContentStageExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
...
def EventContentStageExcelAddMaxTurn(builder, maxTurn): builder.PrependInt32Slot(20, maxTurn, 0)
def AddMaxTurn(builder, maxTurn):
    return EventContentStageExcelAddMaxTurn(builder, maxTurn)
def EventContentStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(21, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return EventContentStageExcelAddRecommandLevel(builder, recommandLevel)
def EventContentStageExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(22, stageEnterEchelonCount, 0)
...
def EventContentStageExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
...
def EventContentStageExcelAddIsDefeatBattle(builder, isDefeatBattle): builder.PrependBoolSlot(24, isDefeatBattle, 0)
def AddIsDefeatBattle(builder, isDefeatBattle):
    return EventContentStageExcelAddIsDefeatBattle(builder, isDefeatBattle)
def EventContentStageExcelAddOpenConditionContentType(builder, openConditionContentType): builder.PrependInt32Slot(25, openConditionContentType, 0)
...
def EventContentStageExcelAddPrevStageSubEventId(builder, prevStageSubEventId): builder.PrependInt64Slot(26, prevStageSubEventId, 0)
...
def EventContentStageExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
...
def EventContentStageExcelAddChallengeDisplay(builder, challengeDisplay): builder.PrependBoolSlot(28, challengeDisplay, 0)
...
def EventContentStageExcelAddStarConditionTurnCount(builder, starConditionTurnCount): builder.PrependInt64Slot(29, starConditionTurnCount, 0)
...
def EventContentStageExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def EventContentStageExcelAddOpenEventPoint(builder, openEventPoint): builder.PrependInt64Slot(31, openEventPoint, 0)
...
def EventContentStageExcelAddOpenConditionContentId(builder, openConditionContentId): builder.PrependInt64Slot(33, openConditionContentId, 0)
...
def EventContentStageExcelAddId(builder, id): builder.PrependInt64Slot(34, id, 0)
def AddId(builder, id):
    return EventContentStageExcelAddId(builder, id)
def EventContentStageExcelAddEventContentStageRewardId(builder, eventContentStageRewardId): builder.PrependInt64Slot(35, eventContentStageRewardId, 0)
...
def EventContentStageExcelAddInstantClear(builder, instantClear): builder.PrependBoolSlot(36, instantClear, 0)
def AddInstantClear(builder, instantClear):
    return EventContentStageExcelAddInstantClear(builder, instantClear)
def EventContentStageExcelAddStarConditionTacticRankSCount(builder, starConditionTacticRankSCount): builder.PrependInt64Slot(37, starConditionTacticRankSCount, 0)
...
def EventContentStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(38, stageEnterCostAmount, 0)
...
def EventContentStageExcelAddStageDisplay(builder, stageDisplay): builder.PrependInt32Slot(39, stageDisplay, 0)
def AddStageDisplay(builder, stageDisplay):
    return EventContentStageExcelAddStageDisplay(builder, stageDisplay)
def EventContentStageExcelAddOpenConditionScenarioId(builder, openConditionScenarioId): builder.PrependInt64Slot(40, openConditionScenarioId, 0)
...
def EventContentStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(41, stageEnterCostType, 0)
