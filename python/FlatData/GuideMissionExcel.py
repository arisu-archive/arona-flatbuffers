...
def GuideMissionExcelAddToastImagePath(builder, toastImagePath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(toastImagePath), 0)
...
def GuideMissionExcelAddCompleteConditionType(builder, completeConditionType): builder.PrependInt32Slot(2, completeConditionType, 0)
...
def GuideMissionExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(4, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return GuideMissionExcelAddSeasonId(builder, seasonId)
def GuideMissionExcelAddCategory(builder, category): builder.PrependInt32Slot(5, category, 0)
def AddCategory(builder, category):
    return GuideMissionExcelAddCategory(builder, category)
def GuideMissionExcelAddIsAutoClearForScenario(builder, isAutoClearForScenario): builder.PrependBoolSlot(6, isAutoClearForScenario, 0)
...
def GuideMissionExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(7, isLegacy, 0)
def AddIsLegacy(builder, isLegacy):
    return GuideMissionExcelAddIsLegacy(builder, isLegacy)
def GuideMissionExcelAddPreMissionId(builder, preMissionId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(preMissionId), 0)
...
def GuideMissionExcelAddId(builder, id): builder.PrependInt64Slot(9, id, 0)
...
def GuideMissionExcelAddTabNumber(builder, tabNumber): builder.PrependInt64Slot(11, tabNumber, 0)
def AddTabNumber(builder, tabNumber):
    return GuideMissionExcelAddTabNumber(builder, tabNumber)
def GuideMissionExcelAddMissionRewardParcelType(builder, missionRewardParcelType): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardParcelType), 0)
...
def GuideMissionExcelAddMissionRewardAmount(builder, missionRewardAmount): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(missionRewardAmount), 0)
...
def GuideMissionExcelAddCompleteConditionParameter(builder, completeConditionParameter): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(completeConditionParameter), 0)
...
def GuideMissionExcelAddCompleteConditionCount(builder, completeConditionCount): builder.PrependInt64Slot(17, completeConditionCount, 0)
