...
class CharacterDialogFieldExcelT(object):
    ...
    def _UnPack(self, characterDialogFieldExcel):
        ...
        self.localizeTh = characterDialogFieldExcel.LocalizeTh()
        self.localizeTw = characterDialogFieldExcel.LocalizeTw()
        self.localizeEn = characterDialogFieldExcel.LocalizeEn()
...
_install_object_api(CharacterDialogFieldExcelT, 'CharacterDialogFieldExcel', (('groupId', 'int64', False), ('phase', 'int32', False), ('targetIndex', 'int32', False), ('dialogType', 'int32', False), ('duration', 'int64', False), ('motionName', 'string', False), ('localizeKr', 'string', False), ('localizeJp', 'string', False), ('localizeTh', 'string', False), ('localizeTw', 'string', False), ('localizeEn', 'string', False)))
