...
def GachaElementRecursiveExcelAddParcelAmountMin(builder, parcelAmountMin): builder.PrependInt32Slot(0, parcelAmountMin, 0)
...
def GachaElementRecursiveExcelAddState(builder, state): builder.PrependInt32Slot(1, state, 0)
def AddState(builder, state):
    return GachaElementRecursiveExcelAddState(builder, state)
def GachaElementRecursiveExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return GachaElementRecursiveExcelAddId(builder, id)
def GachaElementRecursiveExcelAddGachaGroupId(builder, gachaGroupId): builder.PrependInt64Slot(3, gachaGroupId, 0)
def AddGachaGroupId(builder, gachaGroupId):
    return GachaElementRecursiveExcelAddGachaGroupId(builder, gachaGroupId)
def GachaElementRecursiveExcelAddProb(builder, prob): builder.PrependInt32Slot(4, prob, 0)
...
def GachaElementRecursiveExcelAddParcelType(builder, parcelType): builder.PrependInt32Slot(6, parcelType, 0)
def AddParcelType(builder, parcelType):
    return GachaElementRecursiveExcelAddParcelType(builder, parcelType)
def GachaElementRecursiveExcelAddParcelId(builder, parcelId): builder.PrependInt64Slot(7, parcelId, 0)
