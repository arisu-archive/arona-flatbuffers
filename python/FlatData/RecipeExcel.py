...
def RecipeExcelAddResultAmountMin(builder, resultAmountMin): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMin), 0)
...
def RecipeExcelAddResultAmountMax(builder, resultAmountMax): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMax), 0)
...
def RecipeExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return RecipeExcelAddId(builder, id)
def RecipeExcelAddRecipeType(builder, recipeType): builder.PrependInt32Slot(3, recipeType, 0)
def AddRecipeType(builder, recipeType):
    return RecipeExcelAddRecipeType(builder, recipeType)
def RecipeExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def RecipeExcelAddParcelType(builder, parcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(parcelType), 0)
...
def RecipeExcelAddRecipeSelectionGroupId(builder, recipeSelectionGroupId): builder.PrependInt64Slot(7, recipeSelectionGroupId, 0)
