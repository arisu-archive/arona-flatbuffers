...
def RecipeExcelAddParcelId(builder, parcelId):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def RecipeExcelAddRecipeType(builder, recipeType):
    builder.PrependInt32Slot(5, recipeType, 0)
...
def RecipeExcelAddResultAmountMax(builder, resultAmountMax):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMax), 0)
...
def RecipeExcelAddResultAmountMin(builder, resultAmountMin):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(resultAmountMin), 0)
