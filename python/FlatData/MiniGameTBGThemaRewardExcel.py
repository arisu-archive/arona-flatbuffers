...
def MiniGameTBGThemaRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MiniGameTBGThemaRewardExcelAddEventContentId(builder, eventContentId)
def MiniGameTBGThemaRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def MiniGameTBGThemaRewardExcelAddThemaUniqueId(builder, themaUniqueId): builder.PrependInt32Slot(4, themaUniqueId, 0)
def AddThemaUniqueId(builder, themaUniqueId):
    return MiniGameTBGThemaRewardExcelAddThemaUniqueId(builder, themaUniqueId)
def MiniGameTBGThemaRewardExcelAddMiniGameTbgThemaRewardType(builder, miniGameTbgThemaRewardType): builder.PrependInt32Slot(5, miniGameTbgThemaRewardType, 0)
...
def MiniGameTBGThemaRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
