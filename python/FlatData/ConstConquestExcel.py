...
def ConstConquestExcelAddManageUnitChange(builder, manageUnitChange): builder.PrependInt32Slot(1, manageUnitChange, 0)
...
def ConstConquestExcelAddAnimationUnitDelay(builder, animationUnitDelay): builder.PrependFloat32Slot(3, animationUnitDelay, 0.0)
