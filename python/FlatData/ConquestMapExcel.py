...
def ConquestMapExcelAddConquestMap(builder, conquestMap):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(conquestMap), 0)
...
def ConquestMapExcelAddConquestMapBg(builder, conquestMapBg):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(conquestMapBg), 0)
...
def ConquestMapExcelAddDevName(builder, devName):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
...
def ConquestMapExcelAddMapDifficulty(builder, mapDifficulty):
    builder.PrependInt32Slot(5, mapDifficulty, 0)
...
def ConquestMapExcelAddMapGoalLocalize(builder, mapGoalLocalize):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(mapGoalLocalize), 0)
...
def ConquestMapExcelAddStepGoalLocalize(builder, stepGoalLocalize):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(stepGoalLocalize), 0)
...
def ConquestMapExcelAddStepOpenConditionParameter(builder, stepOpenConditionParameter):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(stepOpenConditionParameter), 0)
...
def ConquestMapExcelAddStepOpenConditionType(builder, stepOpenConditionType):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(stepOpenConditionType), 0)
