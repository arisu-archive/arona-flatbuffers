...
def ConquestMapExcelAddMapDifficulty(builder, mapDifficulty): builder.PrependInt32Slot(1, mapDifficulty, 0)
def AddMapDifficulty(builder, mapDifficulty):
    return ConquestMapExcelAddMapDifficulty(builder, mapDifficulty)
def ConquestMapExcelAddStepEnterScenarioGroupId(builder, stepEnterScenarioGroupId): builder.PrependInt64Slot(2, stepEnterScenarioGroupId, 0)
...
def ConquestMapExcelAddStepOpenConditionType(builder, stepOpenConditionType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(stepOpenConditionType), 0)
...
def ConquestMapExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return ConquestMapExcelAddDevName(builder, devName)
def ConquestMapExcelAddStepIndex(builder, stepIndex): builder.PrependInt32Slot(5, stepIndex, 0)
def AddStepIndex(builder, stepIndex):
    return ConquestMapExcelAddStepIndex(builder, stepIndex)
def ConquestMapExcelAddStepNameLocalize(builder, stepNameLocalize): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(stepNameLocalize), 0)
def AddStepNameLocalize(builder, stepNameLocalize):
    return ConquestMapExcelAddStepNameLocalize(builder, stepNameLocalize)
def ConquestMapExcelAddCameraSettingId(builder, cameraSettingId): builder.PrependInt64Slot(7, cameraSettingId, 0)
...
def ConquestMapExcelAddConquestMap(builder, conquestMap): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(conquestMap), 0)
def AddConquestMap(builder, conquestMap):
    return ConquestMapExcelAddConquestMap(builder, conquestMap)
def ConquestMapExcelAddConquestMapBg(builder, conquestMapBg): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(conquestMapBg), 0)
def AddConquestMapBg(builder, conquestMapBg):
    return ConquestMapExcelAddConquestMapBg(builder, conquestMapBg)
def ConquestMapExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(11, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return ConquestMapExcelAddEventContentId(builder, eventContentId)
def ConquestMapExcelAddStepOpenConditionParameter(builder, stepOpenConditionParameter): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(stepOpenConditionParameter), 0)
