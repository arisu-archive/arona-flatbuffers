...
def EventContentMiniEventShortCutExcelAddId(builder, id): builder.PrependInt32Slot(1, id, 0)
...
def EventContentMiniEventShortCutExcelAddShorcutContentType(builder, shorcutContentType): builder.PrependInt32Slot(3, shorcutContentType, 0)
