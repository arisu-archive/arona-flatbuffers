...
def BossPhaseExcelAddNormalAttackSkillUniqueName(builder, normalAttackSkillUniqueName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(normalAttackSkillUniqueName), 0)
...
def BossPhaseExcelAddUseExSkill(builder, useExSkill): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(useExSkill), 0)
...
def BossPhaseExcelAddAiPhase(builder, aiPhase): builder.PrependInt64Slot(3, aiPhase, 0)
