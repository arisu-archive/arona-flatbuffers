...
def AcademyZoneExcelAddLocationId(builder, locationId): builder.PrependInt64Slot(0, locationId, 0)
def AddLocationId(builder, locationId):
    return AcademyZoneExcelAddLocationId(builder, locationId)
def AcademyZoneExcelAddLocationRankForUnlock(builder, locationRankForUnlock): builder.PrependInt64Slot(1, locationRankForUnlock, 0)
...
def AcademyZoneExcelAddTags(builder, tags): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)
...
def AcademyZoneExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(3, rewardGroupId, 0)
def AddRewardGroupId(builder, rewardGroupId):
    return AcademyZoneExcelAddRewardGroupId(builder, rewardGroupId)
def AcademyZoneExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return AcademyZoneExcelAddId(builder, id)
def AcademyZoneExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(5, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return AcademyZoneExcelAddLocalizeEtcId(builder, localizeEtcId)
def AcademyZoneExcelAddStudentVisitProb(builder, studentVisitProb): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(studentVisitProb), 0)
