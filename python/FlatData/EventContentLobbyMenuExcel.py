...
def EventContentLobbyMenuExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(4, eventContentId, 0)
...
def EventContentLobbyMenuExcelAddIconOffsetX(builder, iconOffsetX): builder.PrependFloat32Slot(7, iconOffsetX, 0.0)
