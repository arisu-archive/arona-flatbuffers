...
def EventContentDiceRaceProbExcelAddEventContentDiceRaceResultType(builder, eventContentDiceRaceResultType): builder.PrependInt32Slot(2, eventContentDiceRaceResultType, 0)
...
def EventContentDiceRaceProbExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(3, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentDiceRaceProbExcelAddEventContentId(builder, eventContentId)
def EventContentDiceRaceProbExcelAddCostItemId(builder, costItemId): builder.PrependInt64Slot(4, costItemId, 0)
