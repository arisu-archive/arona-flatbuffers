...
def EventContentDiceRaceTotalRewardExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def EventContentDiceRaceTotalRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentDiceRaceTotalRewardExcelAddEventContentId(builder, eventContentId)
def EventContentDiceRaceTotalRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentDiceRaceTotalRewardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentDiceRaceTotalRewardExcelAddRequiredLapFinishCount(builder, requiredLapFinishCount): builder.PrependInt32Slot(5, requiredLapFinishCount, 0)
...
def EventContentDiceRaceTotalRewardExcelAddRewardId(builder, rewardId): builder.PrependInt64Slot(6, rewardId, 0)
