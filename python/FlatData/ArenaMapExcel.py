...
def ArenaMapExcelAddGroundGroupNameLocalizeKey(builder, groundGroupNameLocalizeKey): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(groundGroupNameLocalizeKey), 0)
...
def ArenaMapExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(4, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return ArenaMapExcelAddUniqueId(builder, uniqueId)
def ArenaMapExcelAddEndRank(builder, endRank): builder.PrependInt64Slot(5, endRank, 0)
def AddEndRank(builder, endRank):
    return ArenaMapExcelAddEndRank(builder, endRank)
def ArenaMapExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(6, groundId, 0)
...
def ArenaMapExcelAddTerrainType(builder, terrainType): builder.PrependInt64Slot(8, terrainType, 0)
