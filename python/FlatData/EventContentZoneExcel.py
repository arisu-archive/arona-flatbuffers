...
def EventContentZoneExcelAddLocationId(builder, locationId): builder.PrependInt64Slot(0, locationId, 0)
...
def EventContentZoneExcelAddOriginalZoneId(builder, originalZoneId): builder.PrependInt64Slot(2, originalZoneId, 0)
def AddOriginalZoneId(builder, originalZoneId):
    return EventContentZoneExcelAddOriginalZoneId(builder, originalZoneId)
def EventContentZoneExcelAddRewardGroupId(builder, rewardGroupId): builder.PrependInt64Slot(3, rewardGroupId, 0)
...
def EventContentZoneExcelAddStudentVisitProb(builder, studentVisitProb): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(studentVisitProb), 0)
...
def EventContentZoneExcelAddEventPointForLocationRank(builder, eventPointForLocationRank): builder.PrependInt64Slot(6, eventPointForLocationRank, 0)
...
def EventContentZoneExcelAddLocationRank(builder, locationRank): builder.PrependInt64Slot(9, locationRank, 0)
