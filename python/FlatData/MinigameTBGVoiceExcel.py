...
def MinigameTBGVoiceExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(0, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MinigameTBGVoiceExcelAddUniqueId(builder, uniqueId)
def MinigameTBGVoiceExcelAddVoiceId(builder, voiceId): builder.PrependUint32Slot(1, voiceId, 0)
def AddVoiceId(builder, voiceId):
    return MinigameTBGVoiceExcelAddVoiceId(builder, voiceId)
def MinigameTBGVoiceExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(2, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return MinigameTBGVoiceExcelAddEventContentId(builder, eventContentId)
def MinigameTBGVoiceExcelAddVoiceCondition(builder, voiceCondition): builder.PrependInt32Slot(3, voiceCondition, 0)
