...
def BulletArmorDamageFactorExcelAddBulletType(builder, bulletType): builder.PrependInt32Slot(0, bulletType, 0)
def AddBulletType(builder, bulletType):
    return BulletArmorDamageFactorExcelAddBulletType(builder, bulletType)
def BulletArmorDamageFactorExcelAddDamageAttribute(builder, damageAttribute): builder.PrependInt32Slot(1, damageAttribute, 0)
...
def BulletArmorDamageFactorExcelAddMaxDamageRate(builder, maxDamageRate): builder.PrependInt64Slot(4, maxDamageRate, 0)
def AddMaxDamageRate(builder, maxDamageRate):
    return BulletArmorDamageFactorExcelAddMaxDamageRate(builder, maxDamageRate)
def BulletArmorDamageFactorExcelAddShowHighlightFloater(builder, showHighlightFloater): builder.PrependBoolSlot(5, showHighlightFloater, 0)
...
def BulletArmorDamageFactorExcelAddDamageFactorGroupId(builder, damageFactorGroupId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(damageFactorGroupId), 0)
...
def BulletArmorDamageFactorExcelAddMinDamageRate(builder, minDamageRate): builder.PrependInt64Slot(7, minDamageRate, 0)
