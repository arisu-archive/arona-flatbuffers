...
def FieldEvidenceExcelAddNameLocalizeKey(builder, nameLocalizeKey): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(nameLocalizeKey), 0)
def AddNameLocalizeKey(builder, nameLocalizeKey):
    return FieldEvidenceExcelAddNameLocalizeKey(builder, nameLocalizeKey)
def FieldEvidenceExcelAddDescriptionLocalizeKey(builder, descriptionLocalizeKey): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(descriptionLocalizeKey), 0)
...
def FieldEvidenceExcelAddDetailLocalizeKey(builder, detailLocalizeKey): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(detailLocalizeKey), 0)
