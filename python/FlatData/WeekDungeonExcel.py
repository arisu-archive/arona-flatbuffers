...
def WeekDungeonExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(0, stageTopography, 0)
def AddStageTopography(builder, stageTopography):
    return WeekDungeonExcelAddStageTopography(builder, stageTopography)
def WeekDungeonExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostType), 0)
...
def WeekDungeonExcelAddEchelonExtensionType(builder, echelonExtensionType): builder.PrependInt32Slot(2, echelonExtensionType, 0)
...
def WeekDungeonExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostAmount), 0)
...
def WeekDungeonExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(stageEnterCostId), 0)
...
def WeekDungeonExcelAddBattleRewardExp(builder, battleRewardExp): builder.PrependInt64Slot(6, battleRewardExp, 0)
def AddBattleRewardExp(builder, battleRewardExp):
    return WeekDungeonExcelAddBattleRewardExp(builder, battleRewardExp)
def WeekDungeonExcelAddGroundId(builder, groundId): builder.PrependInt32Slot(7, groundId, 0)
def AddGroundId(builder, groundId):
    return WeekDungeonExcelAddGroundId(builder, groundId)
def WeekDungeonExcelAddBattleRewardPlayerExp(builder, battleRewardPlayerExp): builder.PrependInt64Slot(8, battleRewardPlayerExp, 0)
...
def WeekDungeonExcelAddWeekDungeonType(builder, weekDungeonType): builder.PrependInt32Slot(9, weekDungeonType, 0)
def AddWeekDungeonType(builder, weekDungeonType):
    return WeekDungeonExcelAddWeekDungeonType(builder, weekDungeonType)
def WeekDungeonExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt64Slot(10, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return WeekDungeonExcelAddRecommandLevel(builder, recommandLevel)
def WeekDungeonExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(11, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return WeekDungeonExcelAddBattleDuration(builder, battleDuration)
def WeekDungeonExcelAddPlayTimeLimitInSeconds(builder, playTimeLimitInSeconds): builder.PrependInt64Slot(12, playTimeLimitInSeconds, 0)
...
def WeekDungeonExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(13, prevStageId, 0)
...
def WeekDungeonExcelAddStageId(builder, stageId): builder.PrependInt64Slot(15, stageId, 0)
def AddStageId(builder, stageId):
    return WeekDungeonExcelAddStageId(builder, stageId)
def WeekDungeonExcelAddStarGoal(builder, starGoal): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(starGoal), 0)
...
def WeekDungeonExcelAddStarGoalAmount(builder, starGoalAmount): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(starGoalAmount), 0)
