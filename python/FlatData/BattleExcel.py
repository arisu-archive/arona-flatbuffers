...
def BattleExcelAddGuided(builder, guided): builder.PrependInt32Slot(0, guided, 0)
def AddGuided(builder, guided):
    return BattleExcelAddGuided(builder, guided)
def BattleExcelAddAllySelf(builder, allySelf): builder.PrependInt32Slot(1, allySelf, 0)
def AddAllySelf(builder, allySelf):
    return BattleExcelAddAllySelf(builder, allySelf)
def BattleExcelAddPreset(builder, preset): builder.PrependInt32Slot(2, preset, 0)
def AddPreset(builder, preset):
    return BattleExcelAddPreset(builder, preset)
def BattleExcelAddCrush(builder, crush): builder.PrependInt32Slot(3, crush, 0)
def AddCrush(builder, crush):
    return BattleExcelAddCrush(builder, crush)
def BattleExcelAddResist(builder, resist): builder.PrependInt32Slot(4, resist, 0)
...
def BattleExcelAddAlly(builder, ally): builder.PrependInt32Slot(6, ally, 0)
def AddAlly(builder, ally):
    return BattleExcelAddAlly(builder, ally)
def BattleExcelAddPosition(builder, position): builder.PrependInt32Slot(7, position, 0)
def AddPosition(builder, position):
    return BattleExcelAddPosition(builder, position)
def BattleExcelAddFinalDamage(builder, finalDamage): builder.PrependInt32Slot(8, finalDamage, 0)
def AddFinalDamage(builder, finalDamage):
    return BattleExcelAddFinalDamage(builder, finalDamage)
def BattleExcelAddTargetToCaster(builder, targetToCaster): builder.PrependInt32Slot(9, targetToCaster, 0)
def AddTargetToCaster(builder, targetToCaster):
    return BattleExcelAddTargetToCaster(builder, targetToCaster)
def BattleExcelAddMain(builder, main): builder.PrependInt32Slot(10, main, 0)
def AddMain(builder, main):
    return BattleExcelAddMain(builder, main)
def BattleExcelAddNone(builder, none): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(none), 0)
...
def BattleExcelAddBlue(builder, blue): builder.PrependInt32Slot(12, blue, 0)
def AddBlue(builder, blue):
    return BattleExcelAddBlue(builder, blue)
def BattleExcelAddAll(builder, all): builder.PrependInt32Slot(13, all, 0)
def AddAll(builder, all):
    return BattleExcelAddAll(builder, all)
def BattleExcelAddUseNextExSkill(builder, useNextExSkill): builder.PrependInt32Slot(14, useNextExSkill, 0)
def AddUseNextExSkill(builder, useNextExSkill):
    return BattleExcelAddUseNextExSkill(builder, useNextExSkill)
def BattleExcelAddTalk(builder, talk): builder.PrependInt32Slot(15, talk, 0)
def AddTalk(builder, talk):
    return BattleExcelAddTalk(builder, talk)
def BattleExcelAddCoverEnter(builder, coverEnter): builder.PrependInt32Slot(16, coverEnter, 0)
def AddCoverEnter(builder, coverEnter):
    return BattleExcelAddCoverEnter(builder, coverEnter)
def BattleExcelAddAble(builder, able): builder.PrependInt32Slot(17, able, 0)
...
def BattleExcelAddSequence(builder, sequence): builder.PrependInt32Slot(19, sequence, 0)
def AddSequence(builder, sequence):
    return BattleExcelAddSequence(builder, sequence)
def BattleExcelAddWood(builder, wood): builder.PrependInt32Slot(20, wood, 0)
def AddWood(builder, wood):
    return BattleExcelAddWood(builder, wood)
def BattleExcelAddLightArmor(builder, lightArmor): builder.PrependInt32Slot(21, lightArmor, 0)
def AddLightArmor(builder, lightArmor):
    return BattleExcelAddLightArmor(builder, lightArmor)
def BattleExcelAddD(builder, d): builder.PrependInt32Slot(22, d, 0)
def AddD(builder, d):
...
def BattleExcelAddDuration(builder, duration): builder.PrependInt32Slot(24, duration, 0)
def AddDuration(builder, duration):
    return BattleExcelAddDuration(builder, duration)
def BattleExcelAddLow(builder, low): builder.PrependInt32Slot(25, low, 0)
def AddLow(builder, low):
    return BattleExcelAddLow(builder, low)
def BattleExcelAddDistance(builder, distance): builder.PrependInt32Slot(26, distance, 0)
def AddDistance(builder, distance):
    return BattleExcelAddDistance(builder, distance)
def BattleExcelAddNormal(builder, normal): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(normal), 0)
...
def BattleExcelAddMain166405e7(builder, main166405e7): builder.PrependInt32Slot(28, main166405e7, 0)
...
def BattleExcelAddSpecialTransStat(builder, specialTransStat): builder.PrependInt32Slot(30, specialTransStat, 0)
def AddSpecialTransStat(builder, specialTransStat):
    return BattleExcelAddSpecialTransStat(builder, specialTransStat)
def BattleExcelAddSingle(builder, single): builder.PrependInt32Slot(31, single, 0)
def AddSingle(builder, single):
    return BattleExcelAddSingle(builder, single)
def BattleExcelAddStreet(builder, street): builder.PrependInt32Slot(32, street, 0)
def AddStreet(builder, street):
    return BattleExcelAddStreet(builder, street)
def BattleExcelAddStudent(builder, student): builder.PrependInt32Slot(33, student, 0)
