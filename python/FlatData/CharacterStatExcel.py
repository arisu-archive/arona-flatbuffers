...
def CharacterStatExcelAddEnhanceUnarmedRate(builder, enhanceUnarmedRate): builder.PrependInt64Slot(0, enhanceUnarmedRate, 0)
...
def CharacterStatExcelAddCriticalPoint(builder, criticalPoint): builder.PrependInt64Slot(1, criticalPoint, 0)
def AddCriticalPoint(builder, criticalPoint):
    return CharacterStatExcelAddCriticalPoint(builder, criticalPoint)
def CharacterStatExcelAddEnhanceExDamageRate(builder, enhanceExDamageRate): builder.PrependInt64Slot(2, enhanceExDamageRate, 0)
...
def CharacterStatExcelAddHealPower100(builder, healPower100): builder.PrependInt64Slot(3, healPower100, 0)
def AddHealPower100(builder, healPower100):
    return CharacterStatExcelAddHealPower100(builder, healPower100)
def CharacterStatExcelAddExtendBuffDuration(builder, extendBuffDuration): builder.PrependInt64Slot(4, extendBuffDuration, 0)
...
def CharacterStatExcelAddHealedPierceRate(builder, healedPierceRate): builder.PrependInt64Slot(5, healedPierceRate, 0)
def AddHealedPierceRate(builder, healedPierceRate):
    return CharacterStatExcelAddHealedPierceRate(builder, healedPierceRate)
def CharacterStatExcelAddDefensePower1(builder, defensePower1): builder.PrependInt64Slot(6, defensePower1, 0)
def AddDefensePower1(builder, defensePower1):
    return CharacterStatExcelAddDefensePower1(builder, defensePower1)
def CharacterStatExcelAddHealHeavyArmorRate(builder, healHeavyArmorRate): builder.PrependInt64Slot(7, healHeavyArmorRate, 0)
...
def CharacterStatExcelAddCriticalDamageResistRate(builder, criticalDamageResistRate): builder.PrependInt64Slot(8, criticalDamageResistRate, 0)
...
def CharacterStatExcelAddEnhancePierceRate(builder, enhancePierceRate): builder.PrependInt64Slot(11, enhancePierceRate, 0)
...
def CharacterStatExcelAddExtendDebuffDuration(builder, extendDebuffDuration): builder.PrependInt64Slot(12, extendDebuffDuration, 0)
...
def CharacterStatExcelAddGroggyTime(builder, groggyTime): builder.PrependInt32Slot(13, groggyTime, 0)
def AddGroggyTime(builder, groggyTime):
    return CharacterStatExcelAddGroggyTime(builder, groggyTime)
def CharacterStatExcelAddEnhanceNormalArmorRate(builder, enhanceNormalArmorRate): builder.PrependInt64Slot(14, enhanceNormalArmorRate, 0)
...
def CharacterStatExcelAddSightPoint(builder, sightPoint): builder.PrependInt64Slot(15, sightPoint, 0)
def AddSightPoint(builder, sightPoint):
    return CharacterStatExcelAddSightPoint(builder, sightPoint)
def CharacterStatExcelAddMoveSpeed(builder, moveSpeed): builder.PrependInt64Slot(16, moveSpeed, 0)
def AddMoveSpeed(builder, moveSpeed):
    return CharacterStatExcelAddMoveSpeed(builder, moveSpeed)
def CharacterStatExcelAddEnhanceExplosionRate(builder, enhanceExplosionRate): builder.PrependInt64Slot(17, enhanceExplosionRate, 0)
...
def CharacterStatExcelAddEnhanceMysticRate(builder, enhanceMysticRate): builder.PrependInt64Slot(18, enhanceMysticRate, 0)
...
def CharacterStatExcelAddIgnoreDelayCount(builder, ignoreDelayCount): builder.PrependInt64Slot(19, ignoreDelayCount, 0)
def AddIgnoreDelayCount(builder, ignoreDelayCount):
    return CharacterStatExcelAddIgnoreDelayCount(builder, ignoreDelayCount)
def CharacterStatExcelAddDamagedRatio2Decrease(builder, damagedRatio2Decrease): builder.PrependInt64Slot(20, damagedRatio2Decrease, 0)
...
def CharacterStatExcelAddStrategyMobility(builder, strategyMobility): builder.PrependInt64Slot(21, strategyMobility, 0)
def AddStrategyMobility(builder, strategyMobility):
    return CharacterStatExcelAddStrategyMobility(builder, strategyMobility)
def CharacterStatExcelAddAmmoCount(builder, ammoCount): builder.PrependInt64Slot(22, ammoCount, 0)
def AddAmmoCount(builder, ammoCount):
    return CharacterStatExcelAddAmmoCount(builder, ammoCount)
def CharacterStatExcelAddEnhanceLightArmorRate(builder, enhanceLightArmorRate): builder.PrependInt64Slot(23, enhanceLightArmorRate, 0)
...
def CharacterStatExcelAddHealUnarmedRate(builder, healUnarmedRate): builder.PrependInt64Slot(24, healUnarmedRate, 0)
def AddHealUnarmedRate(builder, healUnarmedRate):
    return CharacterStatExcelAddHealUnarmedRate(builder, healUnarmedRate)
def CharacterStatExcelAddMaxHp1(builder, maxHp1): builder.PrependInt64Slot(25, maxHp1, 0)
def AddMaxHp1(builder, maxHp1):
    return CharacterStatExcelAddMaxHp1(builder, maxHp1)
def CharacterStatExcelAddHealedSonicRate(builder, healedSonicRate): builder.PrependInt64Slot(26, healedSonicRate, 0)
def AddHealedSonicRate(builder, healedSonicRate):
    return CharacterStatExcelAddHealedSonicRate(builder, healedSonicRate)
def CharacterStatExcelAddGroggyGauge(builder, groggyGauge): builder.PrependInt32Slot(27, groggyGauge, 0)
def AddGroggyGauge(builder, groggyGauge):
    return CharacterStatExcelAddGroggyGauge(builder, groggyGauge)
def CharacterStatExcelAddMaxHp100(builder, maxHp100): builder.PrependInt64Slot(28, maxHp100, 0)
def AddMaxHp100(builder, maxHp100):
    return CharacterStatExcelAddMaxHp100(builder, maxHp100)
def CharacterStatExcelAddRegenCost(builder, regenCost): builder.PrependInt64Slot(29, regenCost, 0)
def AddRegenCost(builder, regenCost):
    return CharacterStatExcelAddRegenCost(builder, regenCost)
def CharacterStatExcelAddDefensePenetrationResist100(builder, defensePenetrationResist100): builder.PrependInt64Slot(30, defensePenetrationResist100, 0)
...
def CharacterStatExcelAddInitialRangeRate(builder, initialRangeRate): builder.PrependInt64Slot(31, initialRangeRate, 0)
def AddInitialRangeRate(builder, initialRangeRate):
    return CharacterStatExcelAddInitialRangeRate(builder, initialRangeRate)
def CharacterStatExcelAddDamageRatio2Increase(builder, damageRatio2Increase): builder.PrependInt64Slot(32, damageRatio2Increase, 0)
...
def CharacterStatExcelAddAttackPower100(builder, attackPower100): builder.PrependInt64Slot(33, attackPower100, 0)
...
def CharacterStatExcelAddActiveGauge(builder, activeGauge): builder.PrependInt64Slot(36, activeGauge, 0)
def AddActiveGauge(builder, activeGauge):
    return CharacterStatExcelAddActiveGauge(builder, activeGauge)
def CharacterStatExcelAddCriticalDamageRate(builder, criticalDamageRate): builder.PrependInt64Slot(37, criticalDamageRate, 0)
...
def CharacterStatExcelAddBlockRate(builder, blockRate): builder.PrependInt64Slot(38, blockRate, 0)
def AddBlockRate(builder, blockRate):
    return CharacterStatExcelAddBlockRate(builder, blockRate)
def CharacterStatExcelAddExDamagedRatioIncrease(builder, exDamagedRatioIncrease): builder.PrependInt64Slot(39, exDamagedRatioIncrease, 0)
...
def CharacterStatExcelAddDamagedRatio(builder, damagedRatio): builder.PrependInt64Slot(40, damagedRatio, 0)
def AddDamagedRatio(builder, damagedRatio):
    return CharacterStatExcelAddDamagedRatio(builder, damagedRatio)
def CharacterStatExcelAddAccuracyPoint(builder, accuracyPoint): builder.PrependInt64Slot(41, accuracyPoint, 0)
def AddAccuracyPoint(builder, accuracyPoint):
    return CharacterStatExcelAddAccuracyPoint(builder, accuracyPoint)
def CharacterStatExcelAddStabilityPoint(builder, stabilityPoint): builder.PrependInt64Slot(42, stabilityPoint, 0)
def AddStabilityPoint(builder, stabilityPoint):
    return CharacterStatExcelAddStabilityPoint(builder, stabilityPoint)
def CharacterStatExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(43, characterId, 0)
def AddCharacterId(builder, characterId):
    return CharacterStatExcelAddCharacterId(builder, characterId)
def CharacterStatExcelAddAttackPower1(builder, attackPower1): builder.PrependInt64Slot(44, attackPower1, 0)
def AddAttackPower1(builder, attackPower1):
    return CharacterStatExcelAddAttackPower1(builder, attackPower1)
def CharacterStatExcelAddIndoorBattleAdaptation(builder, indoorBattleAdaptation): builder.PrependInt32Slot(45, indoorBattleAdaptation, 0)
...
def CharacterStatExcelAddExtendCrowdControlDuration(builder, extendCrowdControlDuration): builder.PrependInt64Slot(46, extendCrowdControlDuration, 0)
...
def CharacterStatExcelAddStrategySightRange(builder, strategySightRange): builder.PrependInt64Slot(47, strategySightRange, 0)
...
def CharacterStatExcelAddOutdoorBattleAdaptation(builder, outdoorBattleAdaptation): builder.PrependInt32Slot(48, outdoorBattleAdaptation, 0)
...
def CharacterStatExcelAddDamageRatio(builder, damageRatio): builder.PrependInt64Slot(49, damageRatio, 0)
def AddDamageRatio(builder, damageRatio):
    return CharacterStatExcelAddDamageRatio(builder, damageRatio)
def CharacterStatExcelAddAmmoCost(builder, ammoCost): builder.PrependInt64Slot(50, ammoCost, 0)
def AddAmmoCost(builder, ammoCost):
    return CharacterStatExcelAddAmmoCost(builder, ammoCost)
def CharacterStatExcelAddNormalAttackSpeed(builder, normalAttackSpeed): builder.PrependInt64Slot(51, normalAttackSpeed, 0)
...
def CharacterStatExcelAddOppressionPower(builder, oppressionPower): builder.PrependInt64Slot(52, oppressionPower, 0)
def AddOppressionPower(builder, oppressionPower):
    return CharacterStatExcelAddOppressionPower(builder, oppressionPower)
def CharacterStatExcelAddDefensePenetration100(builder, defensePenetration100): builder.PrependInt64Slot(53, defensePenetration100, 0)
...
def CharacterStatExcelAddEnhanceSonicRate(builder, enhanceSonicRate): builder.PrependInt64Slot(54, enhanceSonicRate, 0)
def AddEnhanceSonicRate(builder, enhanceSonicRate):
    return CharacterStatExcelAddEnhanceSonicRate(builder, enhanceSonicRate)
def CharacterStatExcelAddHealedExplosionRate(builder, healedExplosionRate): builder.PrependInt64Slot(55, healedExplosionRate, 0)
...
def CharacterStatExcelAddHealLightArmorRate(builder, healLightArmorRate): builder.PrependInt64Slot(57, healLightArmorRate, 0)
...
def CharacterStatExcelAddDefensePenetrationResist1(builder, defensePenetrationResist1): builder.PrependInt64Slot(58, defensePenetrationResist1, 0)
...
def CharacterStatExcelAddReduceExDamagedRate(builder, reduceExDamagedRate): builder.PrependInt64Slot(59, reduceExDamagedRate, 0)
...
def CharacterStatExcelAddStreetBattleAdaptation(builder, streetBattleAdaptation): builder.PrependInt32Slot(60, streetBattleAdaptation, 0)
...
def CharacterStatExcelAddActionCount(builder, actionCount): builder.PrependInt64Slot(61, actionCount, 0)
def AddActionCount(builder, actionCount):
    return CharacterStatExcelAddActionCount(builder, actionCount)
def CharacterStatExcelAddHealEffectivenessRate(builder, healEffectivenessRate): builder.PrependInt64Slot(62, healEffectivenessRate, 0)
...
def CharacterStatExcelAddHealedNormalRate(builder, healedNormalRate): builder.PrependInt64Slot(63, healedNormalRate, 0)
def AddHealedNormalRate(builder, healedNormalRate):
    return CharacterStatExcelAddHealedNormalRate(builder, healedNormalRate)
def CharacterStatExcelAddRange(builder, range): builder.PrependInt64Slot(64, range, 0)
def AddRange(builder, range):
    return CharacterStatExcelAddRange(builder, range)
def CharacterStatExcelAddHealedMysticRate(builder, healedMysticRate): builder.PrependInt64Slot(65, healedMysticRate, 0)
def AddHealedMysticRate(builder, healedMysticRate):
    return CharacterStatExcelAddHealedMysticRate(builder, healedMysticRate)
def CharacterStatExcelAddStabilityRate(builder, stabilityRate): builder.PrependInt64Slot(66, stabilityRate, 0)
def AddStabilityRate(builder, stabilityRate):
    return CharacterStatExcelAddStabilityRate(builder, stabilityRate)
def CharacterStatExcelAddOppressionResist(builder, oppressionResist): builder.PrependInt64Slot(67, oppressionResist, 0)
def AddOppressionResist(builder, oppressionResist):
    return CharacterStatExcelAddOppressionResist(builder, oppressionResist)
def CharacterStatExcelAddCriticalResistPoint(builder, criticalResistPoint): builder.PrependInt64Slot(68, criticalResistPoint, 0)
...
def CharacterStatExcelAddDodgePoint(builder, dodgePoint): builder.PrependInt64Slot(69, dodgePoint, 0)
def AddDodgePoint(builder, dodgePoint):
    return CharacterStatExcelAddDodgePoint(builder, dodgePoint)
def CharacterStatExcelAddDamageRatio2Decrease(builder, damageRatio2Decrease): builder.PrependInt64Slot(70, damageRatio2Decrease, 0)
...
def CharacterStatExcelAddDamagedRatio2Increase(builder, damagedRatio2Increase): builder.PrependInt64Slot(71, damagedRatio2Increase, 0)
...
def CharacterStatExcelAddEnhanceNormalRate(builder, enhanceNormalRate): builder.PrependInt64Slot(72, enhanceNormalRate, 0)
...
def CharacterStatExcelAddExDamagedRatioDecrease(builder, exDamagedRatioDecrease): builder.PrependInt64Slot(73, exDamagedRatioDecrease, 0)
...
def CharacterStatExcelAddHealRate(builder, healRate): builder.PrependInt64Slot(74, healRate, 0)
def AddHealRate(builder, healRate):
    return CharacterStatExcelAddHealRate(builder, healRate)
def CharacterStatExcelAddEnhanceStructureRate(builder, enhanceStructureRate): builder.PrependInt64Slot(75, enhanceStructureRate, 0)
...
def CharacterStatExcelAddDefensePenetration1(builder, defensePenetration1): builder.PrependInt64Slot(76, defensePenetration1, 0)
...
def CharacterStatExcelAddDefensePower100(builder, defensePower100): builder.PrependInt64Slot(77, defensePower100, 0)
def AddDefensePower100(builder, defensePower100):
    return CharacterStatExcelAddDefensePower100(builder, defensePower100)
def CharacterStatExcelAddEnhanceHeavyArmorRate(builder, enhanceHeavyArmorRate): builder.PrependInt64Slot(78, enhanceHeavyArmorRate, 0)
