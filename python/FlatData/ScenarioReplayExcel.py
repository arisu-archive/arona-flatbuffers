...
def ScenarioReplayExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(0, battleDuration, 0)
...
def ScenarioReplayExcelAddBackScenarioGroupId(builder, backScenarioGroupId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(backScenarioGroupId), 0)
...
def ScenarioReplayExcelAddReplayType(builder, replayType): builder.PrependInt32Slot(5, replayType, 0)
...
def ScenarioReplayExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(7, groundId, 0)
def AddGroundId(builder, groundId):
    return ScenarioReplayExcelAddGroundId(builder, groundId)
def ScenarioReplayExcelAddChapterId(builder, chapterId): builder.PrependInt64Slot(8, chapterId, 0)
