...
def FieldWorldMapZoneExcelAddCloseConditionType(builder, closeConditionType): builder.PrependInt32Slot(0, closeConditionType, 0)
...
def FieldWorldMapZoneExcelAddOpenConditionType(builder, openConditionType): builder.PrependInt32Slot(1, openConditionType, 0)
...
def FieldWorldMapZoneExcelAddFieldStageInteractionId(builder, fieldStageInteractionId): builder.PrependInt64Slot(2, fieldStageInteractionId, 0)
...
def FieldWorldMapZoneExcelAddWorldMapButtonType(builder, worldMapButtonType): builder.PrependInt32Slot(3, worldMapButtonType, 0)
...
def FieldWorldMapZoneExcelAddCloseConditionId(builder, closeConditionId): builder.PrependInt64Slot(4, closeConditionId, 0)
...
def FieldWorldMapZoneExcelAddLocalizeCode(builder, localizeCode): builder.PrependUint32Slot(5, localizeCode, 0)
def AddLocalizeCode(builder, localizeCode):
    return FieldWorldMapZoneExcelAddLocalizeCode(builder, localizeCode)
def FieldWorldMapZoneExcelAddNewTagDisplay(builder, newTagDisplay): builder.PrependBoolSlot(6, newTagDisplay, 0)
def AddNewTagDisplay(builder, newTagDisplay):
    return FieldWorldMapZoneExcelAddNewTagDisplay(builder, newTagDisplay)
def FieldWorldMapZoneExcelAddDate(builder, date): builder.PrependInt32Slot(7, date, 0)
def AddDate(builder, date):
    return FieldWorldMapZoneExcelAddDate(builder, date)
def FieldWorldMapZoneExcelAddId(builder, id): builder.PrependInt64Slot(8, id, 0)
def AddId(builder, id):
    return FieldWorldMapZoneExcelAddId(builder, id)
def FieldWorldMapZoneExcelAddResultFieldScene(builder, resultFieldScene): builder.PrependInt64Slot(9, resultFieldScene, 0)
...
def FieldWorldMapZoneExcelAddOpenConditionId(builder, openConditionId): builder.PrependInt64Slot(10, openConditionId, 0)
def AddOpenConditionId(builder, openConditionId):
    return FieldWorldMapZoneExcelAddOpenConditionId(builder, openConditionId)
def FieldWorldMapZoneExcelAddGroupId(builder, groupId): builder.PrependInt32Slot(11, groupId, 0)
