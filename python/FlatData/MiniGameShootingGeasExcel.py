...
def MiniGameShootingGeasExcelAddGeasType(builder, geasType): builder.PrependInt32Slot(0, geasType, 0)
def AddGeasType(builder, geasType):
    return MiniGameShootingGeasExcelAddGeasType(builder, geasType)
def MiniGameShootingGeasExcelAddIcon(builder, icon): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(icon), 0)
def AddIcon(builder, icon):
    return MiniGameShootingGeasExcelAddIcon(builder, icon)
def MiniGameShootingGeasExcelAddNeedGeasId(builder, needGeasId): builder.PrependInt64Slot(2, needGeasId, 0)
...
def MiniGameShootingGeasExcelAddHideInPausePopup(builder, hideInPausePopup): builder.PrependBoolSlot(4, hideInPausePopup, 0)
...
def MiniGameShootingGeasExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(6, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return MiniGameShootingGeasExcelAddUniqueId(builder, uniqueId)
def MiniGameShootingGeasExcelAddProbability(builder, probability): builder.PrependInt64Slot(7, probability, 0)
