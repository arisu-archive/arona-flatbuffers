...
def TerrainAdaptationFactorExcelAddTerrainAdaptation(builder, terrainAdaptation): builder.PrependInt32Slot(1, terrainAdaptation, 0)
...
def TerrainAdaptationFactorExcelAddTerrainAdaptationStat(builder, terrainAdaptationStat): builder.PrependInt32Slot(3, terrainAdaptationStat, 0)
...
def TerrainAdaptationFactorExcelAddAttackPowerFactor(builder, attackPowerFactor): builder.PrependInt64Slot(4, attackPowerFactor, 0)
...
def TerrainAdaptationFactorExcelAddShotFactor(builder, shotFactor): builder.PrependInt64Slot(5, shotFactor, 0)
def AddShotFactor(builder, shotFactor):
    return TerrainAdaptationFactorExcelAddShotFactor(builder, shotFactor)
def TerrainAdaptationFactorExcelAddDodgeFactor(builder, dodgeFactor): builder.PrependInt64Slot(6, dodgeFactor, 0)
