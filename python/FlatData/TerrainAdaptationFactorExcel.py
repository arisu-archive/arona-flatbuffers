...
def TerrainAdaptationFactorExcelAddShotFactor(builder, shotFactor): builder.PrependInt64Slot(0, shotFactor, 0)
...
def TerrainAdaptationFactorExcelAddAccuracyFactor(builder, accuracyFactor): builder.PrependInt64Slot(3, accuracyFactor, 0)
def AddAccuracyFactor(builder, accuracyFactor):
    return TerrainAdaptationFactorExcelAddAccuracyFactor(builder, accuracyFactor)
def TerrainAdaptationFactorExcelAddTerrainAdaptationStat(builder, terrainAdaptationStat): builder.PrependInt32Slot(4, terrainAdaptationStat, 0)
...
def TerrainAdaptationFactorExcelAddAttackPowerFactor(builder, attackPowerFactor): builder.PrependInt64Slot(5, attackPowerFactor, 0)
