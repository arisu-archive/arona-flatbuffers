...
def MiniGameShootingCharacterExcelAddIgnoreObstacleCheck(builder, ignoreObstacleCheck):
    builder.PrependBoolSlot(8, ignoreObstacleCheck, 0)
...
def MiniGameShootingCharacterExcelAddIsBoss(builder, isBoss):
    builder.PrependBoolSlot(9, isBoss, 0)
...
def MiniGameShootingCharacterExcelAddModelPrefabName(builder, modelPrefabName):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(modelPrefabName), 0)
...
def MiniGameShootingCharacterExcelAddNormalAttackSkillData(builder, normalAttackSkillData):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(normalAttackSkillData), 0)
...
def MiniGameShootingCharacterExcelAddPublicSkillData(builder, publicSkillData):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillData), 0)
...
def MiniGameShootingCharacterExcelAddSpineResourceName(builder, spineResourceName):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(spineResourceName), 0)
