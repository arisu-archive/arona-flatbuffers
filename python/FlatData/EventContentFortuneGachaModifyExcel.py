...
def EventContentFortuneGachaModifyExcelAddTitleLocalizeKey(builder, titleLocalizeKey): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(titleLocalizeKey), 0)
...
def EventContentFortuneGachaModifyExcelAddShopBgImagePath(builder, shopBgImagePath): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(shopBgImagePath), 0)
...
def EventContentFortuneGachaModifyExcelAddProbModifyStartCount(builder, probModifyStartCount): builder.PrependInt32Slot(6, probModifyStartCount, 0)
