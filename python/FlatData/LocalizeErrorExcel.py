...
def LocalizeErrorExcelAddEn(builder, en): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(en), 0)
def AddEn(builder, en):
    return LocalizeErrorExcelAddEn(builder, en)
...
def LocalizeErrorExcelAddJp(builder, jp): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(jp), 0)
...
def LocalizeErrorExcelAddKr(builder, kr): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(kr), 0)
def AddKr(builder, kr):
    return LocalizeErrorExcelAddKr(builder, kr)
def LocalizeErrorExcelAddTh(builder, th): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(th), 0)
def AddTh(builder, th):
    return LocalizeErrorExcelAddTh(builder, th)
def LocalizeErrorExcelAddTw(builder, tw): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(tw), 0)
def AddTw(builder, tw):
    return LocalizeErrorExcelAddTw(builder, tw)
