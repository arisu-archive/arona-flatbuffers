...
def DefaultMailExcelAddMailSendPeriodTo(builder, mailSendPeriodTo): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(mailSendPeriodTo), 0)
...
def DefaultMailExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return DefaultMailExcelAddId(builder, id)
def DefaultMailExcelAddLocalizeCodeId(builder, localizeCodeId): builder.PrependUint32Slot(3, localizeCodeId, 0)
def AddLocalizeCodeId(builder, localizeCodeId):
    return DefaultMailExcelAddLocalizeCodeId(builder, localizeCodeId)
def DefaultMailExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelAmount), 0)
...
def DefaultMailExcelAddMailType(builder, mailType): builder.PrependInt32Slot(6, mailType, 0)
def AddMailType(builder, mailType):
    return DefaultMailExcelAddMailType(builder, mailType)
def DefaultMailExcelAddMailSendPeriodFrom(builder, mailSendPeriodFrom): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(mailSendPeriodFrom), 0)
