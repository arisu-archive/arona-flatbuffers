...
def EventContentShopExcelAddCategoryType(builder, categoryType): builder.PrependInt32Slot(0, categoryType, 0)
...
def EventContentShopExcelAddPurchaseCountLimit(builder, purchaseCountLimit): builder.PrependInt64Slot(2, purchaseCountLimit, 0)
...
def EventContentShopExcelAddBuyReportEventName(builder, buyReportEventName): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(buyReportEventName), 0)
...
def EventContentShopExcelAddId(builder, id): builder.PrependInt64Slot(4, id, 0)
def AddId(builder, id):
    return EventContentShopExcelAddId(builder, id)
def EventContentShopExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(5, localizeEtcId, 0)
...
def EventContentShopExcelAddIsLegacy(builder, isLegacy): builder.PrependBoolSlot(7, isLegacy, 0)
...
def EventContentShopExcelAddRestrictBuyWhenInventoryFull(builder, restrictBuyWhenInventoryFull): builder.PrependBoolSlot(9, restrictBuyWhenInventoryFull, 0)
...
def EventContentShopExcelAddPurchaseCooltimeMin(builder, purchaseCooltimeMin): builder.PrependInt64Slot(10, purchaseCooltimeMin, 0)
...
def EventContentShopExcelAddSalePeriodFrom(builder, salePeriodFrom): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(salePeriodFrom), 0)
...
def EventContentShopExcelAddGoodsId(builder, goodsId): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(goodsId), 0)
