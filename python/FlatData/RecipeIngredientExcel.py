...
def RecipeIngredientExcelAddIngredientParcelType(builder, ingredientParcelType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientParcelType), 0)
...
def RecipeIngredientExcelAddIngredientId(builder, ingredientId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientId), 0)
...
def RecipeIngredientExcelAddId(builder, id): builder.PrependInt64Slot(2, id, 0)
def AddId(builder, id):
    return RecipeIngredientExcelAddId(builder, id)
def RecipeIngredientExcelAddCostAmount(builder, costAmount): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(costAmount), 0)
...
def RecipeIngredientExcelAddCostTimeInSecond(builder, costTimeInSecond): builder.PrependInt64Slot(4, costTimeInSecond, 0)
...
def RecipeIngredientExcelAddIngredientAmount(builder, ingredientAmount): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ingredientAmount), 0)
...
def RecipeIngredientExcelAddCostParcelType(builder, costParcelType): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(costParcelType), 0)
