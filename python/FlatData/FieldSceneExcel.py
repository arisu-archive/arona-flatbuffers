...
def FieldSceneExcelAddConditionalBgmQuestId(builder, conditionalBgmQuestId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(conditionalBgmQuestId), 0)
...
def FieldSceneExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(1, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return FieldSceneExcelAddUniqueId(builder, uniqueId)
def FieldSceneExcelAddEndConditionalBgmInteractionId(builder, endConditionalBgmInteractionId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(endConditionalBgmInteractionId), 0)
...
def FieldSceneExcelAddBeginConditionalBgmScenarioGroupId(builder, beginConditionalBgmScenarioGroupId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(beginConditionalBgmScenarioGroupId), 0)
...
def FieldSceneExcelAddDateId(builder, dateId): builder.PrependInt64Slot(4, dateId, 0)
def AddDateId(builder, dateId):
    return FieldSceneExcelAddDateId(builder, dateId)
def FieldSceneExcelAddArtLevelPath(builder, artLevelPath): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(artLevelPath), 0)
def AddArtLevelPath(builder, artLevelPath):
    return FieldSceneExcelAddArtLevelPath(builder, artLevelPath)
def FieldSceneExcelAddBeginConditionalBgmInteractionId(builder, beginConditionalBgmInteractionId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(beginConditionalBgmInteractionId), 0)
...
def FieldSceneExcelAddEndConditionalBgmScenarioGroupId(builder, endConditionalBgmScenarioGroupId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(endConditionalBgmScenarioGroupId), 0)
...
def FieldSceneExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(8, bgmId, 0)
...
def FieldSceneExcelAddConditionalBgmId(builder, conditionalBgmId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(conditionalBgmId), 0)
...
def FieldSceneExcelAddDesignLevelPath(builder, designLevelPath): builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(designLevelPath), 0)
