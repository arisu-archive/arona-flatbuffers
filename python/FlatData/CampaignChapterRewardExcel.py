...
def CampaignChapterRewardExcelAddChapterRewardParcelType(builder, chapterRewardParcelType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(chapterRewardParcelType), 0)
