...
def ConquestGroupBonusExcelAddBonusPercentage2(builder, bonusPercentage2): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(bonusPercentage2), 0)
...
def ConquestGroupBonusExcelAddBonusId(builder, bonusId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(bonusId), 0)
...
def ConquestGroupBonusExcelAddBonusCharacterCount2(builder, bonusCharacterCount2): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(bonusCharacterCount2), 0)
...
def ConquestGroupBonusExcelAddBonusCharacterCount1(builder, bonusCharacterCount1): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(bonusCharacterCount1), 0)
...
def ConquestGroupBonusExcelAddRecommandLocalizeEtcId(builder, recommandLocalizeEtcId): builder.PrependUint32Slot(7, recommandLocalizeEtcId, 0)
...
def ConquestGroupBonusExcelAddBonusPercentage3(builder, bonusPercentage3): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(bonusPercentage3), 0)
...
def ConquestGroupBonusExcelAddConquestBonusId(builder, conquestBonusId): builder.PrependInt64Slot(9, conquestBonusId, 0)
