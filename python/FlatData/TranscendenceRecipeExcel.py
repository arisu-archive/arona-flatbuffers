...
def TranscendenceRecipeExcelAddParcelId(builder, parcelId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(parcelId), 0)
...
def TranscendenceRecipeExcelAddParcelAmount(builder, parcelAmount): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(parcelAmount), 0)
...
def TranscendenceRecipeExcelAddCostCurrencyAmount(builder, costCurrencyAmount): builder.PrependInt64Slot(2, costCurrencyAmount, 0)
...
def TranscendenceRecipeExcelAddCostCurrencyType(builder, costCurrencyType): builder.PrependInt32Slot(3, costCurrencyType, 0)
