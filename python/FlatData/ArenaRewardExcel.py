...
def ArenaRewardExcelAddRewardParcelUniqueName(builder, rewardParcelUniqueName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueName), 0)
...
def ArenaRewardExcelAddRankIconPath(builder, rankIconPath): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rankIconPath), 0)
def AddRankIconPath(builder, rankIconPath):
    return ArenaRewardExcelAddRankIconPath(builder, rankIconPath)
def ArenaRewardExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return ArenaRewardExcelAddUniqueId(builder, uniqueId)
def ArenaRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def ArenaRewardExcelAddRankEnd(builder, rankEnd): builder.PrependInt64Slot(6, rankEnd, 0)
def AddRankEnd(builder, rankEnd):
    return ArenaRewardExcelAddRankEnd(builder, rankEnd)
def ArenaRewardExcelAddRewardParcelUniqueId(builder, rewardParcelUniqueId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelUniqueId), 0)
...
def ArenaRewardExcelAddArenaRewardType(builder, arenaRewardType): builder.PrependInt32Slot(8, arenaRewardType, 0)
