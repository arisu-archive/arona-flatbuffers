...
def ConquestCameraSettingExcelAddConquestMapBoundaryOffsetRight(builder, conquestMapBoundaryOffsetRight): builder.PrependFloat32Slot(1, conquestMapBoundaryOffsetRight, 0.0)
...
def ConquestCameraSettingExcelAddCameraAngle(builder, cameraAngle): builder.PrependFloat32Slot(2, cameraAngle, 0.0)
def AddCameraAngle(builder, cameraAngle):
    return ConquestCameraSettingExcelAddCameraAngle(builder, cameraAngle)
def ConquestCameraSettingExcelAddCameraZoomMax(builder, cameraZoomMax): builder.PrependFloat32Slot(3, cameraZoomMax, 0.0)
def AddCameraZoomMax(builder, cameraZoomMax):
    return ConquestCameraSettingExcelAddCameraZoomMax(builder, cameraZoomMax)
def ConquestCameraSettingExcelAddCameraZoomDefault(builder, cameraZoomDefault): builder.PrependFloat32Slot(4, cameraZoomDefault, 0.0)
...
def ConquestCameraSettingExcelAddConquestMapBoundaryOffsetBottom(builder, conquestMapBoundaryOffsetBottom): builder.PrependFloat32Slot(5, conquestMapBoundaryOffsetBottom, 0.0)
...
def ConquestCameraSettingExcelAddCameraZoomMin(builder, cameraZoomMin): builder.PrependFloat32Slot(6, cameraZoomMin, 0.0)
def AddCameraZoomMin(builder, cameraZoomMin):
    return ConquestCameraSettingExcelAddCameraZoomMin(builder, cameraZoomMin)
def ConquestCameraSettingExcelAddConquestMapBoundaryOffsetLeft(builder, conquestMapBoundaryOffsetLeft): builder.PrependFloat32Slot(7, conquestMapBoundaryOffsetLeft, 0.0)
...
def ConquestCameraSettingExcelAddConquestMapCenterOffsetY(builder, conquestMapCenterOffsetY): builder.PrependFloat32Slot(8, conquestMapCenterOffsetY, 0.0)
...
def ConquestCameraSettingExcelAddConquestMapBoundaryOffsetTop(builder, conquestMapBoundaryOffsetTop): builder.PrependFloat32Slot(9, conquestMapBoundaryOffsetTop, 0.0)
...
def ConquestCameraSettingExcelAddConquestMapCenterOffsetX(builder, conquestMapCenterOffsetX): builder.PrependFloat32Slot(10, conquestMapCenterOffsetX, 0.0)
