...
def EventContentZoneVisitRewardExcelAddEventContentLocationId(builder, eventContentLocationId): builder.PrependInt64Slot(0, eventContentLocationId, 0)
...
def EventContentZoneVisitRewardExcelAddVisitRewardParcelId(builder, visitRewardParcelId): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardParcelId), 0)
...
def EventContentZoneVisitRewardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(7, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentZoneVisitRewardExcelAddEventContentId(builder, eventContentId)
def EventContentZoneVisitRewardExcelAddVisitRewardAmount(builder, visitRewardAmount): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardAmount), 0)
