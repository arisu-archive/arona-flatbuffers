...
def EventContentZoneVisitRewardExcelAddVisitRewardParcelType(builder, visitRewardParcelType): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardParcelType), 0)
...
def EventContentZoneVisitRewardExcelAddDevName(builder, devName): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(devName), 0)
def AddDevName(builder, devName):
    return EventContentZoneVisitRewardExcelAddDevName(builder, devName)
def EventContentZoneVisitRewardExcelAddVisitRewardProb(builder, visitRewardProb): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardProb), 0)
...
def EventContentZoneVisitRewardExcelAddVisitRewardParcelId(builder, visitRewardParcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardParcelId), 0)
...
def EventContentZoneVisitRewardExcelAddCharacterDevName(builder, characterDevName): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(characterDevName), 0)
...
def EventContentZoneVisitRewardExcelAddVisitRewardAmount(builder, visitRewardAmount): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(visitRewardAmount), 0)
