...
def CafeRankExcelAddCharacterVisitMin(builder, characterVisitMin): builder.PrependInt32Slot(0, characterVisitMin, 0)
...
def CafeRankExcelAddCharacterVisitMax(builder, characterVisitMax): builder.PrependInt32Slot(2, characterVisitMax, 0)
...
def CafeRankExcelAddCafeVisitWeightTagBonus(builder, cafeVisitWeightTagBonus): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(cafeVisitWeightTagBonus), 0)
...
def CafeRankExcelAddRank(builder, rank): builder.PrependInt64Slot(9, rank, 0)
