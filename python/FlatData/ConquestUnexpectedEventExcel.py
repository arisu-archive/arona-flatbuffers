...
def ConquestUnexpectedEventExcelAddUnexpectedEventPrefab(builder, unexpectedEventPrefab): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(unexpectedEventPrefab), 0)
...
def ConquestUnexpectedEventExcelAddUnexpectedEventConditionUniqueId(builder, unexpectedEventConditionUniqueId): builder.PrependInt64Slot(1, unexpectedEventConditionUniqueId, 0)
...
def ConquestUnexpectedEventExcelAddUnexpectedEventUnitId(builder, unexpectedEventUnitId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(unexpectedEventUnitId), 0)
...
def ConquestUnexpectedEventExcelAddUnexpectedEventConditionType(builder, unexpectedEventConditionType): builder.PrependInt32Slot(3, unexpectedEventConditionType, 0)
...
def ConquestUnexpectedEventExcelAddUnitCountPerStep(builder, unitCountPerStep): builder.PrependInt32Slot(4, unitCountPerStep, 0)
...
def ConquestUnexpectedEventExcelAddUnexpectedEventConditionAmount(builder, unexpectedEventConditionAmount): builder.PrependInt64Slot(5, unexpectedEventConditionAmount, 0)
...
def ConquestUnexpectedEventExcelAddUnexpectedEventOccurDailyLimitCount(builder, unexpectedEventOccurDailyLimitCount): builder.PrependInt32Slot(6, unexpectedEventOccurDailyLimitCount, 0)
