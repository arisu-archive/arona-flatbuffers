...
def DefaultCharacterExcelAddStarGrade(builder, starGrade): builder.PrependInt32Slot(0, starGrade, 0)
def AddStarGrade(builder, starGrade):
    return DefaultCharacterExcelAddStarGrade(builder, starGrade)
def DefaultCharacterExcelAddExp(builder, exp): builder.PrependInt32Slot(1, exp, 0)
def AddExp(builder, exp):
    return DefaultCharacterExcelAddExp(builder, exp)
def DefaultCharacterExcelAddExSkillLevel(builder, exSkillLevel): builder.PrependInt32Slot(2, exSkillLevel, 0)
def AddExSkillLevel(builder, exSkillLevel):
    return DefaultCharacterExcelAddExSkillLevel(builder, exSkillLevel)
def DefaultCharacterExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(3, characterId, 0)
def AddCharacterId(builder, characterId):
    return DefaultCharacterExcelAddCharacterId(builder, characterId)
def DefaultCharacterExcelAddCommonSkillLevel(builder, commonSkillLevel): builder.PrependInt32Slot(4, commonSkillLevel, 0)
...
def DefaultCharacterExcelAddLevel(builder, level): builder.PrependInt32Slot(7, level, 0)
def AddLevel(builder, level):
    return DefaultCharacterExcelAddLevel(builder, level)
def DefaultCharacterExcelAddExtraPassiveSkillLevel(builder, extraPassiveSkillLevel): builder.PrependInt32Slot(8, extraPassiveSkillLevel, 0)
...
def DefaultCharacterExcelAddFavorRank(builder, favorRank): builder.PrependInt32Slot(9, favorRank, 0)
