...
def LimitedStageExcelAddContentType(builder, contentType): builder.PrependInt32Slot(0, contentType, 0)
def AddContentType(builder, contentType):
    return LimitedStageExcelAddContentType(builder, contentType)
def LimitedStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(1, groundId, 0)
def AddGroundId(builder, groundId):
    return LimitedStageExcelAddGroundId(builder, groundId)
def LimitedStageExcelAddBgmId(builder, bgmId): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(bgmId), 0)
def AddBgmId(builder, bgmId):
    return LimitedStageExcelAddBgmId(builder, bgmId)
def LimitedStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(3, stageEnterCostId, 0)
def AddStageEnterCostId(builder, stageEnterCostId):
    return LimitedStageExcelAddStageEnterCostId(builder, stageEnterCostId)
def LimitedStageExcelAddStageDisplay(builder, stageDisplay): builder.PrependInt32Slot(4, stageDisplay, 0)
def AddStageDisplay(builder, stageDisplay):
    return LimitedStageExcelAddStageDisplay(builder, stageDisplay)
def LimitedStageExcelAddStageDifficulty(builder, stageDifficulty): builder.PrependInt32Slot(5, stageDifficulty, 0)
...
def LimitedStageExcelAddStrategyMapBg(builder, strategyMapBg): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMapBg), 0)
def AddStrategyMapBg(builder, strategyMapBg):
    return LimitedStageExcelAddStrategyMapBg(builder, strategyMapBg)
def LimitedStageExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(8, stageRewardId, 0)
...
def LimitedStageExcelAddStarConditionTacticRankSCount(builder, starConditionTacticRankSCount): builder.PrependInt64Slot(10, starConditionTacticRankSCount, 0)
...
def LimitedStageExcelAddChallengeDisplay(builder, challengeDisplay): builder.PrependBoolSlot(11, challengeDisplay, 0)
def AddChallengeDisplay(builder, challengeDisplay):
    return LimitedStageExcelAddChallengeDisplay(builder, challengeDisplay)
def LimitedStageExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(12, stageEnterEchelonCount, 0)
...
def LimitedStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return LimitedStageExcelAddName(builder, name)
def LimitedStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(14, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return LimitedStageExcelAddRecommandLevel(builder, recommandLevel)
def LimitedStageExcelAddBuffContentId(builder, buffContentId): builder.PrependInt64Slot(15, buffContentId, 0)
def AddBuffContentId(builder, buffContentId):
    return LimitedStageExcelAddBuffContentId(builder, buffContentId)
def LimitedStageExcelAddInstantClear(builder, instantClear): builder.PrependBoolSlot(16, instantClear, 0)
def AddInstantClear(builder, instantClear):
    return LimitedStageExcelAddInstantClear(builder, instantClear)
def LimitedStageExcelAddStageNumber(builder, stageNumber): builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(stageNumber), 0)
def AddStageNumber(builder, stageNumber):
    return LimitedStageExcelAddStageNumber(builder, stageNumber)
def LimitedStageExcelAddBgmIdC9738509(builder, bgmIdC9738509): builder.PrependInt64Slot(18, bgmIdC9738509, 0)
def AddBgmIdC9738509(builder, bgmIdC9738509):
    return LimitedStageExcelAddBgmIdC9738509(builder, bgmIdC9738509)
def LimitedStageExcelAddStrategyEnvironment(builder, strategyEnvironment): builder.PrependInt32Slot(19, strategyEnvironment, 0)
...
def LimitedStageExcelAddOpenEventPoint(builder, openEventPoint): builder.PrependInt64Slot(20, openEventPoint, 0)
def AddOpenEventPoint(builder, openEventPoint):
    return LimitedStageExcelAddOpenEventPoint(builder, openEventPoint)
def LimitedStageExcelAddSeasonId(builder, seasonId): builder.PrependInt64Slot(21, seasonId, 0)
def AddSeasonId(builder, seasonId):
    return LimitedStageExcelAddSeasonId(builder, seasonId)
def LimitedStageExcelAddStarConditionTurnCount(builder, starConditionTurnCount): builder.PrependInt64Slot(22, starConditionTurnCount, 0)
...
def LimitedStageExcelAddOpenDate(builder, openDate): builder.PrependInt64Slot(23, openDate, 0)
def AddOpenDate(builder, openDate):
    return LimitedStageExcelAddOpenDate(builder, openDate)
def LimitedStageExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
...
def LimitedStageExcelAddId(builder, id): builder.PrependInt64Slot(25, id, 0)
def AddId(builder, id):
    return LimitedStageExcelAddId(builder, id)
def LimitedStageExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return LimitedStageExcelAddStrategyMap(builder, strategyMap)
def LimitedStageExcelAddStageEnterCostAmount(builder, stageEnterCostAmount): builder.PrependInt32Slot(27, stageEnterCostAmount, 0)
...
def LimitedStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(28, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return LimitedStageExcelAddBattleDuration(builder, battleDuration)
def LimitedStageExcelAddMaxTurn(builder, maxTurn): builder.PrependInt32Slot(29, maxTurn, 0)
def AddMaxTurn(builder, maxTurn):
    return LimitedStageExcelAddMaxTurn(builder, maxTurn)
def LimitedStageExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def LimitedStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(31, stageEnterCostType, 0)
