...
def LimitedStageExcelAddStageDifficulty(builder, stageDifficulty): builder.PrependInt32Slot(0, stageDifficulty, 0)
def AddStageDifficulty(builder, stageDifficulty):
    return LimitedStageExcelAddStageDifficulty(builder, stageDifficulty)
def LimitedStageExcelAddStageEnterEchelonCount(builder, stageEnterEchelonCount): builder.PrependInt32Slot(1, stageEnterEchelonCount, 0)
...
def LimitedStageExcelAddStrategyMap(builder, strategyMap): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(strategyMap), 0)
def AddStrategyMap(builder, strategyMap):
    return LimitedStageExcelAddStrategyMap(builder, strategyMap)
def LimitedStageExcelAddInstantClear(builder, instantClear): builder.PrependBoolSlot(3, instantClear, 0)
def AddInstantClear(builder, instantClear):
    return LimitedStageExcelAddInstantClear(builder, instantClear)
def LimitedStageExcelAddStageEnterCostId(builder, stageEnterCostId): builder.PrependInt64Slot(4, stageEnterCostId, 0)
def AddStageEnterCostId(builder, stageEnterCostId):
    return LimitedStageExcelAddStageEnterCostId(builder, stageEnterCostId)
def LimitedStageExcelAddChallengeDisplay(builder, challengeDisplay): builder.PrependBoolSlot(5, challengeDisplay, 0)
def AddChallengeDisplay(builder, challengeDisplay):
    return LimitedStageExcelAddChallengeDisplay(builder, challengeDisplay)
def LimitedStageExcelAddOpenDate(builder, openDate): builder.PrependInt64Slot(6, openDate, 0)
...
def LimitedStageExcelAddPrevStageId(builder, prevStageId): builder.PrependInt64Slot(8, prevStageId, 0)
def AddPrevStageId(builder, prevStageId):
    return LimitedStageExcelAddPrevStageId(builder, prevStageId)
def LimitedStageExcelAddStageNumber(builder, stageNumber): builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(stageNumber), 0)
...
def LimitedStageExcelAddStageTopography(builder, stageTopography): builder.PrependInt32Slot(11, stageTopography, 0)
...
def LimitedStageExcelAddStageEnterCostType(builder, stageEnterCostType): builder.PrependInt32Slot(13, stageEnterCostType, 0)
...
def LimitedStageExcelAddStrategyEnvironment(builder, strategyEnvironment): builder.PrependInt32Slot(14, strategyEnvironment, 0)
...
def LimitedStageExcelAddId(builder, id): builder.PrependInt64Slot(16, id, 0)
def AddId(builder, id):
    return LimitedStageExcelAddId(builder, id)
def LimitedStageExcelAddOpenEventPoint(builder, openEventPoint): builder.PrependInt64Slot(17, openEventPoint, 0)
def AddOpenEventPoint(builder, openEventPoint):
    return LimitedStageExcelAddOpenEventPoint(builder, openEventPoint)
def LimitedStageExcelAddStageRewardId(builder, stageRewardId): builder.PrependInt64Slot(18, stageRewardId, 0)
def AddStageRewardId(builder, stageRewardId):
    return LimitedStageExcelAddStageRewardId(builder, stageRewardId)
def LimitedStageExcelAddClearScenarioGroupId(builder, clearScenarioGroupId): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(clearScenarioGroupId), 0)
...
def LimitedStageExcelAddGroundId(builder, groundId): builder.PrependInt64Slot(20, groundId, 0)
...
def LimitedStageExcelAddStageDisplay(builder, stageDisplay): builder.PrependInt32Slot(22, stageDisplay, 0)
def AddStageDisplay(builder, stageDisplay):
    return LimitedStageExcelAddStageDisplay(builder, stageDisplay)
def LimitedStageExcelAddBgmId(builder, bgmId): builder.PrependInt64Slot(23, bgmId, 0)
def AddBgmId(builder, bgmId):
    return LimitedStageExcelAddBgmId(builder, bgmId)
def LimitedStageExcelAddContentType(builder, contentType): builder.PrependInt32Slot(24, contentType, 0)
def AddContentType(builder, contentType):
    return LimitedStageExcelAddContentType(builder, contentType)
def LimitedStageExcelAddBattleDuration(builder, battleDuration): builder.PrependInt64Slot(25, battleDuration, 0)
def AddBattleDuration(builder, battleDuration):
    return LimitedStageExcelAddBattleDuration(builder, battleDuration)
def LimitedStageExcelAddRecommandLevel(builder, recommandLevel): builder.PrependInt32Slot(26, recommandLevel, 0)
def AddRecommandLevel(builder, recommandLevel):
    return LimitedStageExcelAddRecommandLevel(builder, recommandLevel)
def LimitedStageExcelAddBgmIdD0807648(builder, bgmIdD0807648): builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(bgmIdD0807648), 0)
def AddBgmIdD0807648(builder, bgmIdD0807648):
    return LimitedStageExcelAddBgmIdD0807648(builder, bgmIdD0807648)
def LimitedStageExcelAddBuffContentId(builder, buffContentId): builder.PrependInt64Slot(28, buffContentId, 0)
def AddBuffContentId(builder, buffContentId):
    return LimitedStageExcelAddBuffContentId(builder, buffContentId)
def LimitedStageExcelAddName(builder, name): builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)
def AddName(builder, name):
    return LimitedStageExcelAddName(builder, name)
def LimitedStageExcelAddStarConditionTacticRankSCount(builder, starConditionTacticRankSCount): builder.PrependInt64Slot(30, starConditionTacticRankSCount, 0)
...
def LimitedStageExcelAddEnterScenarioGroupId(builder, enterScenarioGroupId): builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(enterScenarioGroupId), 0)
