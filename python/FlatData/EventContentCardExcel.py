...
def EventContentCardExcelAddEventContentId(builder, eventContentId): builder.PrependInt64Slot(0, eventContentId, 0)
def AddEventContentId(builder, eventContentId):
    return EventContentCardExcelAddEventContentId(builder, eventContentId)
def EventContentCardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentCardExcelAddCardGroupId(builder, cardGroupId): builder.PrependInt32Slot(2, cardGroupId, 0)
def AddCardGroupId(builder, cardGroupId):
    return EventContentCardExcelAddCardGroupId(builder, cardGroupId)
def EventContentCardExcelAddBackIconPath(builder, backIconPath): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(backIconPath), 0)
def AddBackIconPath(builder, backIconPath):
    return EventContentCardExcelAddBackIconPath(builder, backIconPath)
def EventContentCardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
...
def EventContentCardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(5, localizeEtcId, 0)
def AddLocalizeEtcId(builder, localizeEtcId):
    return EventContentCardExcelAddLocalizeEtcId(builder, localizeEtcId)
def EventContentCardExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
