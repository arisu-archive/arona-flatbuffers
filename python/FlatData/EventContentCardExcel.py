...
def EventContentCardExcelAddIconPath(builder, iconPath): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(iconPath), 0)
...
def EventContentCardExcelAddCardGroupId(builder, cardGroupId): builder.PrependInt32Slot(3, cardGroupId, 0)
def AddCardGroupId(builder, cardGroupId):
    return EventContentCardExcelAddCardGroupId(builder, cardGroupId)
def EventContentCardExcelAddRewardParcelId(builder, rewardParcelId): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelId), 0)
...
def EventContentCardExcelAddLocalizeEtcId(builder, localizeEtcId): builder.PrependUint32Slot(6, localizeEtcId, 0)
