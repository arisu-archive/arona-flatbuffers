...
def CharacterSkillListExcelAddPassiveSkillGroupId(builder, passiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(passiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddPublicSkillTimeLineIndex(builder, publicSkillTimeLineIndex): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillTimeLineIndex), 0)
...
def CharacterSkillListExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(4, characterSkillListGroupId, 0)
...
def CharacterSkillListExcelAddExSkillLevelTimeLineIndex(builder, exSkillLevelTimeLineIndex): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillLevelTimeLineIndex), 0)
...
def CharacterSkillListExcelAddExSkillGroupId(builder, exSkillGroupId): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillGroupId), 0)
...
def CharacterSkillListExcelAddPublicSkillGroupId(builder, publicSkillGroupId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillGroupId), 0)
...
def CharacterSkillListExcelAddFormIndex(builder, formIndex): builder.PrependInt32Slot(9, formIndex, 0)
def AddFormIndex(builder, formIndex):
    return CharacterSkillListExcelAddFormIndex(builder, formIndex)
def CharacterSkillListExcelAddTsaInteractionId(builder, tsaInteractionId): builder.PrependInt64Slot(10, tsaInteractionId, 0)
...
def CharacterSkillListExcelAddIsRootMotion(builder, isRootMotion): builder.PrependBoolSlot(11, isRootMotion, 0)
def AddIsRootMotion(builder, isRootMotion):
    return CharacterSkillListExcelAddIsRootMotion(builder, isRootMotion)
def CharacterSkillListExcelAddMinimumTierCharacterGear(builder, minimumTierCharacterGear): builder.PrependInt32Slot(12, minimumTierCharacterGear, 0)
...
def CharacterSkillListExcelAddMinimumGradeCharacterWeapon(builder, minimumGradeCharacterWeapon): builder.PrependInt32Slot(13, minimumGradeCharacterWeapon, 0)
...
def CharacterSkillListExcelAddExtraPassiveSkillGroupId(builder, extraPassiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(extraPassiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddNormalSkillTimeLineIndex(builder, normalSkillTimeLineIndex): builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(normalSkillTimeLineIndex), 0)
...
def CharacterSkillListExcelAddExSkillCutInTimeLineIndex(builder, exSkillCutInTimeLineIndex): builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillCutInTimeLineIndex), 0)
...
def CharacterSkillListExcelAddIsMoveLeftRight(builder, isMoveLeftRight): builder.PrependBoolSlot(17, isMoveLeftRight, 0)
def AddIsMoveLeftRight(builder, isMoveLeftRight):
    return CharacterSkillListExcelAddIsMoveLeftRight(builder, isMoveLeftRight)
def CharacterSkillListExcelAddNormalSkillGroupId(builder, normalSkillGroupId): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(normalSkillGroupId), 0)
