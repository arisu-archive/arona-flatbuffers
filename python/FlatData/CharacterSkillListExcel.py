...
def CharacterSkillListExcelAddPublicSkillTimeLineIndex(builder, publicSkillTimeLineIndex): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(publicSkillTimeLineIndex), 0)
...
def CharacterSkillListExcelAddExSkillGroupId(builder, exSkillGroupId): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillGroupId), 0)
...
def CharacterSkillListExcelAddExSkillCutInTimeLineIndex(builder, exSkillCutInTimeLineIndex): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillCutInTimeLineIndex), 0)
...
def CharacterSkillListExcelAddIsMoveLeftRight(builder, isMoveLeftRight): builder.PrependBoolSlot(4, isMoveLeftRight, 0)
...
def CharacterSkillListExcelAddNormalSkillGroupId(builder, normalSkillGroupId): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(normalSkillGroupId), 0)
...
def CharacterSkillListExcelAddExSkillLevelTimeLineIndex(builder, exSkillLevelTimeLineIndex): builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(exSkillLevelTimeLineIndex), 0)
...
def CharacterSkillListExcelAddCharacterSkillListGroupId(builder, characterSkillListGroupId): builder.PrependInt64Slot(8, characterSkillListGroupId, 0)
...
def CharacterSkillListExcelAddHiddenPassiveSkillGroupId(builder, hiddenPassiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(hiddenPassiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddMinimumGradeCharacterWeapon(builder, minimumGradeCharacterWeapon): builder.PrependInt32Slot(11, minimumGradeCharacterWeapon, 0)
...
def CharacterSkillListExcelAddLeaderSkillGroupId(builder, leaderSkillGroupId): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(leaderSkillGroupId), 0)
...
def CharacterSkillListExcelAddMinimumTierCharacterGear(builder, minimumTierCharacterGear): builder.PrependInt32Slot(14, minimumTierCharacterGear, 0)
...
def CharacterSkillListExcelAddSelectExSkillActionSkillSlot(builder, selectExSkillActionSkillSlot): builder.PrependInt32Slot(16, selectExSkillActionSkillSlot, 0)
...
def CharacterSkillListExcelAddTsaInteractionId(builder, tsaInteractionId): builder.PrependInt64Slot(17, tsaInteractionId, 0)
...
def CharacterSkillListExcelAddPassiveSkillGroupId(builder, passiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(passiveSkillGroupId), 0)
...
def CharacterSkillListExcelAddExtraPassiveSkillGroupId(builder, extraPassiveSkillGroupId): builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(extraPassiveSkillGroupId), 0)
