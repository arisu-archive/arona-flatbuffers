...
def FieldMasteryExcelAddTokenId(builder, tokenId): builder.PrependInt64Slot(0, tokenId, 0)
def AddTokenId(builder, tokenId):
    return FieldMasteryExcelAddTokenId(builder, tokenId)
def FieldMasteryExcelAddTokenRequirement(builder, tokenRequirement): builder.PrependInt64Slot(1, tokenRequirement, 0)
def AddTokenRequirement(builder, tokenRequirement):
    return FieldMasteryExcelAddTokenRequirement(builder, tokenRequirement)
def FieldMasteryExcelAddTokenType(builder, tokenType): builder.PrependInt32Slot(2, tokenType, 0)
...
def FieldMasteryExcelAddAccomplishmentConditionId(builder, accomplishmentConditionId): builder.PrependInt64Slot(6, accomplishmentConditionId, 0)
