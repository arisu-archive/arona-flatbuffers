...
def FieldMasteryExcelAddTokenType(builder, tokenType): builder.PrependInt32Slot(0, tokenType, 0)
def AddTokenType(builder, tokenType):
    return FieldMasteryExcelAddTokenType(builder, tokenType)
def FieldMasteryExcelAddOrder(builder, order): builder.PrependInt32Slot(1, order, 0)
def AddOrder(builder, order):
    return FieldMasteryExcelAddOrder(builder, order)
def FieldMasteryExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(2, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return FieldMasteryExcelAddUniqueId(builder, uniqueId)
def FieldMasteryExcelAddAccomplishmentConditionType(builder, accomplishmentConditionType): builder.PrependInt32Slot(3, accomplishmentConditionType, 0)
...
def FieldMasteryExcelAddAccomplishmentConditionId(builder, accomplishmentConditionId): builder.PrependInt64Slot(5, accomplishmentConditionId, 0)
...
def FieldMasteryExcelAddExpAmount(builder, expAmount): builder.PrependInt64Slot(6, expAmount, 0)
def AddExpAmount(builder, expAmount):
    return FieldMasteryExcelAddExpAmount(builder, expAmount)
def FieldMasteryExcelAddTokenRequirement(builder, tokenRequirement): builder.PrependInt64Slot(7, tokenRequirement, 0)
def AddTokenRequirement(builder, tokenRequirement):
    return FieldMasteryExcelAddTokenRequirement(builder, tokenRequirement)
def FieldMasteryExcelAddTokenId(builder, tokenId): builder.PrependInt64Slot(8, tokenId, 0)
