...
def TacticArenaSimulatorSettingExcelAddDefenderStrikerNum(builder, defenderStrikerNum): builder.PrependInt64Slot(0, defenderStrikerNum, 0)
...
def TacticArenaSimulatorSettingExcelAddOrder(builder, order): builder.PrependInt64Slot(1, order, 0)
def AddOrder(builder, order):
    return TacticArenaSimulatorSettingExcelAddOrder(builder, order)
def TacticArenaSimulatorSettingExcelAddAttackerUserArenaRank(builder, attackerUserArenaRank): builder.PrependInt64Slot(2, attackerUserArenaRank, 0)
...
def TacticArenaSimulatorSettingExcelAddDefenderUserArenaRank(builder, defenderUserArenaRank): builder.PrependInt64Slot(3, defenderUserArenaRank, 0)
...
def TacticArenaSimulatorSettingExcelAddDefenderSpecialNum(builder, defenderSpecialNum): builder.PrependInt64Slot(4, defenderSpecialNum, 0)
...
def TacticArenaSimulatorSettingExcelAddDefenderPresetGroupId(builder, defenderPresetGroupId): builder.PrependInt64Slot(6, defenderPresetGroupId, 0)
...
def TacticArenaSimulatorSettingExcelAddRepeat(builder, repeat): builder.PrependInt64Slot(7, repeat, 0)
def AddRepeat(builder, repeat):
    return TacticArenaSimulatorSettingExcelAddRepeat(builder, repeat)
def TacticArenaSimulatorSettingExcelAddAttackerUserArenaGroup(builder, attackerUserArenaGroup): builder.PrependInt64Slot(8, attackerUserArenaGroup, 0)
...
def TacticArenaSimulatorSettingExcelAddDefenderFrom(builder, defenderFrom): builder.PrependInt32Slot(9, defenderFrom, 0)
def AddDefenderFrom(builder, defenderFrom):
    return TacticArenaSimulatorSettingExcelAddDefenderFrom(builder, defenderFrom)
def TacticArenaSimulatorSettingExcelAddAttackerPresetGroupId(builder, attackerPresetGroupId): builder.PrependInt64Slot(10, attackerPresetGroupId, 0)
...
def TacticArenaSimulatorSettingExcelAddAttackerSpecialNum(builder, attackerSpecialNum): builder.PrependInt64Slot(11, attackerSpecialNum, 0)
...
def TacticArenaSimulatorSettingExcelAddAttackerFrom(builder, attackerFrom): builder.PrependInt32Slot(13, attackerFrom, 0)
def AddAttackerFrom(builder, attackerFrom):
    return TacticArenaSimulatorSettingExcelAddAttackerFrom(builder, attackerFrom)
def TacticArenaSimulatorSettingExcelAddAttackerStrikerNum(builder, attackerStrikerNum): builder.PrependInt64Slot(14, attackerStrikerNum, 0)
