...
def CumulativeTimeRewardExcelAddId(builder, id): builder.PrependInt64Slot(1, id, 0)
...
def CumulativeTimeRewardExcelAddDescription(builder, description): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)
...
def CumulativeTimeRewardExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(rewardParcelType), 0)
