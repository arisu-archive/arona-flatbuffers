...
def FieldInteractionExcelAddConditionClass(builder, conditionClass): builder.PrependInt32Slot(1, conditionClass, 0)
def AddConditionClass(builder, conditionClass):
    return FieldInteractionExcelAddConditionClass(builder, conditionClass)
def FieldInteractionExcelAddInteractionType(builder, interactionType): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(interactionType), 0)
...
def FieldInteractionExcelAddFieldSeasonId(builder, fieldSeasonId): builder.PrependInt64Slot(3, fieldSeasonId, 0)
def AddFieldSeasonId(builder, fieldSeasonId):
    return FieldInteractionExcelAddFieldSeasonId(builder, fieldSeasonId)
def FieldInteractionExcelAddFieldDateId(builder, fieldDateId): builder.PrependInt64Slot(4, fieldDateId, 0)
def AddFieldDateId(builder, fieldDateId):
    return FieldInteractionExcelAddFieldDateId(builder, fieldDateId)
def FieldInteractionExcelAddShowEmoji(builder, showEmoji): builder.PrependBoolSlot(5, showEmoji, 0)
def AddShowEmoji(builder, showEmoji):
    return FieldInteractionExcelAddShowEmoji(builder, showEmoji)
def FieldInteractionExcelAddConditionIndex(builder, conditionIndex): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(conditionIndex), 0)
...
def FieldInteractionExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(9, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return FieldInteractionExcelAddUniqueId(builder, uniqueId)
def FieldInteractionExcelAddConditionId(builder, conditionId): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(conditionId), 0)
...
def FieldInteractionExcelAddKeywordLocalize(builder, keywordLocalize): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(keywordLocalize), 0)
def AddKeywordLocalize(builder, keywordLocalize):
    return FieldInteractionExcelAddKeywordLocalize(builder, keywordLocalize)
def FieldInteractionExcelAddOnceOnly(builder, onceOnly): builder.PrependBoolSlot(13, onceOnly, 0)
