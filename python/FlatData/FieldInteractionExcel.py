...
def FieldInteractionExcelAddConditionId(builder, conditionId): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(conditionId), 0)
...
def FieldInteractionExcelAddConditionType(builder, conditionType): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(conditionType), 0)
...
def FieldInteractionExcelAddFieldSeasonId(builder, fieldSeasonId): builder.PrependInt64Slot(2, fieldSeasonId, 0)
def AddFieldSeasonId(builder, fieldSeasonId):
    return FieldInteractionExcelAddFieldSeasonId(builder, fieldSeasonId)
def FieldInteractionExcelAddConditionClass(builder, conditionClass): builder.PrependInt32Slot(3, conditionClass, 0)
def AddConditionClass(builder, conditionClass):
    return FieldInteractionExcelAddConditionClass(builder, conditionClass)
def FieldInteractionExcelAddConditionIndex(builder, conditionIndex): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(conditionIndex), 0)
...
def FieldInteractionExcelAddOnceOnly(builder, onceOnly): builder.PrependBoolSlot(5, onceOnly, 0)
def AddOnceOnly(builder, onceOnly):
    return FieldInteractionExcelAddOnceOnly(builder, onceOnly)
def FieldInteractionExcelAddKeywordLocalize(builder, keywordLocalize): builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(keywordLocalize), 0)
def AddKeywordLocalize(builder, keywordLocalize):
    return FieldInteractionExcelAddKeywordLocalize(builder, keywordLocalize)
def FieldInteractionExcelAddUniqueId(builder, uniqueId): builder.PrependInt64Slot(7, uniqueId, 0)
def AddUniqueId(builder, uniqueId):
    return FieldInteractionExcelAddUniqueId(builder, uniqueId)
def FieldInteractionExcelAddInteractionId(builder, interactionId): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(interactionId), 0)
...
def FieldInteractionExcelAddShowEmoji(builder, showEmoji): builder.PrependBoolSlot(9, showEmoji, 0)
def AddShowEmoji(builder, showEmoji):
    return FieldInteractionExcelAddShowEmoji(builder, showEmoji)
def FieldInteractionExcelAddConditionClassParameters(builder, conditionClassParameters): builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(conditionClassParameters), 0)
...
def FieldInteractionExcelAddNegateCondition(builder, negateCondition): builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(negateCondition), 0)
...
def FieldInteractionExcelAddInteractionType(builder, interactionType): builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(interactionType), 0)
