...
def DuplicateBonusExcelAddRewardParcelType(builder, rewardParcelType): builder.PrependInt32Slot(0, rewardParcelType, 0)
...
def DuplicateBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount): builder.PrependInt64Slot(2, rewardParcelAmount, 0)
def AddRewardParcelAmount(builder, rewardParcelAmount):
    return DuplicateBonusExcelAddRewardParcelAmount(builder, rewardParcelAmount)
def DuplicateBonusExcelAddItemCategory(builder, itemCategory): builder.PrependInt32Slot(3, itemCategory, 0)
def AddItemCategory(builder, itemCategory):
    return DuplicateBonusExcelAddItemCategory(builder, itemCategory)
def DuplicateBonusExcelAddCharacterId(builder, characterId): builder.PrependInt64Slot(4, characterId, 0)
